	...
	<table>
		...
		<tr>
			<td colspan="3" class="cinta">
				<a href="cont-importacuentas.php" class="mgbt"><img src="imagenes/add2.png" title="Nuevo" /></a>
				<a class="mgbt"><img src="imagenes/guardad.png"/></a>
				<a href="cont-vercuentascgr.php" class="mgbt"><img src="imagenes/buscad.png" title="Buscar" /></a>
				...
				<a href="presu-codigoscgr.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
			</td>
		</tr>
	</table>
	<form action="presu-vigenciagasto.php" method="post" enctype="multipart/form-data" name="form2">
	<?php
		$_POST[tabgroup1]=1;
					...
					echo "<table class='inicio'>
						...
						if($_POST[oculto]==2)
						{
							...
							if($archivo)
							{
								...
								$sqlr1="delete from pptosidefgasto";
								...
								{ 
									...
									if($datos[0]!='' && $datos[0]!='Codigo')
									{
										...
										$consulta = "INSERT INTO pptosidefgasto (codigo, nombre, estado) VALUES ('".trim($datos[0])."','".trim($datos[1])."','S')";
							...
							$sql="select * from pptosidefgasto order by codigo";
