...
document.form2.oculto.value=2;
document.form2.action="teso-concecontablesgassf.php";
document.form2.submit();
}
function validar()
{
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a class="mgbt" href="teso-concecontablesgassf.php"><img src="imagenes/add.png" title="Nuevo"/></a>
			<a class="mgbt" href="#" onClick="guardar()"><img src="imagenes/guarda.png" title="Guardar" /></a>
			<a href="teso-buscaconcecontablesgassf.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
			...
			<a class="mgbt" href="teso-concecontables.php"><img src="imagenes/iratras.png" alt="Atr&aacute;s"></a>
		</td>
	</tr>
</table>
...
{	
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(RIGHT(codigo,2)) from conceptoscontables where modulo=4 and tipo='GS' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8">.: Concepto Contable Gastos SSF</td>
      ...
      <tr  >
		<td width="119" class="saludo1">Codigo:</td>
		 ...
		 <td width="119" class="saludo1">Nombre:</td>
		  ...
		  onKeyUp="return tabular(event,this)" value="<?php echo $_POST[nombre]?>" onClick="document.getElementById('acuerdo').focus();document.getElementById('acuerdo').select();"></td><td class="saludo1">Tipo:</td><td><input name="tipo" value="Causacion" size="10" type="text">
		  <input name="tipoc" value="GS" size="10" type="hidden">
	...
	if ($_POST[agregadet]=='1')
		 ...
		 {echo "
			<tr class='$iter'>
				<td><input name='fecha[]' value='".$_POST[fecha][$x]."' class='inpnovisibles' type='text' size='8' readonly></td>
				<td><input name='dccs[]' value='".$_POST[dccs][$x]."' class='inpnovisibles' type='text' size='2' readonly></td>
				<td><input name='dcuentas[]' value='".$_POST[dcuentas][$x]."' class='inpnovisibles' type='text' size='8' readonly></td>
				<td><input name='dncuentas[]' value='".$_POST[dncuentas][$x]."' class='inpnovisibles' type='text' size='70' readonly></td>
				<td><input name='ddebitos[]' value='".$_POST[ddebitos][$x]."' class='inpnovisibles' type='text' size='3' onDblClick='llamarventanadeb(this,$x)' readonly></td>
				<td><input name='dcreditos[]' value='".$_POST[dcreditos][$x]."' class='inpnovisibles' type='text' size='3' onDblClick='llamarventanacred(this,$x)' readonly></td>
	...
	if($_POST[oculto]=='2')	
		...
		if(!mysql_query($sqlr,$linkbd))
		 {
		   echo "<table class='inicio'><tr class='saludo1a'><td><center>No Se ha Almacenado con Exito El Concepto Contable, Error: $sqlr </center></td></tr></table>";
		 }
		 else
		 {
		 echo "<table class='inicio'><tr class='saludoa1'><td ><center>Se ha Almacenado con Exito El Concepto Contable</center></td></tr></table>";
