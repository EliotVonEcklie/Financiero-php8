...
<body>
 <IFRAME src="alertas.php" name="alertas" id="alertas" style="display:none"></IFRAME>
		...
		<form name="form2" method="post" action="ejecucioningresos2.php">
			<?php
 ...
 ?>
	...
	{
	?>
	<div class="subpantallap" style="height:66.6%; width:115.6%; ">
	...
	<?php
		...
		$iter2="zebra2";
		$tipo=array();
		echo "<table class='inicio2'>
			<tr class='titulos'>
				<td colspan='8'>.: Ejecucion Cuentas</td>
			</tr>
			<tr class='titulos2'>
				<td>Cuenta</td>
				<td >Nombre</td>
