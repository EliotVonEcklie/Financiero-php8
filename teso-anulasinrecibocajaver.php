...
<script>
	...
	function adelante(scrtop, numpag, limreg, filtro){
		if(parseFloat(document.form2.ncomp.value)<parseFloat(document.form2.maximo.value)){
			...
			document.form2.action="teso-anulasinrecibocajaver.php?idrecibo="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			document.form2.submit();
		}
	}
	...
	function iratras(scrtop, numpag, limreg, filtro){
		var idcta=document.getElementById('ncomp').value;
		location.href="teso-anulasinrecibocaja.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
	}

	function validar2(){
		//   alert("Balance Descuadrado");
		//document.form2.oculto.value=1;
		//document.form2.action="teso-anulasinrecibocajaver.php";
		//document.form2.submit();
		location.href="teso-anulasinrecibocajaver.php?idrecibo="+document.form2.idcomp.value;
	}
</script>
...
<tr>
  ...
  <a href="teso-anulasinrecibocaja.php" class="mgbt"><img src="imagenes/add.png" alt="Nuevo"  border="0" title="Nuevo" /></a> 
  <a class="mgbt"><img src="imagenes/guardad.png"  alt="Guardar" title="Guardar"/></a>
  <a href="teso-anulasinrecibocaja.php" class="mgbt"> <img src="imagenes/busca.png"  alt="Buscar" title="Buscar"/></a> 
  <a href="#" onClick="mypop=window.open('teso-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" alt="nueva ventana" title="Nueva Ventama"></a> 
    	...
    	<tr >
      	...
      	<tr>
        	...
        	<td style="width:15%" >
                ...
                <input id="idcomp" name="idcomp" type="text" style="width:50%" value="<?php echo $_POST[idcomp]?>" onKeyUp="return tabular(event,this)" onChange="validar2()">
