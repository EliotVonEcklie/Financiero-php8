...
$crit2=" ";
if ($_POST[numero]!="")
$crit1=" and tesorecaudotransferencialiquidar.id_recaudo  like '%".$_POST[numero]."%' ";
if ($_POST[nombre]!="")
$crit2=" and tesorecaudotransferencialiquidar.concepto like '%".$_POST[nombre]."%'  ";
//sacar el consecutivo 
//$sqlr="select *from pptosideforigen where".$crit1.$crit2." order by pptosideforigen.codigo";
	$sqlr="select *from tesorecaudotransferencialiquidar where tesorecaudotransferencialiquidar.id_RECAUDO>-1 ".$crit1.$crit2." order by tesorecaudotransferencialiquidar.id_RECAUDO desc";
