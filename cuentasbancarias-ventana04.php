...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script> 
			function ponprefijo(var00,var01,var02,var03,var04,var05)
			{
				//alert(".-0-."+var00+".-1-."+var01+".-2-."+var02+".-3-."+var03+".-4-."+var04+".-5-."+var05)
   				parent.document.form2.banco.value =var03;
				parent.document.form2.nbanco.value =var00;
				//parent.document.form2.tpcta.value =var04;
				parent.document.form2.cb.value =var03;
				parent.document.form2.ct.value =var05;
				//alert("2");
	...
	<body >
  	<form action="" method="post" name="form2">
		...
		<table  class="inicio" style="width:99.4%;">
      		...
      		<tr >
        		<td style="width:4.5cm" class="saludo1">:. N&deg; Documento, Nombre o Razón Social:
		...
		<div class="subpantalla" style="height:86%; width:99%; overflow-x:hidden;">
			<?php
				...
				$sqlr="select TB1.razonsocial,TB3.nombre,TB2.cuenta,TB2.ncuentaban,TB2.tipo from terceros TB1,tesobancosctas TB2,cuentas TB3 where TB2.tercero=TB1.cedulanit and TB2.estado='S'  AND TB3.cuenta=TB2.cuenta $crit1";
				$resp = mysql_query($sqlr,$linkbd);
				$_POST[numtop]=mysql_num_rows($resp);
				$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
				$sqlr="select TB1.razonsocial,TB3.nombre,TB2.cuenta,TB2.ncuentaban,TB2.tipo,TB1.cedulanit from terceros TB1,tesobancosctas TB2,cuentas TB3 where TB2.tercero=TB1.cedulanit and TB2.estado='S'  AND TB3.cuenta=TB2.cuenta $crit1 ORDER BY TB3.cuenta,TB1.cedulanit LIMIT $_POST[numpos],$_POST[numres]";
				...
				{	
					...
					echo"<tr class='$varcol' style='text-transform:uppercase' onClick=\"javascript:ponprefijo('$row[0]','$row[1]','$row[2]', '$row[3]','$row[4]',$row[5])\" onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" >
					<td>$con2 $colval </td>
					 	<td>$row[0]</td>
					 	<td>$row[1]</td>
					 	<td>$row[2]</td>
