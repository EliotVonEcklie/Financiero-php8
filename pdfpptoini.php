...
{	
	...
	$this->SetY(8);
    $this->Cell(50.1);
    $this->Cell(149,25,'PRESUPUESTO INICIAL',0,0,'C'); 
	//************************************
    $this->SetFont('Arial','B',10);
...
{	if ($con%2==0)
   ...
   // $pdf->Cell(32,4,substr(''.$_POST[balan][3],0,28),0,0,'L',1);//descrip
    ...
    $pdf->Cell(38,4,''.number_format($_POST[dingresos][$con],2),0,0,'R',1);//descrip
  $pdf->Cell(38,4,''.number_format($_POST[dgastos][$con],2),0,0,'R',1);
	$pdf->ln(4);	
