...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function validar(formulario){document.form2.action="ccp-terceros.php";document.form2.submit();}
			...
			function funcionmensaje(){document.location.href = "ccp-terceros.php";}
