...
<tr><td colspan="3" class="tablaprin"> 
	<form name="form2" method="post" action="presu-buscasinsituacion-reflejar.php">
			...
			$iter2='saludo2';
 			while ($row =mysql_fetch_row($resp)){
				...
				$estadosemaforo="<img src='imagenes/sema_rojoON.jpg' style='width:19px; ' title='Inactivo'>";
		 		...
		 		echo "<tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor; this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase;cursor:pointer' onDblClick=\"window.open('presu-sinsituacion-reflejar.php?idr=$row[0]','_self');\">
					<td >$row[0]</td>
					<td >$ntr</td>
					<td>$row[2]</td>
					...
					<td style='text-align:center;'>".strtoupper($estadosemaforo)."</td>";
	 				echo "<td style='text-align:center;'>
						<a href='presu-sinsituacion-reflejar.php?idr=$row[0]'>
