	...
	<body>
  		<form action="" method="post" enctype="multipart/form-data" name="form1">
			...
			<table  class="inicio ancho" align="center" >
     			<tr>
                	<td class="titulos" colspan="5" width="100%">:: Buscar Responsable</td>
                    <td class="boton02" onClick="parent.despliegamodal2('hidden');" >Cerrar</td>
                </tr>
      			<tr>
        			<td class="saludo1" style="width:2cm;">Nombre o apellidos:</td>
        			<td style="width:35%;"><input type="text" name="nombre" id="nombre" style="width:100%;" value="<?php echo $_POST[nombre];?>"/></td>
        			<td class="saludo1" style="width:2cm;">Documento:</td>
					<td>
						<input type="text" name="documento" id="documento" value="<?php echo $_POST[documento];?>">
					</td>
					<td>
						<em class="botonflecha" type="submit" name="Submit" >Buscar</em>
					</td>
       			</tr>                       
    		</table> 
				...
				<table class='inicio' align='center' width='99%'>
					...
					$iter2='saludo2';
 					while ($row =mysql_fetch_row($resp)) 
 					{
						...
						echo"
							<tr class='$iter' style='text-transform:uppercase;' onClick=\"javascript:ponprefijo('$row[12]','$ntercero')\" onMouseOver=\"anterior=this.style.backgroundColor; this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\">
	 							<td>$con2</td>
								<td>$row[24]</td>
								<td>$row[3]</td>
								<td>$row[4]</td>
