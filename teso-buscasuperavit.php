...
<form name="form2" method="post" action="teso-buscasuperavit.php">
    ...
    <?php
		...
		$crit2=" ";
		if ($_POST[numero]!="")
		$crit1=" and pptosuperavit.consvigencia  like '%".$_POST[numero]."%'";
		$sqlr="select * from pptosuperavit where pptosuperavit.consvigencia>-1 ".$crit1." order by pptosuperavit.consvigencia desc";
		...
		while ($row =mysql_fetch_row($resp)) 
		{
			...
			echo "<tr class='$iter'>
					...
					<td><a href='teso-superavitver.php?id=$row[1]'><center><img src='imagenes/buscarep.png'></center></a></td>
				</tr>";
			$con+=1;
			$aux=$iter;
			$iter=$iter2;
