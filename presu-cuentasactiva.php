...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verCuentaActiva(idcta, tipo, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="presu-editarcuentasactiva.php?idcta="+idcta+"&tipo="+tipo+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<?php titlepag();?>
        <?php
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
		       	<td colspan="3" class="cinta">
                    ...
                    <a href="#" onClick="mypop=window.open('presu-principal.php','','');mypop.focus();"class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><img src="imagenes/iratras.png" title="Atr&aacute;s" onClick="location.href='presu-menucuentas.php'" class="mgbt"/>
               	</td>
			</tr>
		</table>
        <?php
		...
		?>
		<form  method="post" enctype="multipart/form-data" name="form2" action="presu-cuentasactiva.php">
