	...
	<head>
		...
		<script>
			...
			function redireccionardestino()
			{
				...
				{
					case '1':
					document.location='presu-cdpcontra.php?vdir=1';
					break;

					case '2':
					document.location='presu-cdp.php?vdir=2';
					break;

					case '3':
					document.location='presu-cdpnomina.php?vdir=3';
					break;
				}
			}
			function despliegamodal2(_valor,_tip)
			{
				...
				else
				{
					...
					{
						case "1":
							document.getElementById('ventana2').src="presu-solicitudproceso.php";break;
					}
				}
			}
			function guardar()
			...
			{document.form2.chacuerdo.value=2;document.form2.action="presu-cdpcontra.php";document.form2.submit();}
			function validar2(formulario)
			{document.form2.chacuerdo.value=2;document.form2.action="presu-cdp.php";document.form2.submit();}
			function validarcdp()
			{
			...
			function funcionmensaje()
			{
				...
				window.location.href = "presu-cdpver.php?is="+numdocar+"&vig="+vigencar;
			}
        ...
        <table>
        	...
        	<tr>
  				<td colspan="3" class="cinta">
					<a href="presu-cdpcontra.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
 ...
 <form name="form2" method="post" action="">
    ...
    <table class="inicio" align="center" width="80%" >
    	<tr>
        	...
        	<td width="65" class="cerrar" ><a href="presu-principal.php">Cerrar</a></td>
     	</tr>
     	<tr>
