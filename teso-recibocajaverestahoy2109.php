...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			{
			alert("holaaa");
			if (document.form2.idcomp.value!='' && document.form2.concepto.value!='')
			  {
			  ...
			  alert('Faltan datos para completar el registro);
				document.form2.idcomp.focus();
				document.form2.idcomp.select();
			  }
			 }
		</script>
		<?php titlepag();?>
	...
	<body>
    		...
    		<table class="inicio" style="width:99.7%;">
				...
				?> 
	  			<tr>
                    ...
                    <td colspan="<?php if($_POST[tiporec]==2){echo '3';}else{echo'5';}?>"><input name="concepto" type="text" value="<?php echo $_POST[concepto] ?>" onKeyUp="return tabular(event,this)" style="width:100%;" ></td>
              	</tr>
                <tr>
		...
		if($_POST[oculto]=='2'){
			$linkbd=conectar_bd();
			$sqlr="update comprobante_cab set concepto='$_POST[concepto]' where tipo_comp='5' and numerotipo='$_POST[idcomp]'";
			mysql_query($sqlr,$linkbd);	
				if(!mysql_query($sqlr,$linkbd))
			{
				echo "<table class='inicio'><tr><td class='saludo1'><center>No Se ha actualizado el recibo</center></td></tr></table>";
			}
			else
			{
				echo "<table class='inicio'><tr><td class='saludo1'><center>Se ha Actualizado el recibo</center></td></tr></table>";
			}
		}
		?>
	</body>
