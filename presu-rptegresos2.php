...
//************* genera reporte ************
	function pdf(){
		...
		if(validacion01!='' && validacion02!=''){
			document.form2.action="pdfrptegresos.php";
...
//************* genera reporte ************
	function excell(){
		...
		var validacion02=document.getElementById('fechafin').value;
		if(validacion01!='' && validacion02!=''){
			document.form2.action="presu-auxiliaregresosexcel.php";
			document.form2.target="_BLANK";
			document.form2.submit(); 
			document.form2.action="";
			document.form2.target="";
...
//***************************************
	function validar(formulario){
		document.form2.action="presu-rptegresos.php";
		document.form2.submit();
	}
</script>
<?php titlepag();?>
...
<form name="form2" method="post" action="presu-rptegresos.php">
	<table width="100%" align="center"  class="inicio" >
    	<tr>
        	<td class="titulos" style="width:93%" colspan="7">:: Buscar .: Auxiliar de Egresos </td>
