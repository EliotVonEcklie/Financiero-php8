...
<head>
    ...
    <script type="text/javascript" src="css/programas.js"></script>
     <script>
		...
		{
			if (confirm("Desea Activar Nuevamente este Recordatorio"))
			{
...
<body>
	...
	<form name="form2" method="post" action="plan-alertasbuscacumplidos.php">
	<table  class="inicio" align="center" >
		<tr>
        	<td class="titulos" colspan="7">:: Buscar Recordatorios Cumplidos </td>
      	</tr>
      	<tr>
    ...
    <div class="subpantallac5" style="height:86%; overflow-x:hidden;">
		...
		{
			$linkbd=conectar_bd();
			$sqlr = "UPDATE alertasdiarias SET estado='A' WHERE codigo='$_POST[iddmod]' ";
			mysql_query($sqlr,$linkbd);
			?><script>alert("Se Marco como Activo Nuevamente el Recordatorio");document.form2.ocumod.value="0";</script><?php
		}
		if($_POST[ocumod]=='2')
		{
			$linkbd=conectar_bd();
			...
			mysql_query($sqlr,$linkbd);
			?><script>alert("Se Elimino el Recordatorio");document.form2.ocumod.value="0";</script><?php
		}
		$oculto=$_POST['oculto'];
		if($_POST[oculto])
		{
			...
			if ($_POST[cdescripcio]!=""){$crit1=" AND descripcion LIKE '%$_POST[cdescripcio]%' ";}
           	$sqlr="SELECT * FROM alertasdiarias WHERE usuario='".$_SESSION[cedulausu]."' AND estado='C' ".$crit1." ORDER BY fechaevento ASC";
			...
			echo'
				<table class="inicio">        
                	<tr>
                    	<td class="titulos" colspan="12">::Lista de Recordatorios Cumplidos</td>
                    </tr>
					<tr>
                    ...
                    <tr>
						...
						<td class="titulos2" style="width:4%" rowspan="2"  align="middle">Activar Nuevamente</td>
