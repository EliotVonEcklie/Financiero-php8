...
function redirecciona(id){
	window.location.href ='teso-ingresopresupuestover.php?id='+id;
}
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a href="teso-ingresopresupuesto.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
...
<form name="form2" method="post" action="teso-buscaingresopresupuesto.php">
	<table  class="inicio" align="center" >
		<tr >
			<td class="titulos" colspan="6">:. Buscar Ingreso presupuesto</td>
			<td width="70" class="cerrar" ><a href="teso-principal.php"> Cerrar</a></td>
		</tr>
		<tr >
			<td width="10" class="saludo1">Numero Ingreso:</td>
			<td width="154" >
    ...
    <?php
		...
		$crit2=" ";
		if ($_POST[numero]!="")
		$crit1=" and pptoingresopresupuesto.consvigencia  like '%".$_POST[numero]."%'";
		$sqlr="select * from pptoingresopresupuesto where pptoingresopresupuesto.consvigencia>-1 ".$crit1." order by pptoingresopresupuesto.consvigencia desc";
		...
		while ($row =mysql_fetch_row($resp)) 
		{
			...
			echo "<tr class='$iter' onDblClick='redirecciona($row[1])'>
					...
					<td><a href='teso-ingresopresupuestover.php?id=$row[1]'><center><img src='imagenes/buscarep.png'></center></a></td>
				</tr>";
			$con+=1;
			$aux=$iter;
			$iter=$iter2;
