...
function genrep(idfac)
{
        ...
        <table>
			...
			<tr>
				<td colspan="3" class="cinta">
					<a href="teso-actividades.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
					<a href="#" onClick="document.form2.submit();" class="mgbt"><img src="imagenes/guarda.png" title="Guardar"/></a>
					<a href="teso-buscaactividades.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a>
 ...
 <form name="form2" method="post" action="teso-actividades.php">
    <table class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="6">.: Agregar Actividad</td><td class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
      </tr>
      <tr  >
	  <td class="saludo1">.: Codigo:
        </td>
        <td>
			<input name="codigo" type="text" value="<?php echo $_POST[codigo]?>"  onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)">
        </td>
        <td class="saludo1">.: Nombre Actividad:
        </td>
        <td >
			<input name="nombre" type="text" value="<?php echo $_POST[nombre]?>"  onKeyUp="return tabular(event,this)">
        </td>
        <td class="saludo1">.: Porcentaje:
        </td>
...
if ($_POST[nombre]!="")
 {
 $nr="1";
 $sqlr="INSERT INTO codigosciiu (codigo,nombre,porcentaje)VALUES ('$_POST[codigo]','".utf8_decode($_POST[nombre])."', '$_POST[porcentaje]')";
 //echo "sqlr:".$sqlr;
