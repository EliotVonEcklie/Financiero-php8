...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
			...
			function funcionmensaje(){document.location.href = "cont-contexoformatosagregar.php";}
	...
	<body>
		...
		<form name="form2" method="post" action="">
			<?php
				...
				if(!$_POST['oculto'])
				{
					$_POST['idnum']=$_POST['codigo']=selconsecutivo('contexoformatos','idnum');
			...
			<table class="inicio" align="center" >
				<tr >
					<td class="titulos" colspan="10">.: Agregar Formatos</td>
			...
			<?php
				...
				if($_POST['oculto']=='2')
				{
					if ($_POST['nombre']!="")
					{
						...
						$_POST['idnum']=selconsecutivo('contexoformatos','idnum');
						$sqlr="INSERT INTO contexoformatos (idnum,codigo,nombre,estado,monto,columna) VALUES ('".$_POST['idnum']."','".$_POST['codigo']."','".iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$_POST['nombre'])."','S','".$_POST['monto']."','".$_POST['letra']."')";
