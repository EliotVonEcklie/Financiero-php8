...
<form name="form2" method="post" action="presu-buscaracuerdos.php">
	...
	<table width="100%" align="center"  class="inicio" >
    	...
    	<tr  >
    		<td width="108" class="saludo1">Vigencia:</td>
    		<td width="64">
    			<input size="5" type="text" name="vigencia" value="<?php echo $_POST[vigencia] ?>" >
    		</td>
    		<td width="68" class="saludo1">Numero:</td>
    		<td width="175">
    			<input name="numero" type="text" id="numero" value="<?php echo $_POST[numero] ?>" size="5">
    		</td>
    		<td width="87" class="saludo1">Fecha Inicial: </td>
    		<td width="162" >
  		...
  		<tr>
    		...
    		<td colspan="3">
    			<input name="objeto" type="text" id="objeto" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[objeto]?>" size="60">
    		</td>
    		<td class="saludo1">Tipo:</td>
    		<td colspan="6">
				<select name="tipoacuerdo" id="tipoacuerdo" onKeyUp="return tabular(event,this)" onChange="clasifica()">
...
$sqlr="select *from pptoacuerdos where pptoacuerdos.estado!='A' ".$crit1.$crit2.$crit3.$crit4.$crit5." order by pptoacuerdos.vigencia DESC, pptoacuerdos.consecutivo ";
...
$sqlr="select *from pptoacuerdos where pptoacuerdos.estado!='A' ".$crit1.$crit2.$crit3.$crit4.$crit5." order by pptoacuerdos.fecha DESC,pptoacuerdos.vigencia DESC, pptoacuerdos.consecutivo $cond2";
$resp = mysql_query($sqlr,$linkbd);
$con=1;
