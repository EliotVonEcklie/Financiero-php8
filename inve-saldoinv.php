	...
	<body>
        ...
        <table>
		    ...
		    <tr><?php menu_desplegable("inve");?></tr>
          	<tr>
          		<td colspan="3" class="cinta"><img src="imagenes/add2.png" title="Nuevo" class="mgbt"/><img src="imagenes/guardad.png" title="Guardar" class="mgbt" /><img src="imagenes/buscad.png" title="Buscar" class="mgbt" /><a href="#" class="mgbt" onClick="mypop=window.open('inve-principal.php','','');mypop.focus();"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a class="mgbt" href="	" target="_blank"><img src="imagenes/print.png"></a><a class="mgbt"><img src="imagenes/excel.png"></a></td>
        	</tr>
		</table>
