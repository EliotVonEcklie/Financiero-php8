        ...
        <table>
 		...
 		<form name="form2" method="post" action="">
    		<table class="inicio">
				...
				<ol id="lista2">
						<li onClick="location.href='presu-rpn.php'" style="cursor:pointer">RP N&oacute;mina</li>
						<li onClick="location.href='presu-rp.php'" style="cursor:pointer">RP B&aacute;sico</li>
                        <li onClick="location.href='presu-rp.php'" style="cursor:pointer">Contrataci&oacute;n</li>
				</ol>
