...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-estratoseditar.php?idban="+idban;
			}
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para crear el Estrato');}
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='serv-estratos.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar()" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='serv-estratosbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("serv");?>" class="mgbt"></td>
			</tr>
		</table>
		...
		<form name="form2" method="post" action="">
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvestratos','id');
					$sqlr="INSERT INTO srvestratos (id,descripcion,tipo,uso,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."','".$_POST['vtipo']."','".$_POST['vuso']."','$valest')";
