...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje(){document.location.href = "hum-variablesretenciones.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><a href="hum-variablesretenciones.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"  border="0" /></a><a href="#" onClick="guardar();" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a><a href="hum-buscavariablesretenciones.php" class="mgbt"><img src="imagenes/busca.png"  title="Buscar" /></a><a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a><a href="hum-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
			</tr>		  
		</table>
		...
		<?php
			...
			if(!$_POST[oculto])
			{
		 		...
		 		$_POST[valor]=0;	
		  		$sqlr="SELECT MAX(RIGHT(codigo,2)) FROM humvariablesretenciones ORDER BY codigo Desc";
 		...
 		<form name="form2" method="post" action="">
    		...
    		<table class="inicio" align="center" >
      			...
      			<tr>
        			...
        			<td style="width:12%;"><input name="codigo" type="text" value="<?php echo $_POST[codigo]?>" maxlength="2" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" style="width:90%;" readonly/></td>
        		...
        		<tr>
					...
					<td>
						<input class="colordobleclik" id="tercero" type="text" name="tercero"  onKeyUp="return tabular(event,this)" onChange="buscater(event)" value="<?php echo $_POST[tercero]?>" style="width:90%;" ondblClick="despliegamodal2('visible','1');" autocomplete="off"/>&nbsp;
						<!-- <a href="#" onClick="despliegamodal2('visible','1');"><img src="imagenes/buscarep.png" align="absmiddle" border="0"></a> -->
					</td>
	  		...
	  		<table class="inicio">
				<tr>
	  				<td colspan="4" class="titulos2">Crear Detalle Variable Retencion</td></tr>
				<tr>
					...
					<td style="width:12%;">
						<input class="colordobleclik" type="text" id="cuenta" name="cuenta" onKeyPress="javascript:return solonumeros(event)" 
							  onKeyUp="return tabular(event,this)" onChange="buscacta(event)" value="<?php echo $_POST[cuenta]?>" onClick="document.getElementById('cuenta').focus();document.getElementById('cuenta').select();"  style="width:90%;" ondblclick="despliegamodal2('visible','2');" autocomplete="off"/>&nbsp;
            ...
            <div class="subpantallac" style="height:53%; width:99.5%;overflow-x:hidden;">
				<table class="inicio">
					<tr><td class="titulos" colspan="6">Detalle Variable Retencion</td></tr>
					<tr>
 			...
 			<?php
				if($_POST[oculto]=='2')
				{
					if ($_POST[nombre]!="")
 					{
 						$nr="1";
 						$sqlr="INSERT INTO humvariablesretenciones (codigo,nombre,beneficiario,estado)VALUES ('$_POST[codigo]','".utf8_decode($_POST[nombre])."','$_POST[tercero]','S')";
  						if (!mysql_query($sqlr,$linkbd))
						{
  						...
  						else
  						{
							...
							for($x=0;$x<count($_POST[dcuentas]);$x++)
		 					{
								$sqlr="insert into humvariablesretenciones_det (codigo,tipo,tipocuenta,cuenta,debito,credito,estado,modulo) values ('$_POST[codigo]','R','N','".$_POST[dcuentas][$x]."','".$_POST[ddebitos][$x]."','".$_POST[dcreditos][$x]."','S','2')";
  								if (!mysql_query($sqlr,$linkbd))
  								{
