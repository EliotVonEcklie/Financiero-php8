...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			...
			<a href="#" onClick="buscar()"> <img src="imagenes/busca.png"  alt="Buscar" /></a>
			...
			<a href="#" onClick="pdf()"  > <img src="imagenes/print.png"  alt="Buscar" /></a>
			<a href="<?php echo "archivos/".$_SESSION[usuario]."reportepredial.csv"; ?>" target="_blank"><img src="imagenes/csv.png"  alt="csv"></a>
		</td>
	</tr>		  
</table>
<tr>
...
?>
    ...
    <td class="saludo1">Descuento:</td><td><input name="descuento" type="text" value="<?php echo $_POST[descuento]?>"  size="5" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" readonly>%</td ></tr>
	  <tr> <td  class="saludo1">Documento: </td>
        <td ><input name="tercero" type="text" value="<?php echo $_POST[tercero]?>" size="15" onKeyUp="return tabular(event,this)" onBlur="buscater(event)">
	  ...
	  <td  ><input type="text" id="ntercero" name="ntercero" value="<?php echo $_POST[ntercero]?>" size="50" onKeyUp="return tabular(event,this) "  readonly><input type="hidden" value="0" id="bt" name="bt"></td><td><input type="hidden" value="<?php echo $_POST[buscav]?>" name="buscav"></td>	 
        </tr>
        <tr><td width="128" class="saludo1">Codigo Catastral:</td>
          <td  ><input id="codcat" type="text" name="codcat" size="18" onKeyUp="return tabular(event,this)" onBlur="buscar(event)" value="<?php echo $_POST[codcat]?>" > <a href="#" onClick="mypop=window.open('catastral-ventana.php','','menubar=0,scrollbars=yes, toolbar=no, location=no, width=900,height=500px');mypop.focus();"><img src="imagenes/buscarep.png" align="absmiddle" border="0"></a><input type="hidden" name="chacuerdo" value="1"><input type="hidden" value="1" name="oculto"></td><td class="saludo1">Avaluo Vigente:</td><td><input name="avaluo2" value="<?php echo $_POST[avaluo2]?>" type="text" size="20" readonly><input type="hidden" name="vavaluo"  value="<?php echo $_POST[vavaluo]?>" > </td><td class="saludo1">Tasa Predial	:</td><td><input name="tasa" value="<?php echo $_POST[tasa]?>" type="text" size="4" readonly>xmil</td><td class="saludo1">Estado Vigencias:</td><td><select name="tipov" >
				  ...
				  </select></td><td ><input type="button" name="buscarb" id="buscarb" value="   Buscar   " onClick="buscar()" ><input name="predial" value="<?php echo $_POST[predial]?>" type="hidden"  readonly></td></tr>
          <?php
	   if($_POST[bt]=='1')
			 {
			  $nresul=buscatercero($_POST[tercero]);
...
fputs($Descriptor1,"VIGENCIA;TERCERO;NOMBRE TERCERO;COD CATASTRAL;DIRECCION;AVALUO;PREDIAL;INTERESES;SOBRETASA BOMBERIL;INTERESES;SOBRETASA AMBIENTAL;INTERESES;VALOR TOTAL;PAGO\r\n");
		 ...
		 $res2=mysql_query($sqlr2,$linkbd);
	  	 ...
	  	 // echo "dc:".$_POST[dcuentas];
			  ...
			  $cuentavigencias=0;
			  $tdescuentos=0;
			$sqlr="Select *from tesoprediosavaluos,tesopredios where tesoprediosavaluos.codigocatastral=$_POST[catastral] and   tesoprediosavaluos.estado='S'  and tesoprediosavaluos.codigocatastral=tesopredios.cedulacatastral and tesoprediosavaluos.vigencia>='".($vigusu-$presc)."' ".$criterio3." order by tesoprediosavaluos.codigocatastral ASC";		
			//echo $sqlr;
			$res=mysql_query($sqlr,$linkbd);
...
//								 echo $tasaintdiaria."-";
			...
			//*************	
			 echo "<tr><td class='saludo1'><input name='dvigencias[]' value='".$r[0]."' type='text' size='4' readonly></td><td class='saludo1'><input name='dterceros[]' value='".$_POST[tercero]."' type='text' size='10' readonly><input name='dnterceros[]' value='".$_POST[ntercero]."' type='text' size='10' readonly></td><td class='saludo1'><input name='dcodcatas[]' value='".$r[1]."' type='text' size='16' readonly><input name='dvaloravaluo[]' value='".$base."' type='hidden' ><input name='dtasavig[]' value='".$tasav."' type='hidden' ></td><td class='saludo1'><input name='dvaloravaluo[]' value='".$base."' type='text' size='8' readonly ></td><td class='saludo1'><input name='dpredial[]' value='".$predial."' type='text' size='12' readonly></td><td class='saludo1'><input name='dipredial[]' value='".$ipredial."' type='text' size='7' readonly></td><td class='saludo1'><input name='dimpuesto1[]' value='".$valoringreso[0]."' type='text'  size='12' readonly></td><td class='saludo1'><input name='dinteres1[]' value='".$intereses[0]."' type='text' size='7' readonly></td><td class='saludo1'><input name='dimpuesto2[]' value='".$valoringreso[1]."' type='text'  size='12' readonly></td><td class='saludo1'><input name='dinteres2[]' value='".$intereses[1]."' type='text' size='7' readonly></td><td class='saludo1'><input type='text' name='ddescuentos[]' value='$tdescuentos' size='6' readonly></td><td class='saludo1'><input name='davaluos[]' value='".number_format($totalpagar,2)."' type='text' size='10' readonly><input name='dhavaluos[]' value='".$totalpagar."' type='hidden' ></td><td class='saludo1'><input type='text' name='dias[]' value='$diasd' size='4' readonly></td><td class='saludo1'><input type='text' name='pagos[]' value='$pagosnp' size='4' readonly> </td><td class='saludo1'><input type='checkbox' name='dselvigencias[]' value='$r[0]' onClick='buscavigencias(this)' $chk></td></tr>";
