...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-tarifaseditar.php?idban="+idban;
			}
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para crear la tarifa');}
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='serv-tarifas.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar()" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='serv-tarifasbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("serv");?>" class="mgbt"></td>
			</tr>
		</table>
		...
		<form name="form2" method="post" action="">
			<?php 
				...
				{
					$_POST['onoffswitch']="S";
					$_POST['codban']=selconsecutivo('srvtarifas','id');
				}
				if(@$_POST['bser']=='1')
				{
			...
			<table class="inicio ancho">
				<tr>
					<td class="titulos" colspan="10">.: Ingresar Tarifas</td>
				...
				<tr>
					...
					<td class="tamano01" style="width:3cm;">Rango Inicial:</td>
					...
					<td class="tamano01" style="width:3cm;">Rango Final:</td>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvtarifas','id');
					$sqlr="INSERT INTO srvtarifas (id,id_servicio,id_estrato,rango_inicial,rango_final,costo_unidad,cargo_fijo,estado) VALUES ('".$_POST['codban']."','".$_POST['codser']."','".$_POST['idestrato']."','".$_POST['medini']."','".$_POST['medfin']."','".$_POST['valuni']."', '".$_POST['cargofijo']."','$valest')";
