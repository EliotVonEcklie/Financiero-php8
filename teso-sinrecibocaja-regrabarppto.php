	...
	for($x=0;$x<count($_POST[dcoding]);$x++)
	 {
	  ...
	  mysql_query($sqlr,$linkbd);	
	  $sqlr="insert into  pptocomprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia,tipo_comp,numerotipo) values('".$rowi[6]."','".$_POST[tercero]."','INGRESO PROPIO',".$vi.",0,'$_POST[estadoc]','$_POST[vigencia]',18,'$consec')";
	  mysql_query($sqlr,$linkbd); 		
			//echo "ppt:$sqlr";
