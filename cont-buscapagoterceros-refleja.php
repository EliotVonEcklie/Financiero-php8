...
<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="cont-pagotercerosvigant-reflejar.php?idtipocom="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
...
function verUltimaPos(idcta){
				location.href="cont-pagotercerosvigant-reflejar.php?idpago="+idcta;
			}
...
<table>
 ...
 <form name="form2" method="post" action="cont-buscapagoterceros-refleja.php">
	 ...
	 <tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\"
		...
		<td style='text-align:center;'><img $imgsem style='width:18px'></td>";
		 ...
		 echo "<td ><a href='#'  onClick=eliminar($row[0])><center><img src='imagenes/anular.png'></center></a></td>";		 
	 	 if($row[9]=='N')
		 echo "<td></td>";	 
	 echo "<td ><a href='cont-pagotercerosvigant-reflejar.php?idpago=$row[0]'><center><img src='imagenes/lupa02.png' style='width:18px'></center></a></td></tr>";
	 $con+=1;
	 $aux=$iter;
	 $iter=$iter2;
	 $iter2=$aux;
