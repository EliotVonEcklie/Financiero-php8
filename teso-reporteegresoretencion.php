...
function excell()
{
    document.form2.action="teso-reporteegresoretencionexcel.php";
...
<body>
    <table>
	    ...
	    <tr>
            <td colspan="3" class="cinta">
                <a href="teso-reporteegresoretencion.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo"/></a>
                <a href="teso-reporteegresoretencion.php" class="mgbt"><img src="imagenes/busca.png"  title="Buscar"/></a>
    ...
    <div class="loading" id="divcarga"><span>Cargando...</span></div> 
	    ...
	    <table class="inicio" align="center"  >
            <tr>
                <td class="titulos" colspan="8">.: Reporte de egresos</td>
    ...
    <div class="subpantalla" style="height:66.5%; width:99.6%;">
        <table class="inicio">
            <tr><td class="titulos" colspan="7">Listado de Egresos</td></tr>
            <tr>
