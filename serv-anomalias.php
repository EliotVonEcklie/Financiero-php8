...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-anomaliaseditar.php?idban="+idban;
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='serv-anomalias.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar()" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='serv-anomaliasbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("serv");?>" class="mgbt"></td>
			</tr>
		</table>
		...
		<form name="form2" method="post" action="">
			...
			<table class="inicio">
				<tr>
					<td class="titulos" colspan="4">.: Ingresar Anomalia</td>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvanomalias','id');
					$sqlr="INSERT INTO srvanomalias (id,nombre,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."','$valest')";
