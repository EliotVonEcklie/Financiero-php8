...
<tr>
 ...
 <form name="form2" method="post" action="teso-buscarecaudos-rg.php">
...
$crit2=" ";
if ($_POST[numero]!="")
$crit1=" and tesorecaudos.id_recaudo like '%".$_POST[numero]."%' ";
if ($_POST[nombre]!="")
...
//$sqlr="select *from pptosideforigen where".$crit1.$crit2." order by pptosideforigen.codigo";
	$sqlr="select *from tesorecaudos where tesorecaudos.id_recaudo>-1 ".$crit1.$crit2." order by tesorecaudos.id_recaudo DESC";
// echo "<div><div>sqlr:".$sqlr."</div></div>";
$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
$con=1;
echo "<table class='inicio' align='center' ><tr><td colspan='7' class='titulos'>.: Resultados Busqueda:</td></tr><tr><td colspan='2'>Recaudos Encontrados: $ntr</td></tr><tr><td class='titulos2' style='width:8%'>Codigo</td><td class='titulos2' >Nombre</td><td class='titulos2' style='width:10%'>Fecha</td><td class='titulos2' style='width:10%'>Contribuyente</td><td class='titulos2' style='width:5%'>Estado</td><td class='titulos2' style='width:5%'><center>Anular</td><td class='titulos2' style='width:5%'><center>Editar</td></tr>";	
//echo "nr:".$nr;
$iter='saludo1a';
$iter2='saludo2';
 while ($row =mysql_fetch_row($resp)) 
 {
	 ...
	 if ($row[7]=='N' || $row[7]=='P')
	 echo "<td></td>";	
	 echo "<td style='text-align:center;'><a href='teso-recaudos-regrabar.php?idrec=$row[0]'><img src='imagenes/b_edit.png' style='width:18px' title='Editar'></a></td></tr>";
	 $con+=1;
	 $aux=$iter;
	 $iter=$iter2;
	 $iter2=$aux;
