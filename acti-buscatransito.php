...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="acti-editatransito.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
  					<img src="imagenes/add.png" title="Nuevo" onClick="location.href='acti-creaciontransito.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png"  title="Buscar" onClick="document.form2.submit();" class="mgbt"/><a onClick="mypop=window.open('plan-agenda.php','','');mypop.focus()" class="mgbt"><img src="imagenes/agenda1.png" title="Agenda" /></a><img src="imagenes/nv.png" title="Nueva Ventana" onClick="mypop=window.open('acti-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/iratras.png" title="Menu" onClick="iratras()" class="mgbt"/></a>
  				</td>
        	</tr>	
		</table>
        <?php
		...
		?>
 		<form name="form2" method="post" action="acti-buscatransito.php">
			<table  class="inicio" align="center" >
      			<tr>
        			<td class="titulos" colspan="2">:: Buscar Activos en Transito</td>
            ...
            <input type="hidden" name="numres" id="numres" value="<?php echo $_POST[numres];?>"/>
     		...
     		<div class="subpantalla" style="height:69.5%; width:99.6%; overflow-x:hidden;">
				...
				if ($_POST[numres]!="-1"){ $cond2="LIMIT $_POST[numpos], $_POST[numres]";}
					...
					$sqlr="SELECT * FROM conceptoscontables WHERE conceptoscontables.tipo='$vtipo' AND conceptoscontables.modulo='5' $crit1 ".$cond2;
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
					...
					<table class='inicio' align='center' width='80%'>
						...
						<tr><td colspan='3'>Concepto Contable Articulos en Transito Encontrados: $_POST[numtop]</td></tr>
						<tr class='titulos2'>
						...
						echo"<tr class='$iter' onDblClick=\"verUltimaPos($idcta, $numfil, $filtro)\" style='text-transform:uppercase; $estilo' >
							<td>".date('d/m/Y',strtotime($rw[0]))."</td>
