...
//session_start();
 ...
 echo "<table bordercolor=#333333 border=1 ><tr><td colspan='15' style='color:#000000; font-weight:bold;' align='center' >NOMINA</td></tr>";
  ...
  $ft="<tr><td >%s</td><td >%s</td><td>%s</td><td >%s</td><td >%s</td><td>%s</td><td >%s</td><td >%s</td><td>%s</td><td >%s</td><td >%s</td><td>%s</td><td >%s</td><td >%s</td><td >%s</td><td >%s</td><td >%s</td><td >%s</td><td >%s</td><td >%s</td><td >%s</td></tr>";
	 ...
	 {
		 printf($ft,$x+1,$_POST[nomemp][$x],$_POST[salbas][$x],$_POST[diast][$x],$_POST[devengado][$x],$_POST[ealim][$x],$_POST[etrans][$x],$_POST[horaextra][$x],$_POST[totaldev][$x],$_POST[ibc][$x],$_POST[saludrete][$x],$_POST[saludemprete][$x],$_POST[totsaludrete][$x],$_POST[pensionrete][$x],$_POST[pensionemprete][$x],$_POST[fondosols][$x],$_POST[totpensionrete][$x],0,$_POST[otrasretenciones][$x],$_POST[totalrete][$x],$_POST[netopago][$x]);
	 }
