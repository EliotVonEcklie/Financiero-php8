...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
        ...
        <title>:: SieS - Gestion Humana</title>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="hum-terceroseditar01.php?idter="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
			function cambioswitch(id,valor)
			{
				document.getElementById('idestado').value=id;
				if(valor==1){despliegamodalm('visible','4','Desea activar como Empleado este Tercero','1');}
				else{despliegamodalm('visible','4','Desea Desactivar como Empleado este Tercero','2');}
			}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='hum-terceros01.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png" title="Buscar" onClick="document.form2.submit();" class="mgbt"/><a href="#" onClick="mypop=window.open('hum-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a><img src='imagenes/iratras.png' title='Men&uacute; Nomina' class='mgbt' onClick="location.href='hum-menunomina.php'"/></td>
        	</tr>
  		</table>
        ...
        <form name="form2" method="post" action="hum-buscaterceros.php">
			<?php
				if($_POST[oculto]=="")
				{
					$accion="INGRESO BUSCAR TERCEROS NOMINA";
				...
				if($_POST[cambioestado]!="")
				{
					if($_POST[cambioestado]=="1")
					{
						...
						$accion="CAMBIO DE ESTADO TERCERO NOMINA S: $sqlr";
        				$origen=getUserIpAddr();
					...
					else 
					{
                        $sqlr="UPDATE terceros SET estado='N' WHERE id_tercero='$_POST[idestado]'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						$accion="CAMBIO DE ESTADO TERCERO NOMINA N: $sqlr";
        				$origen=getUserIpAddr();
        				generaLogs($_SESSION["nickusu"],'HUM','M',$accion,$origen);
					}
			...
			<table  class="inicio" align="center" >
                ...
                <tr>
        			...
        			<td style='width:50%;'>
                    	<input type="search" name="nombre" id="nombre" value="<?php echo $_POST[nombre];?>" style='width:100%; height:35px;'/>
                    </td>
                    <td style="width:3cm;"><label class="boton02" onClick="limbusquedas();">&nbsp;&nbsp;Buscar&nbsp;&nbsp;</label></td>
                    <td></td>
                </tr>                       
    		</table> 
            ...
            <div class="subpantalla" style="height:65%; width:99.6%; overflow-x:hidden;" id="divdet">
                <?php
                    $crit1=" ";
                    $crit2=" ";
                    if ($_POST[nombre]!="")
					...
					<table class='inicio' align='center' width='99%'>
						...
						<tr><td colspan='10'>Terceros Encontrados: $_POST[numtop]</td></tr>
						<tr>
							<td class='titulos2' width='2%'>ITEM</td>
							<td class='titulos2' width='8%'>DOCUMENTO</td>
							<td class='titulos2'>RAZON SOCIAL</td>
                    ...
                    while ($row =mysql_fetch_row($resp)) 
                    {
						...
						echo"<tr class='$iter' onDblClick=\"verUltimaPos($idcta, $numfil, $filtro)\" style='text-transform:uppercase; $estilo' >
							...
							<td class='icoop'>$row[12]</td>
                            <td class='icoop'>".strtoupper($row[5])."</td>
                            <td class='icoop'>".strtoupper($row[3])."</td>
                            <td class='icoop'>".strtoupper($row[4])."</td>
                            <td class='icoop'>".strtoupper($row[1])."</td>
                            <td class='icoop'>".strtoupper($row[2])."</td>
							...
							<td style='text-align:center;'><input type='range' name='lswitch1[]' value='".$_POST[lswitch1][$row[0]]."' min ='0' max='1' step ='1' style='background:$coloracti; width:60%' onChange='cambioswitch(\"$row[0]\",\"".$_POST[lswitch1][$row[0]]."\")' /></td>";
								echo"<td class='icoop' style='text-align:center;'>
