		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editaconceretencion.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
...
document.form2.target="";
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					<a href="teso-conceretencion.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
		...
		?>
 <form name="form2" method="post" action="teso-buscaconceretencion.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:. Buscar Concepto Contable Retencion Causacion </td>
...
//sacar el consecutivo 
	$sqlr="select *from conceptoscontables where conceptoscontables.modulo='4' and conceptoscontables.tipo='RE' ".$crit1." order by conceptoscontables.codigo";
$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *from conceptoscontables where conceptoscontables.modulo='4' and conceptoscontables.tipo='RE' ".$crit1." order by conceptoscontables.codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
