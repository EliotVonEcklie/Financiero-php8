...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<form action="presu-fuentesinv.php" method="post" enctype="multipart/form-data" name="form2">
	<?php
		$_POST[tabgroup1]=1;
					...
					echo "<table class='inicio'>
						...
						if($_POST[oculto]==2)
						{
							...
							if($archivo)
							{
								...
								$sqlr1="delete from pptofutfuenteinv";
								...
								{ 
									...
									$consulta = "INSERT INTO pptofutfuenteinv (codigo, nombre) VALUES ('".trim($datos[0])."','".$dato."')";
