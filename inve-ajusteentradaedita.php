...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
				...
				if(parseFloat(document.form2.ncomp.value)<parseFloat(document.form2.maximo.value))
 				{
					...
					document.form2.action="inve-ajusteentradaedita.php";
					document.form2.submit();
				}
			}
			function atrasc()
	...
	<body>
		...
		<table>
    		...
    		<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='inve-ajusteentrada.php'" class="mgbt"/><img src="imagenes/guardad.png" title="Guardar" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='inve-ajusteentradabuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("inve");?>" class="mgbt"><img src="imagenes/print.png" title="Imprimir" onClick="pdf()" class="mgbt"/><img src="imagenes/iratras.png" title="Atr&aacute;s"  onClick="location.href='inve-ajusteentradabuscar.php'" class="mgbt"></td>
			</tr>
         </table>
 		...
 		<form name="form2" method="post" action="inve-ajusteentradaedita.php">
        	...
        	<?php
				...
				//{
					...
					$sqlr = "SELECT MAX(id) FROM almactoajusteent";
					$resp = mysql_query($sqlr,$linkbd);
					$r=mysql_fetch_row($resp);
					$_POST[maximo]=$r[0];
				
					$sqlr="SELECT * FROM almactoajusteent WHERE id='$_POST[ncomp]'";
					//echo $sqlr;
					$resp = mysql_query($sqlr,$linkbd);
					...
					$respTipoMov = mysql_query($sqlrTipoMov,$linkbd);
					$rowTipoMov =mysql_fetch_row($respTipoMov);
					...
					$sqlr="SELECT id,documento,nombre,cargo FROM almactoajusteentpartici WHERE idacto='$_POST[consec]' AND tipo_mov='$_POST[tipomovimiento]' AND estado='S'";
					$resp = mysql_query($sqlr,$linkbd);
					...
					$sqlr="SELECT id,codigo,descripcion,unumedida,cantidad,valor,estadou FROM almactoajusteentarticu WHERE idacto='$_POST[consec]' AND tipo_mov='$_POST[tipomovimiento]' AND estado='S'";
					$resp = mysql_query($sqlr,$linkbd);
					while ($row =mysql_fetch_row($resp))
					{
			...
			<table class="inicio" align="center" >
				...
				<tr>
					...
					<td style="width:10%;"><img src="imagenes/back.png" title="Anterior" onClick="atrasc()" class="icobut">&nbsp;<input type="text" id="codigo" name="codigo" style="width:50%; text-align:center" value="<?php echo $_POST[codigo] ?>" readonly/>&nbsp;<img src="imagenes/next.png" title="Siguiente" onClick="adelante()" class="icobut"/></td>
					<td class="saludo1" style="width:8%;" >.: Consecutivo:</td>
					<td style="width:10%;"><input type="text" id="consec" name="consec"  style="width:100%;" value="<?php echo $_POST[consec] ?>" readonly/></td>
				...
				<tr>
					...
					<td colspan="1"><input type="text" id="lugarfi" name="lugarfi"  style="width:100%;" value="<?php echo $_POST[lugarfi] ?>" /></td>
					<td ><input type="text" id="tipomov" name="tipomov"  style="width:100%; text-align:center" value="<?php echo $_POST[tipomov] ?>" readonly/></td>
				</tr>
                <tr>
							...
							<table class='inicio' align='center' width='99%' >
                                ...
                                <?php
									...
									if ($_POST[agregadet]=='02')
									{
										...
										$_POST[agvalortotal][]=$_POST[valor]*$_POST[cantidad];
			...
			<input type='hidden' name='bt' id='bt' value=""/>
			  <?php
				if($_POST[oculto]=="2")
				{
					...
					$sqlr ="UPDATE almactoajusteent SET fecha='$fechaf',doctercero='$_POST[tercero]',nomtercero='$_POST[ntercero]', valortotal='$_POST[valort]',ciudad='$_POST[ciudad]',lugarfisico='$_POST[lugarfi]',motivo='$_POST[motivo]',otrosdetalles='$_POST[otdetalles]' WHERE id='$_POST[codigo]'";
					...
					else 
					{
						...
						for ($x=0;$x<$contx;$x++)
						{
							if($_POST[agcodigo][$x]=="N")
							{
								...
								$sqlr="INSERT INTO almactoajusteentpartici (id,idacto,documento,nombre,cargo,estado) VALUES ('$consp','$_POST[consec]','".$_POST[agtercerop][$x]."','".$_POST[agntercerop][$x]."','".$_POST[agcargop][$x]."','S')";
						...
						if($_POST[partielimina]!="")
						{
							...
							{
								$sqlr ="UPDATE almactoajusteentpartici SET estado='N' WHERE id='$nuparti[$x]'";
						...
						for ($x=0;$x<$contx;$x++)
						{
							if($_POST[agcodigo][$x]=="N")
							{
								...
								$sqlr="INSERT INTO almactoajusteentarticu (id,idacto,codigo,descripcion,unumedida,cantidad,valor,estadou,estado) VALUES ('$consa','$_POST[consec]','".$_POST[agcodigoart][$x]."','".$_POST[agdescripcion][$x]."','".$_POST[agunimedida][$x]."','".$_POST[agcantidad][$x]."','".$_POST[agvalor][$x]."','".$_POST[agestado][$x]."','S')";
								if (!mysql_query($sqlr,$linkbd)){$cont2=$cont2+1;}
							}
						}
						if($_POST[articelimina]!="")
						{
							...
							{
								$sqlr ="UPDATE almactoajusteentarticu SET estado='N' WHERE id='$nuarti[$x]'";
								if (!mysql_query($sqlr,$linkbd)){$cont2=$cont2+1;}
							}
						}
						...
						else {echo"<script>despliegamodalm('visible','1','Acto Administrativo No $_POST[codigo] editada con Exito');</script>";}
					}
				}
			?>
