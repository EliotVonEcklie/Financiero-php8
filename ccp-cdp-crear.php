        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					<a class="mgbt"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='ccp-cdp.php'" /></a>
					<a class="mgbt"><img src="imagenes/guarda.png" title="Guardar" onClick="guardar()"/></a>
					<a class="mgbt"><img src="imagenes/busca.png" title="Buscar" onClick="location.href='ccp-buscacdp.php'"/></a>
					<a onClick="mypop=window.open('plan-agenda.php','','');mypop.focus()" class="mgbt"><img src="imagenes/agenda1.png" title="Agenda" /></a>
					<a class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("ccpet");?>"></a>
					...
					<a class="mgbt"><img  src="imagenes/iratras.png" title="Atr&aacute;s" onClick="location.href='ccp-gestioncdp.php'"/></a>
				</td>
        	</tr>
        </table>
