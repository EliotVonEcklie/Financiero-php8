...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a href="acti-activarareas.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
			<a onClick="guardar();" href="#" class="mgbt"><img src="imagenes/guardad.png"/></a>
...
<form name="form2" method="post" action="acti-activarareas.php">
 <?php
				if($_POST[oculto2]=="")
				{
					$_POST[oculto2]="0";
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="4">:: Buscar Areas </td>
        <td width="95" class="cerrar" ><a href="acti-principal.php">Cerrar</a></td>
      </tr>
      <tr >
        <td width="60" class="saludo1">Nombre:</td>
        <td width="523" ><input name="nombre" type="text" value="" size="60">
        </td>
        <td width="107" class="saludo1">Codigo Area:        </td>
        <td width="258" ><input name="documento" type="text" id="documento" value="" size="2" maxlength="2">
    ...
    <div class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;">
		...
		$oculto=$_POST['oculto'];
			...
			$con=1;
			echo "<table class='inicio' align='center' width='80%'><tr><td colspan='7' class='titulos'>.: Resultados Busqueda:</td></tr><tr><td colspan='5'>Ubicaciones Encontrados: $ntr</td></tr><tr><td width='5%' class='titulos2'>Codigo</td><td class='titulos2'>Nombre</td><td class='titulos2' colspan='2' style='width:6%;'>Estado</td></tr>";	
			//echo "nr:".$nr;
			$iter='saludo1a';
			$iter2='saludo2';
