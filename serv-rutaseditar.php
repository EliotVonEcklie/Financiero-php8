	...
	<head>
		...
		<script>
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para Modificar la Ruta');}
			}
		...
		<form name="form2" method="post" action="">
			...
			<div class="subpantalla" style="height:60.5%; width:99.6%; overflow-x:hidden;">
				<table class="inicio" width="99%">
					...
					<?php
						...
						{
							$posi=$_POST['elimina'];
							if(@ $_POST['delbarrio']==''){$_POST['delbarrio']=$_POST['idrutbar'][$posi];}
							else {$_POST['delbarrio']=$_POST['delbarrio'].'<->'.$_POST['idrutbar'][$posi];}
			...
			<?php
				...
				if(@ $_POST['oculto']=="2")
				{
					...
					$sqlr ="UPDATE srvrutas SET nombre='".$_POST['nomban']."',estado='$valest' WHERE id='".$_POST['codban']."'";
