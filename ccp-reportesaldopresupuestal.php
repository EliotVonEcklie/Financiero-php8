...
<body>
 <IFRAME src="alertas.php" name="alertas" id="alertas" style="display:none"></IFRAME>
		...
		<form name="form2" method="post" action="ccp-reportesaldopresupuestal.php">
			<?php
 ...
 ?>
    <table  align="center" class="inicio" >
		<tr >
			...
			<td width="7%" class="cerrar"><a href="ccp-principal.php">Cerrar</a></td>
		</tr>
		<tr>      
