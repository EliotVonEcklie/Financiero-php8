    ...
    <tr><?php menu_desplegable("meci");?></tr>
        <tr>
        	<td colspan="3" class="cinta">
            	<a href="#"><img src="imagenes/add2.png"  title="Nuevo" border="0" /></a> 
                <a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guardad.png"  title="Guardar" /></a> 
               ...
               <?php
					...
					else{echo'<a href="informacion/temp/documentos_derogados.csv" target="_blank""><img src="imagenes/csv.png" title="csv"></a>';}
				?>
        	</td>
</tr>
</table>	
 <form name="form2" method="post" action="meci-docderogados.php" enctype="multipart/form-data">
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="4">:: Buscar Documentos Derogados </td>
	...
	<?php
		...
		if($_POST[oculto])
		{
			...
			$crit1=" ";
			$crit2=" ";
			$namearch="informacion/temp/documentos_derogados.csv";
			...
			$sqlr="SELECT cgd.*, cld.* FROM calgestiondoc cgd, callistadoc cld WHERE cgd.idarchivo=cld.id AND cgd.estado='N' ".$crit1.$crit2." ORDER BY cgd.proceso, cgd.id";
