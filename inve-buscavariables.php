		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="inve-editavariables.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
			function iratras(){
...
<tr>
  <td colspan="3" class="cinta"><a href="inve-variables.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#"  onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  title="Guardar" /></a><a href="inve-buscavariables.php" class="mgbt"><img src="imagenes/busca.png"  title="Buscar"/></a><a href="#" onClick="mypop=window.open('inve-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a href="#" onClick="iratras()" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
		...
		?>
 		<form name="form2" method="post" action="inve-buscavariables.php">
           	...
           	<div class="subpantalla" style="height:68.5%; width:99.6%;overflow-x:hidden" id="divdet">
      			<?php
					//if($_POST[oculto])
					{
						...
						$sqlr="SELECT * FROM invevariables WHERE estado='S' $crit1 ORDER BY codigo";
					...
					if ($_POST[numres]!="-1"){ 
						...
						$sqlr="SELECT * FROM invevariables WHERE estado='S' $crit1 ORDER BY codigo ".$cond2;
						$resp = mysql_query($sqlr,$linkbd);
