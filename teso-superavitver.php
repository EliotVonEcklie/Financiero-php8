...
<tr>
  <td colspan="3" class="cinta">
	  ...
	  <a href="teso-buscasuperavit.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
  </td>
</tr></table>
...
<?php
	...
	{
		$link=conectar_bd();
		$sqlr="select * from pptosuperavit where vigencia=$_POST[vigencia] and consvigencia=$_GET[id]";
...
?>
	<form name="form2" method="post" action="">
		...
		<table class="inicio" width="99%" max-height="380px" style="overflow-x:scroll !important">
			<tr>
				<td class="titulos" colspan="5">Detalle Superavit</td>
			</tr>
			<tr>
			...
			<?php 
				$sqlr="select * from pptosuperavit_detalle where consvigencia=$_POST[numero] and vigencia=$_POST[vigencia]";
...
if($_POST[oculto]=='2')
{
	...
	if($bloq>=1)
	{
		...
		if($numerorecaudos==0)
		{
			...
			$sqlr="insert into pptocomprobante_cab(numerotipo,tipo_comp,fecha,concepto,vigencia,total_debito,total_credito,diferencia,estado) values($_POST[numero],23,'$fechaf','$_POST[objeto]',$_POST[vigencia],'$_POST[cuentagas2]',0,0,'1')";
			
			$sqlr="insert into pptosuperavit (vigencia,consvigencia,fecha,valor,estado,solicita,objeto) values($_POST[vigencia],$_POST[numero],'$fechaf	',$_POST[cuentagas2],'S','$_POST[solicita]','$_POST[objeto]')";
...
//	 			$e =mysql_error($respquery);
			...
			{
				$sqlr="insert into  pptocomprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia,tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcuentas][$x]."','','Superavit','".$_POST[dgastos][$x]."',0,'1','$_POST[vigencia]',23,$_POST[numero],1,'','','$fechaf')";
				mysql_query($sqlr,$linkbd); 			  
				$sqlr="insert into pptosuperavit_detalle (vigencia,consvigencia,cuenta,fuente,valor,estado,saldo,saldo_liberado) values('$_POST[vigencia]','$_POST[numero]','".$_POST[dcuentas][$x]."','".$_POST[dcfuentes][$x]."',".$_POST[dgastos][$x].",'S',".$_POST[dgastos][$x].",0)";
				$res=mysql_query($sqlr,$linkbd);
			}
		}
		else
