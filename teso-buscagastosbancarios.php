		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editagastosbancarios.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
...
function crearexcel(){
	document.form2.action="teso-buscagastosbancariosexcel.php";
	document.form2.target="_BLANK";
	document.form2.submit();
	document.form2.action="";
	document.form2.target="";
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					<a href="teso-gastosbancarios.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
		...
		?>
 <form name="form2" method="post" action="teso-buscagastosbancarios.php">
 ...
 <?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					{
                        $sqlr="UPDATE tesogastosbancarios SET estado='S' WHERE codigo='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
                        $sqlr="UPDATE tesogastosbancarios SET estado='N' WHERE codigo='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
				}
				//*****************************************************************
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:. Buscar Gastos Bancarios </td>
...
//sacar el consecutivo 
			$sqlr="select *from tesogastosbancarios ".$crit1." order by tesogastosbancarios.codigo";
			...
			$ntr = mysql_num_rows($resp);
					...
					$sqlr="SELECT * FROM tesogastosbancarios ".$crit1." order by tesogastosbancarios.codigo $cond2";
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
...
echo "<table class='inicio' align='center' >
	...
	<tr>
		<td colspan='5'>Gastos Bancarios Encontrados: $ntr</td>
	</tr>
	<tr>
