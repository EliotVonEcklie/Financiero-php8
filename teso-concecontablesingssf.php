...
document.form2.oculto.value=2;
document.form2.action="teso-concecontablesingssf.php";
document.form2.submit();
}
function validar()
{
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a href="teso-concecontablesingssf.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
			<a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar"/></a>
			<a href="teso-buscaconcecontablesingssf.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
			...
			<a href="teso-concecontables.php"class="mgbt"><img src="imagenes/iratras.png" alt="Atr&aacute;s"></a>
		</td>
	</tr>
</table>
<?php
...
if(!$_POST[oculto])
{
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(RIGHT(codigo,2)) from conceptoscontables where modulo=4 and tipo='IS' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8">.: Concepto Contable Ingresos SSF</td>
      ...
      <tr  >
		<td width="119" class="saludo1">Codigo:</td>
		 ...
		 <td width="119" class="saludo1">Nombre:</td>
		  ...
		  <input name="tipoc" value="IS" size="10" type="hidden">
	...
	</table><div class="subpantallac" style="height:52%; width:99.6%; overflow-x:hidden;">
	<table class="inicio">
	...
	if($_POST[oculto]=='2')	
		...
		if(!mysql_query($sqlr,$linkbd))
		 ...
		 {
		 echo "<table class='inicio'><tr class='saludo1a'><td><center>Se ha Almacenado con Exito El Concepto Contable</center></td></tr></table>";
