		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editachequeras.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
			...
			function crearexcel(){
				document.form2.action="teso-buscachequerasexcel.php";
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					...
					<a href="#" onClick="mypop=window.open('teso-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a> <a href="#" onclick="crearexcel()" class="mgbt"><img src="imagenes/excel.png" title="Excell"></a>
				</td>
       		</tr>	
        </table>
        <?php
 			...
 			<?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					if($_POST[cambioestado]=="1")
					{
						...
						$sqlr="UPDATE tesocheques SET estado='A' WHERE chequera='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
                        $sqlr="UPDATE tesochequeras SET estado='N' WHERE idchequera='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						$sqlr="UPDATE tesocheques SET estado='N' WHERE chequera='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
				}
				//*****************************************************************
...
echo "<table class='inicio' align='center' >
	...
	<tr>
		<td colspan='8'>Chequeras Encontrados: $ntr</td>
	</tr>
	<tr>
