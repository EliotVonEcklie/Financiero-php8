...
document.form2.action="teso-girarcheques-regrabar.php";
document.form2.submit();
}
else
{
...
$sqlr="select * from tesoegresos ORDER BY id_orden DESC";
$res=mysql_query($sqlr,$linkbd);
//echo $sqlr;
	   		...
	   		<table class="inicio" align="center" >
       			...
       			<tr>
       				...
       				<td style="width:15%;">
       					...
       					<input name="egreso" type="text" value="<?php echo $_POST[egreso]?>"  onKeyUp="return tabular(event,this)" onBlur="validar2()"  > <input name="ncomp" type="hidden" value="<?php echo $_POST[ncomp]?>">
        			...
        			<td >
        				<input id="fc_1198971545" name="fecha" type="text" value="<?php echo $_POST[fecha]?>" maxlength="10" style="width:80%;" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)">  
       				...
       				<td >
				  		...
				  		<input type="text" name="estadoc"  value="<?php echo $estadoc; ?>" style="width:20%;" readonly> 
				...
				<tr>  
					<td style="width:10%;" class="saludo1">No Orden Pago:</td>
	  				<td style="width:15%;">
	  					<input name="orden" type="text" value="<?php echo $_POST[orden]?>"  onKeyUp="return tabular(event,this)" onBlur="buscaop(event)" readonly >
	  					<input type="hidden" value="0" name="bop">  
	  				</td>
      				<td style="width:8%;" class="saludo1">Tercero:</td>
          			<td  >
          				<input id="tercero" type="text" name="tercero"  onKeyUp="return tabular(event,this)" onBlur="buscater(event)" value="<?php echo $_POST[tercero]?>" readonly>
           			</td>
           			<td colspan="2">
				...
				<tr>
					<td class="saludo1">Cuenta:</td>
           			<td style="width:15%;">
           				<input name="tercerocta" type="text" value="<?php echo $_POST[tercerocta]?>"  readonly>
           			</td>
					<td style="width:8%;" class="saludo1">Concepto:</td>
					<td colspan="3">
	  		...
	  		if($_POST[tipop]=='cheque')
	    	{
	  		?>    
           		<tr>
					...
					<td  >
						<input type="text" id="ncheque" name="ncheque" value="<?php echo $_POST[ncheque]?>"  readonly>
					</td>
	  			</tr>
		      	<?php
      			...
      			<tr>
					...
					<td >
						<input type="text" id="ntransfe" name="ntransfe" value="<?php echo $_POST[ntransfe]?>"   >
					</td>
	  			</tr>
      			<?php
	     			}//cierre del if de cheques
      			?> 
	  			<tr>
	  				<td style="width:10%;" class="saludo1">Valor Orden:</td>
	  				<td style="width:15%;">
	  				...
	  				<td>
	  					<input name="retenciones" type="text" id="retenciones" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[retenciones]?>"  readonly>
	  				</td>	  
      			...
      			<tr>
      				<td style="width:10%;" class="saludo1" >Base:</td>
      				<td style="width:15%;">
      					<input type="text" id="base" name="base" value="<?php echo $_POST[base]?>"  onKeyUp="return tabular(event,this)" onChange='' readonly> 
      				</td>
      				<td style="width:8%;" class="saludo1" >Iva:</td>
      				<td>
      					<input type="text" id="iva" name="iva" value="<?php echo $_POST[iva]?>"  onKeyUp="return tabular(event,this)" onChange='' readonly> 
				...
				//***buscar retenciones								
					/*	 	 $sqlr="delete from pptoretencionpago where idrecibo=$ideg ";
							...
							for($x=0;$x<count($_POST[ddescuentos]);$x++)
							 {																		 			 
							  $valorp=$valorp-round($_POST[valororden]*$_POST[dporcentajes][$x]/1000,0);
							  ...
							  while($rowdes=mysql_fetch_row($resdes))
							   ...
							   //$valordes=($row2[4]*$_POST[dporcentajes][$x]/100)*($rowdes[4]/100);
								...
								//echo "<br>Pn: round($row2[4]*($rowdes[4]/100),0) :".$valordes;
	   							 ...
	   							 // $valopb-= $valordes;   								
							   $sqlr="insert into comprobante_det (id_comp,cuenta,tercero,centrocosto,detalle,cheque,valdebito, valcredito, estado, vigencia) values ('6 $ideg','".$rowdes[2]."','".$_POST[tercero]."' ,'".$_POST[cc]."' , 'Descuento ".$_POST[dndescuentos][$x]."','',0,".$valordes.",'1' ,'".$vigusu."')";
   								mysql_query($sqlr,$linkbd);
								//echo "<br>des:$valordes";
								//cuenta puente
								if($rowdes[6]!='')
								 {
								 $sqlr="insert into comprobante_det (id_comp,cuenta,tercero,centrocosto,detalle,cheque,valdebito, valcredito, estado, vigencia) values ('6 $ideg','".$rowdes[6]."','".$_POST[tercero]."' ,'".$_POST[cc]."' , 'Descuento ".$_POST[dndescuentos][$x]."','',".$valordes.",0,'1' ,'".$vigusu."')";
   								mysql_query($sqlr,$linkbd);
								 $sqlr="insert into comprobante_det (id_comp,cuenta,tercero,centrocosto,detalle,cheque,valdebito, valcredito, estado, vigencia) values ('6 $ideg','".$rowdes[6]."','".$_POST[tercero]."' ,'".$_POST[cc]."' , 'Descuento ".$_POST[dndescuentos][$x]."','',0,".$valordes.",'1' ,'".$vigusu."')";
   								mysql_query($sqlr,$linkbd);
								 }
							  //afectacion presupuestal***********							 
					  			/*$sqlr="insert into pptoretencionpago  (cuenta,idrecibo,valor,vigencia) values ($rowdes[3],$ideg,".$valordes.",".$vigusu.")";				
								mysql_query($sqlr,$linkbd);
						 ...
						 if($rowc[3]=='B')
						   {
								...
								$valopb=$row2[4];
								//  echo "<br>PB:".$valopb;			
								//echo "round($valopb-(($valopb/$totpago)*$totaldes),2)";				 							
								$valopb=round($valopb-(($valopb/$totpago)*$totaldes),2);
