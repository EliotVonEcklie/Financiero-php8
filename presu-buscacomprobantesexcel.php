<?php //V 1000 12/12/16 ?> 
<?php 
header("content-disposition: attachment;filename=pptocomprobantes.xls");
...
for($x=0;$x<count($_POST[dpcuentas]);$x++)
 {		 	
	...
	$sumaop+=$row3[1];
	$sumap+=$row4[1];	
	printf($ft,''.$_POST[fecha],$_POST[ntipocomp],$_POST[ncomp],$_POST[dpccs][$x],$_POST[dpcuentas][$x],$_POST[dpncuentas][$x],$_POST[dpterceros][$x],$_POST[dpnterceros][$x],$_POST[dpdetalles][$x],$_POST[ddebitos][$x],$_POST[dcreditos][$x]);	
 }
