    ...
    <body>
        ...
        <table>
 		...
 		<form name="form2" method="post" action="">
    		<table class="inicio">
      			<tr>
        			<td class="titulos" colspan="2">.: PAC </td>
					...
					<td style="background-repeat:no-repeat; background-position:center;">
						<ol id="lista2">
							<li onClick="location.href='presu-pacingresos.php'" style="cursor:pointer;">Reporte PAC ingresos</li>
                            <li onClick="location.href='presu-pacgastos.php'" style="cursor:pointer;">Reporte PAC Gastos</li>
