...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="inve-editaconcecontablesalmacen.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
	...
	<body>
		...
		?>
 		<form name="form2" method="post" action="inve-buscaconcecontablesalmacen.php">
			<table  class="inicio" align="center" >
      			<tr>
        			<td class="titulos" colspan="2">:: Buscar Concepto Contable Deterioro NICSP</td>
     		...
     		<div class="subpantalla" style="height:69.5%; width:99.6%; overflow-x:hidden;">
				...
				if ($_POST[numres]!="-1"){ 
					...
					<table class='inicio' align='center' width='80%'>
						...
						<tr><td colspan='3'>Concepto Contable Deterioro NICSP Encontrados: $_POST[numtop]</td></tr>
						<tr>
