...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="hum-editatablasfiscales.php?idvig="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<script>
        	function cambioswitch(id,valor)
			{
				...
				if(valor==1){despliegamodalm('visible','4','Desea Desactivar Estado','1');}
				else{despliegamodalm('visible','4','Desea activar Estado','2');}
			}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><a href="hum-tablasfiscales.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a><a class="mgbt"><img src="imagenes/guardad.png"/></a><a href="#" onClick="document.form2.submit();" class="mgbt"><img src="imagenes/busca.png"  title="Buscar" /></a><a href="#" onClick="mypop=window.open('hum-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a></td>
         	</tr>
 		</table>
 		...
 		<form name="form2" method="post" action="">
 			<?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					{
                        $sqlr="UPDATE admfiscales SET estado='S' WHERE id='$_POST[idestado]'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
                        $sqlr="UPDATE admfiscales SET estado='N' WHERE id='$_POST[idestado]'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
				}
				//*****************************************************************
			...
			?>
 	 		<table width="80%" class="inicio" align="center">
                <tr>
                    <td class="titulos" colspan="2" style='width:93%'>:: Buscar Tablas Fiscales </td>
                    <td class="cerrar" style='width:7%'><a href="hum-principal.php">&nbsp;Cerrar</a></td>
                </tr>
                <tr>
                    <td class='saludo1' style='width:10%'>:&middot; Vigencia:</td>
                    <td><input type="text" name="nombre" id="nombre" style="width:10%;"> </td>
                </tr>
  			</table> 
            ...
            <input type="hidden" name="oculto" id="oculto" value="1">
 			<div class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;">   
				<?php
					$crit1=" ";
					if ($_POST[nombre]!=""){$crit1="where  vigencia like '%$_POST[nombre]%' ";}
					$sqlr="SELECT * FROM admfiscales  $crit1 ";
					$resp = mysql_query($sqlr,$linkbd);
					$_POST[numtop]=mysql_num_rows($resp);
					$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
					$sqlr="SELECT * FROM admfiscales  $crit1 ORDER BY vigencia ASC LIMIT $_POST[numpos],$_POST[numres]";
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
					...
					<table class='inicio' align='center' width='80%'>
						...
						<tr><td colspan='9'>Perfiles Encontrados: $_POST[numtop]</td></tr>
						<tr>
							<td class='titulos2' style='width:7%;'>Item</td>
							<td class='titulos2' >Vigencia</td>
							<td class='titulos2' >UVT</td>
							<td class='titulos2' >Salario Min</td>
							<td class='titulos2' >Subs. Transporte</td>
							<td class='titulos2' >Subs. Alimentacion</td>
					...
					while ($row =mysql_fetch_row($resp)) 
					{
						...
						if($row[9]=='S'){$imgsem="src='imagenes/sema_verdeON.jpg' title='Activo'";$coloracti="#0F0";$_POST[lswitch1][$row[0]]=0;}
