...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
		<tr >
        	<td class="titulos" colspan="9" style='width:90%'>.: Construir Activos</td>
      ...
      <tr>
            ...
            <td style='width:4%'><input id="deprecia" name="deprecia" type="checkbox" value="S" <?php echo $chk; ?> onClick="deprec()"></td>
	  		...
	  		<td style='width:5%'><input type="text" id="agedep" name="agedep"  onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[agedep]?>" onClick="document.getElementById('agedep').focus();document.getElementById('agedep').select();" style='width:80%'></td>          
	    </tr>
    </table>
	<table class="inicio">
		<tr><td colspan="6" class="titulos2">Crear Detalle Activo</td></tr>	
		<tr>        
        	<td class="saludo1" style='width:10%'>Cuenta Activos:</td>
       		<td  style='width:10%'><input type="text" id="cuentact" name="cuentact" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" onBlur="buscacta('3')" value="<?php echo $_POST[cuentact]?>" onClick="document.getElementById('cuentact').focus();document.getElementById('cuentact').select();" style='width:80%'><input type="hidden" value="0" name="bca" ><a href="#" onClick="mypop=window.open('cuentasgral-ventana.php?objeto=cuentact&nobjeto=ncuentact','','menubar=0,scrollbars=yes, toolbar=no, location=no, width=700px,height=500px');mypop.focus();">&nbsp;<img src="imagenes/buscarep.png" style='width:16px'></a></td>
            <td style='width:30%'><input name="ncuentact" type="text" id="ncuentact" value="<?php echo $_POST[ncuentact]?>" style='width:100%' readonly></td>
			<td class="saludo1" style='width:10%'>Cuenta Perdida:</td>
        	<td style='width:10%'><input type="text" id="cuentaper" name="cuentaper" onKeyPress="javascript:return solonumeros(event)" 
         	...
         	<td style='width:30%'><input id="ncuentaper" name="ncuentaper" type="text" value="<?php echo $_POST[ncuentaper]?>" style='width:100%' readonly></td>
   		</tr>
              <tr>
	...
	<div class="subpantallac" style="height:54.5%; width:99.6%;">
	<table class="inicio">
...
onMouseOut=\"this.style.backgroundColor=anterior\">
	...
	if($_POST[oculto]=='2')	
		...
		$sqlr="insert into acticonsact (`codigo`, `placa`, `referencia`, `modelo`, `serial`, `fechareg`, `fechact`, `clasificacion`, `origen`, `area`, `ubicacion`, `grupo`, `cc`, `valor`, `vladepact`, `saldep`, `valdepmen`, `estado`) values ('$_POST[numero]','$_POST[nombre]', '$_POST[deprecia]',  '$_POST[agedep]','S')";
