		...
		case "plan":
			echo ('<td colspan="3">
				<ul class="mi-menu">
					...
					if($_SESSION["perfil"]=="Superman"){echo('<li><a onClick="alert(\''.$nombre_archivo.'\')" style="cursor:pointer;">Link</a></li>');}
...
function retornar_codigo($dato, $tam){
	$num=strlen($dato);
	$ceros='';
	for($i=$num;$i<$tam;$i++)
		$ceros.='0';
