...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td colspan="3" class="cinta">
                    <a href="serv-concecontribuciones.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
                    <a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a>
                    <a href="serv-buscaconcecontribuciones.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
                    ...
                    <a href="serv-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
                </td>
            </tr>
        </table>
        <?php
        ...
        if(!$_POST[oculto])
        {
            ...
            $_POST[valor]=0;		 
            $sqlr="select MAX(codigo) from conceptoscontables where modulo=10 and tipo='SC' and left(codigo,1)!='P' order by codigo Desc";
            //echo $sqlr;
        ...
        <form name="form2" method="post" action=""> 
            ...
            <table class="inicio" align="center"  >
                <tr>
                    <td class="titulos" colspan="7">.: Concepto Contable de Contribuciones </td>
                ...
                <tr>
                    ...
                    <input name="tipo" value="Contribuciones"  type="text" readonly><input name="tipoc" value="SC"  type="hidden">
		    ...
		    ?>
	        <div class="subpantallac" style="height:46%; width:99.6%; overflow-x:hidden;">
	            <table class="inicio">
	    ...
	    if($_POST[oculto]=='2')	
		{
            ...
            else
            {
                ...
                for($x=0;$x<count($_POST[dcuentas]);$x++) 
                {
		            ...
		            $sqlr="insert into conceptoscontables_det (codigo,tipo,tipocuenta,cuenta,cc,debito,credito,estado,modulo,fechainicial) values ('$_POST[numero]','$_POST[tipoc]','".$_POST[tcuentas][$x]."','".$_POST[dcuentas][$x]."','".$_POST[dccs][$x]."','".$_POST[ddebitos][$x]."','".$_POST[dcreditos][$x]."','S','10','$fechaf')";
                    $res=mysql_query($sqlr,$linkbd);
		        }
		    }
	    }
