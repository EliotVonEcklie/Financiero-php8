...
<form name="form2" method="post" action="">
	...
	<div class="subpantallac5" style="height:68.5%; width:99.6%; overflow-x:hidden;" id="divdet">
		...
		$sqlr="select *from tesoliquidapredial where tesoliquidapredial.idpredial>-1 $crit1 order by tesoliquidapredial.idpredial desc $cond2 ";
        $resp = mysql_query($sqlr,$linkbd);
			...
			onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"verUltimaPos($idcta, $numfil, $filtro)\" style='text-transform:uppercase; $estilo' >
					...
					<td >".number_format($r2[0],2,",",".")."</td>";
	  				if ($row[18]=='S')
						...
						<td >
							<a href='#' onClick=eliminar($row[0])><center><img src='imagenes/borrar01.png' style='Width:19px;' title='Anular'></center></a>
						</td>";
	 				if ($row[18]=='N')
	 					echo "<td >
