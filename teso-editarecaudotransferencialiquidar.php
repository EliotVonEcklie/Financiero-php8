...
document.form2.action="teso-editarecaudotransferencialiquidar.php";
document.form2.submit();
}
}
</script>
...
<table>
	...
	<tr>
  		<td colspan="3" class="cinta">
  			<a href="teso-recaudotransferencialiquidar.php" class="mgbt"><img src="imagenes/add.png" alt="Nuevo"  border="0" /></a>
  			<a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  alt="Guardar" /></a>
  			<a href="teso-buscarecaudotransferencialiquidar.php" class="mgbt"> <img src="imagenes/busca.png"  alt="Buscar" /></a>
...
if($_POST[oculto]=='2')
{
	...
	$sqlr="insert into tesorecaudotransferencialiquidar (id_recaudo,idcomp,fecha,vigencia,banco,ncuentaban,concepto,tercero,cc,valortotal,estado,medio_pago) values($consec,$idcomp,'$fechaf',".$vigusu.",'$_POST[ter]','$_POST[cb]','".strtoupper($_POST[concepto])."','$_POST[tercero]','$_POST[cc]','$_POST[totalc]','S','$_POST[medioDePago]')";
	mysql_query($sqlr,$linkbd);
