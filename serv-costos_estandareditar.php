		...
		<form name="form2" method="post" action="">
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$sqlr ="UPDATE srvcostos_estandar SET id_servicio = '".$_POST['codser']."', medicion_inicial = '".$_POST['medini']."', medicion_final = '".$_POST['medfin']."', costo_unidad = '".$_POST['valuni']."', estado = '$valest' WHERE id='".$_POST['codban']."'";
