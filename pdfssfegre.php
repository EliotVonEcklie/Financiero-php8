...
while($row=mysql_fetch_row($res))
 {
  ...
  $rs=$row[1];
	...
	$this->SetY(8);
    $this->Cell(50.1);
    $this->Cell(149,20,'EGRESO SSF',0,0,'C'); 
	//************************************
    $this->SetFont('Arial','I',7);
	
	$this->SetY(27);
	$this->Cell(50.2);
	$this->multiCell(110.7,3,''.strtoupper($_POST[detallegreso]),'T','J');
	    $this->SetFont('Arial','B',10);
	$this->SetY(27);
    $this->Cell(161.1);
...
$pdf->SetFont('Arial','B',10);
$pdf->cell(0.2);
$pdf->cell(35,5,'Registro:',0,0,'L',1);
$pdf->SetFont('Arial','',10);
$pdf->cell(40,5,''.$_POST[rp],0,0,'L',1);
$pdf->SetFont('Arial','B',10);
$pdf->cell(15,5,'Detalle: ',0,0,'L',1);
$pdf->SetFont('Arial','',10);
$pdf->cell(20,5,''.substr(ucwords(strtolower($_POST[detallecdp])),0,60),0,1,'L',1);
...
$pdf->SetFont('Arial','',10);
$pdf->cell(40,5,'$'.number_format(array_sum($_POST[dvalores]),2),0,0,'L',1);
$pdf->SetFont('Arial','B',10);
/*$pdf->cell(25,5,'Retenciones: ',0,0,'L',1);
$pdf->SetFont('Arial','',10);
$pdf->cell(35,5,'$'.number_format($_POST[valorretencion],2),0,0,'L',1);
$pdf->SetFont('Arial','B',10);
$pdf->cell(25,5,'Base Ret:',0,0,'L',1);
$pdf->SetFont('Arial','',10);
$pdf->cell(38,5,'$'.number_format($_POST[base],2),0,1,'L',1);*/
...
$pdf->SetFont('Arial','',8);
 ...
 for($x=0;$x<count($_POST[dcuentas]);$x++)
	 {	
	 if(0==strcmp($_POST[dcuentas][$x],$_POST[rubros][$y]))
			  {
	  ...
	  {$pdf->SetFillColor(245,245,245);
		...
		$pdf->Cell(22,4,''.$_POST[dcuentas][$x],'',0,'L',1);
 ...
 for($x=0;$x<count($_POST[ddescuentos]);$x++)
	 {	
	  ...
	  {$pdf->SetFillColor(245,245,245);
		...
		$pdf->Cell(22,4,''.$_POST[ddescuentos][$x],'',0,'L',1);
