	...
	<head>
		...
		<script>
			...
			function eliminar(idr)
			{
				...
				document.form2.submit();
				//document.form2.action="teso-anularecibocaja.php";
				//location.href="teso-anularecibocaja.php";
				}
			}	
			function adelante()
			{
				if(parseFloat(document.form2.ncomp.value)<parseFloat(document.form2.maximo.value))
 				{
					...
					document.form2.action="teso-anularrecibover.php";
					document.form2.submit();
				}
			}
			function atrasc()
			...
			function validar2()
			{
				...
				//document.form2.submit();
				location.href="teso-anularrecibover.php?idrecibo="+document.form2.idcomp.value;
			}
			function iratras()
			{
				var idcta=document.getElementById('ncomp').value;
				location.href="teso-anularecibocaja.php?idcta="+idcta;
			}
		</script>
		<?php titlepag();?>
	</head>
	<body>
		...
		<table>
			...
			<tr>
				...
				<a onClick="location.href='teso-anularecibocaja.php'" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
				...
				<a class="mgbt" onClick="iratras()"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
			</tr>		  
		</table>
		<?php
			$vigencia=date(Y);
    		...
    		<table class="inicio" style="width:99.7%;">
                ...
                <tr>
        			...
        			<td style="width:20%;"> 
                        ...
                        <input type="text" name="idcomp" id="idcomp" value="<?php echo $_POST[idcomp]?>" onKeyUp="return tabular(event,this) "  onChange="validar2()"  style="width:50%;" />
        			...
        			<td style="width:18%;"><input type="text" name="fecha"  value="<?php echo $_POST[fecha]?>"  onKeyUp="return tabular(event,this)" style="width:100%;" readonly/></td>
                ...
                <tr>
      			...
      			<tr>
                    ...
                    <td style="width:15%;">
						<?php 
							if($_POST[estado]=='ACTIVO'){
								echo "<input name='estado' type='text' value='ACTIVO' size='5' style='width:40%; background-color:#0CD02A; color:white; text-align:center;' readonly >";
							}
							else
							{
					...
					<td> <input type="Button" name="Anular" value="Anular" onclick="eliminar(<?php echo $_POST[idcomp]?>);"></td>
            	</tr>
					...
					<?php 		
		  				if($_POST[oculto]>=0 && $_POST[encontro]=='1')
						{
							...
							while ($rowg =mysql_fetch_row($resg)) 
							{
								...
								<td style='width:10%;'>$rowg[0]</td>
								<td>$descrip</td>
								<td style='width:20%;text-align:right;'>$ ".number_format($rowg[1],2,',','.')."</td></tr>";
