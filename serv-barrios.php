	...
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-barrioseditar.php?idban="+idban;
			}
	...
	<body>
		...
		<form name="form2" method="post" action="">
			<?php 
				...
				{
					$_POST['onoffswitch']="S";
					$_POST['codban']=selconsecutivo('srvbarrios','id');
				}
			?>
			<table class="inicio">
				<tr>
					<td class="titulos" colspan="4">.: Ingresar Barrio</td>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvbarrios','id');
					$sqlr="INSERT INTO srvbarrios (id,nombre,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."','$valest')";
