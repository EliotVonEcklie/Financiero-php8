...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
        	function guardar()
			{
				...
				if((validacion01.trim()!='')&&(validacion02.trim()!='')){
					...
					despliegamodalm('visible','2','Falta informacion para Crear el Prototipo');
				}
	 		}
			...
			function funcionmensaje(){document.location.href = "acti-prototipo.php";}
	...
	<body>
        ...
        <div id="bgventanamodalm" class="bgventanamodalm">
  		...
  		<form name="form2" method="post" action="acti-prototipo.php">
            <table class="inicio" align="center">
                <tr>
                    <td class="titulos" colspan="6">.: Agregar Prototipo</td>
                ...
                <tr>
                    ...
                    <td style="width:13%;">
                    <?php 
                    	$sqlr="SELECT id FROM acti_prototipo";
            ...
            <input type="hidden" name="valfocus" id="valfocus" value="1"/> 
  			<?php
				...
				if($_POST[oculto]=="2")
				{
					$sqlr="INSERT INTO acti_prototipo (id,nombre,estado) VALUES ($_POST[codigo],'$_POST[nombre]','$_POST[estado]')";
					//echo $sqlr;
