...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			{
				location.href="teso-zonasver.php?codigo="+idcta;
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				...
				<a onClick="location.href='teso-zonas.php'" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
		...
		?>
 		<form name="form2" method="post" action="teso-buscazonas.php">
			...
			<table  class="inicio" align="center" >
    			<tr >
      			...
      			<tr>
         			<td style="width:7%" class="saludo1"> C&oacute;digo o nombre de Zona: </td>
    				<td  style="width: 20%">
			...
			<div class="subpantallac5" style="height:68.5%; width:99.6%; overflow-x:hidden;" id="divdet">
				<?php
                	...
                	$crit1="";
                	if ($_POST[codigo]!=""){
                		$crit1=" and (TB1.codigo like '%$_POST[codigo]%' OR TB1.nombre like '%$_POST[codigo]%')";
                	}

					$sqlr="select * from zonas TB1 where TB1.estado<>'' $crit1 group by id order by TB1.id";
					...
					$sqlr="select * from zonas TB1 where TB1.estado<>'' $crit1 order by TB1.id";
					$resp = mysql_query($sqlr,$linkbd);
					...
					<table class='inicio' align='center' >
						...
						<tr>
							<td colspan='10'>Zonas Encontradas: $ntr</td>
						</tr>
						<tr style='text-align:center;'>
							<td class='titulos2' style='width:15%'>Codigo de zona</td>
					...
					onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"verUltimaPos($idcta, $numfil, $filtro)\" style='text-transform:uppercase; $estilo' >
							...
							<td>$row[1]</td>
							<td>$row[2] </td>";
							if ($row[3]=='S'){echo "<td ><center><img src='imagenes/sema_verdeON.jpg' style='width:18px;'></center></td>";}
							if ($row[3]=='R'){echo "<td ><center><img src='imagenes/sema_rojoON.jpg' style='width:18px;'></center></td>";}
