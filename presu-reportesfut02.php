    ...
    <body>
        ...
        <table>
            ...
            <tr>
				...
				<a href="<?php echo "archivos/".$_SESSION[usuario]."informecgr".$fec.".csv"; ?>" target="_blank" class="mgbt"><img src="imagenes/csv.png" title="csv" style="width:29px; height:25px;"></a>
				<a onClick="location.href='presu-reportesfut.php'" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
  			</tr>
		</table>
		<form name="form2" method="post" action="presu-reportesfut02.php">
 			<?php
    		...
    		<table  align="center" class="inicio" >
      			<tr>
        			<td class="titulos" colspan="6">.: CGR PRESUPUESTAL</td>
