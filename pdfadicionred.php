...
{	
	...
	$this->SetY(8);
    $this->Cell(50.1);
    $this->Cell(149,25,''.$_POST[doc],0,0,'C'); 
    $this->SetFont('Arial','B',10);
	$this->SetY(29);
    $this->Cell(161.1);
	...
	$this->SetY(29);
	$this->Cell(50.2);
	$this->MultiCell(110.7,4,'Acto Administrativo: '.$_POST[acto],'T','L');		
...
//********************************************************************************************************************************
	...
	$this->SetY(43);
    $this->Cell(0.1);
    $this->Cell(22,5,'CODIGO ',0,1,'C'); 
		$this->SetY(43);
    	$this->Cell(22.1);
		$this->Cell(75,5,'CUENTA',0,1,'C');
			$this->SetY(43);
        	$this->Cell(97);
			$this->Cell(38,5,'RECURSO',0,1,'C');
			$this->SetY(43);
        	$this->Cell(135.1);
			$this->Cell(32,5,'INGRESOS',0,1,'C');
			$this->SetY(43);
        	$this->Cell(167.1);
			$this->Cell(32,5,'GASTOS',0,1,'C');
...
{	if ($con%2==0)
    ...
    $pdf->Cell(73,4,substr(''.$_POST[dncuentas][$con],0,25),0,0,'L',1);//descrip

    $pdf->Cell(8,4,substr(''.$_POST[balan][2],0,4),0,0,'R',1);//descrip

    $pdf->Cell(32,4,substr(''.$_POST[balan][3],0,28),0,0,'L',1);//descrip

    $pdf->Cell(32,4,''.$_POST[dingresos][4],0,0,'R',1);//descrip

    $pdf->Cell(32,4,''.$_POST[dgastos][5],0,0,'R',1);
	$pdf->ln(4);	
...
//	$pdf->cell(103);
	...
	$pdf->cell(103,5,'','T',0,'R');
	$pdf->cell(32,5,'Total','T',0,'R');

	$pdf->cell(32,5,''.$_POST[vting],'T',0,'R');

	$pdf->cell(32,5,''.$_POST[vtgas],'T',0,'R');
