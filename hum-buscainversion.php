		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="hum-editainversion.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
...
<tr>
  <td colspan="3" class="cinta"><a href="hum-inversion.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a><a href="#"  onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  title="Guardar" /></a><a href="#" onClick="document.form2.submit();" class="mgbt"><img src="imagenes/busca.png"  title="Buscar" border="0" /></a><a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a> <a href="hum-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td></tr>	
		...
		?>
 <form name="form2" method="post" action="hum-buscainversion.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Inversi&oacute;n</td>
      ...
      <?php
		...
		if ($_POST[numres]!="-1"){ 
          ...
          //sacar el consecutivo 
	        $sqlr="select *from conceptoscontables where conceptoscontables.tipo='IN' and conceptoscontables.modulo='2' ".$crit1." order by conceptoscontables.codigo";
          $resp = mysql_query($sqlr,$linkbd);
          $ntr = mysql_num_rows($resp); 
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *from conceptoscontables where conceptoscontables.tipo='IN' and conceptoscontables.modulo='2' ".$crit1." order by conceptoscontables.codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
		...
		if(($_POST[numpos]==0)||($_POST[numres]=="-1")){
          ...
          echo "<table class='inicio' align='center'>
			...
			<tr>
				<td colspan='3'>Inversi&oacute;n Encontrados: $ntr</td>
			</tr>
			<tr>
