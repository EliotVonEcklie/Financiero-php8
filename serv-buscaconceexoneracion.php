...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="serv-editaconceexoneracion.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
    ...
    <body>
		...
		?>
        <form name="form2" method="post" action="serv-buscaconceexoneracion.php">
            ...
            <table  class="inicio" align="center" >
                <tr>
                    <td class="titulos" colspan="2">:. Buscar Concepto Contable de Exoneracion </td>
            ...
            <div class="subpantalla" style="height:68.5%; width:99.6%;">
	            ...
	            $sqlr="select *from conceptoscontables where conceptoscontables.modulo='10' and conceptoscontables.tipo='SE' ".$crit1." order by conceptoscontables.codigo";
                $resp = mysql_query($sqlr,$linkbd);
                $ntr = mysql_num_rows($resp);
                $_POST[numtop]=$ntr;
                $nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
                $sqlr="select *from conceptoscontables where conceptoscontables.modulo='10' and conceptoscontables.tipo='SE' ".$crit1." order by conceptoscontables.codigo ".$cond2;
                $resp = mysql_query($sqlr,$linkbd);			
                $co='saludo1a';
                $co2='saludo2';	
