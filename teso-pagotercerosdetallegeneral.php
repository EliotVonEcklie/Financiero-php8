		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta">
					<a href="teso-pagotercerosdetalle.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
					<a href="#" class="mgbt" onClick="guardar()"><img src="imagenes/guarda.png"/></a>
			...
			?>
 			<form name="form2" method="post" action=""> 
				...
				if($_POST[bt]=='1')
				{
 				...
 				?>
	   			<table class="inicio" align="center" >
	   				<tr>
	     				<td colspan="6" class="titulos">Declaraci&oacute;n Retenciones</td><td width="68" class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
					</tr>
      				<tr>
	  					<td  class="saludo1" style="width:10%">Fecha: </td>
        				<td style="width:15%"><input name="fecha" type="text" value="<?php echo $_POST[fecha]?>" maxlength="10" style="width:80%" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)"  id="fc_1198971545" onKeyDown="mascara(this,'/',patron,true)" title="DD/MM/YYYY">   <a href="#" onClick="displayCalendarFor('fc_1198971545');"><img src="imagenes/calendario04.png" style="width:20px" align="absmiddle" border="0"></a>     </td>
	  					<td   class="saludo1" style="width:12%">Vigencia: </td>
        				<td><input name="vigencia" type="text" value="<?php echo $_POST[vigencia]?>" maxlength="2" style="width:23%" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" readonly> </td>
						<td colspan="1" rowspan="3"> 
							<IMG SRC="imagenes/siglas.png" style="width:100%; height:40%"  >
						</td>
					</tr>
       				<tr>
         				...
         				<td  class="saludo1">Tercero:</td>
          				<td><input id="tercero" type="text" name="tercero" size="10" onKeyUp="return tabular(event,this)" onBlur="buscater(event)" value="<?php echo $_POST[tercero]?>" ><a href="#" onClick="mypop=window.open('terceros-ventana.php','','menubar=0,scrollbars=yes, toolbar=no, location=no, width=900,height=500px');mypop.focus();"><img src="imagenes/buscarep.png" align="absmiddle" border="0"></a>           <input name="ntercero" type="text" value="<?php echo $_POST[ntercero]?>" style="width:70%" readonly><input type="hidden" value="0" name="bt"></td>    </tr>
          			<tr>                
						<td class="saludo1">Valor a Pagar:</td>
						<td>
							<input name="valorpagar" type="text" id="valorpagar" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[valorpagar]?>" style="width:80%" readonly>
						</td>	
						...
						$nreten=array();		
						?>
						<select name="retencion" style="width:50%" onChange="validar()" onKeyUp="return tabular(event,this)">
							<option value="">Seleccione ...</option>
				...
				<div class="subpantallac6" style="width:99.6%; height:165px; overflow-x:hidden;">
       				<table class="inicio" style="overflow:scroll">
						<tr><td class="titulos">Retenciones / Ingresos</td><td class="titulos">Banco</td><td class="titulos">Cuenta Bancaria</td><td class="titulos">Contabilidad</td><td class="titulos">Valor</td><td></td></tr>        
						<?php
						$linkbd=conectar_bd();
				...
				if($_POST[oculto]=='2')
				{
					...
					{	
						...
						{		
							...
							{
								echo "<script>document.form2.".$ncheck.".cheched=true;	</script>";
								echo "Seleccionado ".$ncheck."<br>";
