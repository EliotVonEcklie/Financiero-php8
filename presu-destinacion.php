...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<form action="presu-destinacion.php" method="post" enctype="multipart/form-data" name="form2">
	<?php
		$_POST[tabgroup1]=1;
					...
					echo "<table class='inicio'>
						...
						if($_POST[oculto]==2)
						{
							...
							if($archivo)
							{
								...
								$sqlr1="delete from pptosidefdestinacion";
								...
								{ 
									...
									if($datos[0]!='' && $datos[0]!='Codigo')
									{
										...
										echo $datos[0]; echo "<br>";
											echo $dato;	echo "<br>";	
										$consulta = "INSERT INTO pptosidefdestinacion (codigo, nombre, estado) VALUES ('".trim($datos[0])."','".$dato."','S')";
							...
							$sql="select * from pptosidefdestinacion order by codigo";
