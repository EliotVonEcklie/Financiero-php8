...
{   
	parent.document.form2.cuentaper.value =pref;
	parent.document.form2.cuentaper_.value =pref;
	parent.document.form2.ncuentaper.value =opc;
	parent.document.form2.defecto.value =1 ;
...
<body >
  ...
  $año=date("Y", strtotime($_POST[fecha]));
  ?>
