...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-rutaseditar.php?idban="+idban;
			}
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para crear la Ruta');}
			}
			...
			function fagregar()
			{
				...
				else{despliegamodalm('visible','2','Falta seleccionar un barrio para agregar');}
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='serv-rutas.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar()" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='serv-rutasbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("serv");?>" class="mgbt"></td>
			</tr>
		</table>
		...
		<form name="form2" method="post" action="">
			<?php 
				...
				{
					$_POST['onoffswitch']="S";
					$_POST['codban']=selconsecutivo('srvrutas','id');
				}
			?>
			<table class="inicio ancho">
				<tr>
					<td class="titulos" colspan="5">.: Ingresar Ruta</td>
				...
				<tr>
					...
					<td colspan="2"><input type="text" name="nomban" id="nomban" value="<?php echo @ $_POST['nomban'];?>" style="width:100%;height:30px;text-transform:uppercase"/></td>
				</tr>
				<tr>
			...
			<div class="subpantalla" style="height:60.5%; width:99.6%; overflow-x:hidden;">
				<table class="inicio" width="99%">
					...
					?>
					<script>document.form2.idbar.</script>
				</table>
			</div>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvrutas','id');
					$sqlr="INSERT INTO srvrutas (id,nombre,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."', '$valest')";
