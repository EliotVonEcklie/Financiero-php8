 ...
 document.form2.submit();
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta"><a href="presu-distribucionconpes.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#"  onClick="guardar();" class="mgbt"><img src="imagenes/guarda.png" title="Guardar"/></a><a href="presu-buscadistribucionconpes.php" class="mgbt"><img src="imagenes/busca.png"  title="Buscar" /></a><a href="#" onClick="mypop=window.open('presu-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a></td>
        	</tr>		  
        </table>
<?php
$linkbd=conectar_bd();
...
<?php  //***** busca tercero
    ...
    <table class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="8">.: Agregar Conpes  -   *Nota: No se usa para SSF</td><td class="cerrar" ><a href="presu-principal.php">Cerrar</a></td>
      </tr>
      <tr  >
