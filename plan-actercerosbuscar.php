...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
  	<head>
		...
		<script>
			function verUltimaPos(idcta, filas)
			{
				...
				var vbusq=document.getElementById('nombre').value;
				if((numpag<=0)||(numpag=="")){numpag=0;}
				if((limreg==0)||(limreg=="")){limreg=10;}
				numpag++;
				location.href="plan-actercerosmodifica.php?idter="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&vbusq="+vbusq;
			}
	...
	<body>
    	...
    	<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><a href="plan-acterceros.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a><a class="mgbt"><img src="imagenes/guardad.png" title="Guardar" /></a><a onClick="document.form2.submit();" href="#" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a><a href="#" onClick="mypop=window.open('plan-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva ventana"></a></td>
 			</tr>
		</table>
		...
		?>
 		<form name="form2" method="post" action="plan-actercerosbuscar.php">
        	<?php
				if($_POST[oculto2]=="")
				{
					$_POST[oculto2]="0";
			...
			<div class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;" id="divdet" >
      			<?php
					...
					<table class='inicio' align='center' width='99%'>
						...
						<tr>
							<td class='titulos2' style='width:2%'>Item</td>
							...
							<td class='titulos2' style='width:4%'>DOCUMENTO</td>
							<td class='titulos2' colspan='2' style='width:6%;' >Estado</td>
							<td class='titulos2' style='width:3%'>EDITAR</td>
						</tr>";	
					$iter='saludo1a';
					$iter2='saludo2';
					$filas=1;
