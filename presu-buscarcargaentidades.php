    ...
    <body>
        ...
        <table>
        	...
        	<tr>
				...
				<a href="presu-cargaentidades.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
...
<table  class="inicio" align="center" >
      <tr >
		<td class="titulos" colspan="9" style='width:93%'>:: Buscar Cargue Entidades - Ejecucion de Gastos</td>
...
if ($_POST[trimestre]!="")
$crit1=" and entidadesgastos.trimestre like '%".$_POST[trimestre]."%' ";
if ($_POST[cc]!="")
$crit2=" and entidadesgastos.unidad like '%$_POST[cc]%' ";
if ($_POST[vigencia]!="")
$crit3=" and entidadesgastos.vigencia like '%".$_POST[vigencia]."%' ";

$sqlr="select *from entidadesgastos where entidadesgastos.cuenta!=''".$crit1.$crit2.$crit3." GROUP BY fecha,unidad";
...
$iter2='saludo2';
 while ($row =mysql_fetch_row($resp)) 
 {
	 ...
	 $sqlr="select nombre from pptouniejecu where id_cc='$row[15]'";
	 $result=mysql_query($sqlr,$linkbd);
	 $row1=mysql_fetch_row($result);
	 echo "
	 <tr >
		<td class='$iter'>".strtoupper($row1[0])."</td>
		<td class='$iter'>".strtoupper($row[16])."</td>
		<td class='$iter'>".strtoupper($tri)."</td>
		<td class='$iter'>".strtoupper($row[18])."</td>
		<td class='$iter'>Consolidacion Entidades</td>
		<td class='$iter'><a href='presu-cargaentidadesver.php?trime=$row[17]&uni=$row[15]&fec=$row[18]&vig=$row[16]'><center><img src='imagenes/buscarep.png'></center></a></td>
	</tr>";
	 $con+=1;
	 $aux=$iter;
	 $iter=$iter2;
