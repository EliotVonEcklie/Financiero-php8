...
document.form2.action="presu-sinsituacionegreso-reflejar.php";
document.form2.submit();
}
}
</script>
...
<tr>
	<td colspan="3" class="cinta">
		<a href="#" ><img src="imagenes/add2.png" title="Nuevo" class="mgbt" border="0" /></a> 
		<a href="#"><img src="imagenes/guardad.png" class="mgbt" title="Guardar" /></a>
		<a href="#"> <img src="imagenes/busca.png" class="mgbt" title="Buscar" /></a> 
		<a href="#" onClick="mypop=window.open('presu-principal.php','','');mypop.focus();"><img src="imagenes/nv.png" class="mgbt" title="nueva ventana"></a> 
		<a href="#" onClick="guardar()"><img src="imagenes/reflejar1.png"  title="Reflejar" class="mgbt" style="width:24px;" /> 
		<a href="#" <?php if($_POST[oculto]==2) { ?> onClick="pdf()"  <?php } ?>> <img src="imagenes/print.png" class="mgbt" title="Buscar" /></a> 
		<a href="presu-reflejardocs.php"><img src="imagenes/iratras.png" class="mgbt" title="nueva ventana"></a></td>
</tr>		  
</table>
<tr>
...
<?php
	...
	{
		$_POST[dcoding][]=$r[2];
		$_POST[dncoding][]=buscacuentapres($r[2],2);			 		
		$_POST[dvalores][]=$r[4];
	}
...
//***** busca tercero
 ...
 ?>
    ...
    <table class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="9"> Egresos Sin Situacion de Fondos - SSF</td>
        <td width="70" class="cerrar" ><a href="presu-principal.php">Cerrar</a></td>
      </tr>
      <tr  >
        <td   class="saludo1" >Numero Egreso:</td>
        <td  ><a href="#" onClick="atrasc()"><img src="imagenes/back.png" title="anterior" align="absmiddle"></a> <input name="idcomp" type="text" size="5" value="<?php echo $_POST[idcomp]?>" onKeyUp="return tabular(event,this) "   onBlur="validar2()" ><input name="ncomp" type="hidden" value="<?php echo $_POST[ncomp]?>"><a href="#" onClick="adelante()"><img src="imagenes/next.png" title="siguiente" align="absmiddle"></a> <input type="hidden" value="a" name="atras" ><input type="hidden" value="s" name="siguiente" ><input type="hidden" value="<?php echo $_POST[maximo]?>" name="maximo"></td>
      ...
      <tr>
        <td  class="saludo1">Concepto Egreso:</td>
...
<script>
			 ...
			 else
			 {
			  $_POST[codingreso]="";
			  ?>
			  <script>alert("Codigo Egresos Incorrecto");document.form2.codingreso.focus();</script>
			  <?php
			  }
			 }
			 ?>
    ...
    <div class="subpantalla">
		<table class="inicio">
			<tr>
				<td colspan="4" class="titulos">Detalle Egresos Sin Situacion de Fondos</td>
			</tr>                  
			<tr>
				<td class="titulos2" style="width:15%">Codigo</td>
				<td class="titulos2" style="width:70%">Nombre De La Cuenta</td>
	...
	if($_POST[oculto]=='2')
	{
		...
		$consec=$_POST[idcomp];
		$sqlr="delete from pptocomprobante_cab where numerotipo=$_POST[idcomp] and tipo_comp='13'";
		mysql_query($sqlr,$linkbd);
	    $sqlr="delete from pptocomprobante_det where numerotipo=$_POST[idcomp] and tipo_comp='13'";
		mysql_query($sqlr,$linkbd);		
		//***cabecera comprobante
		$sqlr="insert into  pptocomprobante_cab (numerotipo,tipo_comp,fecha,concepto,vigencia,total_debito,total_credito,diferencia,estado) values($_POST[idcomp],13,'$fechaf','EGRESOS SSF',$_POST[vigencia],0,0,0,'$_POST[estadoc]')";
		if(mysql_query($sqlr,$linkbd))
		{
			echo "<table class='inicio'><tr><td class='saludo1'><center>Se ha Actualizado el Egreso SSF con Exito <img src='imagenes/confirm.png'><script></script></center></td></tr></table>"; 
			//******************* DETALLE DEL COMPROBANTE CONTABLE *********************
			for($x=0;$x<count($_POST[dcoding]);$x++)
			{
				//***** BUSQUEDA INGRESO ********
				$sqlri="Select * from tesossfegreso_det where cuentap='".$_POST[dcoding][$x]."' and id_egreso=$_POST[idcomp]";
				$res2=mysql_query($sqlri,$linkbd);   
				while($row2=mysql_fetch_row($res2))
				{
					$vi= $_POST[dvalores][$x];
					$sqlr="insert into  pptocomprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia,tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcoding][$x]."','".$_POST[tercero]."','EGRESOS SSF',".$vi.",0,'$_POST[estadoc]','$_POST[vigencia]',13,$_POST[idcomp],1,'','','$fechaf')";
					mysql_query($sqlr,$linkbd);
				}	
			}	
		}
		...
		{
			echo "<table class='inicio'><tr><td class='saludo1'><center>No se ha Actualizado el Egreso SSF <img src='imagenes/alert.png'><script></script></center></td></tr></table>"; 
		}
	}
?>	
</form>
