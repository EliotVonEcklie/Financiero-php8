...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje(){document.location.href = "inve-conceconajuste.php";}
			function guardar()
			{
			...
			function agregardetalle()
			{
				if(document.getElementById('fecha1').value!='')
				{
					...
					if(cuentas==0){
						if(val01!=""){document.form2.agregadet.value="1";document.form2.oculto.value=9;document.form2.submit();}
		...
		<script>
			function adelante(scrtop, numpag, limreg, filtro, next){
				...
				if(parseFloat(maximo)>parseFloat(actual)){
					...
					document.form2.action="inve-editaconceconajuste.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
            ...
            function iratras(scrtop, numpag, limreg, filtro){
                var idcta=document.getElementById('codigo').value;
                location.href="inve-buscaconceconajuste.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
            }
			function validar3(formulario)
			{
				document.form2.action="teso-editaconceconajuste.php";
				document.form2.submit();
			}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><a href="inve-conceconajuste.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a><a href="inve-buscaconceconajuste.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a> <a href="#" onClick="iratras(<?php echo $scrtop; ?>, <?php echo $numpag; ?>, <?php echo $limreg; ?>, <?php echo $filtro; ?>)" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
			</tr>
   		</table>
	 ...
	 ?>
    		<table class="inicio" align="center"  >
      			<tr >
        			<td class="titulos" colspan="8">.: Editar Concepto Contable Entrada por Ajuste </td>
			...
			<table class="inicio">
				...
				<tr>
						...
						<td><input type="text" name="ncuenta" id="ncuenta" value="<?php echo $_POST[ncuenta]?>" style="width:70%;" readonly></td>
				</tr>
				<tr>
					<td class="saludo1" style="width:2cm;">Tipo:</td>
                    <td>
...
onMouseOut=\"this.style.backgroundColor=anterior\" >
								<td style='width:10%'><input name='fecha[]' class='inpnovisibles' value='".$_POST[fecha][$x]."' type='text' style='width:100%;' readonly></td>
								<td style='width:5%'><input type='text' class='inpnovisibles' name='dccs[]' value='".$_POST[dccs][$x]."' style='width:100%;' readonly ></td>
