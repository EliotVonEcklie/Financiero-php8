				...
				if($_POST[oculto]==2)
 				{
					...
					if($_POST[swparafiscal]=='S'){$pagopara='S';}
  					...
  					$sqlr="INSERT INTO hum_incapacidades(num_inca,fecha,vigencia,doc_funcionario,nom_funcionario,cod_inca_n,cod_inca_a,salario, fecha_ini,fecha_fin,tipo_inca,valor_total,paga_ibc,paga_arl,paga_para,meses,dias_total,estado) VALUES ('$consec','$_POST[fecha]','$_POST[vigenciat]', '$_POST[tercero]','$_POST[ntercero]','$_POST[incaeps]','$_POST[incaepsant]','$_POST[salbas]','$fechai','$fechaf','$_POST[tipoinca]', '$_POST[valinca]','$pagoibc','$pagoarl','$pagopara','$_POST[mesletras]','$_POST[totaldiasinca]','S')";
