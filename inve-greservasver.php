...
<link href="css/css3.css?<?php echo date('d_m_Y_h_i_s');?>" rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<table>
    		...
    		<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='inve-greservas.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='inve-greservasbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="mypop=window.open('inve-principal.php','','');mypop.focus();" class="mgbt"/><img src="imagenes/print.png" title="Imprimir" onclick="pdf()" class="mgbt"><img src="imagenes/iratras.png" title="Atrás" onclick="iratras(60, 1, 10, '')" class="mgbt"></td>
			</tr>
         </table>
 		...
 		<form name="form2" method="post" action="inve-greservaseditar.php">
    		...
    		<table class="inicio" align="center" >
                ...
                <tr>
                    ...
                    <td class="saludo1" style="width:3.1cm;">.: Descripci&oacute;n:</td>
