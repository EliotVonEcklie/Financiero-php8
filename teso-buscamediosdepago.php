		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editamediosdepago.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
...
function pdf()
{
document.form2.action="teso-pdfmediosdepago.php";
...
function crearexcel(){
				document.form2.action="teso-buscamediosdepagoexcel.php";
				document.form2.target="_BLANK";
				document.form2.submit();
				document.form2.action="";
				document.form2.target="";
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a href="teso-mediosdepago.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
		...
		?>
 <form name="form2" method="post" action="teso-buscamediosdepago.php">
 			...
 			<?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					{
                        $sqlr="UPDATE tesomediodepago SET estado='S' WHERE id ='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
                        $sqlr="UPDATE tesomediodepago SET estado='N' WHERE id ='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
				}
				//*****************************************************************
...
//sacar el consecutivo 
	$sqlr="select *from tesomediodepago where tesomediodepago.id>-1 ".$crit1." order by tesomediodepago.id";
	...
	$ntr = mysql_num_rows($resp);
					...
					$sqlr="SELECT *from tesomediodepago where tesomediodepago.id>-1 ".$crit1." order by tesomediodepago.id ".$cond2;
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
...
echo "<table class='inicio' align='center' >
	...
	<tr>
		<td colspan='5'>Sanciones Encontrados: $ntr</td>
	</tr>
	<tr>
