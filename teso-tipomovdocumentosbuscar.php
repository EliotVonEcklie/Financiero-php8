...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
		...
		<table>
        	...
        	<tr>
  				<td colspan="3" class="cinta"><a href="" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#" onClick="guardar()" class="mgbt1"><img src="imagenes/guardad.png"  title="Guardar"/></a><a href="" onClick="document.form2.submit()" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a href="#" onClick="mypop=window.open('teso-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a></td>
			</tr>
		</table>	
		...
		?>
 		<form name="form2" method="post" action="teso-tipomovdocumentosbuscar.php">
        	<?php
				if($_POST[oculto]=="")
				{
					$_POST[cambioestado]="";
    		...
    		<div class="subpantallac5" style="height:69.5%; width:99.6%; overflow-x:hidden;" id="divdet">
				<?php
					...
					$sqlr="SELECT * FROM tipo_movdocumentos where estado='S' and modulo='4'".$cond2;
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
