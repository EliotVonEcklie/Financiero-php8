...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    <head>
        ...
        <script> 
			function ponprefijo(ingreso,concepto,valor,numeroIngreso)
			{
                ...
                parent.document.form2.idIngreso.value=numeroIngreso;
    ...
    <body>
        <form name="form2" action="" method="post">
            ...
            <div class="subpantalla" style="height:84.5%; width:99%; overflow-x:hidden;">
                ...
                $sqlr="SELECT tesoidentificar.id, tesoidentificar.concepto, tesoidentificar.tercero, tesoidentificar.fecha, tesoidentificar.estado, tesoidentificar.valortotal FROM tesoidentificar WHERE tesoidentificar.estado='S' AND tesoidentificar.tipo_mov='201' $crit1 ";
                ...
                $sqlr="SELECT tesoidentificar.id, tesoidentificar.concepto, tesoidentificar.tercero, tesoidentificar.fecha, tesoidentificar.estado, tesoidentificar.valortotal, tesoidentificar.idcomp FROM tesoidentificar WHERE tesoidentificar.estado='S' AND tesoidentificar.tipo_mov='201' $crit1 $crit2 order by tesoidentificar.id desc $cond2 ";
                //echo $sqlr;
                $resp = mysql_query($sqlr,$linkbd);
                $con=1;
                ...
                while ($row =mysql_fetch_row($resp)) 
                {
                    ...
                    echo"
                    <tr class='$iter' onClick=\"javascript:ponprefijo($row[0],'$row[1]',$row[5],$row[6])\" onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase'>
                        <td>$row[0]</td>
                        <td>$row[1]</td>
                        <td>$row[3]</td>
                        <td >$row[5]</td>
