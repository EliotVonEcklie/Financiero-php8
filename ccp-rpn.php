	...
	<head>
		...
		<script>
			...
			function validar(formulario)
			{
				...
				document.form2.action="ccp-rpn.php";
	...
	<body >
		...
		<table>
			...
			<tr>
				...
				<a onClick="location.href='ccp-rpn.php'" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
						...
						<td>
							<select name="numerocdp" id="numerocdp" onChange="validar()" onKeyUp="return tabular(event,this)" style="width:80%;">
								...
								<?php
									$sqlr="
									SELECT TB1.* 
									FROM ccpet_cdp TB1, hum_nom_cdp_rp TB2 
					...
					<table class="inicio" width="99%">
						...
						<?php
							if ($_POST[oculto]==1)
							{
								...
								$saldoscdpdet=array();
								$valorcdpor=array();
								$sqlr="Select * from ccpetcdp_detalle  where estado='S' and vigencia=$_POST[vigencia] and consvigencia=$_POST[numerocdp] and tipo_mov='201'  order by consvigencia";
								$resp = mysql_query($sqlr,$linkbd);
								while ($row =mysql_fetch_row($resp)) 
								{
			...
			?>
				...
				if($_POST[tipomovimiento]=='201'){
					...
					if($_POST[oculto]=='2')
					{
						...
						if($bloq>=1)
						{	
							$sqlr="select count(*) from ccpet_rp where vigencia='$_POST[vigencia]' and consvigencia=$_POST[numero]";
							$res=mysql_query($sqlr,$linkbd);
							while($r=mysql_fetch_row($res))
							{
								$numerorecaudos=$r[0];
	  						...
	  						if($numerorecaudos==0)
	 						{
								...
								$sqlr="insert into ccpet_rp (vigencia,consvigencia,fecha,idcdp,estado,tercero,valor,saldo,contrato,tipo_mov) values('$_POST[vigencia]','$_POST[numero]','$fechaf','$_POST[numerocdp]','S','$_POST[tercero]','$_POST[valorrp]','$_POST[valorrp]','$_POST[ncontrato]','201')";
									...
									for($x=0;$x<count($_POST[dgastos]);$x++)
			 						{
										...
										$sqlr="insert into ccpetrp_detalle (vigencia,consvigencia,cuenta,fuente,valor,estado,saldo,saldo_liberado,tipo_mov) values('$_POST[vigencia]','$_POST[numero]','".$_POST[dcuentas][$x]."','".$_POST[dcfuentes][$x]."',".$_POST[dgastos][$x].",'S',".$_POST[dgastos][$x].",0,'201')";
			 							...
			 							$sqlr="update ccpetcdp_detalle set saldo=saldo-".$_POST[dgastos][$x]." where  cuenta='".$_POST[dcuentas][$x]."' and consvigencia=$_POST[numerocdp] and  vigencia=".$vigusu." and tipo_mov='201' ";
			  							mysql_query($sqlr,$linkbd);
			  							$sqlr="insert into  ccpet_comprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia, tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcuentas][$x]."','$_POST[tercero]','".$_POST[dfuentes][$x]."',".$_POST[dgastos][$x].",0,1,'$_POST[vigencia]', 7,'$_POST[numero]','201','1','','$fechaf')";
	 	  								mysql_query($sqlr,$linkbd); 
										$sqlr="insert into  ccpet_comprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia, tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcuentas][$x]."','$_POST[tercero]','".$_POST[dfuentes][$x]."',0,".$_POST[dgastos][$x].",1,'$_POST[vigencia]', 6,'$_POST[numerocdp]','201','1','$_POST[numero]','$fechaf')";
	 	  								mysql_query($sqlr,$linkbd); 
						...
						{	
							...
							//************** modificacion del presupuesto **************
								...
								if($_POST[tipomovimiento]=='401'){
									$sqlr="update ccpet_comprobante_cab set estado=2 where numerotipo=$_POST[rp] and tipo_comp=7";
									mysql_query($sqlr,$linkbd);
									...
									$sqlr="insert into ccpet_rp (vigencia,consvigencia,idcdp,estado,fecha,detalle,user,tipo_mov) values (".$vigusu.",'$_POST[rp]','$_POST[cdp]','R','$gfecha','$_POST[objeto]','".$_SESSION['nickusu']."','401')";
									...
									$sqlr="insert into ccpet_rp (vigencia,consvigencia,idcdp,estado,fecha,detalle,user,tipo_mov) values (".$vigusu.",'$_POST[rp]','$_POST[cdp]','R','$gfecha','$_POST[objeto]','".$_SESSION['nickusu']."','402')";
									mysql_query($sqlr,$linkbd);
									// echo $sqlr."<br><br>";
							...
							for($x=0;$x<count($_POST[dgastos]);$x++)
							{
								if($_POST[tipomovimiento]=='401'){
									...
									// // echo $sqlr."<br>";
									// mysql_query($sqlr,$linkbd); 
									$sqlr="insert into  ccpet_comprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia, tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcuentas][$x]."','$_POST[tercero]','".$_POST[dfuentes][$x]."',0,".$_POST[dgastos][$x].",'2','$_POST[vigencia]', 7,'$_POST[rp]','401','1','','$fechaf')";
									mysql_query($sqlr,$linkbd); 
									// echo $sqlr."<br><br>";
									$sqlr="insert into  ccpet_comprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia, tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcuentas][$x]."','$_POST[tercero]','".$_POST[dfuentes][$x]."',".$_POST[dgastos][$x].",0,1,'$_POST[vigencia]', 6,'$_POST[cdp]','401','1','$_POST[rp]','$fechaf')";
									mysql_query($sqlr,$linkbd);
								}else if($_POST[tipomovimiento]=='402'){
									...
									// // echo $sqlr."<br>";
									// mysql_query($sqlr,$linkbd); 
									$sqlr="insert into  ccpet_comprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia, tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcuentas][$x]."','$_POST[tercero]','".$_POST[dfuentes][$x]."',0,'".$_POST[dgastos][$x]."',3,'$_POST[vigencia]', 7,'$_POST[rp]','402','1','','$fechaf')";
									mysql_query($sqlr,$linkbd); 
									// echo $sqlr."<br><br>";
									$sqlr="insert into  ccpet_comprobante_det (cuenta,tercero,detalle,valdebito,valcredito,estado,vigencia, tipo_comp,numerotipo,tipomovimiento,uniejecutora,doc_receptor,fecha) values('".$_POST[dcuentas][$x]."','$_POST[tercero]','".$_POST[dfuentes][$x]."',".$_POST[dgastos][$x].",0,1,'$_POST[vigencia]', 6,'$_POST[cdp]','402','1','$_POST[rp]','$fechaf')";
									mysql_query($sqlr,$linkbd);
									// echo $sqlr."<br><br>";
								}
