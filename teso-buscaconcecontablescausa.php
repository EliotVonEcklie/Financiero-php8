		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editaconcecontablescausa.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<script>
//************* ver reporte ************
...
document.form2.razonsocial.value="";
    ...
    <body>
		...
		?>
 <form name="form2" method="post" action="teso-buscaconcecontablescausa.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Concepto Contable Causacion Ingresos</td>
...
//sacar el consecutivo 
	$sqlr="select *from conceptoscontables where conceptoscontables.tipo='C' and conceptoscontables.modulo='4' ".$crit1." order by conceptoscontables.codigo";
$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *from conceptoscontables where conceptoscontables.tipo='C' and conceptoscontables.modulo='4' ".$crit1." order by conceptoscontables.codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
