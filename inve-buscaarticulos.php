...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
		...
		?>
 		<form name="form2" method="post" action="inve-buscaarticulos.php">
    		...
    		<div class="subpantalla" style="height:69.5%; width:99.6%; overflow-x:hidden;" id="divdet">
      			<?php
					$crit1=" ";
					$crit2=" ";
					if ($_POST[nombre]!=""){$crit1="WHERE concat_ws(' ', nombre, concat_ws('', grupoinven, codigo)) LIKE '%$_POST[nombre]%'";}
			...
			onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"verUltimaPos($idcta, $numfil, $filtro)\" style='text-transform:uppercase; $estilo' >
							...
							<td><input type='range' name='lswitch1[]' value='".$_POST[lswitch1][$codac]."' min ='0' max='1' step ='1' style='background:$coloracti; width:60%' onChange='cambioswitch(\"$row[0]\",\"$row[3]\",\"".$_POST[lswitch1][$codac]."\")' /></td>";
								$idcta="'".$row[3].$row[0]."'";
								$numfil="'".$filas."'";
