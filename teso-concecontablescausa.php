...
document.form2.oculto.value=2;
document.form2.action="teso-concecontablescausa.php";
document.form2.submit();
}
function validar()
{
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a href="teso-concecontablescausa.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
			<a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  title="Guardar" /></a>
			<a href="teso-buscaconcecontablescausa.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
...
if($_POST[ncuen]==1){
	if(!empty($_POST[cuenta])){
			$sqlr="SELECT distinct nombre from cuentas where  cuenta like'%".$_POST[cuenta]."%' order by cuenta";
...
if(!$_POST[oculto])
{
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(RIGHT(codigo,2)) from conceptoscontables where modulo=4 and tipo='C' order by codigo Desc";
		 //echo $sqlr;
		  $res=mysql_query($sqlr,$linkbd);
		  $row=mysql_fetch_row($res);
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8">.: Concepto Contable Causacion Ingresos </td>
      ...
      <tr  >
		<td width="119" class="saludo1">Codigo:</td>
		 ...
		 <td width="119" class="saludo1">Nombre:</td>
		  ...
		  <input name="tipoc" value="C" size="10" type="hidden">
	...
	if($_POST[oculto]=='2')	
		...
		if(!mysql_query($sqlr,$linkbd))
		 {
		   echo "<table class='inicio'><tr><td class='saludo1a'><center>No Se ha Almacenado con Exito El Concepto Contable, Error: $sqlr </center></td></tr></table>";
		 }
		 else
		 {
		 echo "<table class='inicio'><tr><td class='saludo1a'><center>Se ha Almacenado con Exito El Concepto Contable</center></td></tr></table>";
