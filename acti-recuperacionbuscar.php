...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
        ...
        <script>
			...
			function fundeshacer(iddelete)
			{
				...
				despliegamodalm('visible','4','Desea Deshacer el acto No '+iddelete,'3');
			}
		</script>
		<?php titlepag(); ?>
	</head>
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='acti-recuperacion.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png" title="Buscar" onClick="document.form2.submit();" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" class="mgbt" onClick="mypop=window.open('acti-principal.php','','');mypop.focus();"><img src="imagenes/printd.png" class="mgbt1"/></td>
        	</tr>
     	</table>
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="">
        	...
        	<table class="inicio">
      			<tr>
        			<td class="titulos" colspan="5">.: Buscar Actos Administrativos de Acuerdo de Recuperaci&oacute;n</td>
            ...
            <div class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;">
            	<?php
					...
					$sqlr="
					SELECT id FROM actiactorecuperacion $crit1";
					$resp = mysql_query($sqlr,$linkbd);
					$_POST[numtop]=mysql_num_rows($resp);
					$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
					$sqlr="
					SELECT id,fecha,nomdonante,motivo,valortotal,estado FROM actiactorecuperacion $crit1 GROUP BY id DESC LIMIT $_POST[numpos], $_POST[numres]";
					$resp = mysql_query($sqlr,$linkbd);
					...
					<table class='inicio' align='center' >
						...
						<tr><td colspan='7'>Actos de Recuperacion Encontrados: $_POST[numtop]</td></tr>
						<tr>
					...
					while ($row =mysql_fetch_row($resp)) 
					{
						...
						echo "
						<tr class='$iter' style='text-transform:uppercase' onClick=\"location.href='acti-recuperacionedita.php?codi=$row[0]'\">
