		...
		<script>
			function verUltimaPos(idcta, filas, vigini, vigfin, padre, buscta, ruta){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="plan-editaplandesarrollopoai.php?idproceso="+idcta+"&vigini="+vigini+"&vigfin="+vigfin+"&buscta="+buscta+"&padre="+padre+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&ruta="+ruta;
			}
...
<tr>
  ...
  <a href="#" onClick="buscaante()" class="mgbt"><img src="imagenes/iratras.png" title="Buscar" border="0" /></a></td>
</tr></table>
...
//	$crit3="";
	...
	$resp=mysql_query($sqlr,$linkbd);
                		...
                		echo"
                	 	<table class='inicio'>        
							...
							<tr><td colspan='4'>$_POST[ruta]</td></tr>
							<tr><td colspan='4'>Encontrados: $_POST[numtop]</td></tr>
							<tr >
								<td class='titulos2' style='width:1%'>No</td>
								...
								<td class='titulos2' style='width:85%'></td>
							</tr>";
	...
	$ante=$rowp[2];
						...
						echo"<tr class='$co' onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" $tbusqueda style='text-transform:uppercase; cursor:pointer; $estilo' >
							<td class='titulos2'>
								<a onClick='verpoai($con,".$rowp[0].",".$vig1.",".$vig2.")' style='cursor:pointer;'>
									<img id='img".$con."' src='imagenes/plus.gif'>
								</a>
							</td>
							<td style='text-align:center;'><a href='#'>$con</a></td>
							<td><a href='#'>$rowp[0]</a></td>
							<td><a href='#'>$rowp[1]</a></td>
						</tr>
						<tr>
							<td align='center'></td>
