	...
	<table class="inicio" align="center" >       
		<tr>
       	...
       	<tr>
       		...
       		<td style="width:10%;">
       			...
       			<input name="egreso" type="text" value="<?php echo $_POST[egreso]?>" onKeyUp="return tabular(event,this)" onBlur="validar2()"  > 
        	...
        	<td style="width:10%;">
        		<input id="fc_1198971545" name="fecha" type="text" value="<?php echo $_POST[fecha]?>" maxlength="10" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)">    
        		<a href="#" onClick="displayCalendarFor('fc_1198971545');">
        			<img src="imagenes/buscarep.png" align="absmiddle" border="0">
        		</a>      
        	</td>       
       		<td style="width:10%;" class="saludo1">Forma de Pago:</td>
       		<td style="width:10%;">
          	...
          	<td>
          		<input name="estado" type="text" value="<?php echo $_POST[estado]?>" style="width:30%;" readonly >
          	</td>      
       	</tr>
		<tr>  
    	...
    	<tr>
      	...
      	<tr>
			...
			<td colspan="2">
				<input type="text" id="nbanco" style="width:100%;" name="nbanco" value="<?php echo $_POST[nbanco]?>"  readonly>
			</td>
	  	...
	  	<tr>
	  		...
	  		<td style="width:10%;">
	  			<input name="valororden" type="text" id="valororden" onKeyUp="return tabular(event,this)" style="width:100%;" value="<?php echo $_POST[valororden]?>"  readonly>
	  		</td>	  
	  		<td style="width:8%;" class="saludo1">Retenciones:</td>
	  		<td style="width:10%;">
	  			<input name="retenciones" style="width:100%;" type="text" id="retenciones" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[retenciones]?>"  readonly>
	  		</td>	  
