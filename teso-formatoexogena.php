    ...
    <body>
        ...
        <table>
        	...
        	<tr>
				...
				<a onClick="location.href='teso-gestionexogena.php'"  class="mgbt"><img src="imagenes/iratras.png" title="Retornar"></a></td>
        	</tr>
        </table>
 		<form name="form2" method="post" action="">
    		<table class="inicio">
				...
				<ol id="lista2">
				<li onClick="location.href='cont-codigosintbuscar.php'" style="cursor:pointer">Columnas 2276</li>
						<li onClick="location.href='teso-exogena1001.php'" style="cursor:pointer">Formato Ex&oacute;gena 1001 - 2276</li>
