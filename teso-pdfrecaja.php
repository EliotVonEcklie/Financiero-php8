...
while($row=mysql_fetch_row($res))
 ...
 //$nit="892000812-0";
	...
	$this->SetY(11);
    $this->Cell(0.1);
    $this->Cell(250,5,''.$rs,0,0,'C'); 
	$this->SetFont('Arial','B',8);
	$this->SetY(15);
    $this->Cell(0.1);
    $this->Cell(250,5,''.$nit,0,0,'C'); //Cuadro Izquierdawsx
	...
	$this->SetY(10);
    $this->Cell(50.1);
    $this->Cell(107,25,'RECIBO OFICIAL DE CAJA',0,0,'C'); 
	//************************************
    $this->SetFont('Arial','B',10);
...
$pdf->RoundedRect(10, 55 ,195 , 22, 2,'' );
...
$niy=$pdf->Gety();
$pdf->RoundedRect(10, 78 ,195 ,$niy-78 , 2,'' );
