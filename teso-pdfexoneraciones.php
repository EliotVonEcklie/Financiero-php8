...
//V 1000 12/12/16 
	...
	class MYPDF extends TCPDF 
	{
		public function Header() 
		{
			...
			$this->SetY(10);
			$this->SetX(62);
			$this->Cell(190,17,'Listado Exoneraciones de Predios',0,0,'C'); 
			...
			//-----------------------------------------------------
			$this->SetY(44);
			$this->Cell(20,5,'Num',1,0,'C',false,0,0,false,'T','C');
			$this->Cell(20,5,'Resolucion',1,0,'C',false,0,0,false,'T','C');
			$this->Cell(40,5,'Codigo Catastral',1,0,'C',false,0,0,false,'T','C');
			$this->Cell(70,5,'Propietario',1,0,'C',false,0,0,false,'T','C');
			$this->Cell(70,5,'Tipo predio',1,0,'C',false,0,0,false,'T','C');
			$this->Cell(25,5,'Fecha',1,0,'C',false,0,0,false,'T','C');
			$this->Cell(35,5,'Valor Exento',1,0,'C',false,0,0,false,'T','C');
		}
...
EOD;
	...
	$sqlr="SELECT TB1.* FROM tesoexoneracion TB1  ";
	...
	while ($row =mysql_fetch_row($resp))
	{
		...
		$ancini=35;
		$altaux=0;
		$colst01=strlen(utf8_encode($row[0]));
		$colst02=strlen(utf8_encode($row[1]));
		...
		$pdf->Cell(40,$altura,$row[3],1,0,'C',true,0,0,false,'T','C');
		...
		$pdf->Cell(25,$altura,$row[1],1,0,'C',true,0,0,false,'T','C');
