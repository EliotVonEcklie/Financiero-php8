...
function genrep(idfac)
{
		...
		<script>
			function verCuentaActiva(idcta, tipo, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="ccp-editarcuentaspasiva.php?idcta="+idcta+"&tipo="+tipo+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
  ...
  <table class="inicio" width="99%">
    <tr >
      <td height="25" colspan="2" class="titulos" >Buscar Cuentas Gastos</td><td width="91"  class="cerrar"><a href="ccp-principal.php"> Cerrar</a></td>
    </tr>
		<tr>
