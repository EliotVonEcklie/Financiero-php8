        ...
        <table>
 		...
 		<form name="form2" method="post" action="">
    		<table class="inicio">
				...
				<ol id="lista2">
						<li onClick="location.href='presu-cdpnomina.php'" style="cursor:pointer">CDP N&oacute;mina</li>
						<li onClick="location.href='presu-cdp.php'" style="cursor:pointer">CDP B&aacute;sico</li>
                        <li onClick="location.href='presu-cdpcontra.php'" style="cursor:pointer">Contrataci&oacute;n</li>
