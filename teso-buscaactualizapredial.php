...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="teso-predialactualizarliqui.php?idpredial="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
	...
	<body>
		...
		<table>
			...
			<tr>
		  		<td colspan="3" class="cinta"><img src="imagenes/add2.png"  class="mgbt" title="Nuevo"/><img src="imagenes/guardad.png"  class="mgbt1"/><img src="imagenes/busca.png" onClick="document.form2.submit();" class="mgbt" title="Buscar" /><img src="imagenes/nv.png" onClick="mypop=window.open('teso-principal.php','','');mypop.focus();" class="mgbt" title="Nueva Ventana"><img src="imagenes/excel.png" title="Exportar Excel" onclick="crearexcel()" class="mgbt"/></td>
       		</tr>	
		</table>
        <?php
			if($_GET[numpag]!="")
