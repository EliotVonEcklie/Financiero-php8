...
<table>
	...
	<td colspan="3" class="cinta">
		...
		<a href="teso-reporegresostercerosexcel.php?tercero=<?php echo $_POST[tercero]?>&fecha1=<?php echo $_POST[fecha]?>&fecha2=<?php echo $_POST[fecha2]?>&retencion=<?php echo $_POST[chkret]?>" target="_blank"><img src="imagenes/excel.png"  class="mgbt" alt="csv"></a>
		<a href="presu-librosppto.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
	</td>
</tr>	
</table>
<tr><td colspan="3" class="tablaprin"> 
 <form name="form2" method="post" action="presu-rptegresosterceros.php">
 <?php
 if($_POST[bc]=='1')
			{
...
<table  class="inicio" align="center" >
      ...
      <tr >
        <td class="titulos" colspan="8">:. Buscar Pagos recaudo tercero</td>
...
$sqlr3="select *from tesopagoterceros where tesopagoterceros.id_PAGO>-1  AND FECHA BETWEEN '$fechaf' AND '$fechaf2' order by tesopagoterceros.id_PAGO DESC";
...
$iter='saludo1';
$iter2='saludo2';
while ($row3 =mysql_fetch_row($resp)) 
 {
