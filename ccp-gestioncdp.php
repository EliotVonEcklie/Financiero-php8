	...
	<body>
		...
		<form name="form2" method="post" action="">
			<table class="inicio">
				...
				<ol id="lista2">
						<li onClick="location.href='ccp-cdpnomina.php'" style="cursor:pointer">CDP N&oacute;mina</li>
						<li onClick="location.href='ccp-cdp.php'" style="cursor:pointer">CDP B&aacute;sico</li>
						<li onClick="location.href='ccp-cdpcontra.php'" style="cursor:pointer">Contrataci&oacute;n</li>
				</ol>
				</tr>
			</table>
		</form>
