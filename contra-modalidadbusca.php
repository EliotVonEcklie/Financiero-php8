...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
					<a href="contra-modalidad.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a>
		...
		?>
 		<form name="form2" method="post" action="contra-modalidadbusca.php">
        	<?php 
				if($_POST[oculto]=="")
				{
					$_POST[cambioestado]="";
			...
			<table  class="inicio" align="center" >
      			<tr>
        			<td class="titulos" colspan="3">:: Buscar Modalidad de Contrataci&oacute;n </td>
        			<td class="cerrar" style='width:7%'><a href="contra-principal.php">Cerrar</a></td>
     			</tr>
      			<tr>
        			<td class="saludo1" style='width:2cm;'>Modalidad De Selecci&oacute;n:</td>
        			<td>
			...
			<?php 
				...
				//if($_POST[oculto])
				{
					$crit1=" ";
					$crit2=" ";
					if ($_POST[modalidad]!=""){$crit1="AND (descripcion_valor LIKE '%$_POST[modalidad]%') ";}
					$sqlr="SELECT * FROM dominios WHERE nombre_dominio='MODALIDAD_SELECCION' AND (valor_final IS NULL or valor_final ='') $crit1";
					...
					$sqlr="SELECT * FROM dominios WHERE nombre_dominio='MODALIDAD_SELECCION' AND (valor_final IS NULL or valor_final ='') $crit1 ORDER BY valor_inicial ".$cond2;
					//echo $sqlr;
					$resp = mysql_query($sqlr,$linkbd);
					...
					<table class='inicio' align='center' width='80%'>
						...
						<tr>
							...
							<td class='titulos2' style=\"width:23%\">Modalidad De Selecci&oacute;n</td>
							<td class='titulos2'>Procedimiento / Causal</td>
							<td class='titulos2' >Abreviatura</td>
					...
					while ($row =mysql_fetch_row($resp)) 
					{
						...
						$sqlr2="SELECT valor_inicial,valor_final, descripcion_valor, tipo,descripcion_dominio FROM dominios WHERE nombre_dominio='MODALIDAD_SELECCION' AND (valor_final IS NOT NULL OR valor_final <> '0')  AND valor_final='$row[0]' ORDER BY valor_inicial";
						//echo $sqlr2;
			...
			onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"verUltimaPos($idcta, $numfil, $filtro)\" style='text-transform:uppercase; $estilo' >
								...
								<td rowspan='$ntr2' id='$nommodalida'>$row[2]</td>
								<td>$row2[2]</td>
								<td>$row[5]</td>
