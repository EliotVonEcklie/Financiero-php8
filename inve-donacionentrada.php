...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function guardar()
			{
				...
				valg08=document.form2.centrocosto.value;
				if (valg01!='' && valg02!='' && valg03!='' && valg04!='' && valg05!='' && valg06!='' && valg07!='' && valg08!='')
	...
	<body>
		...
		<table>
    		...
    		<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='inve-donacionentrada.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar();" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='inve-donacionentradabuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("inve");?>" class="mgbt"><img src="imagenes/printd.png" class="mgbt"/><img src="imagenes/iratras.png" title="Atr&aacute;s"  onClick="location.href='inve-menuactos.php'" class="mgbt"></td>
			</tr>
         </table>
 		...
 		<form name="form2" method="post" action="inve-donacionentrada.php">
        	<input type="hidden" name="valfocus" id="valfocus" value="0"/>
        	<?php
				if ($_POST[oculto]=="")
				{ 
					$_POST[codigo]=selconsecutivo('almactodonacionesent','id');
			...
			<input type='hidden' name='bt' id='bt' value=""/>
			  ...
			  <?php
				if($_POST[oculto]=="2")
				{
					$cons=selconsecutivo('almactodonacionesent','id');
					preg_match("/([0-9]{2})\/([0-9]{2})\/([0-9]{4})/", $_POST[fecha],$fecha);
					$fechaf="$fecha[3]-$fecha[2]-$fecha[1]";
					 $sqlr="INSERT INTO almactodonacionesent (id,fecha,docdonante,nomdonante,valortotal,ciudad,lugarfisico,motivo,otrosdetalles,estado,cc) VALUES ('$cons','$fechaf','$_POST[tercero]', '$_POST[ntercero]','$_POST[valort]','$_POST[ciudad]','$_POST[lugarfi]','$_POST[motivo]','$_POST[otdetalles]','A','$_POST[centrocosto]')";
					...
					else 
					{
						...
						for ($x=0;$x<$contx;$x++)
						{
							...
							$sqlr="INSERT INTO almactodonacionesentpartici (id,idacto,documento,nombre,cargo,estado) VALUES ('$consp','$cons','".$_POST[agtercerop][$x]."','".$_POST[agntercerop][$x]."','".$_POST[agcargop][$x]."','S')";
						...
						for ($x=0;$x<$contx;$x++)
						{
							...
							$sqlr="INSERT INTO almactodonacionesentarticu (id,idacto,descripcion,unumedida,cantidad,valor,estadou,estado) VALUES ('$consa','$cons','".$_POST[agdescripcion][$x]."','".$_POST[agunimedida][$x]."','".$_POST[agcantidad][$x]."','".$_POST[agvalor][$x]."','".$_POST[agestado][$x]."','S')";
						...
						if($cont!=0 || $cont2!=0)
						{
							$sqlr ="DELETE FROM almactodonacionesent WHERE id='$cons'";
							mysql_query($sqlr,$linkbd);
							$sqlr ="DELETE FROM almactodonacionesentpartici WHERE idacto='$cons'";
							mysql_query($sqlr,$linkbd);
							$sqlr ="DELETE FROM almactodonacionesentarticu WHERE idacto='$cons'";
							mysql_query($sqlr,$linkbd);
						}
						else {echo"<script>despliegamodalm('visible','1','Donacion No $_POST[codigo] solicitada con Exito');</script>";}
					}
				}
			?>
