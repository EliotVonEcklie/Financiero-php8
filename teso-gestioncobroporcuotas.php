    		...
    		<table class="inicio">
				...
				<tr>	
					<td style="background-repeat:no-repeat; background-position:center;">
						<ol id="lista2">
							<li onClick="location.href='teso-acuerdopredial.php'" style="cursor:pointer;">Liquidacion del acuerdo predial</li>
							<li onClick="location.href='teso-abonoacuerdopredial.php'" style="cursor:pointer;">Abono por acuerdo </li>
                        </ol>
				</td>                 
				</tr>							
    		</table>
