...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="contra-editaterceros.php?idter="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
        <script>
	...
	<body>
      ...
      <span id="todastablas2"></span>
		...
		?>
  		<form name="form2" method="post" action="contra-buscaterceros.php">
        	<?php 
				if($_POST[oculto]=="")
				{
    		...
    		<?php
      			...
      			{
        			$crit1="";
        			if ($_POST[nombre]!=""){$crit1="WHERE concat_ws(' ', nombre1,nombre2,apellido1,apellido2,razonsocial,cedulanit) LIKE '%$_POST[nombre]%'";}
