		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="presu-editaconcecontablespag.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<script>
//************* ver reporte ************
...
{
document.form2.action="presu-buscaconcecontablespag.php";
document.form2.submit();
}
...
document.form2.razonsocial.value="";
	...
	<body>
		...
		?>
 <form name="form2" method="post" action="presu-buscaconcecontablespag.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Concepto Contable Pagos </td>
	...
	$sqlr="select *from conceptoscontables where conceptoscontables.tipo='P' and conceptoscontables.modulo='3' ".$crit1." order by conceptoscontables.codigo";
$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *from conceptoscontables where conceptoscontables.tipo='P' and conceptoscontables.modulo='3' ".$crit1." order by conceptoscontables.codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
		...
		echo "<table class='inicio' align='center'>
			...
			<tr>
				<td colspan='3'>Concepto Contable Causacion Encontrados: $ntr</td>
			</tr>
			<tr>
