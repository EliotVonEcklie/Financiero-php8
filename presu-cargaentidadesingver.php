...
return tabular(e,elemento);
	...
	<body >
        ...
        <table>
            ...
            <tr>
          <td colspan="3" class="cinta"><a href="presu-cargaentidades.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#" onClick="" class="mgbt"><img src="imagenes/guardad.png" title="Guardar" /></a><a href="presu-buscarcargaentidadesing.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a href="#" onClick="mypop=window.open('presu-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><img src="imagenes/iratras.png" title="Atr&aacute;s" onClick="location.href='presu-buscarcargaentidadesing.php'" class="mgbt"/></td>
        </tr></table> 
<?php
...
if(!$_POST[oculto])
{
	...
	$_POST[vigencia]=$_GET[vig];
			...
			$sqlr1="select *from entidadesing where entidadesing.unidad='$_POST[unidad]' and entidadesing.vigencia='$_POST[vigencia]' and entidadesing.trimestre='$_POST[trimestre]' and entidadesing.fecha='$_POST[fecha]'";
			$res1=mysql_query($sqlr1,$linkbd);
			$con=0;
			while ($row1=mysql_fetch_row($res1))
		 	{		
				$_POST[dcuentas][$con]=$row1[0];	
				$_POST[inicial][$con]=$row1[1];
				$_POST[adicion][$con]=$row1[2];
				$_POST[superavit][$con]=$row1[3];
				$_POST[reduccion][$con]=$row1[4];
				$_POST[definitivo][$con]=$row1[5];
				$_POST[recaudoant][$con]=$row1[6];
				$_POST[recaudocon][$con]=$row1[7];
				$_POST[recaudotot][$con]=$row1[8];
				$_POST[saldoporreca][$con]=$row1[9];
				$con++;
			}
	}
?>
 <form name="form2" method="post" action="">
    ...
    <table class="inicio" align="center" width="80%" >
      	<tr >
        	<td class="titulos" style="width:95%;" colspan="2">.: Consolidacion Entidad - Ejecucion Ingresos</td>
	...
	<?php
		...
		<tr>
			...
			<td class="titulos2">Superavit</td>
			<td class="titulos2">Reduccion</td>
			<td class="titulos2">Definitivo</td>
			<td class="titulos2">Recaudo Anterior</td>
			<td class="titulos2">Recaudo de Consulta</td>
			<td class="titulos2">Total Recaudo</td>
			<td class="titulos2">Saldo por Recaudar</td>
		</tr> 
		<?php 
		  $iter='zebra1';
		  $iter2='zebra2';
		 ...
		 echo "<tr class='$iter'>
			...
			<td><input name='superavit[]' value='".$_POST[superavit][$x]."' type='text' style='width:100%;' readonly></td>
			...
			<td><input name='recaudoant[]' value='".$_POST[recaudoant][$x]."' type='text' style='width:100%;' readonly></td>
			<td><input name='recaudocon[]' value='".$_POST[recaudocon][$x]."' type='text' style='width:100%;' readonly></td>
			<td><input name='recaudotot[]' value='".$_POST[recaudotot][$x]."' type='text' style='width:100%;' readonly></td>
			<td><input name='saldoporreca[]' value='".$_POST[saldoporreca][$x]."' type='text' style='width:100%;' readonly></td>
		</tr>";
		  	$aux=$iter;
	 		$iter=$iter2;
	 		$iter2=$aux;
