...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tdocumento').change(function(event) {
                funbuscar();
            });
        });
    </script>
	...
	<form name="form2" method="post" action="meci-gestionmaestrosdoc.php" enctype="multipart/form-data">
		...
		<?php
            ...
            if($_POST[oculto])
            {
                ...
                if ($_POST[tdocumento]!=""){$crit1=" AND documento='".$_POST[tdocumento]."' ";}
								...
								echo"
									<tr class='$iter'>
										...
										<td>".$row2[6]."</td>
										 <td>
											<div style=\"margin-top:10px\" align=\"middle\">".$bdescargar."&nbsp;&nbsp;&nbsp;".$procesos."</div>
											<div style=\"font-size:11;margin-bottom:10px; margin-left:10px; margin-right:10px;\" align=\"middle\">Versi&oacute;n:".$row2[11]." ".$row2[13]."; Responsalbe:".$nresul."</div>
										</td>
									</tr>";	
							}
						}
