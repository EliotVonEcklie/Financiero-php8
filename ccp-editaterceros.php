	...
	<head>
		...
		<script>
			function adelante(scrtop, numpag, limreg, filtro, next){
				...
				document.form2.action="ccp-editaterceros.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
				document.form2.submit();
			}
			...
			function iratras(scrtop, numpag, limreg, filtro){
				var idcta=document.getElementById('idtercero').value;
				location.href="ccp-buscaterceros.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<?php titlepag();?>
	</head>
		...
		<table>
			...
			<tr>
            	<?php 
					...
					{$botonnuevo="<a onClick=\"location.href='ccp-terceros.php'\" class='mgbt'><img src='imagenes/add.png' title='Nuevo' /></a>";}
					else
					{$botonnuevo="<a class='mgbt1'><img src='imagenes/add2.png' /></a>";}
				?>
  				<td colspan="3" class="cinta">
					<a onClick="location.href='ccp-terceros.php'" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
					<a onClick="guardar();" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a>
					<a onClick="location.href='ccp-buscaterceros.php'" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a>
