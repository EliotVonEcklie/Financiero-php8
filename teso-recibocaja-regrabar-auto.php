...
document.form2.action="teso-recibocaja-regrabar.php";
document.form2.submit();
}
}
</script>
...
//*****incio para hacer el ciclo de los recibos de caja
if($_POST[oculto]==2)
{
$valini=$_POST[reciboini];
$valfin=$_POST[recibofin];
for($x=$valini;$x<$valfin;$x++)
{	
...
//				$_POST[modorec]=$row[13];
 ...
 ?>
    <table class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="9">Regrabar Recibo de Caja</td>
        <td width="68" class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
    </tr>
    <tr><td  class="saludo1" >Recibo inicial:</td><td><input type="text" name="reciboini" value="<?php echo $_POST[reciboini]?>"></td><td  class="saludo1" >Recibo Final:</td><td><input type="text" name="recibofin" value="<?php echo $_POST[recibofin]?>"></td></tr>
      <tr  >     
					 ...
					 while($row2=mysql_fetch_row($res2))
					  {
					   ...
					   if($row2[6]=='S')
						 {				 
						 $valordeb=0;
						 $valorcred=$industria+$sanciones-$retenciones;
					...
					$rescr=mysql_query($sqlr2,$linkbd);
					 while($rowcr=mysql_fetch_row($rescr))
					  ...
					  //**fin rete ica
						 ...
						 $valorcred=0;
						$sqlr="insert into comprobante_det (id_comp,cuenta,tercero,centrocosto,detalle,cheque,valdebito,valcredito,estado,vigencia) values ('5 $concecc','".$cuentacb."','".$_POST[tercero]."','".$row2[5]."','Industria y Comercio $_POST[modorec]','',".($valordeb-$retenciones).",0,'1','".$_POST[vigencia]."')";
						mysql_query($sqlr,$linkbd);
