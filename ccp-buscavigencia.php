...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, idcta2, filas){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="ccp-editavigencia.php?idvigini="+idcta+"&idvigfin="+idcta2+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg;
			}
		</script>
		<script>
	...
	<body>
		...
		?>
 		<form name="form2" method="post" action="ccp-buscavigencia.php">
		<?php
		//*****************************************************************
