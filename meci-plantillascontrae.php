...
<body>
    ...
    <?php 
		if($_POST[oculto]=="")
		{
			...
			$versiondes=explode(".",$row[2]);
			$_POST[versiona]=$versiondes[0];
			$_POST[versionb]=$versiondes[1];
			$_POST[oculto]=0;		
		}
	?>
	<table>
        ...
        <tr>
  			<td colspan="3" class="cinta"><a href="#" class="mgbt"><img src="imagenes/add2.png" border="0" /></a><a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a><a href="meci-plantillascontra.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar" border="0" /></a><a href="#" onClick="mypop=window.open('meci-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a>
            </td>
		</tr>
	</table>
