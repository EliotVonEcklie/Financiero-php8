<?php
	...
	if (!isset($_SESSION['usuario']))
	{
		...
		else
		{
			...
			//$linkset[$x]="";
			$res=mysqli_query($linkbd,$sqlr);
			while($roww=mysqli_fetch_row($res)){ @$_SESSION['linkmod'][$roww[1]].=$roww[2];}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<style>
			body
			{
				background:url("imagenes/FONDOAGUA-NEW-1.jpg?<?php echo date('d_m_Y_h_i_s');?>");
		...
		<script language="javascript">
			...
			function tipopresupuesto(_valor)
			{
				...
				{
					document.getElementById('ventanam').src="ventana-tipopresupuesto.php";
				}
			}
	...
	<body>
		...
		<table class="tablaprin">
			<tr></tr>
			<tr>
				<td rowspan="2" margin-top="100px;" style="padding-left: 7px;"><img src="imagenes/FONDO-1.png" align="texttop" style="width:100%; height:85%; opacity: 0.5;border-radius: 10px;"/></td>
				<td>
					<table>
						<tr>
						...
						<tr>
							...
							<td onClick="tipopresupuesto('visible');"><img src="imagenes/presupuesto.png" alt="presupuesto" onMouseOut="src='imagenes/presupuesto.png'" onMouseOver="src='imagenes/presupuesto2.png'"></a></td>
						...
						<tr>
							<td><a href="<?php echo @ $_SESSION['linkmod'][10];?>" title="Archivo"><img src="imagenes/serviciospublicos.png"  onMouseOut="src='imagenes/serviciospublicos.png'" onMouseOver="src='imagenes/serviciospublicos2.png'"></a></td>
			...
			<tr>
				...
				<div  class="inicio" style=" width:99.2%; height:10%;" ><img src="imagenes/soluciones.png" alt="soluciones estrategicas integrales" style=" width:55%; height:100%;">
						<?php
