...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="inve-editaconcecontransito.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<?php 
			titlepag();
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='inve-concecontransito.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png"  title="Buscar" onClick="document.form2.submit();" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/iratras.png" title="Menu" onClick="location.href='inve-concecontables.php'" class="mgbt"/></a></td>
        	</tr>	
		</table>
        <?php
		if($_GET[numpag]!=""){
		...
		?>
 		<form name="form2" method="post" action="inve-buscaconcecontransito.php">
			<table  class="inicio" align="center" >
      			<tr>
        			<td class="titulos" colspan="2">:: Buscar Concepto Contable Articulos en Transito</td>
