...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<table>
		...
		<tr>
			<td colspan="3" class="cinta">
				<a href="cont-importacuentas.php" class="mgbt"><img src="imagenes/add2.png" title="Nuevo" /></a><a class="mgbt"><img src="imagenes/guardad.png"/></a><a href="cont-vercuentascgr.php" class="mgbt"><img src="imagenes/buscad.png" title="Buscar" /></a><a href="#" onClick="<?php echo paginasnuevas("presu");?>" class="mgbt"><img src="imagenes/nv.png" title="Nueva ventana"></a><a href="presu-codigoscgr.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
			</td>
		</tr>
	</table>
	<form action="presu-clasificador.php" method="post" enctype="multipart/form-data" name="form2">
	<?php
		$_POST[tabgroup1]=1;
	...
	<div class="tabsic" style="height:68%; width:99.6%;"> 
			...
			<label for="tab-1">Cuentas CGR</label>
			<div class="content" width="100%" style="overflow-x:hidden;">
				<table  align="center" class="inicio" >
					<tr >
						<td class="titulos" colspan="5">.: Importar Cuentas CGR</td>
						<td width="72" class="cerrar"><a href="presu-principal.php">X Cerrar</a></td>
					</tr>   
					<tr> 
					...
					echo "<table class='inicio'>
						<tr>
							...
							<td class='titulos2' style='width:15%;'>Nivel</td>
							<td class='titulos2' style='width:15%;'>Nuevos Conceptos</td>
						</tr>";
						$iter='saludo1a';
						$iter2='saludo2';
						...
						if($_POST[oculto]==2)
						{
							...
							if($archivo)
							{
								...
								$sqlr1="delete from pptosidefclas";
								...
								{ 
									...
									{			
										...
										$consulta = "INSERT INTO pptosidefclas (codigo, nombre, nivel, estado) VALUES ('".trim($datos[0])."','".$dato."','".trim($datos[2])."','".trim($datos[3])."')";
							...
							$sql="select * from pptosidefclas order by codigo";
