	...
	<head>
		...
		<script>
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para modificar el servicio');}
			}
	...
	<body>
		...
		<form name="form2" method="post" action="">
			<?php
				if(@ $_POST['oculto']=="")
				{
					$sqlr="SELECT MIN(codigo), MAX(codigo) FROM srvservicios";
					$res=mysqli_query($linkbd,$sqlr);
					$r=mysqli_fetch_row($res);
					$_POST['minimo']=$r[0];
					$_POST['maximo']=$r[1];
					$sqlr="SELECT * FROM srvservicios WHERE codigo='".$_GET['idban']."'";
			...
			<table class="inicio ancho">
				<tr>
					<td class="titulos" colspan="6">.: Editar Servicios</td>
			...
			<?php
				if(@ $_POST['oculto']=="2")
				{
					...
					$sqlr ="UPDATE srvservicios SET nombre='".$_POST['nomban']."',cuenta_p='".$_POST['cuenta']."',concepto='".$_POST['concecont']."',estado='$valest' WHERE codigo='".$_POST['codban']."'";
