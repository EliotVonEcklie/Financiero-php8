  		...
  		<form name="form2" action="" method="post">
    		...
    		<div class="subpantalla" style="height:84.5%; width:99%; overflow-x:hidden;">
				<?php
					...
					$sqlr="SELECT pptorp.vigencia,pptorp.consvigencia,pptocdp.objeto,pptorp.estado,pptocdp.consvigencia,pptorp.valor,pptorp.saldo, pptorp.tercero FROM pptocdp,pptorp WHERE pptorp.idcdp=pptocdp.consvigencia and pptorp.saldo=pptorp.valor and pptorp.estado='S' and pptocdp.tipo_mov='201' and pptorp.tipo_mov='201' $crit1 $crit2";
                    // $sqlr="select pptorp.vigencia,pptorp.consvigencia,pptocdp.objeto,pptorp.estado,pptocdp.consvigencia,pptorp.valor,pptorp.saldo, pptorp.tercero from pptorp,pptocdp where pptorp.estado='S' and pptorp.idcdp=pptocdp.consvigencia and saldo!='0' $crit1 $crit2";
					...
					$sqlr="SELECT pptorp.vigencia,pptorp.consvigencia,pptocdp.objeto,pptorp.estado,pptocdp.consvigencia,pptorp.valor,pptorp.saldo, pptorp.tercero FROM pptocdp,pptorp WHERE pptorp.idcdp=pptocdp.consvigencia and pptorp.saldo=pptorp.valor and pptorp.estado='S' and pptocdp.tipo_mov='201' and pptorp.tipo_mov='201' $crit1 $crit2 order by pptorp.consvigencia desc $cond2 ";
