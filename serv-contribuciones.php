	...
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-contribucioneseditar.php?idban="+idban;
			}
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para crear la contribucion');}
			}
	...
	<body>
		...
		<form name="form2" method="post" action="">
			<?php 
				...
				{
					$_POST['onoffswitch']="S";
					$_POST['codban']=selconsecutivo('srvcontribuciones','id');
				}
				if(@ $_POST['bc']!='')
				{
			...
			<table class="inicio ancho">
				<tr>
					<td class="titulos" colspan="6">.: Ingresar Contribuci&oacute;n</td>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvcontribuciones','id');
					$sqlr="INSERT INTO srvcontribuciones (id,nombre,id_estrato,cuenta_p,porcentaje,valor,concepto,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."','".$_POST['idestrato']."','".$_POST['cuenta']."','".$_POST['porcentaje']."','".$_POST['valor']."','".$_POST['concecont']."', '$valest')";
