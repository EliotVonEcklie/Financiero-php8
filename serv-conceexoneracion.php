...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td colspan="3" class="cinta">
                    <a href="serv-conceexoneracion.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
                    <a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a>
                    <a href="serv-buscaconceexoneracion.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
        ...
        if(!$_POST[oculto])
        {
            ...
            $_POST[valor]=0;		 
            $sqlr="select MAX(codigo) from conceptoscontables where modulo=10 and tipo='SE' and left(codigo,1)!='P' order by codigo Desc";
            //echo $sqlr;
        ...
        <form name="form2" method="post" action=""> 
            ...
            <table class="inicio" align="center"  >
                <tr>
                    <td class="titulos" colspan="7">.: Concepto Contable de Exoneracion </td>
                ...
                <tr>
                    ...
                    <input name="tipo" value="Exoneracion"  type="text" readonly><input name="tipoc" value="SE"  type="hidden">
