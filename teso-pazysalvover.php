...
<tr>
  ...
  <a href="teso-pazysalvo.php" class="mgbt"><img src="imagenes/add.png" alt="Nuevo"  border="0" title="Nuevo"/></a> 
  <a href="#"  class="mgbt"><img src="imagenes/guardad.png"  alt="Guardar" title="Guardar" title="Guardar"/></a>
  ...
  <a href="#"  onClick="pdf()"> <img src="imagenes/print.png"  alt="Buscar" title="Imprimir"/></a>
...
<?php
	...
	while($r=mysql_fetch_row($res))
	{
		...
		$_POST[numpredial]=$r[0];	
 		 //$fec=date("d/m/Y");
//		 $fec=$r[3];
	 	ereg( "([0-9]{2,4})-([0-9]{1,2})-([0-9]{1,2})", $r[3],$fec);
...
?>
      ...
      <tr >
        <td class="titulos" colspan="6">Consultar Predio</td><td width="68" class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
      </tr>
     <tr>
		 ...
		 <td style="width:10%;">
                ...
                <input name="numpredial" id="numpredial" type="text" value="<?php echo $_POST[numpredial]?>"  style="width:50%" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" readonly>
