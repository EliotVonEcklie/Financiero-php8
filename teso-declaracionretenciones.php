    ...
    <body>
        ...
        <table>
 		...
 		<form name="form2" method="post" action="">
    		<table class="inicio">
      			<tr>
        			<td class="titulos" colspan="2">.: Declaración retenciones </td>
					...
					<td style="background-repeat:no-repeat; background-position:center;">
						<ol id="lista2">
							<li onClick="location.href='teso-pagotercerosdetalle.php'" style="cursor:pointer;">Declaración Retenciones - Banco</li>
                            <li onClick="location.href='teso-pagotercerosdetalle_rete.php'" style="cursor:pointer;">Declaración detallado Retenciones - Documento</li>
