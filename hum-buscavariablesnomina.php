...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="hum-editavariablesnomina.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
			function cambioswitch(id,valor)
			{
				document.getElementById('idestado').value=id;
				if(valor==1){despliegamodalm('visible','4','Desea Desactivar Variable de Nomina','1');}
				else{despliegamodalm('visible','4','Desea activar Variable de Nomina','2');}
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='hum-variablesnomina.php'" class="mgbt"/><img src="imagenes/guardad.png" title="Guardar" class="mgbt1"/><img src="imagenes/busca.png" title="Buscar" onClick="document.form2.submit();" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="mypop=window.open('hum-principal.php','','');mypop.focus();" class="mgbt"></td>
			</tr>	
		</table>
		...
		<form name="form2" method="post" action="hum-buscavariablesnomina.php">
			<?php
				...
				else
				{
					...
					if($_POST[cambioestado]!="")
					{
						...
						{
							$sqlr="UPDATE humvariables SET estado='S' WHERE codigo='$_POST[idestado]'";
							mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						}
						else 
						{
							$sqlr="UPDATE humvariables SET estado='N' WHERE codigo='$_POST[idestado]'";
							mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						}
					}
					//*****************************************************************
			...
			<table  class="inicio" align="center" >
				<tr>
					<td class="titulos" colspan="5">:. Buscar Variables </td>
					<td style="width:7%"><label class="boton02" onClick="location.href='hum-principal.php'">Cerrar</label></td>
				</tr>
				<tr>
					<td class="tamano01" style='width:4cm;'>::N&deg; C&oacute;digo o Nombre:</td>
					<td><input type="search" name="nombre" id="nombre" value="<?php echo $_POST[nombre];?>" class="tamano02" style='width:100%;'/></td>
					<td style="padding-bottom:4px"><em class="botonflecha" onClick="limbusquedas();">Buscar</em></td>
					<td></td>
				</tr>
				<tr></tr>
			</table>
			...
			<div class="subpantalla" style="height:65.5%; width:99.6%;overflow-x:hidden" id="divdet">
				<?php
					//if($_POST[oculto])
					{
						...
						$sqlr="SELECT * FROM humvariables  $crit1";
						$resp = mysql_query($sqlr,$linkbd);
						$_POST[numtop]=mysql_num_rows($resp);
						$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
						$cond2="";
						if ($_POST[numres]!="-1"){$cond2="LIMIT $_POST[numpos], $_POST[numres]";}
						$sqlr="SELECT * FROM humvariables $crit1 ORDER BY humvariables.codigo $cond2";
						$resp = mysql_query($sqlr,$linkbd);
						$con=1;
						...
						<table class='inicio' align='center'>
							...
							<tr>
								...
								<td class='titulos2' style='width:5%;'>Provision</td>
								<td class='titulos2' colspan='2' style='text-align:center;width:7%;'>Estado</td>
								<td class='titulos2' style='width:5%;'>Asignados</td>
							</tr>";	
						$iter='saludo1a';
						$iter2='saludo2';
						$filas=1;
						while ($row =mysql_fetch_row($resp)) 
						{
							...
							$sqlr2="SELECT * FROM humvariables_det WHERE estado='S' AND codigo='$row[0]' AND vigencia='$vigusu' ";
