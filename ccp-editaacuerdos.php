	...
	function respuestaconsulta(pregunta)
	{
		...
		<script>
			...
			function iratras(scrtop, numpag, limreg){
				var idcta=document.getElementById('codigo').value;
				location.href="ccp-buscaracuerdos.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg;
			}
		</script>
		<?php titlepag();?>
    </head>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					<a href="ccp-acuerdos.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
					<a href="#"  onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar"/></a>
					<a href="ccp-buscaracuerdos.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
