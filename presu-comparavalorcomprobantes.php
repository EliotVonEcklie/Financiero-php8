    		...
    		<table class="inicio">
      			<tr>
					...
					<td style="background-repeat:no-repeat; background-position:center;">
						<ol id="lista2">
							<li onClick="location.href='presu-compararcdp.php'" style="cursor:pointer;">Compara saldos CDP</li>
                            <li onClick="location.href='presu-compararp.php'" style="cursor:pointer;">Compara compara RP </li>
