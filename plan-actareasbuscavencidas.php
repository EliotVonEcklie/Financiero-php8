...
<body>
	<form name="form2" method="post" action="plan-actareasbuscavencidas.php" >
	<table  class="inicio" align="center" >
		<tr>
        	<td class="titulos" colspan="5">:: Buscar Tareas Vencidas </td>
      	</tr>
      	<tr>
    ...
    <div class="subpantallac5" style="height:86%; overflow-x:hidden;">
		...
		if($_POST[oculto])
		{
			...
			$crit2=" AND cgd.codigospid LIKE '%$_POST[documento]%' ";
           	$sqlr="SELECT res.*,rad.numeror,rad.fechalimite,rad.descripcionr FROM planacresponsables res, planacradicacion rad WHERE res.codradicacion=codigobarras AND res.estado='A' AND rad.fechalimite < '".$hoy."' AND res.usuariocon='".$_SESSION[cedulausu]."'".$crit1.$crit2."  ORDER BY codigo ASC";
			...
			echo'
				<table class="inicio">        
                	<tr>
                    	<td class="titulos" colspan="6">::Lista de Tareas vencidas</td>
                    </tr>
					<tr>
                    ...
                    <tr>
                        ...
                        <td class="titulos2" style="width:7%">Mirar</td>
                     </tr>';
            while ($row = mysql_fetch_row($res)) 
       		{
				...
				$pagina="plan-actareasmirar.php?idradicado=".$row[9]."&idresponsable=".$row[0];
				echo'
					<td align="middle"><a href="#"><img src="imagenes/buscarep.png" onClick="parent.cargarpagina(\''.$pagina.'\');" /></a></td>
				</tr>';
          		$aux=$iter;
     			$iter=$iter2;
        		$iter2=$aux;
