...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="hum-editanivelsalarial.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<script>
	...
	<body>
		...
		?>
 		<form name="form2" method="post" action="hum-buscanivelsalarial.php">
 			<?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					{
                        $sqlr="UPDATE humnivelsalarial SET estado='S' WHERE id_nivel='$_POST[idestado]'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
                        $sqlr="UPDATE humnivelsalarial SET estado='N' WHERE id_nivel='$_POST[idestado]'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
				}
				//*****************************************************************
			...
			<table  class="inicio" align="center" >
      			<tr>
        			<td class="titulos" colspan="6">:. Buscar Niveles Salariales </td>
      			...
      			<tr>
    				...
    				<td><input type="text" name="nombre" id="nombre" value="<?php echo $_POST[nombre];?>" style="width:35%;"/></td>
        		</tr>                       
    		</table>  
            ...
            <div class="subpantallac5" style="height:68.5%; width:99.6%; overflow-x:hidden;" id="divdet">
				<?php
                    $crit1="";
                    if ($_POST[nombre]!="")
					{$crit1="WHERE concat_ws(' ', id_nivel,nombre) LIKE '%$_POST[nombre]%'";}
                    $sqlr="SELECT * FROM humnivelsalarial $crit1 ORDER BY id_nivel";
					...
					$sqlr="SELECT * FROM humnivelsalarial $crit1 ORDER BY id_nivel ".$cond2;
                    $resp = mysql_query($sqlr,$linkbd);
                    $con=1;
                    ...
                    <table class='inicio' align='center' >
                        ...
                        <tr>
                            ...
                            <td class='titulos2' style='text-align:center;width:15%;'>Valor</td>
                            <td class='titulos2' colspan='2' style='text-align:center;width:6%;'>Estado</td>
