...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			...
			function agregardetalle()
			{
				...
				if(validacion01.trim()!='' && validacion02.trim()!=''){document.form2.agregadet.value=1;document.form2.submit();}
			 	else {despliegamodalm('visible','2','Falta información para poder Agregar Detalle de Clasificación');}
			}
			...
			{document.location.href = "teso-clasificaprediosguarda.php?idproceso="+document.getElementById('codigo').value}
	...
	<tr><?php menu_desplegable("teso");?></tr>
			<tr>
  				<td colspan="3" class="cinta"><a href="teso-clasificaprediosguarda.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo"/></a><a href="#"  onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar"/></a><a href="teso-clasificapredios.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a> <a href="#" onClick="mypop=window.open('contra-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a></td>
			</tr>
     	</table>
		...
		<?php
			...
			{
				$_POST[contdet]=0;
				$sqlr="SELECT MAX(CONVERT(codigo, SIGNED INTEGER)) FROM teso_clasificapredios";
 		...
 		?>
            <table class="inicio" >
                <tr>
                    <td class="titulos" colspan="4">Crear Clasificaci&oacute;n De Predio</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="nombre" id="nombre" value="<?php echo $_POST[nombre]?>" style="width:80%;"></td>
                </tr>
                <tr>
            ...
            <table class="inicio" >
                <tr><td class="titulos" colspan="4">Agregar Tipo</td></tr>
                <tr>
 			...
 			<?php  
				...
				if($_POST[oculto]=="2")
				{
					$status=TRUE;
						...
						for ($x=0;$x<count($_POST[dnvars]);$x++)
						{
							$sqlr="insert into teso_clasificapredios (codigo,nombre,estado,id_rango,nom_rango) values ('".$_POST[codigo]."','".$_POST[nombre]."','".$_POST[estado]."','".$_POST[dids][$x]."','".$_POST[dnvars][$x]."') ";
							$resultado=mysql_query($sqlr,$linkbd);
							if(!$resultado){
								echo"<script>despliegamodalm('visible','1','Error al momento de crear la Clasificación de Predio');</script>";
								$status=FALSE;
							}
						}
						if($status)
