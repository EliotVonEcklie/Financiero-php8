...
document.form2.oculto.value=2;
document.form2.action="hum-inversiontemporal.php";
document.form2.submit();
}
...
<table>
    ...
    <tr>
        <td colspan="3" class="cinta">
            <a href="hum-inversiontemporal.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
            <a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a>
            <a href="hum-buscainversiontemporal.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
            <a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a>
            <a href="hum-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
        </td>
    </tr>
</table>
<?php
...
{	
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(RIGHT(codigo,2)) from conceptoscontables where modulo=2 and tipo='IT' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8">.: Inversi&oacute;n Temporal </td>
      ...
      <tr  >
		<td width="119" class="saludo1">Codigo:</td>
		 ...
		 <td width="119" class="saludo1">Nombre:</td>
		  ...
		  onKeyUp="return tabular(event,this)" value="<?php echo $_POST[nombre]?>" onClick="document.getElementById('acuerdo').focus();document.getElementById('acuerdo').select();"></td><td class="saludo1">Tipo:</td><td><input name="tipo" value="Causacion" size="10" type="text"><input name="tipoc" value="IT" size="10" type="hidden"></td>
	    </tr>
    </table>
	<table class="inicio">
	<tr><td colspan="6" class="titulos2">Crear Detalle Inversi&oacute;n Temporal</td></tr>
	<tr>
	...
	<table class="inicio">
	<tr><td class="titulos" colspan="7">Detalle Inversi&oacute;n Temporal</td></tr>
