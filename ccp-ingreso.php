			...
			<div id="myapp">
				<div class="row" style="margin: 20px 50px 0 50px; border-radius:4px; background-color: #E1E2E2; ">
					...
					<div class="col-md-6" style="padding: 4px">
						<input type="text" class="form-control" style="height: auto; border-radius:0;" placeholder="Ej: Superavit fiscal" v-on:keyup.enter="searchMonitor"  v-model="search.keyword">
					</div>
