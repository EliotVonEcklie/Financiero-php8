...
";						
						...
						$vigcal=$r[0];
							...
							if($r[3]=="N")
							{
                                echo "<tr class='$varcol' onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\"onMouseOut=\"this.style.backgroundColor=anterior\" $clihis $titvig>
                                <td>
                                    <input type='text' name='dvigencias[]' value='$r[0]' />
                                </td>
                                <td>
                                    <input type='text' name='dcodcatas[]' value='$r[1]'/>
                                </td>
                                <td>
                                    <input type='text' name='dvaloravaluo[]' value='$base'/>
                                </td>
                                <td>
                                    <input type='text' name='dtasavig[]' value='$tasav'/>
                                </td>
                                <td>
                                    <input type='text' name='dpredial[]' value='$predial'/>
                                </td>
                                <td>
                                    <input type='text' name='dipredial[]' value='$ipredial'/>
                                </td>
                                <td>
                                    <input type='text' name='ddescipredial[]' value='$descipred'/>
                                </td>
                                <td>
                                    <input type='text' name='ditpredial[]' value='".($ipredial-$descipred)."'/>
                                </td>
                                <td>
                                    <input type='text' name='dimpuesto1[]' value='".($valoringreso[0]+0)."'/>
                                </td>
                                <td>
                                    <input type='text' name='dinteres1[]' value='".($intereses[0]+0)."'/>
                                </td>
                                <td>
                                    <input type='text' name='dimpuesto2[]' value='".($valoringreso[1]+0)."'/>
                                </td>
                                <td>
                                    <input type='text' name='dinteres2[]' value='".($intereses[1]+0)."'/>
                                </td>";
                                if($valorAlumbrado>0)
                                {
                                    echo "<td><input type='text' name='dvalorAlumbrado[]' value='$valorAlumbrado'/></td>";
                                }
                                echo "
                                <td>
                                    <input type='text' name='ddescuentos[]' value='$tdescuentos'/>
                                </td>
                                <td>
                                    <input type='text' name='davaluos[]' value='".number_format($totalpagar,2)."'/>
                                </td>
                                <td>
                                    <input type='text' name='dhavaluos[]' value='$totalpagar'/>
                                </td>
                                <td>
                                    <input type='text' name='dias[]' value='$diasd'/>
                                </td>
