	...
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-usosdesueloeditar.php?idban="+idban;
			}
	...
	<body>
		...
		<form name="form2" method="post" action="">
			<?php 
				...
				{
					$_POST['onoffswitch']="S";
					$_POST['codban']=selconsecutivo('srvusosdesuelo','id');
				}
			?>
			<table class="inicio">
				<tr>
					<td class="titulos" colspan="4">.: Ingresar Uso de Suelo</td>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvusosdesuelo','id');
					$sqlr="INSERT INTO srvusosdesuelo (id,nombre,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."','$valest')";
