...
<tr>
  <td colspan="3" class="cinta"><a href="teso-reportenotificacionpredial.php" ><img src="imagenes/add.png" alt="Nuevo"  border="0" /></a> <a href="#" onClick="guardar()" ><img src="imagenes/guarda.png"  alt="Guardar" /></a><a href="teso-buscareportecobropredial.php"> <img src="imagenes/busca.png"  alt="Buscar" /></a> <a href="#" onClick="mypop=window.open('teso-principal.php','','');mypop.focus();"><img src="imagenes/nv.png" alt="nueva ventana"></a> <a href="#" <?php if($_POST[oculto]!="") { ?> onClick="pdf()" <?php } ?>> <img src="imagenes/print.png"  alt="Buscar" /></a></td>
</tr>		  
</table>
<tr>
...
//								 echo $tasaintdiaria."-";
	...
	$fechaf=$fecha[3]."-".$fecha[2]."-".$fecha[1];
	  $linkbd=conectar_bd();
	 $sqlr="insert into tesocobropredial (  `fecha`,`codigocatastral`, tercero, `total`,estado) values ('$fechaf','$_POST[catastral]','$_POST[tercero]',$_POST[totliquida],'S')";
