	...
	<head>
		...
		function adelante()
		{
			if(parseFloat(document.form2.ncomp.value)<parseFloat(document.form2.maximo.value))
			{
				...
				document.form2.action="ccp-cdp-reversarp.php";
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					...
					<a><img  src="imagenes/iratras.png" title="Atr&aacute;s"  onClick="location.href='ccp-gestioncdp.php'" class="mgbt"/></a>
				</td>
        	</tr>
        </table>
						 ...
						 <form name="form2" method="post" action="">
							<table class="inicio" align="center" width="80%" >
							  <tr >
								...
								<td width="73" class="cerrar" ><a href="ccp-principal.php">Cerrar</a></td>
							  </tr>
							  <tr  >
