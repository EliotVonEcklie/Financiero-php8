...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="teso-egresocajamenorver.php?idegre="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='teso-egresocajamenor.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png" title="Buscar" onClick="document.form2.submit();" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana"  onClick="<?php echo paginasnuevas("teso");?>" class="mgbt"/></td>
			</tr>	
		</table>
		<?php
			if($_GET[numpag]!="")
		...
		?>
		<form name="form2" method="post" action="teso-buscaegresocajamenor.php">
			<input type="hidden" name="numres" id="numres" value="<?php echo $_POST[numres];?>"/>
			<input type="hidden" name="numpos" id="numpos" value="<?php echo $_POST[numpos];?>"/>
			<input type="hidden" name="nummul" id="nummul" value="<?php echo $_POST[nummul];?>"/>
			<table  class="inicio" align="center" >
				<tr>
					<td class="titulos" colspan="3" >:. Buscar Egresos Caja Menor</td>
					<td style="width:7%"><label class="boton02" onClick="location.href='teso-principal.php';">Cerrar</label></td>
				</tr>
				<tr style="height: 30px;">
					<td class="tamano01" style="width:4cm;">N&uacute;mero:</td>
					<td style="width:15%;"><input type="search" name="nombre" id="nombre" value="<?php echo $_POST[nombre];?>" style="width:98%;" class="tamano02"/></td>
			...
			<div class="subpantallap" style="height:64.5%; width:99.6%; overflow-x:hidden;" id="divdet">
			<?php
				$crit1="";
				if ($_POST[nombre]!="")
				$crit1="and concat_ws(' ', tesoegresosnomina.id_egreso, tesoegresosnomina.concepto) LIKE '%$_POST[nombre]%'";
				$sqlr="SELECT id FROM tesoegresocajamenor ORDER BY id DESC";
				...
				$sqlr="SELECT id,fecha,id_rp,tipo_egreso,tercero,detalle,valorpagar,estado FROM tesoegresocajamenor ORDER BY id DESC $cond2";
				$resp = mysql_query($sqlr,$linkbd);
				$con=1;
				...
				<table class='inicio' align='center' >
					...
					<tr>
						...
						<td class='titulos2'>Descipci&oacute;n</td>
