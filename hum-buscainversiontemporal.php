		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="hum-editainversiontemporal.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
...
<tr>
  ...
  <a href="hum-inversiontemporal.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a>
  <a href="#"  onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  title="Guardar" /></a>
  <a href="hum-buscainversiontemporal" class="mgbt"><img src="imagenes/busca.png"  title="Buscar" border="0" /></a>
  ...
  <a href="hum-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
		...
		?>
 <form name="form2" method="post" action="hum-buscainversiontemporal.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Inversi&oacute;n Temporal</td>
      ...
      <?php
		...
		if ($_POST[numres]!="-1"){ 
          ...
          //sacar el consecutivo 
	        $sqlr="select *from conceptoscontables where conceptoscontables.tipo='IT' and conceptoscontables.modulo='2' ".$crit1." order by conceptoscontables.codigo";
          $resp = mysql_query($sqlr,$linkbd);
          $ntr = mysql_num_rows($resp); 
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *from conceptoscontables where conceptoscontables.tipo='IT' and conceptoscontables.modulo='2' ".$crit1." order by conceptoscontables.codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
		...
		if(($_POST[numpos]==0)||($_POST[numres]=="-1")){
          ...
          echo "<table class='inicio' align='center'>
			...
			<tr>
				<td colspan='3'>Inversi&oacute;n Temporal Encontrados: $ntr</td>
			</tr>
			<tr>
