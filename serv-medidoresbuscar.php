...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="serv-medidoreseditar.php?idban="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
			...
			function cambioswitch(id,valor)
			{
				...
				if(valor==1){despliegamodalm('visible','4','Desea activar este Estrato','1');}
				else{despliegamodalm('visible','4','Desea Desactivar este Estrato','2');}
			}
		</script>
		<?php 
			titlepag();
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='serv-medidores.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='serv-medidoresbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("serv");?>" class="mgbt"></td>
			</tr>
		</table>
		<?php
			if(@ $_POST['oculto']=="")
		...
		<form name="form2" method="post" action="">
			...
			<?php
				if(@ $_POST['cambioestado']!="")
				{
					...
					{
						$sqlr="UPDATE srvmedidores SET estado='S' WHERE id='".$_POST['idestado']."'";
						mysqli_query($linkbd,$sqlr);
					}
					else
					{
						$sqlr="UPDATE srvmedidores SET estado='N' WHERE id='".$_POST['idestado']."'";
						mysqli_query($linkbd,$sqlr);
					}
			...
			<table class="inicio">
				<tr>
					<td class="titulos" colspan="4">:: Buscar Medidores</td>
					<td class="cerrar" style="width:7%" onClick="location.href='serv-principal.php'">Cerrar</td>
				</tr>
				<tr >
					<td class="tamano01" style='width:4cm;'>:: C&oacute;digo o Descripci&oacute;n:</td>
			...
			<?php
				if (@ $_POST['nombre']!=""){$crit1="WHERE concat_ws(' ',id,descripcion) LIKE '%".$_POST['nombre']."%'";}
				else {$crit1='';}
				$sqlr="SELECT * FROM srvmedidores $crit1";
				$resp = mysqli_query($linkbd,$sqlr);
				$_POST['numtop']=mysqli_num_rows($resp);
				$nuncilumnas=ceil($_POST['numtop']/$_POST['numres']);
				$cond2="";
				if (@ $_POST['numres']!="-1"){$cond2="LIMIT ".$_POST['numpos'].", ".$_POST['numres']; }
				$sqlr="SELECT * FROM srvmedidores $crit1 ORDER BY CONVERT(id, SIGNED INTEGER) DESC $cond2";
				$resp = mysqli_query($linkbd,$sqlr);
				$con=1;
				...
				echo "
					<table class='inicio'>
						...
						<tr><td colspan='11'>Medidores Encontrados: ".$_POST['numtop']."</td></tr>
						<tr>
							<td class='titulos2' style='width:5%;'>Item</td>
							<td class='titulos2' style='width:5%;'>Código</td>
							<td class='titulos2' >Descripción</td>
							<td class='titulos2' style='width:12%;'>Fabricante</td>
							<td class='titulos2' style='width:12%;'>Marca</td>
							<td class='titulos2' style='width:12%;'>Serial</td>
							<td class='titulos2' style='width:12%;'>Referencia</td>
							<td class='titulos2' style='width:5%;'>Diametro</td>
							<td class='titulos2' style='width:10%;'>Activacion</td>
