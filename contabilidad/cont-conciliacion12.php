	...
	<head>
		...
		<script>
			...
			function validar()
			{
				...
				document.form2.action="cont-conciliacion12.php";
				document.form2.submit();
			}
			//************* genera reporte ************
			function guardar()
 		...
 		<form name="form2" method="post" action="">
    		...
    		<table  align="center" class="inicio">
                ...
                <tr>
        			...
        			<td class="saludo3">Cuenta:</td>
                    <td  colspan="2" ><input name="ncuenta" id="ncuenta" type="text" value="<?php echo $_POST[ncuenta]?>" style="width:100%" readonly></td>
             	</tr>
                <tr>
                    ...
                    <td colspan="1" ><input type="button" name="generar" value="Conciliar" onClick="buscarconciliar()" ><input type="hidden" value="0" name="bconc" id="bconc">
                    </td>
                ...
                <tr>
                    ...
                    <td><input name="crednc" id="crednc" type="text"  readonly value="<?php echo $_POST[crednc]?>" style="width:100%"></td>
				...
				{	
					...
					while($row=mysql_fetch_row($res))
 					{	 	 
						...
						$sqlr="select count(*),periodo2 from conciliacion where id_det=$row[5] and cuenta='$_POST[cuenta]' AND periodo2 between '$fechaf' and '$fechaf2'";
						$vc=0;
