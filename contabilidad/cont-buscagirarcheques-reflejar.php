...
<tr><td colspan="3" class="tablaprin"> 
	<form name="form2" method="post" action="cont-buscagirarcheques-reflejar.php">
			...
			$iter2='saludo2';
 			while ($row =mysql_fetch_row($resp)){
				...
				if($row[13]=='S')
		 		...
		 		echo "<tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor; this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase;cursor:pointer' onDblClick=\"window.open('cont-girarcheques-reflejar.php?idegre=$row[0]','_self');\">
					<td >$row[0]</td>
					<td>$row[2]</td>
					<td >$ntr</td>
					<td>$row[3]</td>
					...
					<td style='text-align:center;'>".strtoupper($estadosemaforo)."</td>";
	 				...
	 				if ($row[13]=='P' || $row[13]=='N')
	 					echo "<td></td>";	 
	 				echo "<td style='text-align:center;'>
						<a href='cont-girarcheques-reflejar.php?idegre=$row[0]'>
