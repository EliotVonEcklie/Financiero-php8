...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="cont-codigosinteditar.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
	...
	<body>
		...
		<form name="form2" method="post" action="cont-codigosintbuscar.php">
			<?php
				...
				else
				{
					...
					if($_POST[cambioestado]!="")
					{
						...
						{
							$sqlr="UPDATE contcodigosinternos SET estado='S' WHERE idnum='$_POST[idestado]'";
							mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						}
						else 
						{
							$sqlr="UPDATE contcodigosinternos SET estado='N' WHERE idnum='$_POST[idestado]'";
							mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						}
					}
					//*****************************************************************
			...
			<table  class="inicio" align="center" >
				<tr>
					<td class="titulos" colspan="5">:. Buscar C&oacute;digos Internos </td>
			...
			<div class="subpantalla" style="height:63.5%; width:99.6%;overflow-x:hidden" id="divdet">
				<?php
					//if($_POST[oculto])
					{
						...
						$sqlr="SELECT * FROM contcodigosinternos $crit1";
						$resp = mysql_query($sqlr,$linkbd);
						$_POST[numtop]=mysql_num_rows($resp);
						$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
						$cond2="";
						if ($_POST[numres]!="-1"){$cond2="LIMIT $_POST[numpos], $_POST[numres]";}
						$sqlr="SELECT * FROM contcodigosinternos  $crit1 ORDER BY idnum $cond2";
						$resp = mysql_query($sqlr,$linkbd);
						$con=1;
						...
						while ($row =mysql_fetch_row($resp)) 
						{
							...
							$sqlr2="SELECT * FROM contcodigosinternos_det WHERE estado='S' AND idnum='$row[0]'";
