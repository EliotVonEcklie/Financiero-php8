...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			function buscar()
			{
					...
					document.form2.action="cont-companulados.php";
	...
	<body>
		...
		<form name="form2" method="post" action="cont-companulados.php"> 
	 			...
	 			<table class='inicio' >
					...
					<?php
						...
						$sqlr="SELECT * FROM comprobante_det, comprobante_cab 
							WHERE (comprobante_cab.estado='0' OR comprobante_det.estado='0')
