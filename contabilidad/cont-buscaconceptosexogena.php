...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="4">:: Buscar Conceptos Exogena </td>
      ...
      <tr >
        ...
        <td width="13%" class="saludo1">Codigo Concepto:        </td>
...
$crit1=" ";
$crit2=" ";
if ($_POST[nombre]!=""){$crit1=" WHERE (contexogenaconce_cab.nombre like '%".$_POST[nombre]."%') ";}
if ($_POST[documento]!="")
{
	if ($_POST[nombre]!=""){$crit2=" and contexogenaconce_cab.codigo like '%$_POST[documento]%' ";}
	else {$crit2=" WHERE contexogenaconce_cab.codigo like '%$_POST[documento]%' ";}
}

$sqlr="select * from contexogenaconce_cab ".$crit1.$crit2." order by contexogenaconce_cab.codigo";

$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
$con=1;
echo "<table class='inicio' align='center' width='80%'><tr><td colspan='8' class='titulos'>.: Resultados Busqueda:</td></tr><tr><td colspan='7'>Conceptos Encontrados: $ntr</td></tr><tr><td width='5%' class='titulos2'>Codigo</td><td class='titulos2'>Nombre</td><td class='titulos2' colspan='2' style='width:6%;'>ESTADO</td><td class='titulos2' width='5%'>EDITAR</td></tr>";	
//echo "nr:".$nr;
$iter='saludo1a';
$iter2='saludo2';
 ...
 if($row[2]=='S')
	 ...
	 <td style='text-align:center;'><a href='cont-editaconceptosexogena.php?cod=$row[0]'><img src='imagenes/b_edit.png' style='width:18px' title='Editar'></a></td></tr>";
	 $con+=1;
	 $aux=$iter;
	 $iter=$iter2;
	 $iter2=$aux;
