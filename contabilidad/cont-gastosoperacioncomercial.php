...
function validar2()
{
	...
	document.form2.action="cont-gastosoperacioncomercial.php";
	document.form2.submit();
}
...
{	
		 ...
		 $_POST[valor]=0;		
		  $sqlr="select MAX(codigo) from conceptoscontables where modulo=3 and tipo='GO' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8" style='width:93%'>.: Gastos de Operaci&oacute;n Comercial</td>
      ...
      <tr  >
		...
		<td><input name="tipo" value="Gasto" size="10" type="text"><input name="tipogo" value="GO" size="10" type="hidden"></td>
	...
	if($_POST[oculto]=='2')	
		...
		$sqlr="insert into conceptoscontables (codigo,nombre,modulo,tipo) values ('$_POST[numero]','$_POST[nombre]','3','$_POST[tipogo]')";
		...
		for($x=0;$x<count($_POST[dcuentas]);$x++) 
		 {
		  ...
		  $sqlr="insert into conceptoscontables_det (codigo,tipo,tipocuenta,cuenta,cc,debito,credito,estado,modulo,fechainicial) values ('$_POST[numero]','$_POST[tipogo]','N','".$_POST[dcuentas][$x]."','".$_POST[dccs][$x]."','".$_POST[ddebitos][$x]."','".$_POST[dcreditos][$x]."','S','3','$fechaf')";
		  $res=mysql_query($sqlr,$linkbd);
		 }
