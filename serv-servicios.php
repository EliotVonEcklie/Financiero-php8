	...
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-servicioseditar.php?idban="+idban;
			}
	...
	<body>
		...
		<form name="form2" method="post" action="">
			...
			<table class="inicio ancho">
				<tr>
					<td class="titulos" colspan="6">.: Ingresar Servicios</td>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvservicios','id');
					$sqlr="INSERT INTO srvservicios (codigo,nombre,cuenta_presupuestal,concepto,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."','".$_POST['cuenta']."','".$_POST['concecont']."', '$valest')";
