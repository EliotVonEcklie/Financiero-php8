					...
					if($_POST[oculto])
					{
						...
						if($_POST[tipocom] && $_POST[tipoestado]){
							...
							if($_POST[tipoestado]=='1'){
								...
								pptocomprobante_det.cuenta,
								pptocomprobante_det.valdebito,
								pptocomprobante_det.valcredito, pptocomprobante_det.tipo_comp, pptocomprobante_det.numerotipo,pptocomprobante_det.vigencia, 
								pptocomprobante_det.detalle,pptocomprobante_det.tipo_comp, pptocomprobante_det.doc_receptor, pptocomprobante_det.tipomovimiento
								FROM pptocomprobante_det
								WHERE tercero=''
								AND detalle=''
								AND (valdebito='' OR valdebito='0')
								AND (valcredito='' OR valcredito='0')
								AND estado=''
								AND vigencia=''
								AND (tipo_comp='0' OR tipo_comp='')
								AND (numerotipo='0' OR numerotipo='')
								AND doc_receptor=''";
							}
						}else{
							$sqlr3="SELECT 
						...
						} else if($_POST[tipoestado]=='2'){

						} else if($_POST[tipoestado]=='3'){

							echo "<table class='inicio' ><tr><td colspan='13' class='titulos'>Auxiliar por Cuenta</td></tr>";
							echo "<tr>							
						...
						} else if($_POST[tipoestado]=='4'){
							//cuenta	tercero	detalle Ascendente	valdebito	valcredito	estado	vigencia	tipo_comp	numerotipo	tipomovimiento	uniejecutora	doc_receptor
							echo "<table class='inicio' ><tr><td colspan='9' class='titulos'>Auxiliar por Cuenta</td></tr>";
							echo "<tr><td class='titulos2' style='width: 11%;'>Cuenta</td>
							<td class='titulos2' style='width: 11%;'>TIPO COMPROBANTE</td>
							<td class='titulos2' style='width: 5%;'>No Com.</td>
