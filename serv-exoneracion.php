...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "serv-exoneracioneditar.php?idban="+idban;
			}
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para crear la Anomalia');}
			}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='serv-exoneracion.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar()" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='serv-exoneracionbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("serv");?>" class="mgbt"></td>
			</tr>
		</table>
		...
		<form name="form2" method="post" action="">
			<?php 
				...
				{
					$_POST['onoffswitch']="S";
					$_POST['codban']=selconsecutivo('srvexoneraciones','id');
				}
			?>
			<table class="inicio ancho">
				<tr>
					<td class="titulos" colspan="4">.: Ingresar Exoneraci&oacute;n</td>
			...
			<?php 
				if(@ $_POST['oculto']=="2")
				{
					...
					$_POST['codban']=selconsecutivo('srvexoneraciones','id');
					$sqlr="INSERT INTO srvexoneraciones (id,nombre,concepto,estado) VALUES ('".$_POST['codban']."','".$_POST['nomban']."','".$_POST['concecont']."', '$valest')";
