...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
        ...
        <script>
			...
			function funcionmensaje(){document.location.href = "presu-uniejecutora.php";}
    ...
    <body>
        ...
        <table>
			...
			<tr>
  				<td colspan="3" class="cinta">
					<img src="imagenes/add.png" title="Nuevo" onClick="location.href='presu-uniejecutora.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar();" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='presu-buscauniejecutora.php'" class="mgbt" /><img src="imagenes/agenda1.png" title="Agenda" onClick="mypop=window.open('plan-agenda.php','','');mypop.focus()" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("presu");?>" class="mgbt">
				</td>
           	</tr>
		</table>
        <div id="bgventanamodalm" class="bgventanamodalm">
  		...
  		<form name="form2" method="post" action="presu-uniejecutora.php">
        	<table class="inicio" align="center">
                <tr>
                    <td class="titulos" colspan="6">.: Agregar Unidad Ejecutora</td>
                ...
                <tr>
                    ...
                    <td class="saludo1" style="width:15%;">.: Nombre Unidad Ejecutora:</td>
				...
				if($_POST[oculto]=="8")
				{
					$sqlr="SELECT * FROM pptouniejecu WHERE id_cc='$_POST[codigo]'";
				...
				if($_POST[oculto]=="2")
				{
					$sqlr="INSERT INTO pptouniejecu (id_cc,nombre,estado,entidad)VALUES ('$_POST[codigo]','$_POST[nombre]','$_POST[estado]', '$_POST[tipo]')";
