		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="acti-editaterceros.php?idter="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<script>
...
?>
 <form name="form2" method="post" action="acti-buscaterceros.php">
...
<table  class="inicio" align="center" >
      ...
      <tr >
		<td style="width:3.5cm" class="saludo1">:. N&deg; Documento o Nombre:</td>
        <td style="width:80%">
	...
	<div class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;" id="divdet">
      <?php
		...
		$crit1="where concat_ws(' ', nombre1, nombre2, apellido1, apellido2, razonsocial, cedulanit) LIKE '%$_POST[nombre]%'";
			$sqlr="select * from terceros ".$crit1." order by apellido1,apellido2,nombre1,nombre2,razonsocial";
		...
		if(($_POST[numpos]==0)||($_POST[numres]=="-1")){
			...
			echo "<table class='inicio' align='center' width='99%'>
				...
				<tr>
					<td colspan='10'>Terceros Encontrados: $ntr</td>
				</tr>
				<tr>
