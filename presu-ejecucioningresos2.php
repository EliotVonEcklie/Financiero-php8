...
<body>
 <IFRAME src="alertas.php" name="alertas" id="alertas" style="display:none"></IFRAME>
		...
		<form name="form2" method="post" action="presu-ejecucioningresos2.php">
			<?php
 ...
 ?>
	...
	<?php
		...
		//--CUENTAS
		$sqlr="select cuenta,nombre,tipo, sideforigen from pptocuentas where cuenta like '1%'  and vigencia='$vigusu' order by cuenta asc";
		$res=mysql_query($sqlr,$linkbd);
		...
		$totalpag1=0;
		$totalpag2=0;
		$sqlr7="SELECT p1.cuenta,sum(p1.valdebito),sum(p1.valcredito), p1.tipo_comp FROM pptocomprobante_det p1, pptocomprobante_cab p2 WHERE p1.cuenta like '1%' and p1.numerotipo=p2.numerotipo and p1.tipo_comp=p2.tipo_comp and p2.fecha>='$f1' and p2.fecha<='$f2' and p1.estado=1 and p2.estado=1 and p1.vigencia=$vigencia and p1.tipo_comp=16 GROUP BY tipo_comp,cuenta ORDER BY CUENTA ASC";
		...
		for($x=0;$x<count($var1);$x++){
			...
			if($var1[$x]==$c1[$cont1]){
				...
				$sqlr="select sum(p1.valdebito),sum(p1.valcredito) from pptocomprobante_det p1, pptocomprobante_cab p2 where p1.cuenta like '".$var1[$x]."%' and p1.tipo_comp=1 and p1.numerotipo=p2.numerotipo and p1.tipo_comp=p2.tipo_comp and p2.fecha>='$f1' and p2.fecha<='$f2' and (p1.estado=1 or p1.estado=4) and p1.vigencia=$vigencia";
				$res=mysql_query($sqlr,$linkbd);
				$row=mysql_fetch_row($res);
				if($row[0]==0){$row[0]=0;}
				if($row[1]==0){$row[1]=0;}
			...
			if($var1[$x]==$c2[$cont2]){
				...
				$sqlr="select sum(p1.valdebito),sum(p1.valcredito) from pptocomprobante_det p1, pptocomprobante_cab p2 where p1.cuenta like '".$var1[$x]."%' and p1.tipo_comp=2 and p1.numerotipo=p2.numerotipo and p1.tipo_comp=p2.tipo_comp and p2.fecha>='$f1' and p2.fecha<='$f2' and (p1.estado=1 or p1.estado=4) and p1.vigencia=$vigencia";
				$res=mysql_query($sqlr,$linkbd);
				$row=mysql_fetch_row($res);
				if($row[0]==0){$row[0]=0;}
				echo "
			...
			if($var1[$x]==$c3[$cont3]){
				...
				$sqlr="select sum(p1.valdebito),sum(p1.valcredito) from pptocomprobante_det p1, pptocomprobante_cab p2 where p1.cuenta like '".$var1[$x]."%' and p1.tipo_comp=3 and p1.numerotipo=p2.numerotipo and p1.tipo_comp=p2.tipo_comp and p2.fecha>='$f1' and p2.fecha<='$f2' and (p1.estado=1 or p1.estado=4) and p1.vigencia=$vigencia";
				$res=mysql_query($sqlr,$linkbd);
				$row=mysql_fetch_row($res);
				if($row[1]==0){$row[1]=0;}
				echo "
			...
			/*if($var1[$x]==$c7[$cont7]){
				...
				$sqlr="select sum(p1.valdebito),sum(p1.valcredito) from pptocomprobante_det p1, pptocomprobante_cab p2 where p1.cuenta like '".$var1[$x]."%' and p1.numerotipo=p2.numerotipo and p1.tipo_comp=p2.tipo_comp and p2.fecha>='$f1' and p2.fecha<='$f2' and p1.estado=1 and p2.estado=1 and p1.vigencia=$vigencia and p1.tipo_comp=16";
				$res=mysql_query($sqlr,$linkbd);
				$row=mysql_fetch_row($res);
				if($row[0]==0){$row[0]=0;}
				if($row[1]==0){$row[1]=0;}
			...
			if($var1[$x]==$c7[$cont7]){
				...
				$sqlr="select sum(p1.valdebito),sum(p1.valcredito) from pptocomprobante_det p1, pptocomprobante_cab p2 where p1.cuenta like '".$var1[$x]."%' and p1.tipo_comp=16 and p1.numerotipo=p2.numerotipo and p1.tipo_comp=p2.tipo_comp and p2.fecha>='$f1' and p2.fecha<='$f2' and (p1.estado=1 or p1.estado=4) and p1.vigencia=$vigencia";
				//echo $sqlr;
				$res=mysql_query($sqlr,$linkbd);
				$row=mysql_fetch_row($res);
				if($row[0]==0){$row[0]=0;}
