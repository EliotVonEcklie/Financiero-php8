...
<table>
	...
	<td colspan="3" class="cinta">
		...
		<a href="teso-reporegresosnominaexcel.php?tercero=<?php echo $_POST[tercero]?>&fecha1=<?php echo $_POST[fecha]?>&fecha2=<?php echo $_POST[fecha2]?>&retencion=<?php echo $_POST[chkret]?>" target="_blank"><img src="imagenes/excel.png"  class="mgbt" alt="csv"></a>
		<a href="presu-librosppto.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
	</td>
</tr>	
</table>
<tr><td colspan="3" class="tablaprin"> 
 <form name="form2" method="post" action="presu-rptegresosnomina.php">
 <?php
 if($_POST[bc]=='1')
			{
...
<table  class="inicio" align="center" >
      ...
      <tr >
        <td class="titulos" colspan="8">:. Buscar Pagos de nomina</td>
