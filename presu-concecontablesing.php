...
document.form2.oculto.value=2;
document.form2.action="presu-concecontablesing.php";
document.form2.submit();
}
function validar()
{
...
if(!$_POST[oculto])
{
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(codigo) from conceptoscontables where modulo=3 and tipo='I' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8">.: Concepto Contable Ingresos </td>
