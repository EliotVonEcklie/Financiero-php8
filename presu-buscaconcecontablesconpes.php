		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="presu-editaconcecontablesconpes.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<script>
//************* ver reporte ************
...
{
document.form2.action="presu-buscaconcecontablesconpes.php";
document.form2.submit();
}
function cleanForm()
{
...
document.form2.razonsocial.value="";
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta"><a href="presu-concecontablesconpes.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a class="mgbt"><img src="imagenes/guardad.png"/><a onClick="document.form2.submit();" href="#" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a> <a href="presu-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
         	</tr>	
		</table>
        <?php
		if($_GET[numpag]!=""){
		...
		?>
 <form name="form2" method="post" action="presu-buscaconcecontablesconpes.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Concepto Contable Conpes </td>
...
$ntr = mysql_num_rows($resp);
		...
		$sqlr="select *from conceptoscontables where conceptoscontables.tipo='CP' and conceptoscontables.modulo='3' ".$crit1." order by conceptoscontables.codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
