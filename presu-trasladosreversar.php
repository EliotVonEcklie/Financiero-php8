        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					<img src="imagenes/add.png" title="Nuevo" href="presu-traslados.php" class="mgbt"/><img src="imagenes/guardad.png" href="#" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" href="presu-buscartraslados.php" class="mgbt"/><img src="imagenes/agenda1.png" title="Agenda" onClick="mypop=window.open('plan-agenda.php','','');mypop.focus()" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" href="#" onClick="mypop=window.open('presu-principal.php','','');mypop.focus();" class="mgbt"/><img src="imagenes/print.png" title="imprimir" href="#" onClick="pdf()" class="mgbt"/><img src="imagenes/iratras.png" title="Atr&aacute;s" href="#" onClick="iratras()" class="mgbt" />
				</td>
       		</tr>
        </table>
		<?php
