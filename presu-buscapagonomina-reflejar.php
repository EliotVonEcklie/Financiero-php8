...
<form name="form2" method="post" action="presu-buscapagonomina-reflejar.php">
			...
			$iter2='saludo2';
		 	while($row =mysql_fetch_row($resp)){
				...
				$estadosemaforo="<img src='imagenes/sema_rojoON.jpg' style='width:19px; ' title='Inactivo'>";
		 		...
		 		echo "<tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor; this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase;cursor:pointer' onDblClick=\"window.open('presu-pagonominaver-reflejar.php?idegre=$row[0]','_self');\">
					<td>$row[0]</td>
					<td>$row[2]</td>
					<td>$ntr</td>
					<td>$row[3]</td>
					...
					<td style='text-align:center;'>
						<a href='presu-pagonominaver-reflejar.php?idegre=$row[0]'><img src='imagenes/anular.png'></a>
					</td>
					<td style='text-align:center;'><a href='presu-pagonominaver-reflejar.php?idegre=$row[0]'><img src='imagenes/b_edit.png' style='width:18px' title='Editar'></a>
					</td>
				</tr>";
			 	$con+=1;
			 	$aux=$iter;
