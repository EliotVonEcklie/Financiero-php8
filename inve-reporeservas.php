...
<link href="css/css3.css?<?php echo date('d_m_Y_h_i_s');?>" rel="stylesheet" type="text/css" />
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><a href="#" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a><a class="mgbt"><img src="imagenes/guardad.png"/></a><a onClick="document.form2.submit();" href="#" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a><a href="#" onClick="mypop=window.open('inve-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a href="<?php echo "archivos/".$_SESSION[usuario]."-reportereservas.csv"; ?>" target="_blank"><img src="imagenes/csv.png"  alt="csv"></a></td>
          	</tr>
     	</table>
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="inve-reporeservas.php">
       		...
       		<div class="subpantalla" style="height:69.5%; width:99.6%; overflow-x:hidden;">
				<?php
                    ...
                    <table class='inicio' align='center' width='80%'>
                        <tr>
							<td colspan='8' class='titulos'>.: Resultados Busqueda: <label style='float:right;'>::<img src='imagenes/sema_azulON.jpg' style='width:16px'/>&nbsp;Reserva Entregada&nbsp;&nbsp;::<img src='imagenes/sema_verdeON.jpg' style='width:16px'/>&nbsp;Reserva Activa&nbsp;&nbsp;::<img src='imagenes/sema_rojoON.jpg' style='width:16px'/>&nbsp;Reserva Anulada&nbsp;&nbsp;::<img src='imagenes/candado.png' style='width:15px'/>&nbsp;Bloqueo por Usuario&nbsp;&nbsp;&nbsp;</label></td>
							<td class='submenu'>
                        ...
                        <tr>
							...
							<td class='titulos2' width='4%'>Anular</td>
                        </tr>";	
                    $iter='saludo1a';
                    $iter2='saludo2';
					$namearch="archivos/".$_SESSION[usuario]."-reportereservas.csv";
$Descriptor1 = fopen($namearch,"w+"); 
fputs($Descriptor1,"CODIGO;FECHA;SOLICITANTE;DEPENDENCIA;ARTICULO;CANTIDAD;ESTADO\r\n");
                    while ($row =mysql_fetch_row($resp)) 
                    {
						...
						$narticulo=$row3[0];
						$imganu="<a href='#' onclick='' ><img src='imagenes/anular.png' title='Anular' style='width:24px'/></a>";
						$imgedi="<a href='inve-greservaseditar.php?idreserva=$row[0]'><img src='imagenes/b_edit.png'></a>";
						switch($row[5])
						{
							case "ACT":	$imgsem="<img src='imagenes/sema_verdeON.jpg' title='Activa' style='width:21px'/>";break;
						...
						fputs($Descriptor1,$row[0].";".$row[1].";".$tercero.";".$dependencia.";".$narticulo.";".$row2[4].";".strtoupper($row[5])."\r\n");
						if($ntr2!=1)
						{
