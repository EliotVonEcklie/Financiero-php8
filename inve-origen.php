...
function buscacta(){
if (document.form2.cuenta.value!=""){document.form2.bc.value='1';document.form2.submit();}else{ document.form2.ncuenta.value=""; document.form2.submit(); }    }
...
function validar2()
{
	...
	document.form2.action="inve-origen.php";
	document.form2.submit();
}
function iratras(){
...
<tr>
  <td colspan="3" class="cinta"><a href="inve-origen.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a><a href="#"  onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  title="Guardar" /></a><a href="inve-buscaorigen.php" class="mgbt"><img src="imagenes/busca.png"  title="Buscar" border="0" /></a><a href="#" onClick="mypop=window.open('inve-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a><a href="#" onClick="iratras()" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
</tr></table>
<?php
$vigencia=date(Y);
$linkbd=conectar_bd();
...
if(!$_POST[oculto])
{
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(RIGHT(codigo,2)) from almorigenes order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
	...
	<div class="subpantallac" style="height:51.5%; width:99.6%; overflow-x:hidden;">
	<table class="inicio">
