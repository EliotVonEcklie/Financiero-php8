					...
					<td width="60%" style="background-repeat:no-repeat; background-position:center;">
						<ol id="lista2">
							<table>
								<tr>
									<td style="width:45%;">
										<li onClick="location.href='adm-reciboscaja(3).php'" style="cursor:pointer;">Comprobante de Ingresos</li>
										<li onClick="location.href='adm-notasbancarias-retencion.php'" style="cursor:pointer;">Ingresos Internos</li>
										<li onClick="location.href='adm-recatransfer-retencion.php'" style="cursor:pointer;">Ingresos SSF</li>
										<li onClick="location.href=''" style="cursor:pointer;">Recaudo Transferencia</li>
									<td style="width:30%;">
