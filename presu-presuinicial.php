...
<?php //V 1000 12/12/16 ?> 
<!--V 1001 12/12/16 Se modifico el tipodemovimiento linea:604,654--> 
<?php
	require"comun.inc"; 
...
function verep(idfac)
{
  ...
  function protocoloimport()
	{
		document.form2.action="presu-inicial-import.php";
    ...
    <table class="inicio" align="center" width="80%" >
      	...
      	<tr>
      		<td style="width:75%;">
      			<table>
      				<tr  >
			        	...
			        	<td style="width:15%;">
			        		<input name="fecha" type="text" id="fc_1198971545" title="DD/MM/YYYY" style="width:75%;" value="<?php echo $_POST[fecha]; ?>" onKeyUp="return tabular(event,this) " onKeyDown="mascara(this,'/',patron,true)"  maxlength="10">        
					 	...
					 	<td style="width:10%;" class="saludo1">Acto Administrativo:</td>
					  	...
					  	<td>
							<input type="text" name="vigencia" id="vigencia" value="<?php echo $_POST[vigencia]?>">
			...
			<table  align="center" class="inicio" >
				<tr >
					<td class="titulos" colspan="7">.: Importar Cuentas Presupuesto Inicial</td>
				</tr>   
				<tr> 
...
<table class="inicio">
	...
	<tr>
		...
		<td style="width:12%;">
	   		<select name="tipocta" id="tipocta" onKeyUp="return tabular(event,this)" onChange="validar()">
				<option value="0" <?php if($_POST[tipocta]=='0') echo "SELECTED"; ?>>Seleccione</option>
	...
	?>
		...
		if ($_POST[elimina]!='')
		 ...
		 {
			$sqlr="select tipo from pptocuentas where cuenta='".$_POST[dcuentas][$x]."' and vigencia=$_POST[vigencia]";
			// echo $sqlr;
			...
			if($row[0]=='Auxiliar'){
			 echo "<tr>
					...
					<td class='saludo2'>
						<input name='dncuentas[]' value='".$_POST[dncuentas][$x]."' type='text' size='100' readonly>
					</td>
					<td class='saludo2'>
						<input name='dingresos[]' value='".$_POST[dingresos][$x]."' type='text' size='15' readonly>
					</td>
					<td class='saludo2'>
		...
		switch($_POST[tipomov])
		{
			case 1:
				...
				for($x=0;$x<count($_POST[dcuentas]);$x++)	
				{
					...
					$sqlr="update pptocuentas set pptoinicial=$valores where cuenta='".$_POST[dcuentas][$x]."' and vigencia='$_POST[vigencia]'";
					mysql_query($sqlr,$linkbd);
				}   //****for
			break;		   
		} //****switch
