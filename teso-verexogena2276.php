...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
		...
		<table>
			...
			<tr>
 				<td colspan="3" class="cinta"><a onClick="location.href='teso-exogena2276.php'" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a class="mgbt" onClick="guardar()" ><img src="imagenes/guarda.png" title="Guardar" /></a><a class="mgbt" onClick="location.href='teso-buscaexogena2276.php'"><img src="imagenes/busca.png" title="Buscar" /></a><a class="mgbt" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a class="mgbt" onClick="pdf()"><img src="imagenes/print.png" title="imprimir" style="width:29px;height:25px;"/></a><a class="mgbt" onClick="location.href='<?php echo "archivos/".$_SESSION[usuario]."-reporteegresosexogena.csv"; ?>'" ><img src="imagenes/csv.png" title="csv" style="width:26px;height:25px;"/></a><a class="mgbt" onClick="excell2276();"><img src="imagenes/excel.png" title="Exogena 2276" style='width:24px;height:24px;'></a><a href="teso-buscaexogena2276.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
        	</tr>	
		</table>
		<div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="">
        	<input type="hidden" name="ordestados" id="ordestados" value="<?php echo $_POST[ordestados];?>"/>
 			<?php
 				if($_POST[oculto]=="")
 				{
 					...
 					$sqlr="select * from exogena_cab_2276 where id_exo='$_GET[idexo]'";
					...
					$_POST[concepto]=$row[3];
 					$sqlr="select * from exogena_det_2276 where id_exo=$_GET[idexo] ORDER BY tercero";
					$resp=mysql_query($sqlr,$linkbd);
			...
			<table  class="inicio" align="center" >
      			<tr >
        			<td class="titulos" colspan="8">:. Formato Exogena 2276</td>
    		...
    		<div class="subpantallap" style="height:68%;overflow-x:hidden;">
      			<?php	  
					...
					if($_POST[oculto]==2 || $_POST[oculto]==3)
					{
						...
						$fechaf=$_POST[fecha];
						$sqlr="delete from exogena_cab_2276 where id_exo=$_POST[idexo]";
						mysql_query($sqlr,$linkbd);
						$sqlr="insert into exogena_cab_2276 (id_exo,fecha,vigencia,descripcion,estado) values ($_POST[idexo],'$fechaf', '$_POST[vigencias]','$_POST[concepto]','S')";
						if(mysql_query($sqlr,$linkbd))
						{
							//$id=mysql_insert_id($linkbd);
							$sqlr="delete from exogena_det_2276 where id_exo=$_POST[idexo]";
							mysql_query($sqlr,$linkbd);
	 						echo"<script>despliegamodalm('visible','3','Se ha almacenado La Exogena con Exito');</script>";
	 						$conta=count($_POST[conexogena]);
	 						for($x=0;$x<$conta;$x++)
	 						{
	  							$sqlr="insert into exogena_det_2276 (id_exo, concepto, id_egre, id_cxp, fecha, tercero, detalle, valor, retefte,reteiva, tipoegre) values ($_POST[idexo],'".$_POST[conexogena][$x]."','".$_POST[egresos][$x]."','".$_POST[ordenes][$x]."','".$_POST[fechas][$x]."','".$_POST[terceros][$x]."','".$_POST[conceptos][$x]."','".$_POST[valoresb][$x]."','".$_POST[valores][$x]."','".$_POST[valoresiv][$x]."','".$_POST[estados][$x]."')";
	  							mysql_query($sqlr,$linkbd);
	 						}
	   						if($_POST[oculto]==3)
	   						{
