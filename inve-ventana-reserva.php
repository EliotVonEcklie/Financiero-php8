		...
		<form name="form2" method="post">
			...
			<?php
                    ...
                    if ($_POST[nombre]!=""){
 					...
 					$sqlr="SELECT codigo, nombre FROM almginventario WHERE tipomov='$tipomov' AND tiporeg='$tipoentra' $crit1 $crit2";
 					$resp=mysql_query($sqlr,$linkbd);
					$_POST[numtop]=mysql_num_rows($resp);
					$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
					$sqlr="SELECT consec, nombre, fecha FROM almginventario WHERE tipomov='$tipomov' AND tiporeg='$tipoentra' $crit1 $crit2 ORDER BY fecha DESC, codigo DESC LIMIT $_POST[numpos],$_POST[numres]";
 					$resp=mysql_query($sqlr,$linkbd);
					...
					echo"
 					<table class='inicio'>
						...
						<tr><td colspan='5'>Reservas Encontrados: $_POST[numtop]</td></tr>
 						<tr>
							<td class='titulos2' style='width:10%'>Codigo</td>
							<td class='titulos2'>Nombre</td>
							<td class='titulos2' colspan='3' style='width:25%'>Fecha Registro</td>
						</tr>";
