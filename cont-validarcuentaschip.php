...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
					<a href="cont-validarcuentaschip.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
					<a class="mgbt"><img src="imagenes/guardad.png"/></a>
					<a onClick="mypop=window.open('plan-agenda.php','','');mypop.focus()" class="mgbt"><img src="imagenes/agenda1.png" title="Agenda" /></a>
					<a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana">
					</a><?php if($_POST[gchip]=='1'){?><a href="<?php echo "archivos/".$_SESSION[usuario]."chip-$_POST[periodo].csv"; ?>" target="_blank" class="mgbt"><img src="imagenes/csv.png" title="csv"></a><?php } ?>
					<a href="cont-gestioninformecgr.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
				</td>
         	</tr>
    	</table>
  		<form name="form2" action="cont-validarcuentaschip.php"  method="post" enctype="multipart/form-data" >
    		...
    		<table class="inicio" align="center"> 
      		<tr>
        		<td class="titulos" colspan="10">Validar Cuentas CGN</td>
      		...
      		<tr>
                ...
                <td colspan="2"> 
                    ...
                    <input type="button" name="valida" value="Validar CGN" onClick="validarchip()"> 
				...
				{	
					...
					if($_POST[oculto])
					{
						...
						echo "<tr class='$co'>
									...
									</tr><script>document.getElementById('divcarga').style.display='none';</script>";  
						$horafin=date('h:i:s');	
		...
		if($_POST[gchip]=='1')
		 ...
		 $Descriptor1 = fopen($namearch,"w+"); 
		 fputs($Descriptor1,"S;".$_POST[codent].";".$_POST[periodo].";".$_POST[vigencias].";CGN2005_001_SALDOS_Y_MOVIMIENTOS\r\n");
		for($x=0;$x<count($_POST[cuentac]);$x++)
		 {	 
		  ...
		  if(strlen($_POST[cuentac][$x])==6)
		  {
		   ...
		   $salfinal=($saldoinicial+$debitos-$creditos); 
			...
			$ncuentas=substr($_POST[cuentac][$x],0,1).".".substr($_POST[cuentac][$x],1,1).".".substr($_POST[cuentac][$x],2,2).".".substr($_POST[cuentac][$x],4,2); 
	  		 fputs($Descriptor1,"D;".$ncuentas.";".abs(round($saldoinicial)).";".round($debitos).";". round($creditos).";".round($salfinal).";".round($salfinal).";0\r\n");
			 $chk="checked";
		  ...
		  $ch2=esta_en_array($_POST[nctes], $_POST[cuentac][$x]);
			...
			$ncuentas=substr($_POST[cuentac][$x],0,1).".".substr($_POST[cuentac][$x],1,1).".".substr($_POST[cuentac][$x],2,2).".".substr($_POST[cuentac][$x],4,2); 
			  fputs($Descriptor1,"D;".$ncuentas.";".abs(round($saldoinicial)).";". round($debitos).";". round($creditos).";".round($salfinal).";0;".round($salfinal).";\r\n");
			 $chk2="checked";
