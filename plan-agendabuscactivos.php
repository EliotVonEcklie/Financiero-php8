...
<body>
	<form name="form2" method="post" action="plan-agendabuscactivos.php" >
	<table  class="inicio" align="center" >
		<tr>
        	<td class="titulos" colspan="7">:: Buscar Eventos Activos  </td>
      	</tr>
      	<tr>
    ...
    <div class="subpantallac5" style="height:86%; overflow-x:hidden;">
		...
		if($_POST[oculto])
		{
			...
			echo'
				<table class="inicio">        
                	<tr>
                    	<td class="titulos" colspan="15">::Lista de Eventos Activos</td>
                    </tr>
					<tr>
