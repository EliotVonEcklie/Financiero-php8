...
<script>
	function iratras(scrtop, numpag, limreg, filtro){
		...
		location.href="presu-cuentasactivaexterno.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
	}
</script>
            ...
            <tr><?php menu_desplegable("presu");?></tr>
       	 	<tr>
          		<td colspan="3" class="cinta">
					...
					<a href="presu-cuentasactivaexterno.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
  ...
  //           echo htmlentities($e['sqltext']);
   ...
   // echo "Oc:$_POST[oculto] -";
    if (!$_POST[oculto])
	 {
		 $link=conectar_bd();		 
		 $sqlr="Select * from pptocuentasentidades  where estado='S'  and (left(cuenta,1)='1' OR left(cuenta,2)='R1') and vigencia='".$vigusu."'  order by cuenta";//echo  $sqlr;
		...
		if($_POST[oculto]=='1' || $_POST[oculto]=='' || $_POST[oculto]=='3' || $_POST[oculto]=='2')
		 {
   		   $link=conectar_bd();
		   //*******verificacion de si tiene auxiliares debajo
		   $sqlr="select count(*) from pptocuentasentidades where $_POST[codigo]=left(cuenta,".strlen($_POST[codigo]).") (vigencia=".$vigusu." or vigenciaf=$vigusu)";
		   $resp=mysql_query($sqlr,$link);
//		   echo $sqlr;
		   	while ($row =mysql_fetch_row($resp)) 
				{
    ...
    <tr >
      ...
      <td class="cerrar"><a href="presu-principal.php">Cerrar</a></td>
				...
				<tr >
				  ...
				  <td >
				  <select name="unidad" onChange="document.form2.submit();">
