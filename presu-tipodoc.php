...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje(){document.location.href = "presu-tipodoc.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="4" class="cinta"><a onClick="location.href='presu-tipodoc.php'" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a><a onClick="guardar();" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a><a onClick="location.href='presu-buscatipodoc.php'" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a><a onClick="<?php echo paginasnuevas("presu");?>"><img src="imagenes/nv.png" title="nueva ventana"></a></td>
         	</tr>
		</table>
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="presu-tipodoc.php">
    		<table class="inicio" align="center" >
                ...
                <tr>
                    ...
                    <td class="saludo1" style="width:10%;">.: Nombre Comprobante:</td>
                    <td style="width:30%;"><input type="text" name="nombre" id="nombre" value="<?php echo $_POST[nombre]?>" style="width:99.5%"></td></tr>
					<tr>
					<td class="saludo1" style="width:8%;">.: Categoria:</td>
					<td colspan="1">
					<select name="cat"  onKeyUp="return tabular(event,this)">
					<?php
					$linkbd=conectar_bd();
					$sqlr="select *from tipo_comprobante_categoria where estado='S'";
                    ...
                    <td >
                        <select name="estado" id="estado" style="">
            ...
            <?php
               	if($_POST[oculto]=="8")
				{
					$sqlr="SELECT * FROM pptotipo_comprobante WHERE codigo='$_POST[codigo]'";
					$res=mysql_query($sqlr,$linkbd);
                ...
                if($_POST[oculto]=="2")
                {
                    if ($_POST[nombre]!="")
                    {
						$mxa=selconsecutivo('pptotipo_comprobante','id_tipo');
                        $sqlr="INSERT INTO pptotipo_comprobante (id_tipo,nombre,estado,codigo,fijo) VALUES ('mxa','$_POST[nombre]','$_POST[estado]', '$_POST[codigo]','N')";
