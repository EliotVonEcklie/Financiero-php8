...
<IFRAME src="alertas.php" name="alertas" id="alertas" style="display:none"></IFRAME>
 ...
 <form name="form2" method="post" action="presu-pacingresos.php">
<?php
$vigusu=vigencia_usuarios($_SESSION[cedulausu]); 
?>
    <table  align="center" class="inicio" >
      <tr >
        <td class="titulos" colspan="2">.: INGRESOS VIGENCIA</td>
...
$iter2="zebra2";
$nm=count($meses);
 echo "<table class='inicio' ><tr><td colspan='".($nm+3)."' class='titulos'>PAC INGRESOS $vigusu</td></tr>";
...
AND(pptocomprobante_cab.VIGENCIA=".$pctasvig1[$pctas[$x]]." or pptocomprobante_cab.VIGENCIA=".$pctasvig2[$pctas[$x]].")
	  AND(pptocomprobante_det.VIGENCIA=".$pctasvig1[$pctas[$x]]." or pptocomprobante_det.VIGENCIA=".$pctasvig2[$pctas[$x]].")
		  ...
		  AND (pptotipo_comprobante.tipo = 'I' or pptotipo_comprobante.tipo = 'D') AND pptocomprobante_det.cuenta = '".$pctas[$x]."' 
