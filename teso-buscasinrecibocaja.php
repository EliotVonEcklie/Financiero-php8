...
?>
<form name="form2" method="post" action="teso-buscasinrecibocaja.php">
   	<input type="hidden" name="numres" id="numres" value="<?php echo $_POST[numres];?>"/>
   	<input type="hidden" name="numpos" id="numpos" value="<?php echo $_POST[numpos];?>"/>
   	<input type="hidden" name="nummul" id="nummul" value="<?php echo $_POST[nummul];?>"/>
	<table  class="inicio" align="center" >
    	<tr >
        	<td class="titulos" colspan="2">:. Buscar Ingresos Propios</td>
        	<td style="width:7%" class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
      	</tr>
      	<tr >
         	<td style="width:3.5cm" class="saludo1">Numero o Concepto Liquidacion: </td>
    		<td style="width:75%" >
            	<input name="nombre" type="text" value="" style="width:70%" >
    ...
    <div class="subpantallap" style="height:68.5%; width:99.6%; overflow-x:hidden;" id="divdet">
		...
		$crit1="";
		if ($_POST[nombre]!="")
			$crit1=" and tesosinreciboscaja.id_recibos like '%".$_POST[nombre]."%' ";
		$sqlr="select *from tesosinreciboscaja where tesosinreciboscaja.estado<>'' ".$crit1." order by tesosinreciboscaja.id_recibos DESC";
		$resp = mysql_query($sqlr,$linkbd);
		...
		$sqlr="select *from tesosinreciboscaja where tesosinreciboscaja.estado<>'' ".$crit1." order by tesosinreciboscaja.id_recibos DESC ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);
		$con=1;
