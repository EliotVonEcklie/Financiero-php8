<?php //V 1001 14/12/16 Nota: se modifico para guardar un tercero con *-_?> 
<?php
	require"comun.inc";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function validar(formulario){document.form2.action="teso-terceros.php";document.form2.submit();}
			...
			function funcionmensaje(){document.location.href = "teso-terceros.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><a onClick="location.href='teso-terceros.php'" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" /></a><a onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  title="Guardar" /></a><a onClick="location.href='teso-buscaterceros.php'"  class="mgbt"><img src="imagenes/busca.png"  title="Buscar" /></a><a onClick="<?php echo paginasnuevas("teso");?>" class="mgbt"><img src="imagenes/nv.png" title="nueva ventana"></a></td>
          	</tr>
     	</table>
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="">
			...
			?>
            <script type="text/javascript">$('#apellido1,#apellido2,#nombre1,#nombre2').alphanum({allow: '*-_'});</script>
            <script type="text/javascript">$('#razonsocial').alphanum({allow: '&*-_'});</script>
