...
$crit2=" ";
if ($_POST[nombre]!="")
$crit1=" and (tesoingresossf_cab.nombre like '%".$_POST[nombre]."%' ) ";
if ($_POST[documento]!="")
$crit2=" and tesoingresossf_cab.codigo like '%$_POST[documento]%' ";
//sacar el consecutivo 
$sqlr="select *from tesoingresossf_cab where tesoingresossf_cab.estado='S'".$crit1.$crit2."  order by tesoingresossf_cab.codigo";
