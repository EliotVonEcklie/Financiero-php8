...
//   $niv=$_SESSION["nivel"];
  ...
  echo "Quepaso".$sqlr;
    ...
    {
	 $_SESSION[linkset][$roww[2]].='<li> <a onClick="location.href=\''.$roww[1].'\'" style="cursor:pointer;">'.$roww[0].' <span style="float:right">'.$roww[3].'</span></a></li>';
	}  
 }
}
else
