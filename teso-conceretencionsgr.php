...
function validar3(formulario)
			...
			{
				document.location.href = "teso-conceretencionsgr.php";
			}
</script>
<?php titlepag();?>
</head>
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a href="teso-conceretencionsgr.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
			<a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  title="Guardar" /></a>
			<a href="teso-buscaconceretencionsgr.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
...
if(!$_POST[oculto])
{
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(RIGHT(codigo,2)) from conceptoscontables where modulo=4 and tipo='SR' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8">.: Concepto Contable Retencion SGR</td>
      ...
      <tr  >
		<td width="119" class="saludo1">Codigo:</td>
		 ...
		 <td width="119" class="saludo1">Nombre:</td>
		  ...
		  <td class="saludo1">Tipo:</td><td><input name="tipo" value="Anticipo" size="10" type="text" readonly>
		  <input name="tipoc" value="SR" size="10" type="hidden">
	...
	if($_POST[oculto]=='2')	
		...
		for($x=0;$x<count($_POST[dcuentas]);$x++) 
         ...
         if($error == 0)
            {
                echo "<script>despliegamodalm('visible','1','Se ha almacenado la retencion con Exito');</script>";
            }
		 }	
	   }
	?>	
