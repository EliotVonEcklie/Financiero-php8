...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, grupo){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="acti-editaractivo.php?idproceso="+grupo+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&clase="+idcta;
			}
		</script>
		<script>
			...
			function funcionmensaje(){document.location.href = "acti-creacionactivos.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
	  				<a href="acti-creacionactivos.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a>
		...
		?>
 		<form name="form2" method="post" action="acti-buscaactivo.php">
        	<?php 
				if($_POST[oculto]=="")
				{
					$_POST[cambioestado]="";
			...
			<?php 
				...
				//if($_POST[oculto])
				{
					...
					$sqlr="SELECT * FROM acti_activos_det WHERE estado='S'";
					...
					$sqlr="SELECT * FROM acti_activos_cab WHERE estado='S'";
					$resp = mysql_query($sqlr,$linkbd);
					...
					<table class='inicio' align='center' width='100%'>
						...
						<tr>
							...
							<td class='titulos2'>cuenta_activo</td>
							<td class='titulos2'>cuenta_perdida</td>
							<td class='titulos2'>cuenta_recuperacion</td>
							<td class='titulos2'>cuenta_retiro</td>
							<td class='titulos2'>disposicion_activos</td>
							<td class='titulos2'>centro_costos</td>
					...
					while ($row =mysql_fetch_row($resp)) 
					{
						...
						$sqlr2="SELECT * FROM acti_activos_det WHERE id_cab=$row[0] AND estado='S'";
						//echo $sqlr2;
						...
						if($row2[10]=='S'){$imgsem="src='imagenes/sema_verdeON.jpg' title='Activo'";$coloracti="#0F0";$_POST[lswitch1][$posid1]=0;}
						...
						echo"<tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\"
								onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"verUltimaPos($idcta, $numfil, $row2[0])\" style='text-transform:uppercase; $estilo' >
								<td rowspan='$ntr2' id='$nomnum'>$row[0]</td>
