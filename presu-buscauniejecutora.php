...
<html xmlns="http://www.w3.org/1999/xhtml" xml: lang="es">
        ...
        <script>
			function verUltimaPos(idcta,filas,filtro)
			{
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="presu-editaruniejecutora.php?idtipocom="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
        <script>
    ...
    <body>
        ...
        <table>
			...
			<tr>
            	<?php 
					...
					{$botonnuevo="<a onClick=\"location.href='presu-uniejecutora.php'\" class='mgbt'><img src='imagenes/add.png' title='Nuevo' /></a>";}
					else
		...
		?>
        <form name="form2" method="post" action="presu-buscauniejecutora.php">
        	<?php
				if($_POST[oculto2]=="")
                {
                    $_POST[oculto2]="0";
