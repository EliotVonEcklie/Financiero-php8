...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
        	function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta informacion para Crear la Clase');}
	 		}
			...
			function funcionmensaje(){document.location.href = "acti-clase.php";}
	...
	<body>
        ...
        <div id="bgventanamodalm" class="bgventanamodalm">
  		...
  		<form name="form2" method="post" action="acti-clase.php">
            <table class="inicio" align="center">
                <tr>
                    <td class="titulos" colspan="6">.: Agregar Clase</td>
                ...
                <tr>
                    ...
                    <td class="saludo1" style="width:15%;">.: Nombre de la Clase:</td>
            ...
            <input type="hidden" name="valfocus" id="valfocus" value="1"/> 
  			<?php
				...
				if($_POST[oculto]=="2")
				{
					$sqlr="INSERT INTO acti_clase (id,nombre,estado,entidad)VALUES ('$_POST[codigo]','$_POST[nombre]','$_POST[estado]', '$_POST[tipo]')";
