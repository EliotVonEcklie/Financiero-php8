...
while ($rowg =mysql_fetch_row($respg)){
	...
	$detalles="Relación de Descuentos de Nómina para el periodo laborado $vmes del $rowg[2]";
	...
	$pdf->Cell(50.1);
	$pdf->Cell(149,20,'DESCUENTOS DE NOMINA',0,0,'C'); 
//************************************
