...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function ponprefijo(codigo,nombre,archivo,valor,desc)
			{ 
				parent.document.form2.codproyecto.value = codigo ;	
				parent.document.form2.nproyecto.value =nombre;
				parent.document.form2.nomarchadj.value =archivo;
				parent.document.form2.valorproyecto.value =valor;
				parent.document.form2.descripcion.value =desc;
			...
			<?php
 				//if ($_POST[oculto]=='2')
				{
					...
					while($r=mysql_fetch_row($resp))
  					{
						echo"
						<tr class='$co' onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\"onMouseOut=\"this.style.backgroundColor=anterior\" onClick=\"ponprefijo('$r[1]','$r[3]','$r[4]','$r[6]','$r[7]')\" style='text-transform:uppercase'>
							<td>$r[1]</td>
							<td>$r[3]</td>
							<td>$r[2]</td>
						</tr>";
