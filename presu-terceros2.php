...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<form action="presu-terceros2.php" method="post" enctype="multipart/form-data" name="form2">
	<?php
		$_POST[tabgroup1]=1;
					...
					echo "<table class='inicio'>
						...
						if($_POST[oculto]==2)
						{
							...
							if($archivo)
							{
								...
								$sqlr1="delete from pptosidefterceros";
								...
								{ 	
									...
									if($datos[0]!='' && $datos[0]!='Codigo')
									{
										...
										//echo $datos[0]; echo " "; echo $dato; echo "<br>"; echo "<br>";									 			
										$consulta = "INSERT INTO pptosidefterceros (codigo, nombre, estado) VALUES ('".trim($datos[0])."','".$dato."','S')";
							...
							$sql="select * from pptosidefterceros order by codigo";
