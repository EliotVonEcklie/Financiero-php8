...
<table  class="inicio" align="center" >
      ...
      <select name="rp" id="rp" onChange="validar()" >
				 ...
				 <?php
				 $sqlr="Select humnom_rp.consvigencia, pptorp.valor, pptorp.idcdp  from humnom_rp inner join pptorp on humnom_rp.consvigencia=pptorp.consvigencia  where humnom_rp.estado='S' and humnom_rp.vigencia='".$_SESSION[vigencia]."'";
...
//*************************************		 
	 $sqlr="insert into humnomina_det (`id_nom`, `cedulanit`, `salbas`, `diaslab`, `devendias`, `ibc`, `auxalim`, `auxtran`, `valhorex`, `totaldev`, `salud`, `saludemp`, `pension`, `pensionemp`, `fondosolid`, `retefte`, `otrasdeduc`, `totaldeduc`, `netopagar`, `estado`) values ($id,'".$_POST[ccemp][$x]."',".$_POST[salbas][$x].",".$_POST[diast][$x].",".$_POST[devengado][$x].",".$_POST[ibc][$x].",".$_POST[ealim][$x].",".$_POST[etrans][$x].",0,".$_POST[totaldev][$x].",".$_POST[saludrete][$x].",".$_POST[saludemprete][$x].",".$_POST[pensionrete][$x].",".$_POST[pensionemprete][$x].",".$_POST[fondosols][$x].",0,".$_POST[otrasretenciones][$x].",".$_POST[totalrete][$x].",".$_POST[netopago][$x].",'S')";
	  if (!mysql_query($sqlr,$linkbd))
		...
		$ctacont='';
		$ctapres='';
		$sqlrins="insert into  humnomina_saludpension (id_nom, tipo, empleado, tercero, cc, valor, estado) values($id,'SE',".$_POST[ccemp][$x].",'$eps',".$_POST[centrocosto][$x].",".$_POST[saludrete][$x].",'S')";
					 ...
					 if('S'==$rowh[4])
					  {
						...
						mysql_query($sqlr,$linkbd);	
												//***nomina parafiscales
						$sqlr="insert into humnomina_parafiscales (id_nom, id_parafiscal, porcentaje, valor, cc,estado) values ($id,'01',$rowh[13],$debito,'$rowcc[0]','S')";			
						mysql_query($sqlr,$linkbd);											
				   }
				}
		   }
					 ...
					 if('S'==$rowh[4])
					  {
						...
						mysql_query($sqlr,$linkbd);	
												//***nomina parafiscales
						$sqlr="insert into humnomina_parafiscales (id_nom, id_parafiscal, porcentaje, valor, cc,estado) values ($id,'02',$rowh[13],$debito,'$rowcc[0]','S')";			
						mysql_query($sqlr,$linkbd);											
				   }
				}
		   }
					 ...
					 if('S'==$rowh[4])
					  {
						...
						mysql_query($sqlr,$linkbd);		
						//***nomina parafiscales
						$sqlr="insert into humnomina_parafiscales (id_nom, id_parafiscal, porcentaje, valor, cc, estado) values ($id,'03',$rowh[13],$debito,'$rowcc[0]', 'S')";			
						mysql_query($sqlr,$linkbd);																
				   }
				}
		   }
					 ...
					 if('S'==$rowh[4])
					  {
						...
						mysql_query($sqlr,$linkbd);		
												//***nomina parafiscales
						$sqlr="insert into humnomina_parafiscales (id_nom, id_parafiscal, porcentaje, valor, cc, estado) values ($id,'04',$rowh[13],$debito,'$rowcc[0]', 'S')";			
						mysql_query($sqlr,$linkbd);										
				   }
				}
		   }
					 ...
					 if('S'==$rowh[4])
					  {
						...
						mysql_query($sqlr,$linkbd);	
						//***nomina parafiscales
						$sqlr="insert into humnomina_parafiscales (id_nom, id_parafiscal, porcentaje, valor, cc,estado) values ($id,'05',$rowh[13],$debito,'$rowcc[0]','S')";			
						mysql_query($sqlr,$linkbd);								
				   }
				}
		   }
					 ...
					 if('S'==$rowh[4])
					  {
						...
						//***nomina parafiscales
						$sqlr="insert into humnomina_parafiscales (id_nom, id_parafiscal, porcentaje, valor, cc,estado) values ($id,'06',$rowh[13],$debito,'$rowcc[0]','S')";			
						mysql_query($sqlr,$linkbd);								
					  }		
				   }
				}
