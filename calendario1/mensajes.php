...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
        ...
        <script type='text/javascript'>
			...
			function guardar()
			{
				/*alert("evento="+document.getElementById('evento').value+" prioridad="+document.getElementById('prioevento').value+" frecuancia="+document.getElementById('frecuenciah').value+" descripcion="+document.getElementById('desevento').value);*/
				if((document.getElementById('evento').value!="")&&(document.getElementById('prioevento').value!="")&&(document.getElementById('frecuenciah').value!="")&&(document.getElementById('desevento').value!=""))
				{
	...
	<body id="cuerpomensaje" class="cuerpomensaje">
        ...
        <form name ="client" id="client" method="POST" >
        	...
        	<table  class="inicio">
            	<tr>
                	<td colspan="5" class="titulos" style="width:85%;" >:.Ingresar Evento en la Agenda </td>
                    	...
                    	<select id="frecuenciah" name="frecuenciah" onKeyUp="return tabular(event,this)" style="width:90%">
                            <?php
								...
								for($ii=0;$ii<12;$ii++)
								{
									...
									else{$min="00";echo'<option value="'.$horr.':'.$min.'">'.$horr.':'.$min.'</option>';}
            ...
            <input type="hidden" name="id" id="id" value="">
                ...
                <?php
					...
					$sqlr = "INSERT INTO agenda (usremitente, usrecibe, fechaevento, horainicial, horafinal, evento, descripcion,prioridad, tiempoalerta,frecuencia,fechaverificacion,estado) VALUES ('$_SESSION[cedulausu]','$_SESSION[cedulausu]','$_POST[fecha]', '$_POST[horainicial]','$_POST[horafinasl]','$_POST[evento]','$_POST[desevento]','$_POST[prioevento]','$talerta','$_POST[frecuenciah]','','A')";
