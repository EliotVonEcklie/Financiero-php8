					...
					if($_POST[bt]=='1')
					{
 					...
 					?>
	   				<table class="inicio" align="center" >
						<tr>
							<td colspan="6" class="titulos">Declaracion Ingresos</td><td width="68" class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
						</tr>
						<tr>
        					...
        					<td><input name="vigencia" type="text" value="<?php echo $_POST[vigencia]?>" maxlength="2" size="5" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" readonly> </td>
						</tr>
						<tr>
          				...
          				<tr>                
          	  				<td class="saludo1">Valor a Pagar:</td><td><input name="valorpagar" type="text" id="valorpagar" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[valorpagar]?>" size="20" readonly></td>	
								...
								if(substr($_POST[ddescuentos][$x],0,1)=='I')
		  						{
									...
									while ($row =mysql_fetch_row($res)) 
									{
		 								$sqlr="select *from  tesoingresos_det where codigo='$row[0]' and vigencia='$_POST[vigencia]'";
										$res2=mysql_query($sqlr,$linkbd);	
										//echo "$row[0] - ".$sqlr;
										while($row2 =mysql_fetch_row($res2))
										{
