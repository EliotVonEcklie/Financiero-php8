...
<head>
	...
	<script>
		...
		function funcionmensaje(){
			document.location.href = "acti-correcdeterioro.php";
		}
...
/*           	$sqlr="SELECT * FROM acticrearact ORDER BY codigo DESC";
		...
		<table class="inicio" align="center"  >
			<tr>
				<td class="titulos" colspan="10">.: Gestion de Activos - Correcci&oacute;n por Deterioro</td>
    ...
    <table class="inicio">
		<tr>
			<td colspan="12" class="titulos2">Correcci&oacute;n por Deterioro:</td>
		</tr>
    	<tr>
    		...
    		<td style="width:5%">
				<input type="text" id="cpor" name="cpor" onKeyUp="return tabular(event,this)" style="width:90%; text-align:center;" value="<?php echo $_POST[cpor]?>" maxlength="3" >
			</td>
    		<td class="saludo1" style="width:2%">$</td>
    		<td style="width:10%">
				<input name="cpes" type="text" id="cpes" value="<?php echo $_POST[cpes]?>" style="width:90%; text-align:right;" >
			</td>
