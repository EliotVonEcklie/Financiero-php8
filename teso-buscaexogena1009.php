...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-verexogena1009.php?idexo="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
					<a onClick="location.href='teso-exogena1009.php'" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
					...
					<a onClick="location.href='teso-exogena1009.php'" class="mgbt"><img src="imagenes/iratras.png" title="Retornar"></a>
				</td>
         	</tr>
     	</table>	
		...
		?>
 		<form name="form2" method="post" action="teso-buscaexogena1009.php">
        	<?php
        		if($_POST[oculto]=="")
				{
			...
			<table  class="inicio" style="width:99.7%">
                <tr >
                    <td class="titulos" colspan="6">:. Buscar Exogenas 1009 </td>
    		...
    		<div class="subpantallap" style="height:68%; width:99.6%; overflow-x:hidden;" id="divdet">
    			<?php	
					...
					$crit1=" ";
					$crit2=" ";
					if ($_POST[numero]!=""){$crit1=" and exogena_cab_1009.id_exo like '%$_POST[numero]%' ";}
					if ($_POST[nombre]!=""){$crit2=" and exogena_cab_1009.descripcion like '%$_POST[nombre]%'  ";}
					//sacar el consecutivo 
					//$sqlr="select *from pptosideforigen where".$crit1.$crit2." order by pptosideforigen.codigo";
					$sqlr="select *from exogena_cab_1009 where exogena_cab_1009.id_exo>-1 $crit1 $crit2 order by exogena_cab_1009.id_exo DESC";
					...
					$sqlr="select *from exogena_cab_1009 where exogena_cab_1009.id_exo>-1 $crit1 $crit2 order by exogena_cab_1009.id_exo DESC $cond2";
