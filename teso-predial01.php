           				...
           				<table class="inicio" align="center" >
     						...
     						<tr>
	  						...
	  						<tr>
                                ...
                                <td style="width:8%;"><input name="fechaav" type="text" value="<?php echo $_POST[fechaav]?>"  id="fc_1198971545" title="DD/MM/YYYY" style="width:80%;" readonly />&nbsp;<img src="imagenes/calendario04.png" class="icobut" onClick="displayCalendarFor('fc_1198971545');" title="Calendario"/></td> 	
                                <td  class="saludo1">C&oacute;digo Catastral:</td>
          						<td colspan="3">
									...
									<input id="tot" type="text" name="tot"  value="<?php echo $_POST[tot]?>" style="width:18%;" readonly>&nbsp;<img src="imagenes/find02.png" style="width:20px;" class="icobut" title="Listado de Predios" onClick="despliegamodal2('visible');"/>
                             	</td>
