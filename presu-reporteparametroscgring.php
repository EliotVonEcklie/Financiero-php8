...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
        ...
        <table>
 		...
 		<form name="form2" method="post" action="presu-reporteparametroscgring.php">
			<table width="100%" align="center"  class="inicio" >
                <tr>
                    <td class="titulos" colspan="9">:: Buscar .: Consulta la parametrizacion de CGR - Ingresos</td>
            ...
            <input type="hidden" name="iddesh" id="iddesh" value="<?php echo $_POST[iddesh];?>"/>
          	...
          	<div  class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;"> 
						...
						<?php
                            $sqlr="SELECT cuenta,sidefclas,sidefrecur,sideforigen,sidefdest,sideftercero FROM pptocuentas WHERE estado='S' and (tipo='Auxiliar' || tipo='auxiliar') AND clasificacion='ingresos' $crit1 $crit2  ORDER BY cuenta DESC";
                            ...
                            <table class='inicio' align='center' style='overflow-x:hidden;'>
                                ...
                                <tr>
                                    ...
                                    <td class='titulos2' >Codigo CGR</td>
