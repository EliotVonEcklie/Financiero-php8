			...
			<div class="subpantalla" style="height:83.5%; width:99%; overflow-x:hidden;">
				<?php
					...
					while ($row =mysql_fetch_row($resp)) 
					{
						...
						$ntercero=iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$ntercero);
						echo "
						<tr class='$iter' onClick=\"javascript:ponprefijo('$row[12]','$ntercero','$_POST[tobjeto]','$_POST[tnobjeto]', '$_POST[tnfoco]')\">
							<td>$con2</td>
							<td>".strtoupper(iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$row[5]))."</td>
							<td>".strtoupper(iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$row[3]))."</td>
							<td>".strtoupper(iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$row[4]))."</td>
							<td>".strtoupper(iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$row[1]))."</td>
							<td>".strtoupper(iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$row[2]))."</td>
							<td>$row[12]</td>
						</tr>";
						$con+=1;
						$aux=$iter;
