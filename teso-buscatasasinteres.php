		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editatasasinteres.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<script>
//************* ver reporte ************
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			<a href="teso-tasasinteres.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
		...
		?>
 <form name="form2" method="post" action="teso-buscatasasinteres.php">
...
$crit1=" ";
if ($_POST[nombre]!="")
	$crit1=" where tesotasainteres.vigencia like '%".$_POST[nombre]."%' ";

	$sqlr="select *from tesotasainteres".$crit1." order by tesotasainteres.vigencia";
	...
	$ntr = mysql_num_rows($resp);
					...
					$sqlr="SELECT * from tesotasainteres".$crit1." order by tesotasainteres.vigencia desc $cond2 ";
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
...
echo "<table class='inicio' align='center' width='80%'>
	...
	<tr>
		<td colspan='3'>Tasas de Interes Encontrados: $ntr</td>
	</tr>
	<tr>
