...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="presu-trasladosver.php?idac="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg;
			}
    ...
    <body>
            ...
            <tr><?php menu_desplegable("presu");?></tr>
       		<tr>
          		<td colspan="3" class="cinta">
					<a href="presu-traslados.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
		...
		?>
		<form name="form2" method="post" action="presu-buscartraslados.php">
            <input type="hidden" name="numres" id="numres" value="<?php echo $_POST[numres];?>"/>
            <input type="hidden" name="numpos" id="numpos" value="<?php echo $_POST[numpos];?>"/>
            <input type="hidden" name="nummul" id="nummul" value="<?php echo $_POST[nummul];?>"/>
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="6">:: Buscar  Traslados Presupuestal</td>
      ...
      <td class="saludo1">Consecutivo:</td>
        ...
        <td><input name="acto" type="text" id="acto" value="" size="40" maxlength="40">
			<input name="oculto" type="hidden" value="1" id="oculto">
	...
	<div class="subpantalla" style="height:64.5%; width:99.6%; overflow-x:hidden;" id="divdet">
		...
		$sqlr="select *from pptoacuerdos where (pptoacuerdos.valortraslado>0) and pptoacuerdos.tipo='M'".$crit1.$crit2.$crit3." ORDER BY vigencia DESC, consecutivo";
		...
		$sqlr="select *from pptoacuerdos where (pptoacuerdos.valortraslado>0) and pptoacuerdos.tipo='M'".$crit1.$crit2.$crit3." ORDER BY vigencia DESC, consecutivo $cond2";
		$resp = mysql_query($sqlr,$linkbd);
		...
		while ($row =mysql_fetch_row($resp)) 
		{
			...
			onMouseOut=\"this.style.backgroundColor=anterior\" $dblclic style='text-transform:uppercase; $estilo' >
				...
				if($row[9]=='S')
				{
					...
					echo"<td>
						<center><img src='imagenes/candado.png' style='width:18px'></center>
					</td>";
				}
				echo"<td>
