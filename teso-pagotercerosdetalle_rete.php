		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
					<a href="teso-pagotercerosdetalle_rete.php" class="mgbt"><img src="imagenes/add.png" alt="Nuevo"  title="Nuevo" border="0" /></a>
					...
					$meses=array('','Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre');
 					...
 					?>
	   				<table class="inicio" align="center" >
						...
						<tr>
							<td colspan="6" class="titulos">Declaracion Retenciones</td>
							<td width="68" class="cerrar" >
						...
						<tr>
							...
							<td>
							<input id="tercero" type="text" name="tercero" size="10" onKeyUp="return tabular(event,this)" onBlur="buscater(event)" value="<?php echo $_POST[tercero]?>" ><a href="#" onClick="mypop=window.open('terceros-ventana.php','','menubar=0,scrollbars=yes, toolbar=no, location=no, width=900,height=500px');mypop.focus();"><img src="imagenes/buscarep.png" align="absmiddle" border="0"></a>           <input name="ntercero" type="text" value="<?php echo $_POST[ntercero]?>" size="70" readonly><input type="hidden" value="0" name="bt">
							</td>    
						</tr>
						<tr>                
							<td class="saludo1">Valor a Pagar:</td>
							<td>
								<input name="valorpagar" type="text" id="valorpagar" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[valorpagar]?>" size="20" readonly>
							</td>	
								...
								if(substr($_POST[ddescuentos][$x],0,1)=='R')
		  						{
									...
									else
									{
										...
										while($row = mysql_fetch_row($res))
										{
											...
											$sqlr="select *from tesoretenciones, tesoretenciones_det  where tesoretenciones_det.codigo='$row[0]' AND tesoretenciones.id=tesoretenciones_det.codigo $crit";
											$rowRete = view($sqlr);
											for($xx = 0; $xx<count($rowRete); $xx++)
											{
