...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function pdf()
			{
				document.form2.action="inve-donacionentradapdf.php";
	...
	<body>
		...
		<table>
    		...
    		<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='inve-donacionentrada.php'" class="mgbt"/><img src="imagenes/guardad.png" title="Guardar" onClick="guardar();" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='inve-donacionentradabuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("inve");?>" class="mgbt"><img src="imagenes/print.png" title="Imprimir" onClick="pdf()" class="mgbt"/><img src="imagenes/iratras.png" title="Atr&aacute;s"  onClick="location.href='inve-donacionentradabuscar.php'" class="mgbt"></td>
			</tr>
         </table>
 		...
 		<form name="form2" method="post" action="inve-donacionentradaedita.php">
        	<input type="hidden" name="valfocus" id="valfocus" value="0"/>
        	<?php
				if ($_POST[oculto]=="" && $_GET[codi]!="")
				{
					$sqlr="SELECT * FROM almactodonacionesent WHERE id='$_GET[codi]'";
					...
					$sqlr="SELECT id,documento,nombre,cargo FROM almactodonacionesentpartici WHERE idacto='$_GET[codi]' AND estado='S'";
					$resp = mysql_query($sqlr,$linkbd);
					...
					$sqlr="SELECT id,descripcion,unumedida,cantidad,valor,estadou FROM almactodonacionesentarticu WHERE idacto='$_GET[codi]' AND estado='S'";
					$resp = mysql_query($sqlr,$linkbd);
					while ($row =mysql_fetch_row($resp))
					{
			...
			<table class="inicio" align="center" >
				...
				<tr>
					...
					<td class="saludo1" style="width:10%;"  >.: Donante:</td>
                ...
                <tr>
					...
					<td colspan="3">
					<select name='centrocosto' id='centrocosto'  onKeyUp='return tabular(event,this)' style='width:86%;' onChange='validar();'>
			...
			<input type='hidden' name='bt' id='bt' value=""/>
			  <?php
				if($_POST[oculto]=="2")
				{
					...
					$sqlr ="UPDATE almactodonacionesent SET fecha='$fechaf',docdonante='$_POST[tercero]',nomdonante='$_POST[ntercero]', valortotal='$_POST[valort]',ciudad='$_POST[ciudad]',lugarfisico='$_POST[lugarfi]',motivo='$_POST[motivo]',otrosdetalles='$_POST[otdetalles]',cc='$_POST[centrocosto]' WHERE id='$_POST[codigo]'";
					...
					else 
					{
						...
						if($_POST[partielimina]!="")
						{
							...
							{
								$sqlr ="UPDATE almactodonacionesentpartici SET estado='N' WHERE id='$nuparti[$x]'";
						...
						for ($x=0;$x<$contx;$x++)
						{
							if($_POST[agcodigoart][$x]=="N")
							{
								...
								$sqlr="INSERT INTO almactodonacionesentarticu (id,idacto,descripcion,unumedida,cantidad,valor,estadou,estado) VALUES ('$consa','$_POST[codigo]','".$_POST[agdescripcion][$x]."','".$_POST[agunimedida][$x]."','".$_POST[agcantidad][$x]."','".$_POST[agvalor][$x]."','".$_POST[agestado][$x]."','S')";
								if (!mysql_query($sqlr,$linkbd)){$cont2=$cont2+1;}
							}
						}
						if($_POST[articelimina]!="")
						{
							...
							{
								$sqlr ="UPDATE almactodonacionesentarticu SET estado='N' WHERE id='$nuarti[$x]'";
								if (!mysql_query($sqlr,$linkbd)){$cont2=$cont2+1;}
							}
						}
						...
						else {echo"<script>despliegamodalm('visible','1','Donacion N° $_POST[codigo] editada con Exito');</script>";}
					}
				}
			?>
