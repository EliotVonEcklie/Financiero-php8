...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function validar(formulario){document.form2.action="cont-terceros.php";document.form2.submit();}
			...
			function funcionmensaje(){document.location.href = "cont-terceros.php";}
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
					<a onClick="location.href='cont-terceros.php'" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" /></a>
    		...
    		<table class="inicio" align="center" width="80%" >
                <tr>
		   		...
		   		<tr>
        			...
        			<td>
						<input type="text" name="documento" id="documento" value="<?php echo $_POST[documento]?>" onBlur="buscater(event)"  onKeyUp="return tabular(event,this)" style="width:35%;"/>&nbsp;-&nbsp;<input type="text" name="codver" id="codver" value="<?php echo $_POST[codver]?>" style="width:6%;" readonly/>
						<?php 
						if($_POST[idEntidad] != '')
						{
						?>
							<label for="idEntidad">Reciproca:</label>
							<input type="text" id="idEntidad" name="idEntidad" value="<?php echo $_POST[idEntidad] ?>" readonly>
						<?php
						}
						?>
					</td>
