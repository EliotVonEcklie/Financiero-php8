    ...
    <body>
        ...
        <table>
        	...
        	<tr>
				...
				<a href="#" onClick="mypop=window.open('ccp-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a></td>
        	</tr>
        </table>
						...
						<table>
							<tr>
								<td style="width:50%;">
									...
									<li><a href='ccp-cuentasactiva.php'>Plan de Cuentas de Ingresos</a></li>
									<li><a href='ccp-cuentaspasiva.php'>Plan de Cuentas de Gastos</a></li>
								</td>
