...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="ccp-trasladosver.php?idac="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg;
			}
    ...
    <body>
		...
		?>
		<form name="form2" method="post" action="ccp-buscartraslados.php">
