...
EOD;
	...
	$infoinicio="En la ciudad de $_POST[ciudad] a los $fechaen[0] días del mes de $mesen del $fechaen[2] en el $_POST[lugarfi], se procede a la entrega física de los bienes donados efectuada por $_POST[ntercero].";
	...
	$pdf->Cell(30,4,"Articulos Donados:",0,1,'L',false,0,0,false,'T','C');
	...
	$pdf->ln(2);
	$pdf->SetFont('helvetica','',12);
	$infoadicional="Al respecto, se hace entrega en fotocopia de la documentación sustentatoria presentada; sobre la leagalidad de los bienes donados, para su registro respectivo.";
