...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			{
				document.form2.action="teso-concecondonacion.php";
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><a href="inve-concecondonacion.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a><a href="inve-buscaconcecondonacion.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a href="inve-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Buscar" /></a></td>
			</tr>
   		</table>
        ...
        <form name="form2" method="post" action=""> 
    		...
    		<table class="inicio" align="center">
      			<tr>
        			<td class="titulos" colspan="8">.: Concepto Contable Entrada por Donacion</td>
