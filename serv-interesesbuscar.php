...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="serv-intereseseditar.php?idban="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
			...
			function cambioswitch(id,valor)
			{
				...
				if(valor==1){despliegamodalm('visible','4','Desea activar este interes','1');}
				else{despliegamodalm('visible','4','Desea desactivar este interes','2');}
			}
		</script>
		<?php 
			titlepag();
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='serv-intereses.php'" class="mgbt"/><img src="imagenes/guardad.png" class="mgbt1"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='serv-interesesbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="<?php echo paginasnuevas("serv");?>" class="mgbt"></td>
			</tr>
		</table>
		<?php
			if(@ $_POST['oculto']=="")
		...
		<form name="form2" method="post" action="">
			...
			<?php
				if(@ $_POST['cambioestado']!="")
				{
					...
					{
						$sqlr="UPDATE srvintereses SET estado='S' WHERE id='".$_POST['idestado']."'";
						mysqli_query($linkbd,$sqlr);
					}
					else
					{
						$sqlr="UPDATE srvintereses SET estado='N' WHERE id='".$_POST['idestado']."'";
						mysqli_query($linkbd,$sqlr);
					}
			...
			<table class="inicio">
				<tr>
					<td class="titulos" colspan="4">:: Buscar Intereses</td>
