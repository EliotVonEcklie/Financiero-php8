                ...
                "render": function(data, type, row, meta) {
                    if (row['estado'] == 'S')
                        return `<div class="btn-group" role="group">
									<a href="ccp-acuerdos.php?type=edit&id=` + data + `&type_act=` + row['tipo_acto_adm'] + `&date=` + row[
                        ...
                        return `<div class="btn-group" role="group">
									<a href="ccp-acuerdos.php?type=view&id=` + data + `&type_act=` + row['tipo_acto_adm'] + `&date=` + row[
                            'vigencia'] + `" target="_self">
