...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function crearexcel()
			{
				document.form2.action="presu-auxiliarcpexcel.php";
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
				...
				<a href="#" onclick="crearexcel()" class="mgbt"><img src="imagenes/excel.png" title="Excell"></a><a href="presu-librosppto.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
        	</tr>	
        </table>
        <?php
		...
		?>
 		<form name="form2" method="post" action="presu-rptcp.php">
