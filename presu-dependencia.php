...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			{
				document.form2.action="formatos/FMT_CODIGOS_CGR.csv";
				document.form2.target="_BLANK";
				document.form2.submit(); 
				document.form2.action="";
				document.form2.target="";
	...
	<form action="presu-dependencia.php" method="post" enctype="multipart/form-data" name="form2">
	<?php
		$_POST[tabgroup1]=1;
				...
				<table  align="center" class="inicio" >
					...
					echo "<table class='inicio'>
						<tr>
							...
							<td class='titulos2' style='width:15%;'>Estado</td>
						</tr>";
						$iter='saludo1a';
						$iter2='saludo2';
						...
						if($_POST[oculto]==2)
						{
							...
							if($archivo)
							{
								...
								$sqlr1="delete from pptosidefdependencia";
								...
								{ 
									...
									if($datos[0]!='' && $datos[0]!='Codigo')
									{
										...
										$consulta = "INSERT INTO pptosidefdependencia (codigo, nombre, estado) VALUES ('".trim($datos[0])."','".$dato."','S')";
							...
							$sql="select * from pptosidefdependencia order by codigo";
