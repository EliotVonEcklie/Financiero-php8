			...
			<table class="inicio">
				<tr>
					...
					<td style="background-repeat:no-repeat; background-position:center;">
						<ol id="lista2">
							<li onClick="location.href='ccp-rptdisponibilidad.php'" style="cursor:pointer;">Auxiliar Disponibilidades</li>
							<li onClick="location.href='ccp-rptregistros.php'" style="cursor:pointer;">Auxiliar Registros</li>	
							<li onClick="location.href='ccp-rptcp.php'" style="cursor:pointer;">Auxiliar Cuentas por Pagar</li>
