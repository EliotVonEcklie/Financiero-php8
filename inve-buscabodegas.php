...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="inve-editarbodegas.php?idtipocom="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<script>
			function cambioswitch(id,valor)
			{
				...
				if(valor==1){despliegamodalm('visible','4','Desea Activar esta Bodega','1');}
				else{despliegamodalm('visible','4','Desea Desactivar esta Bodega','2');}
			}
	...
	<body>
        ...
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="inve-buscabodegas.php">
            ...
            <?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					{
						$sqlr ="UPDATE almbodegas SET estado='S' WHERE id_cc='$_POST[idestado]'";
						mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
						$sqlr ="UPDATE almbodegas SET estado='N' WHERE id_cc='$_POST[idestado]'";
						mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
			...
			<table  class="inicio" align="center" >
      			<tr>
        			<td class="titulos" colspan="4">:: Buscar Bodegas</td>
       		...
       		<div class="subpantalla" style="height:69.5%; width:99.6%; overflow-x:hidden;" id="divdet">
				<?php
                    $crit1=" ";
                    $crit2=" ";
                    if ($_POST[nombre]!=""){$crit1="WHERE concat_ws(' ', nombre, id_cc) LIKE '%$_POST[nombre]%'";}
                    $sqlr="SELECT * FROM almbodegas $crit1";
					...
					$sqlr="SELECT * FROM almbodegas $crit1 ORDER BY id_cc $cond2";
                    $resp = mysql_query($sqlr,$linkbd);
                    $con=1;
                    ...
                    <table class='inicio' align='center' width='80%'>
                        ...
                        <tr><td colspan='5'>Bodegas Encontrados: $_POST[numtop]</td></tr>
                        <tr>
