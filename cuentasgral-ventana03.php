  		...
  		<form action="" method="post" name="form2">
    		...
    		<div class="subpantalla" style="height:78.5%; width:99.6%; overflow-x:hidden;">
      		<?php
				...
				$sqlr="SELECT DISTINCT * FROM pptocuentas WHERE estado='S' $crit1 AND cuenta NOT LIKE '1%'";
				$resp = mysql_query($sqlr,$linkbd);
				$_POST[numtop]=mysql_num_rows($resp);
				$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
				$cond2="";
				if ($_POST[numres]!="-1"){$cond2="LIMIT $_POST[numpos], $_POST[numres]";}
				$sqlr="SELECT DISTINCT * FROM pptocuentas WHERE estado='S' $crit1 AND cuenta NOT LIKE '1%' ORDER BY cuenta $cond2";
				$resp = mysql_query($sqlr,$linkbd);
				$co='saludo1a';
				$co2='saludo2';	
				$i=1;
				...
				<table class='inicio'>
					...
					{	
						...
						<td>$r[1]</td>
						<td>$r[2]</td>
						<td style='text-align:center;'>$r[3]</td></tr>";
						 $aux=$co;
						 $co=$co2;
						 $co2=$aux;
						 $i=1+$i;
