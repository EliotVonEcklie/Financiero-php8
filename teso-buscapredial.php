		...
		<table>
			...
			<tr>
		  		<td colspan="3" class="cinta">
					<a><img src="imagenes/add.png" onClick="location.href='teso-predial.php'" class="mgbt" title="Nuevo"/></a>
					...
					<a><img src="imagenes/excel.png" title="Exportar Excel" onclick="crearexcel()" class="mgbt"/></a>
				</td>
       		</tr>	
		</table>
        <?php
