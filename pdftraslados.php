...
{	
	...
	$this->SetY(8);
    $this->Cell(50.1);
    $this->Cell(149,25,''.$_POST[adre],0,0,'C'); 
	//************************************
    $this->SetFont('Arial','B',10);
...
//********************************************************************************************************************************
    ...
    $this->Cell(30,5,'CODIGO ',0,1,'C'); 
		...
		$this->Cell(93,5,'CUENTA',0,1,'C');
			$this->SetY(43);
        	$this->Cell(123.1);
			$this->Cell(38,5,'CREDITO',0,1,'C');
			$this->SetY(43);
        	$this->Cell(161.1);
			$this->Cell(38,5,'CONTRACREDITO',0,1,'C');
...
{	if ($con%2==0)
   ...
   // $pdf->Cell(32,4,substr(''.$_POST[balan][3],0,28),0,0,'L',1);//descrip
    ...
    $pdf->Cell(38,4,''.$_POST[dcreditos][$con],0,0,'R',1);//descrip

  $pdf->Cell(38,4,''.$_POST[dcontras][$con],0,0,'R',1);
	$pdf->ln(4);	
