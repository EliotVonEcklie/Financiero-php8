...
<?php
	...
	class PDF extends FPDF
	{
		...
		{	
			...
			$this->SetY(8);
			$this->Cell(50.1);
			$this->Cell(190,20,'ADQUISICIONES PLAN DE COMPRAS ',0,0,'C'); 
			//************************************
			$this->SetFont('Arial','I',10);
			$this->SetY(27);
			$this->Cell(50.2);
			$this->multiCell(169.8,7,''.strtoupper($_POST[detallegreso]),'T','L');
	   		$this->SetFont('Arial','B',10);
			$this->SetY(27);
			$this->Cell(220.1);
			...
			$this->SetY(27);
			$this->Cell(220);
			$this->Cell(35,5,'NUMERO : '.$_POST[banderin1],10,0,'L');
			$this->SetY(31);
			$this->Cell(220);
			$this->Cell(35,5,'FECHA: '.date("d/m/Y"),0,0,'L');
			$this->SetY(35);
			$this->Cell(220);
			$this->Cell(35,5,'VIGENCIA: '.$_POST[vigenciactual],0,0,'L');
			$this->SetY(27);
			$this->Cell(50.2);
	...
	{	
		...
		$cadena=str_replace("</br>"," ",$_POST[adqprodtodos][$k]);
		$cadena2=explode( '-',$_POST[adqprodtodosg][$k]);
		$pdf->SetY($y+1);
