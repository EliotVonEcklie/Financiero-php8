	...
	<body >
  	<form action="" method="post" name="form2">
		...
		<table  class="inicio" style="width:99.4%;">
      		<tr>
        		<td class="titulos" colspan="4">:: Buscar Liquidacion Recaudo Transferencia</td>
                <td class="cerrar"><a onClick="parent.despliegamodal2('hidden');" href="#" >&nbsp;Cerrar</a></td>
      		</tr>
      		<tr>
        		<td class="saludo1" style="width:7cm">:: Id o nombre de la liquidacion del recaudo:</td>
		...
		<div class="subpantalla" style="height:86%; width:99%; overflow-x:hidden;">
			<?php
				...
				$sqlr="SELECT * FROM tesorecaudotransferencialiquidar WHERE estado='S' $crit1  ";
				$resp = mysql_query($sqlr,$linkbd);
				$_POST[numtop]=mysql_num_rows($resp);
				$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
				$sqlr="SELECT * FROM tesorecaudotransferencialiquidar WHERE estado='S' $crit1   order by id_recaudo desc LIMIT $_POST[numpos],$_POST[numres]";
				$resp = mysql_query($sqlr,$linkbd);
				$con=1;
