	...
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="cont-codigosint1001editar.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
	...
	<body>
		...
		<form name="form2" method="post" action="cont-contexoformatosbuscar.php">
			...
			<table  class="inicio" align="center" >
				<tr>
					<td class="titulos" colspan="5">:. Buscar Formatos - Columna</td>
						...
						while ($row =mysql_fetch_row($resp)) 
						{
							...
							echo"<tr class='$iter' onDblClick=\"verUltimaPos('$idcta', '$numfil', '$filtro')\" style='text-transform:uppercase; $estilo'>
									...
									<td class='icoop'>$row[2]</td>
									 ...
									 <td><input type='range' name='lswitch1[]' value='".$_POST[lswitch1][$row[0]]."' min ='0' max='1' step ='1' style='background:$coloracti; width:60%'  readonly/></td>
