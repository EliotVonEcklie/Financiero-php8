...
{   
	parent.document.form2.cuentarecuperacion.value =pref;
	parent.document.form2.cuentarecuperacion_.value =pref;
	parent.document.form2.ncuentarecuperacion.value =opc;
