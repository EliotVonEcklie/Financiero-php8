...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
		...
		<table>
 		...
 		<form name="form2" method="post" action="presu-comprobantesdescuadrados.php"> 
			...
			<div class="subpantalla" style="height:68%; width:99.6%; overflow-x:hidden;">
				<?php
  					...
  					{
  						$crit1="";
						if($_POST[tipocomprobante]!=""){$crit1="AND pptocomprobante_cab.tipo_comp LIKE '$_POST[tipocomprobante]'";}  
...
onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase'>
						...
						$sqlr="SELECT DISTINCT pptocomprobante_det.numerotipo,pptocomprobante_cab.tipo_comp, pptocomprobante_cab.numerotipo, pptocomprobante_cab.fecha, pptocomprobante_cab.concepto,pptocomprobante_det.valdebito, pptocomprobante_det.valcredito,pptocomprobante_det.cuenta FROM pptocomprobante_cab,pptocomprobante_det WHERE pptocomprobante_cab.fecha BETWEEN '$fechaf1' AND '$fechaf2' AND pptocomprobante_det.tipo_comp=pptocomprobante_cab.tipo_comp AND pptocomprobante_det.numerotipo=pptocomprobante_cab.numerotipo and pptocomprobante_cab.estado='1' AND pptocomprobante_det.CUENTA='' $crit1 GROUP BY pptocomprobante_det.numerotipo,pptocomprobante_cab.tipo_comp, pptocomprobante_cab.numerotipo ORDER BY pptocomprobante_cab.tipo_comp, pptocomprobante_cab.numerotipo";
						$res=mysql_query($sqlr,$linkbd);
						while($row=mysql_fetch_row($res))
						{
							$sqlr="SELECT * FROM tipo_comprobante WHERE codigo=$row[1]";
