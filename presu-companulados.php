...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			function buscar()
			{
					...
					document.form2.action="presu-companulados.php";
	...
	<body>
		...
		<form name="form2" method="post" action="presu-companulados.php"> 
  			<table  align="center" class="inicio" >
      			<tr>
        			<td class="titulos" colspan="8" >.: Comprobantes Anulados</td>
      			...
      			<tr>
					...
					<td>&nbsp;<input type="button" name="generar" value="Generar" onClick="buscar()"></td>
				</tr>
 			</table>
			<?php
 				if ($_POST[oculto]=='2') {
			...
			<div class="subpantalla" style="height:68%; width:99.6%; overflow-x:hidden;">
	 			<table class='inicio' >
					<tr><td colspan='9' class='titulos'>.: Comprobantes Anulados</td></tr>
					<tr>
					...
					<?php
						...
						$sqlr="SELECT * FROM pptocomprobante_det, pptocomprobante_cab
							WHERE (pptocomprobante_cab.estado='0' OR pptocomprobante_det.estado='0')
							...
							AND pptocomprobante_cab.fecha BETWEEN '$fechaf1' AND '$fechaf2' $script1
							ORDER BY pptocomprobante_det.tipo_comp";
						//echo $sqlr;
						...
						echo "<tr>
						<td class='titulos2' align='center' colspan='6' >TOTAL</td>
