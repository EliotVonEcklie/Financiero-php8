	...
	<head>
        ...
        <script>
			...
			function funcionmensaje()
			{
				...
				document.location.href = "hum-nivelesarleditar.php?idnarl="+_idban;
			}
        ...
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="">
        	<?php 
				...
				{
					$_POST[onoffswitch]="S";
					$_POST[numid]=selconsecutivo('hum_nivelesarl','id');
					$accion="INGRESO A CREAR TRARIFA ARL";
            ...
            <?php
				...
				{
					$_POST[numid]=selconsecutivo('hum_nivelesarl','id');
					$sqlr="INSERT INTO hum_nivelesarl (id,codigo,tarifa,detalle,estado) VALUES ('$_POST[numid]','$_POST[codnarl]','$_POST[tararl]', '$_POST[nomacti]','$_POST[onoffswitch]')";
