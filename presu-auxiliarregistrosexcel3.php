<?php  
	...
	$objPHPExcel->getProperties()
        ...
        ->setTitle("Auxiliar de compromisos")
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2', 'AUXILIAR DE COMPROMISOS - Periodo: '.$_POST[fechaini].' - '.$_POST[fechafin]);
    ...
    {
        $sqld = "SELECT cuenta, fuente, valor FROM pptorp_detalle WHERE vigencia='$row[3]' AND consvigencia='$row[0]' AND tipo_mov='$row[5]'";
        ...
        while($rowd = mysqli_fetch_row($resd))
        {
            ...
            ->setCellValueExplicit ("B$i", 'COMPROMISO', PHPExcel_Cell_DataType :: TYPE_STRING)
	...
	$objPHPExcel->getActiveSheet()->setTitle('COMPROMISOS');
	$objPHPExcel->setActiveSheetIndex(0);

//----Guardar documento----
header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment;filename="LIOBRO_COMPROMISOS.xls"');
