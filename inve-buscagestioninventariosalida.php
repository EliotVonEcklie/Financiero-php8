...
function redirecciona(cod){
	window.location.href = "inve-editagestioninventario.php?is="+cod+"&mov=1"
}
</script>
	...
	<div id="bgventanamodalm" class="bgventanamodalm">
 	...
 	<form name="form2" method="post" action="inve-buscagestioninventario.php">
		<table  class="inicio" align="center" >
	    	<tr>
    	  		<td class="titulos" colspan="4">:: Buscar Gestión de Inventario</td>
	      	...
	      	<tr >
				...
				<td class="saludo1a">Tipo de Movimiento:</td>
        		<td>
	          		<select name="tipomov" id="tipomov" onChange="validar()" >
        ...
        <div class="subpantalla"  style="height:69.5%; width:99.6%; overflow-x:hidden;">
			...
			if ($_POST[documento]!="")
				$crit2=" and almginventario.codigo like '%$_POST[documento]%' ";
			//sacar el consecutivo 
			//$sqlr="select *from pptosideforigen where".$crit1.$crit2." order by pptosideforigen.codigo";
			$sqlr="select *from almginventario where almdestinocompra.estado<>''".$crit1.$crit2." order by almginventario.codigo";
			$resp = mysql_query($sqlr,$linkbd);
    	   	$_POST[numtop]=mysql_num_rows($resp);
			$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
			$sqlr="select *from almginventario where almginventario.estado<>''".$crit1.$crit2." order by almginventario.codigo LIMIT $_POST[numpos],$_POST[numres]";
			$resp = mysql_query($sqlr,$linkbd);
    	    $con=1;
			...
			echo "<table class='inicio' align='center' width='80%'>
				...
				while($row =mysql_fetch_row($resp)){
 					echo "<tr class='$iter' onDblClick='redirecciona($row[9])'>
						<td>".$row[9]."</td>
						<td>".$row[1]."</td>
						<td>";
						...
						<td><a href='inve-editagestioninventario.php?is=$row[9]&mov=$row[2]'>
