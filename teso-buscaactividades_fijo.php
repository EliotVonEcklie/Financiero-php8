		...
		<script>
			function verUltimaPos(idcta, filas){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editaactividades_fijo.php?idtipocom="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg;
			}
		</script>
<script>
//************* ver reporte ************
...
document.form2.razonsocial.value="";
    ...
    <body>
		...
		?>
 <form name="form2" method="post" action="teso-buscaactividades_fijo.php">
         	<input type="hidden" name="numres" id="numres" value="<?php echo $_POST[numres];?>"/>
       		<input type="hidden" name="numpos" id="numpos" value="<?php echo $_POST[numpos];?>"/>
         	<input type="hidden" name="nummul" id="nummul" value="<?php echo $_POST[nummul];?>"/>
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="4">:: Buscar Actividades Valor fijo</td>
        <td width="11%" class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
      </tr>
      <tr >
        ...
        <td width="21%"><input name="documento" type="text" id="documento" value="" size="2" maxlength="8">
...
$crit2=" ";
if ($_POST[nombre]!="")
$crit1=" and (codigosciiu_fijos.nombre like '%".$_POST[nombre]."%') ";
if ($_POST[documento]!="")
$crit2=" and codigosciiu_fijos.codigo like '%$_POST[documento]%' ";
//sacar el consecutivo 
$sqlr="select *from codigosciiu_fijos where codigosciiu_fijos.porcentaje<>''".$crit1.$crit2." order by codigosciiu_fijos.codigo";
...
$ntr = mysql_num_rows($resp);
					...
					$sqlr="select *from codigosciiu_fijos where codigosciiu_fijos.porcentaje<>''".$crit1.$crit2." order by codigosciiu_fijos.codigo ".$cond2;
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
