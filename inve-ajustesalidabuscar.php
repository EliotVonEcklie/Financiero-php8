	...
	<body>
        ...
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action="">
        	...
        	<table class="inicio">
      			<tr>
        			<td class="titulos" colspan="5">.: Buscar Actos Administrativos de Acuerdo de Ajuste</td>
            ...
            <div class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;">
            	<?php
					...
					$sqlr="
					SELECT id FROM almactoajustesal $crit1";
					$resp = mysql_query($sqlr,$linkbd);
					$_POST[numtop]=mysql_num_rows($resp);
					$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
					$sqlr="
					SELECT id,fecha,nomtercero,motivo,valortotal,estado FROM almactoajustesal $crit1 GROUP BY id ASC LIMIT $_POST[numpos], $_POST[numres]";
					$resp = mysql_query($sqlr,$linkbd);
					...
					while ($row =mysql_fetch_row($resp)) 
					{
						...
						echo "
						<tr class='$iter' style='text-transform:uppercase' onDblClick=\"location.href='inve-ajustesalidaedita.php?codi=$row[0]'\">
