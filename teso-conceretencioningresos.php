...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			...
			<a href="teso-buscaconceretencioningresos.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
...
if(!$_POST[oculto])
{
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(RIGHT(codigo,2)) from conceptoscontables where modulo=4 and tipo='RI' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8">.: Concepto Contable Retencion Ingresos</td>
      ...
      <tr  >
		<td width="119" class="saludo1">Codigo:</td>
		 ...
		 <td width="119" class="saludo1">Nombre:</td>
		  ...
		  <input name="tipoc" value="RI" size="10" type="hidden">
