...
<script>
	function iratras(scrtop, numpag, limreg, filtro){
		...
		location.href="ccp-cuentaspasiva.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
	}
</script>
		<?php titlepag();?>
    </head>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta">
					<a href="ccp-cuentaspasivaadd.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a>
					<a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a>
					<a href="ccp-cuentaspasiva.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
 ...
 //**** busca cuenta
    ...
    <tr >
      ...
      <td class="cerrar"><a href="ccp-principal.php">Cerrar</a></td>
		...
		<td  ><select name="sectores" id="sectores" onChange="document.form2.submit();">
				  <option value="-1">Seleccione ....</option>
					<?php
