			...
			<script>
				...
				function verUltimaPos1(idpres, filas, filtro){
					...
					if((limreg==0)||(limreg==""))
						limreg=10;
					numpag++;
					location.href="cont-prescripcion-reflejar.php?idpres="+idpres;
				}
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta">
					<a href="cont-prescripcion-reflejar.php" class="mgbt"><img src="imagenes/add.png" alt="Nuevo" border="0" title="Nuevo"/> </a> 
...
<form name="form2" method="post" action="" action="teso-buscaexoneraciones.php">
	...
	<table  class="inicio" align="center" >
    	<tr >
        	<td class="titulos" colspan="2">:. Buscar Prescripcion Predial</td>
...
<form name="form2" method="post" action="cont-buscapagonomina-reflejar.php">
	...
	<div class="subpantallap" style="height:68.5%; width:99.6%; overflow-x:hidden;">
   		<?php
		$oculto=$_POST['oculto'];
		$sqlr="select * from tesopredios tp, tesoprescripciones te where te.cedulacatastral=tp.cedulacatastral and tp.estado='S' order by id desc";
		...
		<table class='inicio' align='center'>
			...
			if($_POST[oculto]==2)
			{
				 ...
				 //********Comprobante contable en 000000000000
				  ...
				  //echo $sqlr;
				  $sqlr="update comprobante_det set estado='0' where tipo_comp='18' and numerotipo=$row[0]";
				  mysql_query($sqlr,$linkbd);
				  
				  $sqlr="update tesoprescripciones set estado='N' where id=$row[0]";
				  mysql_query($sqlr,$linkbd);

				  $sqlr="update tesoprescripciones_det set estado='N' where id=$row[0]";
				  mysql_query($sqlr,$linkbd);
