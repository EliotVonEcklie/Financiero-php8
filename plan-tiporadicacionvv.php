...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <script>
			...
			function guardarm()
			{
				if((document.getElementById('granombre').value!="")&&(document.getElementById('gradescr').value!=""))
					{despliegamodalm('visible','4','Seguro de Guardar el Tipo de Radicaci\xf3n','1');}
			...
			function modificarm()
			{
				if((document.getElementById('granombrem').value!="")&&(document.getElementById('gradescrm').value!=""))
					{despliegamodalm('visible','4','Seguro de Modificar el Tipo de Radicaci\xf3n','2');}
				else{despliegamodalm('visible','2','Se deben ingresar la informaci\xf3n en todos los campos');}
			}
			...
			{document.location.href = 'http://servidor/financiero/plan-tiporadicacion.php';}
		</script>
    </head>
    <body>
    ...
    <span id="todastablas2"></span>
	 ...
	 <span id="tablanuevo" class="ocultanuevo">
        <form name="formulario" method="post" action="" >
       		<?php
				$sqlr="SELECT max(valor_inicial) FROM dominios WHERE nombre_dominio='TIPO_RADICACION_AC'";
			...
			<table class="inicio" >
                <tr>
        			<td class="titulos" colspan="9" style="width:95%">:: Ingresar Tipo de Radicaci&oacute;n</td>
	...
	<span id="tablamodificar" class="ocultamodificar">
        ...
        <table class="inicio" >
            <tr>
              <td class="titulos" colspan="9" style="width:95%">:: Modificar Tipo de Radicaci&oacute;n</td>
    ...
    <span id="tablabuscar" class="ocultabuscar">
    	<form action="" method="post" enctype="multipart/form-data" name="formulario3"> 
  			<table class="inicio">
                <tr >
                  <td height="25" colspan="4" class="titulos" >:.Buscar Tipos de Radicaci&oacute;n </td>
				...
				<tr >
				  <td width="13%" class="saludo1" >:&middot; Tipo Radicaci&oacute;n:</td>
    ...
    <span id="tablarebuscar" class="ocultarebuscar">
    	<div class="subpantallap">
            <table class="inicio">        
                <tr>
                    <td class="titulos" colspan="6">:: Lista de Tipos de Radicaci&oacute;n</td>
                </tr>
                <tr >
                    ...
                    <?php 
                        if($_POST['oculto']=="")
                        {
                            $cond=" (valor_inicial like'%".$_POST[numero]."%' or descripcion_valor like '%".strtoupper($_POST[numero])."%') AND nombre_dominio='TIPO_RADICACION_AC'";
    ...
    <?php
		...
		if ($_POST[oculto1]== 2)
		{
			$sqlr = "INSERT INTO dominios (valor_inicial,valor_final,descripcion_valor,nombre_dominio,tipo,descripcion_dominio) VALUES ('$_POST[graid]','$_POST[gratiempo]','$_POST[granombre]','TIPO_RADICACION_AC','$_POST[readjunto1]','$_POST[gradescr]')";
			if(mysql_query($sqlr,$linkbd))
				{echo "<script>despliegamodalm('visible','1','Se Guardo con Exito El Tipo de Radicaci\xf3n');</script>";}
		}
		//Modificar
		if ($_POST[oculto2]== 2)
		{
