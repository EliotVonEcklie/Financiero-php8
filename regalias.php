...
function habilitar(id_acuerdo,acuerdo){
    ...
    <body>
		...
		<td width="10%" ><input name="numero" type="text" id="numero" value="" readonly></td>
		...
		?>
 <form name="form2" method="post" action="presu-desbacuerdos.php">
...
echo "<table class='inicio' align='center' width='80%'>
	<tr>
		<td colspan='9' class='titulos'>: Regalias :</td>
	</tr>
	<tr>
		<td width='5%' class='titulos2'>Recibo</td>
		<td class='titulos2'>Detalle</td>
		<td class='titulos2'>Liquidacion</td>
		<td class='titulos2'>Fecha</td>
		<td class='titulos2'>Valor Total</td>
		<td class='titulos2'>Valor a Presupuesto</td>
