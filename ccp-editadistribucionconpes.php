	...
	if(parseFloat(document.form2.codigo.value)<parseFloat(document.form2.maximo.value))
	 {
		...
		document.form2.action="ccp-editadistribucionconpes.php";
		document.form2.submit();
	}
}
function atrasc()
...
<?php  //***** busca tercero
    ...
    <table class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="8">.: Agregar Conpes</td><td class="cerrar" ><a href="ccp-principal.php">Cerrar</a></td>
      </tr>
      <tr  >
