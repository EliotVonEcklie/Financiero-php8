...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
   	...
   	<body>
		...
		<form name="form2" method="post" action="presu-compcompleto.php"> 
          			...
          			<td style="width:25%;">
                    	<select name="tipocomprobante" onKeyUp='return tabular(event,this)' onChange="validar()" style="width:100%;">
		 					<option value="">Seleccion Tipo Comprobante</option>	  
		   					<?php
  		   						$sqlr="SELECT * FROM pptotipo_comprobante WHERE estado='S' ORDER BY codigo";
			...
			<div class="subpantalla" style="height:68%; width:99.6%; overflow-x:hidden;">
				<?php
 				 	...
 				 	if($_POST['oculto'])
  					{
  						$crit1=" AND cab.tipo_comp!='1'  AND cab.tipo_comp!='2'  AND cab.tipo_comp!='3' AND cab.tipo_comp!='4'  AND cab.tipo_comp!='5'  AND cab.tipo_comp!='10' AND cab.tipo_comp!='11' ";
						...
						$sqlr="SELECT cab.tipo_comp, 
							...
							WHERE cab.fecha BETWEEN '$fechaf1' AND '$fechaf2' 
							 $crit1 							 
							 AND cab.estado!='0'
							ORDER BY cab.tipo_comp, cab.numerotipo";
						echo $sqlr;
						$fechaf=$_POST[fecha];
						...
						while($row=mysql_fetch_row($res)){							
							$sqlr1="SELECT * FROM pptotipo_comprobante WHERE codigo=$row[0] ORDER BY codigo ";
