<?php
header("content-disposition: attachment;filename=balanceprueba.xls");
...
//$sqlr="Select distinct cuenta from pptocuentaspptoinicial where left(cuenta,1)>='2' and vigencia='".$_POST[vigencias]."'"; 	 	 
 // echo "<tr><td class='titulos2'>Cuenta</td><td class='titulos2'>Nombre</td><td class='titulos2'>PRES INI</td><td class='titulos2'>ADICION</td><td class='titulos2'>REDUCC</td><td class='titulos2'>CREDITO</td><td class='titulos2'>CONT CRED</td><td class='titulos2'>PRES DEF</td><td class='titulos2'>CDP</td><td class='titulos2'>RP</td><td class='titulos2' >ORDEN PAGO</td><td class='titulos2' >PAGOS</td></tr>";  
   echo "<table bordercolor=#333333 border=1 ><tr><td colspan='6' style='color:#000000; font-weight:bold;background-color:#cccccc' align='center'>$rs - $nit</td></tr><tr><td colspan='6' style='color:#000000; font-weight:bold;background-color:#ccddee' align='center' >BALANCE DE PRUEBA Periodo: $_POST[fecha] - $_POST[fecha2]</td></tr>";
  echo "<tr><td style='color:#000000; font-weight:bold;background-color:#0066FF'>CUENTA</td><td style='color:#000000; font-weight:bold;background-color:#0066FF''>NOMBRE CUENTA</td><td style='color:#000000; font-weight:bold;background-color:#0066FF''>SALDO INICIAL</td><td style='color:#000000; font-weight:bold;background-color:#0066FF''>DEBITOS</td><td style='color:#000000; font-weight:bold;background-color:#0066FF''>CREDITOS</td><td style='color:#000000; font-weight:bold;background-color:#0066FF''>SALDO FINAL</td></tr>";  
