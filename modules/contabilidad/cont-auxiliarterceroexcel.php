<?php 
header("content-disposition: attachment;filename=auxiliartercero.xls");
...
for($x=0;$x<count($_POST[tipocomps]);$x++)
 {		 	
	...
	$sumaop+=$row3[1];
	$sumap+=$row4[1];	
	printf($ft,''.$_POST[fechas][$x],$_POST[tipocomps][$x],$_POST[ncomps][$x],$_POST[ccs][$x],$_POST[cuentas][$x],$_POST[ncuentas][$x],$_POST[terceros][$x],$_POST[nterceros][$x],$_POST[detalles][$x],$_POST[saldanteriores][$x],$_POST[debitos][$x],$_POST[creditos][$x],$_POST[nuevosaldos][$x]);	
 }
?>
