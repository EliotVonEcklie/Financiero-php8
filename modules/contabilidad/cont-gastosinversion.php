...
function validar2()
{
	...
	document.form2.action="cont-gastosinversion.php";
	document.form2.submit();
}
...
{	
		 ...
		 $_POST[valor]=0;		
		  $sqlr="select MAX(codigo) from conceptoscontables where modulo=3 and tipo='GI' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8" style='width:93%'>.: Gastos de Inversi&oacute;n</td>
      ...
      <tr  >
		...
		<td><input name="tipo" value="Gasto" size="10" type="text"><input name="tipogi" value="GI" size="10" type="hidden"></td>
	...
	<table class="inicio">
	<tr><td colspan="6" class="titulos2">Crear Detalle Gasto de Inversi&oacute;n</td></tr>
	<tr>
	...
	<table class="inicio">
	<tr><td class="titulos" colspan="7">Detalle Gasto de Inversi&oacute;n</td></tr>
	...
	if($_POST[oculto]=='2')	
		...
		$sqlr="insert into conceptoscontables (codigo,nombre,modulo,tipo) values ('$_POST[numero]','$_POST[nombre]','3','$_POST[tipogi]')";
		if(!mysql_query($sqlr,$linkbd))
		 {
		   echo "<table class='inicio'><tr><td class='saludo1'><center>No Se ha Almacenado con Exito El Gasto de Inversi&oacute;n, Error: $sqlr </center></td></tr></table>";
		 }
		 else
		 {
		 echo "<table class='inicio'><tr><td class='saludo1'><center>Se ha Almacenado con Exito El Gasto de Inversi&oacute;n</center></td></tr></table>";
		 }
		...
		for($x=0;$x<count($_POST[dcuentas]);$x++) 
		 {
		  ...
		  $sqlr="insert into conceptoscontables_det (codigo,tipo,tipocuenta,cuenta,cc,debito,credito,estado,modulo,fechainicial) values ('$_POST[numero]','$_POST[tipogi]','N','".$_POST[dcuentas][$x]."','".$_POST[dccs][$x]."','".$_POST[ddebitos][$x]."','".$_POST[dcreditos][$x]."','S','3','$fechaf')";
		  $res=mysql_query($sqlr,$linkbd);
		 }
