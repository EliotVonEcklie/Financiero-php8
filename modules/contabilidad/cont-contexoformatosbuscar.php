...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="cont-contexoformatoseditar.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
	...
	<body>
		...
		<form name="form2" method="post" action="cont-contexoformatosbuscar.php">
			<?php
				...
				else
				{
					...
					if($_POST[cambioestado]!="")
					{
						...
						{
							$sqlr="UPDATE contexoformatos SET estado='S' WHERE idnum='$_POST[idestado]'";
							mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						}
						else 
						{
							$sqlr="UPDATE contexoformatos SET estado='N' WHERE idnum='$_POST[idestado]'";
							mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
						}
					}
					//*****************************************************************
			...
			<table  class="inicio" align="center" >
				<tr>
					<td class="titulos" colspan="5">:. Buscar Formatos </td>
			...
			<div class="subpantalla" style="height:63.5%; width:99.6%;overflow-x:hidden" id="divdet">
				<?php
					//if($_POST[oculto])
					{
						...
						$sqlr="SELECT * FROM contexoformatos  $crit1 ORDER BY idnum $cond2";
						$resp = mysql_query($sqlr,$linkbd);
						$con=1;
						...
						<table class='inicio' align='center'>
							...
							<tr>
								...
								<td class='titulos2' style='width:5%;'>Conceptos</td>
								<td class='titulos2' style='width:8%;'>Monto minimo</td>
							</tr>";
						$iter='saludo1a';
						$iter2='saludo2';
						$filas=1;
						while ($row =mysql_fetch_row($resp)) 
						{
							...
							$sqlr2="SELECT * FROM contexoformatos_det WHERE estado='S' AND idnum='$row[0]'";
							...
							echo"<tr class='$iter' onDblClick=\"verUltimaPos('$idcta', '$numfil', '$filtro')\" style='text-transform:uppercase; $estilo'>
									...
									<td class='icoop' style='text-align:center;'>$row[4]</td>
								</tr>";
