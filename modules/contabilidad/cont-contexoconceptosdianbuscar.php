...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
			function verUltimaPos(idcta, filas, filtro)
			{
				...
				numpag++;
				location.href="cont-contexoconceptosdianeditar.php?idr="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
	...
	<body>
		...
		<form name="form2" method="post" action="cont-contexoconceptosdianbuscar.php">
			<?php
			...
			<table  class="inicio" align="center" >
				<tr>
					<td class="titulos" colspan="5">:. Buscar Conceptos DIAN </td>
