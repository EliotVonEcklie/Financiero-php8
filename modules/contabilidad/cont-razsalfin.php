  			...
  			<table  align="center" class="inicio" >
      			...
      			<tr>
					...
					<td style="width:11%;">
		 			...
		 			<td  class="saludo1" style="width:3cm;">Tipo Comprobante:</td>
          			<td style="width:25%;">
                    	<select name="tipocomprobante" onKeyUp='return tabular(event,this)' onChange="validar()" style="width:90%;">
				...
				<tr>
					...
					<td colspan="2" style="width:25%;">
						<select id='cc' name="cc" onKeyUp="return tabular(event,this)" style="width:90%;" tabindex="10">
