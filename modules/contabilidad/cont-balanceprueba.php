	...
	<body>
		<table>
			...
			<tr>
				...
				<a href="cont-balanceprueba" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
				...
				<a href="<?php echo "archivos/".$_SESSION[usuario]."balanceprueba-nivel$_POST[nivel].csv"; ?>" target="_blank" class="mgbt"><img src="imagenes/csv.png"  title="csv"></a></td>
  			</tr>
		</table>
    		...
    		<tr>
        		...
        		<td style="width:12%;">
        			<select name="nivel" id="nivel" style="width:80%;" tabindex="1">
						<?php
                            $niveles=array();
                            $sqlr="Select * from nivelesctasant  where estado='S' order by id_nivel";
            	...
            	<td class="saludo1">
                	<span  style=" vertical-align:middle; width:10px"> Consolidado <input type="checkbox" name="consolidado" id="consolidado" value="1" <?php echo $chkcomp ?>  style="vertical-align:middle; " tabindex="11"></span>
            <span  style=" vertical-align:middle"> Cierre <input type="checkbox" name="cierre" id="cierre" value="1" <?php echo $chkcierre ?>  style="vertical-align:middle;" tabindex="12"></span>
       			</td>
   	 		</tr>
    		<tr> 
		...
		<div class="subpantallap" style="height:62%; width:99.6%; overflow-x:hidden;">
  		<?php
			...
			{	 
				...
				$sqlr2="select distinct digitos, posiciones from nivelesctasant where estado='S' ORDER BY id_nivel DESC ";
