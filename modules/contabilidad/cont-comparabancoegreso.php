			...
			<table class='inicio' align='center'>
						<tr>
						 ...
						 <tr class='titulos ' style='text-align:center;'>
								...
								<td style='width:3%;'>Tesoreria</td>
								<td colspan='2' style='width:9%;'>Contabilidad</td>
							</tr>
							<tr class='titulos' style='text-align:center;'>
                                <td id='col1' style='width:7%;'>Id Recaudo</td>
                                <td id='col1' style='width:7%;'>Fecha</td>
                                <td id='col1' style='width:7%;'>Medio de pago</td>
								<td id='col2' style='width:31%;'>Concepto</td>
								<td id='col3' style='width:3%;'>Valor Total</td>
								<td id='col6' style='width:4.5%;'>Valor Total</td>
								<td id='col7' style='width:4.5%;'>Diferencia</td>
							</tr>	</table>
</div>";
		?>
				...
				<tbody>";
						...
						$sqlr="select T.id_egreso, T.valorpago, T.estado,T.concepto,T.fecha, T.id_orden from tesoegresos T where T.tipo_mov='201' $queryDate ";
                        ...
                        while ($row =mysql_fetch_row($resp)) 
                        {
							...
							$sqlrMedioPago = "SELECT medio_pago FROM tesoordenpago WHERE id_orden=$row[5]";
                            ...
                            $sql="select C.numerotipo,sum(C.valcredito),C.cuenta,C.tipo_comp,CB.estado from comprobante_det C, comprobante_cab CB where C.numerotipo='$row[0]' and C.tipo_comp='6' and C.numerotipo=CB.numerotipo and C.tipo_comp=CB.tipo_comp and LEFT(cuenta,2)='11'";
                            ...
                            $row2=mysql_fetch_row($res2);
								echo"<tr class='$co' ondblclick='direccionaComprobante($row2[5],$row2[3],$rw[0])' style='text-transform:uppercase;cursor: hand; $estilo; $stado' >
                                        ...
                                        <td style='text-align:center; width:7%;' id='2'>$medioPago</td>
