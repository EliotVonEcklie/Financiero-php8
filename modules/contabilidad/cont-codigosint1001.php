...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script>
			...
			function funcionmensaje(){document.location.href = "cont-codigosint1001.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='cont-codigosint1001.php'" class="mgbt"/><img src="imagenes/guarda.png"  title="Guardar" onClick="guardar();" class="mgbt"/><img src="imagenes/busca.png"  title="Buscar" onClick="location.href='cont-codigosint1001buscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="nueva ventana" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"></td>
			</tr>
		</table>
		...
		<form name="form2" method="post" action="">
			<?php
				...
				if(!$_POST['oculto'])
				{
					$_POST['idnum']=$_POST['codigo']=selconsecutivo('contcodigosinternos1001','idnum');
			...
			<table class="inicio" align="center" >
				<tr >
					<td class="titulos" colspan="10">.: Agregar C&oacute;digos Internos 1001 - N</td>
			...
			<?php
				...
				{
					$sqlr="SELECT codigo FROM contcodigosinternos1001";
			...
			<?php
				...
				if($_POST['oculto']=='2')
				{
					if ($_POST['nombre']!="")
					{
						...
						$_POST['idnum']=$_POST['codigo']=selconsecutivo('contcodigosinternos1001','idnum');
						$sqlr="INSERT INTO contcodigosinternos1001 (idnum,codigo,nombre,estado) VALUES ('".$_POST['idnum']."','".$_POST['codigo']."','".iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$_POST['nombre'])."','S')";
						if (!mysql_query($sqlr,$linkbd))
						{
							echo "<script>despliegamodalm('visible','2','Manejador de Errores de la Clase BD humvariables, No se pudo ejecutar la petici�n');</script>";
						}
						else
						{
							for($x=0;$x<count($_POST['dcodigo']);$x++)
							{
								$niddet=selconsecutivo('contcodigosinternos1001_det','iddet');
								$sqlr="INSERT INTO contcodigosinternos1001_det (iddet,idnum,codigo,nombre,concepto,estado)VALUES ('$niddet','".$_POST['idnum']."','".$_POST[dcodigo][$x]."','".$_POST[dncuentas][$x]."', '".$_POST[dconceptos][$x]."','S')";
								if (!mysql_query($sqlr,$linkbd))
								{
									echo "<script>despliegamodalm('visible','2','Manejador de Errores de la Clase BD contcodigosinternos1001_det, No se pudo ejecutar la petici�n');</script>";
								}
