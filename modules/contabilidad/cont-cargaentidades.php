		...
		<table>
            ...
            <tr>
                <td colspan="3" class="cinta">
					<a href="cont-cargaentidades.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
					...
					<a href="<?php echo "formatos/FMT_CONSOLIDACION_ENTIDADES.csv"; ?>" target="_blank" class="mgbt"><img src="imagenes/csv.png" style="width:29px;height:25px;" title="csv"></a>
				<a href="cont-agregarbalances.php" class="mgbt"><img src="imagenes/iratras.png" title="Retornar"></a>
				</td>
            </tr>
   		</table>
 		<form name="form2" action="cont-cargaentidades.php"  method="post" enctype="multipart/form-data" >
 			<?php
	 		...
	 		<table class="inicio">
      			...
      			<tr>
                    ...
                    <td style="width:13%;"><input id="tercero" type="text" name="tercero" style="width:80%;" onKeyUp="return tabular(event,this)" onBlur="buscater(event)" value="<?php echo $_POST[tercero]?>" onClick="document.getElementById('tercero').focus();document.getElementById('tercero').select();">&nbsp;<a href="#" onClick="despliegamodal2('visible');"><img src="imagenes/find02.png" style="width:20px;" align="absmiddle" border="0"></a></td>
	  				...
	  				<td>
						<select name="cc" onKeyUp="return tabular(event,this)">
							...
							<?php
								$sqlr="SELECT * FROM centrocosto WHERE estado='S' AND entidad='N'";
			 				...
			 				{ 
 	 							...
 	 							if($datos[0]!='' && $tama==$digitos && $campos==6)
								{
									...
									if(strlen($datos[0])==$digitos)
	 		 						{				 
	  		 							$sqlrchip="SELECT count(*) FROM cuentasnicsp WHERE cuenta=$datos[0]";
