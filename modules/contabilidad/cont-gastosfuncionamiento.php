...
function validar2()
{
	...
	document.form2.action="cont-gastosfuncionamiento.php";
	document.form2.submit();
}
...
{	
		 ...
		 $_POST[valor]=0;		
		  $sqlr="select MAX(codigo) from conceptoscontables where modulo=3 and tipo='GF' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="8" style='width:93%'>.: Gastos de Funcionamiento</td>
        <td class="cerrar" style='width:7%'><a href="cont-principal.php">Cerrar</a></td>
      </tr>
      <tr  >
		<td style="width:10%" class="saludo1">Codigo:</td>
        <td style="width:8%" valign="middle" ><input type="text" id="numero" name="numero" style="width:80%" onKeyPress="javascript:return solonumeros(event)" 		  onKeyUp="return tabular(event,this)" value="<?php echo $_POST[numero]?>" onClick="document.getElementById('numero').focus();document.getElementById('numero').select();"></td>
		<td style="width:10%" class="saludo1">Nombre:</td>
        <td style="width:36%" valign="middle" ><input type="text" id="nombre" name="nombre" style="width:90%"
		...
		<td><input name="tipo" value="Gasto" size="10" type="text"><input name="tipogf" value="GF" size="10" type="hidden"></td>
		<!-- <td class="saludo1">Almacen:</td><td><input name="almacen" id="almacen"  type="checkbox" style="max-height: 15px" <?php //if(!empty($_POST[almacen])){echo "checked "; }?> ></td> -->
      </tr>
        <tr>
	...
	<tr>
		    ...
		    <td valign="middle">
				<input class="colordobleclik" name="cuenta" id="cuenta" type="text"  value="<?php echo $_POST[cuenta]?>" onKeyUp="return tabular(event,this) " style="width:90%;" onBlur="buscacta(event)" onClick="despliegamodal2('visible',1);" autocomplete="off"><input type="hidden" value="" name="bc" id="bc">
	...
	if($_POST[oculto]=='2')	
		...
		$sqlr="insert into conceptoscontables (codigo,nombre,modulo,tipo) values ('$_POST[numero]','$_POST[nombre]','3','$_POST[tipogf]')";
		...
		for($x=0;$x<count($_POST[dcuentas]);$x++) 
		 {
		  ...
		  $sqlr="insert into conceptoscontables_det (codigo,tipo,tipocuenta,cuenta,cc,debito,credito,estado,modulo,fechainicial) values ('$_POST[numero]','$_POST[tipogf]','N','".$_POST[dcuentas][$x]."','".$_POST[dccs][$x]."','".$_POST[ddebitos][$x]."','".$_POST[dcreditos][$x]."','S','3','$fechaf')";
		  $res=mysql_query($sqlr,$linkbd);
		 }
