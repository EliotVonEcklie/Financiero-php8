...
<form name="form2" method="post" action="cont-buscarecaudos-reflejar.php">
    	...
    	<tr >
      	...
      	<tr >
        	...
        	<td style="width:10%">
         	...
         	<td style="width:2.5cm" class="saludo1">Concepto Liquidacion: </td>
    		<td style="width:50%">
    ...
    //sacar el consecutivo 
        ...
        $sqlr="select *from tesorecaudos where tesorecaudos.id_recaudo>-1 ".$crit1.$crit2." order by tesorecaudos.id_recaudo DESC ".$cond2;
        $resp = mysql_query($sqlr,$linkbd);
		...
		echo "<table class='inicio' align='center' >
			...
			<tr>
				...
				<td class='titulos2' style='width:5%'><center>Editar</td>
			</tr>";	
			$iter='saludo1a';
			$iter2='saludo2';
 			while ($row =mysql_fetch_row($resp)){
		 		echo "<tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor; this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase;cursor:pointer' onDblClick=\"window.open('cont-recaudos-reflejar.php?idr=$row[0]','_self');\">
					<td>$row[0]</td>
					<td>$row[6]</td>
					<td>$row[2]</td>
					<td>$row[4]</td>
					<td>$row[7]</td>";
	 				...
	 				if($row[7]=='N' || $row[7]=='P')
	 					echo "<td></td>";	
	 				echo "<td style='text-align:center;'>
						<a href='cont-recaudos-reflejar.php?idr=$row[0]'>
