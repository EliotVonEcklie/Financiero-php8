		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="cont-editagastosinversion.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<script>
//************* ver reporte ************
...
{
document.form2.action="cont-buscagastosinversion.php";
document.form2.submit();
}
...
<?php titlepag();?>
    ...
    <body>
		...
		?>
 		<form name="form2" method="post" action="cont-buscagastosinversion.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Gasto de Inversi&oacute;n</td>
...
$sqlr="select * from conceptoscontables where tipo='GI' and modulo='3' ".$crit1." order by codigo";
$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *	 from conceptoscontables where tipo='GI' and modulo='3' ".$crit1." order by codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
		...
		echo "<table class='inicio' align='center'>
			...
			<tr>
				<td colspan='3'>Gastos de Inversi&oacute;n Encontrados: $ntr</td>
			</tr>
			<tr>
