		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
					<a href="cont-consolidarbalances.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a>
					...
					<?php if($_POST[gchip]=='1'){?><a href="<?php echo "archivos/".$_SESSION[usuario]."chip-$_POST[periodo].csv"; ?>" target="_blank" class="mgbt"><img src="imagenes/csv.png" title="csv"></a><a href="descargartxt.php?id=SALDOS_Y_MOVIMIENTOS.txt&dire=archivos" target="_blank" class="mgbt"><img src="imagenes/cgn.png" style="width: 40px; height: 40px;" title="contraloria general de la nacion"></a><?php } ?>
					
					<a href="cont-gestioninformecgr.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
				</td>
         	</tr>
    	</table>
  		<form name="form2" action="cont-consolidarbalances.php"  method="post" enctype="multipart/form-data" >
 			<?php
...
?>
 ...
 <?php
	...
	if($_POST[gchip]=='1')
	{
		$namearch2="archivos/SALDOS_Y_MOVIMIENTOS.txt";
		$Descriptor2 = fopen($namearch2,"w+");
		fputs($Descriptor2,"S\t".$_POST[codent]."\t".$_POST[periodo]."\t".$_POST[vigencias]."\tCGN2015_001_SALDOS_Y_MOVIMIENTOS_CONVERGENCIA\r\n");

		$namearch="archivos/".$_SESSION[usuario]."chip-$_POST[periodo].csv";
		$Descriptor1 = fopen($namearch,"w+"); 
		fputs($Descriptor1,"S;".$_POST[codent].";".$_POST[periodo].";".$_POST[vigencias].";CGN2015_001_SALDOS_Y_MOVIMIENTOS_CONVERGENCIA\r\n");
		...
		{	 
			...
			if(strlen($_POST[cuentac][$x])==6)
			{
				...
				{				
					...
					fputs($Descriptor1,"D;".$ncuentas.";".round($saldoinicial,2).";".round($debitos,2).";".round($creditos,2).";".round($salfinal,2).";0;".round($salfinal,2)."\r\n");

					fputs($Descriptor2,"D\t".$ncuentas."\t".round($saldoinicial,2)."\t".round($debitos,2)."\t".round($creditos,2)."\t".round($salfinal,2)."\t0\t".round($salfinal,2)."\r\n");
					$chk="checked";
				...
				else
				{
					...
					$ncuentas=substr($_POST[cuentac][$x],0,1).".".substr($_POST[cuentac][$x],1,1).".".substr($_POST[cuentac][$x],2,2).".".substr($_POST[cuentac][$x],4,2); 
					fputs($Descriptor1,"D;".$ncuentas.";".round($saldoinicial,2).";". round($debitos,2).";". round($creditos,2).";".round($salfinal,2).";".round($salfinal,2).";0\r\n");

					fputs($Descriptor2,"D\t".$ncuentas."\t".round($saldoinicial,2)."\t".round($debitos,2)."\t".round($creditos,2)."\t".round($salfinal,2)."\t".round($salfinal,2)."\t0\r\n");
					$chk2="checked";
