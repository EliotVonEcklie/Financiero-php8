	...
	<body>
		...
		?>
				...
				<tbody>";
                        ...
                        $sqlr="select consec,fecha,nombre from almginventario where tipomov='2' and tiporeg='06' $queryDate ";
                        //echo $sqlr;
                        ...
                        while ($row =mysql_fetch_row($resp)) 
                        {
                            $estilo="";
                            $stado="";
                            $sqlalmacendet="select sum(valortotal) from almginventario_det where codigo='$row[0]' and tipomov='2' and tiporeg='06'";
                            //echo $sqlalmacendet."<br>";
                            $resalmacendet=mysql_query($sqlalmacendet,$linkbd);
                            $rowalmacendet=mysql_fetch_row($resalmacendet);

                            $sql="select sum(valcredito) from comprobante_det where tipo_comp='65' and numerotipo='$row[0]' and valcredito>0 ";
