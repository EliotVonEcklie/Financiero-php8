...
document.form2.action="cont-entradacompra-reflejar-kardex.php";
document.form2.submit();
}
}
</script>
...
<input type="hidden" name="cc" id="cc" value="<?php echo $_POST[cc] ?>">
	<table class="inicio" align="center" >
    	<tr >
       		<td class="titulos" colspan="10">Interfaz Otras entradas por compra - kardex</td>
		...
		if($bloq>=1)
		{
			...
			else
			{
                ...
                for($x = 0; $x<count($_POST[codart]); $x++)
                {
                    ...
                    $sql = "UPDATE comprobante_det SET numacti='".$_POST[codart][$x]."', cantarticulo='".$_POST[cantidad][$x]."' WHERE tipo_comp='54' AND numerotipo='$_POST[idcomp]' AND cuenta='".$row[0][cuenta]."' AND valdebito='".$_POST[valtotal][$x]."'";
                    view($sql);
                    //$sql="INSERT INTO comprobante_det(id_comp,cuenta,tercero,centrocosto,detalle,valdebito,valcredito,estado,vigencia,tipo_comp,numerotipo) VALUES ('54 $_POST[idcomp]','".$row[0][cuenta]."','".$_POST[tercero]."','".$row[0][cc]."','$_POST[concepto]','".$_POST[valtotal][$x]."','0',1,'$_POST[anioact]','54','$_POST[idcomp]')";
                    //view($sql);
                    ...
                    $sql = "UPDATE comprobante_det SET numacti='".$_POST[codart][$x]."', cantarticulo='".$_POST[cantidad][$x]."' WHERE tipo_comp='54' AND numerotipo='$_POST[idcomp]' AND cuenta='".$row[0][cuenta]."' AND valcredito='".$_POST[valtotal][$x]."'";
                    view($sql);
                    //$sql="INSERT INTO comprobante_det(id_comp,cuenta,tercero,centrocosto,detalle,valdebito,valcredito,estado,vigencia,tipo_comp,numerotipo) VALUES ('54 $_POST[idcomp]','".$row[0][cuenta]."','".$_POST[tercero]."','".$row[0][cc]."','$_POST[concepto]','0','".$_POST[valtotal][$x]."',1,'$_POST[anioact]','54','$_POST[idcomp]')";
                }
