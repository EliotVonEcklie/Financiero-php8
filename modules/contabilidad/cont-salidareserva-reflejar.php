...
<input type="hidden" name="cc" id="cc" value="<?php echo $_POST[cc] ?>">
	<table class="inicio" align="center" >
    	<tr >
       		<td class="titulos" colspan="10">Interfaz Salida de almacen por reserva</td>
   	...
   	<div class="subpantalla">
    	<?php 
	   	$linkbd=conectar_bd();
        $sqlr="select *from almginventario_det where tipomov='2' and tiporeg='01' and almginventario_det.codigo=$_POST[idcomp] ";
