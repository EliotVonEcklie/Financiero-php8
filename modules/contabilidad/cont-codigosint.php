...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table>
			...
			<tr>
				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='cont-codigosint.php'" class="mgbt"/><img src="imagenes/guarda.png"  title="Guardar" onClick="guardar();" class="mgbt"/><img src="imagenes/busca.png"  title="Buscar" onClick="location.href='cont-codigosintbuscar.php'" class="mgbt"/><img src="imagenes/nv.png" title="nueva ventana" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"></td>
			</tr>
		</table>
		...
		<form name="form2" method="post" action="">
			<?php
				...
				if(!$_POST['oculto'])
				{
					$_POST['idnum']=$_POST['codigo']=selconsecutivo('contcodigosinternos','idnum');
			...
			<table class="inicio" align="center" >
				<tr >
					<td class="titulos" colspan="10">.: Agregar C&oacute;digos Internos</td>
			...
			<?php
				...
				{
					$sqlr="SELECT codigo FROM contcodigosinternos";
			...
			<?php
				...
				if($_POST['oculto']=='2')
				{
					if ($_POST['nombre']!="")
					{
						...
						$_POST['idnum']=$_POST['codigo']=selconsecutivo('contcodigosinternos','idnum');
						$sqlr="INSERT INTO contcodigosinternos (idnum,codigo,nombre,estado) VALUES ('".$_POST['idnum']."','".$_POST['codigo']."','".iconv($_SESSION["VERCARPHPINI"], $_SESSION["VERCARPHPFIN"]."//TRANSLIT",$_POST['nombre'])."','S')";
