        ...
        if($user == ''){
            ...
            die('
                    <center style="margin-top:20px;">
                        <table border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" width="50%"><tr bgcolor="#000066" colspan="1">
                            <tr>
                                <td>
                                    <center>
                                        <font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="4" ><b>Contabilidad</b></font>
                                    </center>
                                </td>
                            </tr>
                            <tr bgcolor="#ffffff" colspan="1">
                                <td>
                                    <center>
                                        <h3>
                                            <font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif">Error: Usuario o contraseña Incorrecta, para volver a intentarlo da <a href="../../principal.php">click aqui</a></font>
                                        </h3>
                                    </center>
                                </td>
                            </tr>
