	...
	<head>
        ...
        <script>
            function iratras(scrtop, numpag, limreg, filtro)
            {
                ...
                location.href="presu-cuentaspasiva.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
            }
        </script>
		<?php titlepag();?>
        </head>
                    ...
                    switch ($_POST[clasificacion])
                    {
                        ...
                        case 'sgr-gastos':
                            if($_POST[regalias]=='S')
                            {
                                ...
                                $vigi=trim($arrvig[0]);
                                $vigf=trim($arrvig[1]);
                                $sqlr="update pptocuentas  set nombre='".$_POST[nombre]."', tipo='$_POST[tipo]',sidefclas='$_POST[cgrclas]',sidefrecur='$_POST[cgrrecu]',sideforigen='$_POST[cgrorigen]',sideftercero='$_POST[cgrtercero]',sidefdest='$_POST[cgrdest]' ,sidefgasto='$_POST[cgrvigencia]',sidefgastofin='$_POST[cgrfinalidad]',sidefdep='$_POST[cgrdependencia]',sideffondos='$_POST[cgrsituacion]',futinversion='$_POST[futinversion]', futfuenteinv='$_POST[futfuenteinv]' ,codconcepago='$_POST[concepago]',codconcecausa='$_POST[concecausa]' , nomina='$_POST[nomina]' , clasificacion='$_POST[clasificacion]', regalias='$_POST[regalias]', vigenciarg='$_POST[vigenciarg]', vigencia='$vigi', vigenciaf='$vigf',unidad='$_POST[unidad]',futsgrgas='$_POST[futregalias]' where  cuenta='$_POST[codigo]' and (vigencia='".$vigusu."' or vigenciaf='$vigusu')";
                            }
                            else
                            {
                                $sqlr="update pptocuentas  set nombre='".$_POST[nombre]."', tipo='$_POST[tipo]',sidefclas='$_POST[cgrclas]',sidefrecur='$_POST[cgrrecu]',sideforigen='$_POST[cgrorigen]',sideftercero='$_POST[cgrtercero]',sidefdest='$_POST[cgrdest]' ,sidefgasto='$_POST[cgrvigencia]',sidefgastofin='$_POST[cgrfinalidad]',sidefdep='$_POST[cgrdependencia]',sideffondos='$_POST[cgrsituacion]',futinversion='$_POST[futinversion]', futfuenteinv='$_POST[futfuenteinv]' ,codconcepago='$_POST[concepago]',codconcecausa='$_POST[concecausa]' , nomina='$_POST[nomina]' , clasificacion='$_POST[clasificacion]', regalias='$_POST[regalias]', vigenciarg='$_POST[vigenciarg]',unidad='$_POST[unidad]',futsgrgas='$_POST[futregalias]' where  cuenta='$_POST[codigo]' and (vigencia='".$vigusu."' or vigenciaf='$vigusu')";
                            }

                            mysql_query($sqlr,$linkbd);
                            $sql="SELECT COUNT(*) FROM pptocuentas_fuen_regalias WHERE cuenta='$_POST[codigo]' and (vigenciai='".$vigusu."' or vigenciaf='$vigusu')";
                            
                            $res=mysql_query($sql,$linkbd);
                            $row=mysql_fetch_row($res);
                            if($row[0]==0)
                            {
                                $sqlc="SELECT MAX(codigo) FROM pptocuentas_fuen_regalias";
                                $resc=mysql_query($sqlc,$linkbd);
                                $rowc=mysql_fetch_row($resc);
                                $count=$rowc[0]+1;
                                
                                $sql="INSERT INTO pptocuentas_fuen_regalias(codigo,vigenciai,vigenciaf,cuenta,fuente) VALUES ($count,'".$vigi."','".$vigf."','".strtoupper($_POST[codigo])."','$_POST[futfuentesgr]')";
                            }
                            else
                            {
					            $sql="UPDATE pptocuentas_fuen_regalias SET fuente='$_POST[futfuentesgr]' WHERE  cuenta='$_POST[codigo]' and (vigenciai='".$vigusu."' or vigenciaf='$vigusu')  ";
				            }
				    ...
				    while ($row =mysql_fetch_row($resp)) 
					{
					    ...
					    {	
                            ...
                            case 'sgr-gastos':
                                ...
                                $sql="SELECT pptofutfuentesgr.codigo,pptofutfuentesgr.nombre FROM pptocuentas_fuen_regalias,pptofutfuentesgr WHERE pptocuentas_fuen_regalias.cuenta='$_GET[idcta]' AND (vigenciai='$vigusu' or vigenciaf='$vigusu')  ";
                                $res=mysql_query($sql,$linkbd);
                                $row = mysql_fetch_row($res);
                                $_POST[futfuentesgr]=$row[0];
                                $_POST[nfuente]=$row[1];
					        break;
                ...
                if ($_POST[oculto]=='3' || $_POST[oculto]=='2' )
                {
                    ...
                    while ($row =mysql_fetch_row($resp)) 
                    {
                        ...
                        {	
                            ...
                            case 'sgr-gastos':
                                $_POST[futregalias]=$row[32];
                                $sql="SELECT pptofutfuentesgr.codigo,pptofutfuentesgr.nombre FROM pptocuentas_fuen_regalias,pptofutfuentesgr WHERE pptocuentas_fuen_regalias.cuenta='".$_POST[todascuentas][$npos]."' AND (vigenciai='$vigusu' or vigenciaf='$vigusu')  ";
                                $res=mysql_query($sql,$linkbd);
                                $row = mysql_fetch_row($res);
                                $_POST[futfuentesgr]=$row[0];
                                $_POST[nfuente]=$row[1];
                ...
                if($_POST[oculto]=='1' || $_POST[oculto]=='' || $_POST[oculto]=='3' || $_POST[oculto]=='2')
                {
                    ...
                    <table class="inicio" width="99%">
				        ...
				        <tr>
				            ...
				            <td>
				                <select name="tipo" onChange="document.form2.submit();" style="width: 60%">
                    ...
                    if ($_POST[tipo]=='Auxiliar')
                    {
				        ?>
				        <table class="inicio" width="99%">
				            <tr><td class="titulos2" colspan="5">Parametrizacion contable</td></tr>
				            <tr>
                        ...
                        <table class="inicio" width="99%">				
				            ...
				            <tr>
                                ...
                                <td><input name="cgrclasnom" type="text" size="80" value="<?php echo $_POST[cgrclasnom]?>"></td>
                            </tr>
				            <tr>
				                <td class="saludo1" >Recurso	:</td>
				                <td>
                                    <select name="cgrrecu" id="cgrrecu" onChange="document.form2.submit();">
                                        <option value="-1">Seleccione ....</option>
                                        <?php
				            ...
				            <tr>
                                ...
                                <td>
                                    <select name="cgrorigen" id="cgrorigen" onChange="document.form2.submit();">
                                        <option value="-1">Seleccione ....</option>
                                        <?php
				            ...
				            <tr>
                                ...
                                <td>
                                    <select name="cgrdest" id="cgrdest" onChange="document.form2.submit();">
                                        <option value="-1">Seleccione ....</option>
                                        <?php
                                ...
                                <td><input name="cgrdestnom" type="text" size="80" value="<?php echo $_POST[cgrdestnom]?>"></td>
                            </tr>
					        <tr>
                                <td class="saludo1" >Tercero:</td>
                                <td>
                                    <select name="cgrtercero" id="cgrtercero" onChange="document.form2.submit();">
				                        <option value="-1">Seleccione ....</option>
                                        <?php
				            ...
				            <tr>
                                ...
                                <td>
                                    <select name="cgrvigencia" id="cgrvigencia" onChange="document.form2.submit();">
				                        <option value="-1">Seleccione ....</option>
                                        <?php
  				            ...
  				            <tr>
                                ...
                                <td>
                                    <select name="cgrfinalidad" id="cgrfinalidad" onChange="document.form2.submit();">
				                        <option value="-1">Seleccione ....</option>
                                        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="cgrdependencia" id="cgrdependencia" onChange="document.form2.submit();">
                                        <option value="-1">Seleccione ....</option>
					                    <?php
  				            ...
  				            <tr>
                                ...
                                <td>
                                    <select name="cgrsituacion" id="cgrsituacion" onChange="document.form2.submit();">
                                        <option value="-1">Seleccione ....</option>
                                        <?php
                            ...
                            switch(strtolower($_POST[clasificacion]))
                            {
				                ...
				                <table class="inicio" width="99%">				
				                    ...
				                    <tr>
				                        ...
				                        <td>
                                            <select name="futcodfun" id="futcodfun" onChange="document.form2.submit();">
				                                <option value="-1">Seleccione ....</option>
					                            <?php
...
//			 echo $sqlr;
				...
				?>
				  ...
				  <td class="saludo1" >Cod Inversion nombre:</td>
				  <td  ><input name="futregaliasnom" type="text" size="80" value="<?php echo $_POST[futregaliasnom]?>"></td>
			    </tr>
				<tr>				
				...
				?>
				  ...
				  <td class="saludo1" >Nombre Fuente:</td>
				  <td  ><input name="nfuente" type="text" size="80" value="<?php echo $_POST[nfuente]?>" readonly></td>
				</tr>			
  			</table>
				 <?php
				 break;
