    ...
    <body>
        ...
        <table>
 		...
 		<form name="form2" method="post" action="">
    		<table class="inicio">
      			<tr>
        			<td class="titulos" colspan="2">.: Estados financieros </td>
					...
					<td style="background-repeat:no-repeat; background-position:center;">
						<ol id="lista2">
							<li onClick="location.href='ayuda.html'" style="cursor:pointer;">Balance general</li>
                            <li onClick="location.href='ayuda.html'" style="cursor:pointer;">Estado de resultados</li>
