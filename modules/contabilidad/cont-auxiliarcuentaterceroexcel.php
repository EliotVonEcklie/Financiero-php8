<?php 
header("content-disposition: attachment;filename=contabilidadcuentatercero.xls");
...
//$sqlr="Select distinct cuenta from pptocuentaspptoinicial where left(cuenta,1)>='2' and vigencia='".$_POST[vigencias]."'"; 	 	 
 // echo "<tr><td class='titulos2'>Cuenta</td><td class='titulos2'>Nombre</td><td class='titulos2'>PRES INI</td><td class='titulos2'>ADICION</td><td class='titulos2'>REDUCC</td><td class='titulos2'>CREDITO</td><td class='titulos2'>CONT CRED</td><td class='titulos2'>PRES DEF</td><td class='titulos2'>CDP</td><td class='titulos2'>RP</td><td class='titulos2' >ORDEN PAGO</td><td class='titulos2' >PAGOS</td></tr>";  
   echo "<table bordercolor=#333333 border=1 ><tr><td colspan='12' style='color:#000000; font-weight:bold;background-color:#cccccc' align='center'>$rs - $nit</td></tr><tr><td colspan='12' style='color:#000000; font-weight:bold;background-color:#ccddee' align='center' >AUXILIAR CONTABILIDAD CUENTA TERCERO - Periodo: $_POST[fecha] - $_POST[fecha2]</td></tr>";
  echo "<tr>
  ...
  <td style='color:#000000; font-weight:bold;background-color:#0066FF''>SALDO</td></tr>";  
...
for($x=0;$x<count($_POST[cuentas]);$x++)
 {		 	
	...
	$sumaop+=$row3[1];
	$sumap+=$row4[1];	
	printf($ft,''.$_POST[cuentas][$x],$_POST[ncuentas][$x],$_POST[terceros][$x],$_POST[nterceros][$x],$_POST[saldanteriores][$x],$_POST[debitos][$x],$_POST[creditos][$x],$_POST[nuevosaldos][$x]);	
 }
