...
<tr>
  ...
  <a href="#" <?php if($_POST[oculto]==2) { ?> onClick="pdf()" <?php } ?>><img src="imagenes/print.png" alt="Imprimir" title="Imprimir"></a></td>
</tr></table>
...
<?php
	if(!$_POST[oculto])
	{
		...
		$_POST[cuentagas2]=0;
		$link=conectar_bd();
		$sqlr="select max(consvigencia) from pptoreservas where vigencia=$_POST[vigencia] ";
...
?>
	...
	if($_POST[oculto]=='2')
	{
		...
		{
			$linkbd=conectar_bd();
			$sqlr="select count(*) from pptoreservas where vigencia='$_POST[vigencia]' and consvigencia=$_POST[numero]";
			$res=mysql_query($sqlr,$linkbd);
			//echo $sqlr;
			...
			if($numerorecaudos==0)
			{
				...
				$sqlr="insert into pptocomprobante_cab(numerotipo,tipo_comp,fecha,concepto,vigencia,total_debito,total_credito,diferencia,estado) values($_POST[numero],25,'$fechaf','$_POST[objeto]',$_POST[vigencia],'$_POST[cuentagas2]',0,0,'1')";
				mysql_query($sqlr,$linkbd);
				echo $sqlr."<br>";
				$sqlr="insert into pptoreservas (vigencia,consvigencia,fecha,valor,estado,objeto) values($_POST[vigencia],$_POST[numero],'$fechaf','$_POST[cuentagas2]','S','$_POST[objeto]')";
				// echo $sqlr."<br>";
	...
	//	 			$e =mysql_error($respquery);
				...
				{
					echo "<table class='inicio'><tr><td class='saludo1'>Se ha almacenado la Reserva con Exito <img src='imagenes\confirm.png'></center></td></tr></table>";
				}
				for ($x=0;$x<count($_POST[dcuentas]);$x++)
				{
					...
					mysql_query($sqlr,$linkbd); 		
					echo $sqlr."<br>";					
					$sqlr="insert into pptoreservas_det (vigencia,consvigencia,cuenta,valor,estado) values('$_POST[vigencia]','$_POST[numero]','".$_POST[dcuentas][$x]."',".$_POST[dgastos][$x].",'S')";
					$res=mysql_query($sqlr,$linkbd);
					// echo $sqlr."<br>";
				}
			}
			...
			{
				echo "<table class='inicio'><tr><td class='saludo1'><center>Ya Existe una Reserva con este Numero <img src='imagenes/alert.png'></center></td></tr></table>";
			}
		}
		else
		{
