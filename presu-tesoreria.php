...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<form action="presu-tesoreria.php" method="post" enctype="multipart/form-data" name="form2">
	<?php
		$_POST[tabgroup1]=1;
					...
					echo "<table class='inicio'>
						...
						if($_POST[oculto]==2)
						{
							...
							if($archivo)
							{
								...
								$sqlr1="delete from pptofuttesoreria";
								...
								{ 
									...
									$consulta = "INSERT INTO pptofuttesoreria (codigo, nombre) VALUES ('".trim($datos[0])."','".$dato."')";
							...
							$sql="select * from pptofuttesoreria order by codigo";
