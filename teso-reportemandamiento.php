	...
	<head>
		...
		function despliegamodal2(_valor,ventana)
			...
			function funcionmensaje()
			{
				...
				var proceso=document.getElementById('codproceso').value;
				var catas=document.getElementById('codcatastral').value;
				document.location.href = "teso-reportemandamientover.php?cod="+numdocar+"&proceso="+proceso+"&codcatas="+catas;
			}
		...
		titlepag();
			...
			$sql="SELECT MAX(codmandamiento) FROM tesoreportemandamiento";
			...
			if($_POST[bc]!='')
			{
				unset($_POST[descripcion1]);
				unset($_POST[cpdigo1]);
				unset($_POST[numresolucion1]);
				unset($_POST[codcatastral1]);
                        ...
                        <table class="inicio" >
							...
							<?php 
							 ...
							 echo "<tr class='$iter'>
								...
								<td><input name='codcatastralp[]' value='".$_POST[codcatastral]."'  style='width:100%;' readonly></td>
                ...
                <div class="tab">
                    ...
                    <div class="content" style="overflow:hidden;" >
                            ...
                            <tr>
								...
								<td colspan="1">
									<input name="fechaini" type="text" id="fechaini" title="DD/MM/YYYY" value="<?php echo $_POST[fechaini]; ?>" onKeyUp="return tabular(event,this) " onKeyDown="mascara(this,'/',patron,true)"  style="width: 98%" readonly>  
							   </td>
								<td style="width:5%;" class="saludo1">Fecha fin proceso:        </td>
								<td colspan="1">
									<input name="fechafin" type="text" id="fechafin" title="DD/MM/YYYY" value="<?php echo $_POST[fechafin]; ?>" onKeyUp="return tabular(event,this) " onKeyDown="mascara(this,'/',patron,true)"  style="width: 100%" readonly>	  
							   </td>
                            </tr>
                        </table>
                        	 ...
                        	 echo"
                                ...
                                if ($_POST[agregadet3]=='1')
                                {
                                    ...
                                    {			 
                                        ...
                                        $_POST[patharchivosman][]=$_POST[patharchivo];
                                        $_POST[agregadet3]=0;
                                        echo"
                                        <script>	
                                ...
                                {
                                	$rutaarchivo=$_POST[patharchivosmanman][$x];
                                    echo "
		 	...
		 	if($_POST[oculto]=="2")
			{
				...
				if (!mysql_query($sqlr,$linkbd))
				{
					...
					{ 	
						...
						echo "<script>despliegamodalm4('visible','1','Se almaceno el mandamiento de pago con exito');</script>";
