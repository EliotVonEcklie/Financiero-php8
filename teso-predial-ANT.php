...
//				$fechaini=mktime(0,0,0,1,1,$r[0]);
	...
	$fechaf=$fecha[3]."-".$fecha[2]."-".$fecha[1];
	  $linkbd=conectar_bd();
	  $sqlr="insert into tesoliquidapredial ( `codigocatastral`, `fecha`, `vigencia`, tercero,`tasamora`, `descuento`, `tasapredial`, `totaliquida`, `totalpredial`, `totalbomb`, `totalmedio`, `totalinteres`, `intpredial`, `intbomb`, `intmedio`, `totaldescuentos`, concepto,`estado`) values ('$_POST[catastral]','$fechaf','".$_SESSION[vigencia]."','$_POST[tercero]',$_POST[tasamora],$_POST[descuento],$_POST[tasa],$_POST[totliquida],$_POST[totpredial], $_POST[totbomb],$_POST[totamb] ,$_POST[totint],$_POST[intpredial],$_POST[intbomb],$_POST[intamb],$_POST[totdesc],'".utf8_decode("Años Liquidados:".$ageliqui)."','S')";
