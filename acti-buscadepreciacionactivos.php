...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, grupo){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="acti-editadepreciacionactivos.php?idproceso="+grupo+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&clase="+idcta;
			}
		</script>
		<script>
			...
			function funcionmensaje(){document.location.href = "acti-creaciondepreciacionactivos.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
	  				<a href="acti-creaciondepreciacionactivos.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a>
		...
		?>
 		<form name="form2" method="post" action="acti-buscadepreciacionactivos.php">
			...
			<?php 
				...
				//if($_POST[oculto])
				{
					...
					$sqlr="SELECT * FROM acti_depreciacionactivos_cab WHERE estado='S'";
					...
					$sqlr="SELECT * FROM acti_depreciacionactivos_cab WHERE estado='S' ORDER BY id";
					$resp = mysql_query($sqlr,$linkbd);
