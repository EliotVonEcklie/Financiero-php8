		...
		<script>
			function verUltimaPos(idcta, idcta1, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="presu-tipomovimientoeditar.php?idproceso="+idcta+"&codproceso="+idcta1+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
    	<script>
