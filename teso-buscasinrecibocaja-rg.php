...
$tipos=array('Predial','Industria y Comercio','Otros Recaudos');
 while ($row =mysql_fetch_row($resp)) 
 {
	 ...
	 echo "<td style='text-align:center;'><a href='teso-sinrecibocaja-regrabar.php?idrecibo=$row[0]&tiporeca=$row[10]'><img src='imagenes/b_edit.png' style='width:18px' title='Editar'></a></td></tr>";
	 $con+=1;
	 $aux=$iter;
	 $iter=$iter2;
	 $iter2=$aux;
