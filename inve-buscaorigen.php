		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="inve-editaorigen.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<script>
...
<tr>
  <td colspan="3" class="cinta"><a href="inve-origen.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a><a class="mgbt"><img src="imagenes/guardad.png"/></a><a onClick="document.form2.submit();" href="#" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a><a href="#" onClick="mypop=window.open('inve-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a href="#" onClick="iratras()" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td></tr>	
</table>
        <?php
		if($_GET[numpag]!=""){
			$oculto=$_POST[oculto];
		...
		?>
 <form name="form2" method="post" action="inve-buscaorigen.php">
            <input type="hidden" name="numres" id="numres" value="<?php echo $_POST[numres];?>"/>
 			...
 			<?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					{
                        $sqlr="UPDATE almorigenes SET estado='S' WHERE codigo='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
                        $sqlr="UPDATE almorigenes SET estado='N' WHERE codigo='".$_POST[idestado]."'";
                     	mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
				}
				//*****************************************************************
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Origen</td>
        <td style="width:7%" class="cerrar" ><a href="acti-principal.php">Cerrar</a></td>
      </tr>
      <tr >
    ...
    <div class="subpantalla" style="height:68.5%; width:99.6%; overflow-x:hidden;" id="divdet">
      <?php
		...
		$crit1="where concat_ws(' ', codigo, nombre) LIKE '%$_POST[nombre]%'";
			$sqlr="select * from almorigenes ".$crit1." order by codigo";
			...
			$ntr = mysql_num_rows($resp);
					...
					$sqlr="SELECT * from almorigenes ".$crit1." order by codigo ".$cond2;
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
		...
		if(($_POST[numpos]==0)||($_POST[numres]=="-1")){
			...
			echo "<table class='inicio' align='center' width='80%'>
				...
				<tr>
					<td colspan='5'>Origenes Encontrados: $ntr</td>
				</tr>
				<tr>
