		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="teso-editaconcecontablesgassf.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<script>
//************* ver reporte ************
...
{
document.form2.action="teso-buscaconcecontablespresial.php";
document.form2.submit();
}
function cleanForm()
{
...
document.form2.razonsocial.value="";
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta"><a href="teso-concecontablesgassf.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo" /></a><a class="mgbt"><img src="imagenes/guardad.png" /></a><a onClick="document.form2.submit();" href="#" class="mgbt"><img src="imagenes/busca.png" title="Buscar" /></a><a href="#" onClick="mypop=window.open('teso-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a> <a href="teso-concecontables.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td></tr>	
        </table>
        <?php
		if($_GET[numpag]!=""){
			$oculto=$_POST[oculto];
		...
		?>
 <form name="form2" method="post" action="teso-buscaconcecontablesgassf.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="4">:: Buscar Parametro Contable Gastos SSF</td>
        <td style="width:2%" class="cerrar" ><a href="teso-principal.php">Cerrar</a></td>
      </tr>
      <tr >
	...
	$sqlr="select *from conceptoscontables where conceptoscontables.tipo='GS' and conceptoscontables.modulo='4' ".$crit1." order by conceptoscontables.codigo";
$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *from conceptoscontables where conceptoscontables.tipo='GS' and conceptoscontables.modulo='4' ".$crit1." order by conceptoscontables.codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
		...
		echo "<table class='inicio' align='center'>
			...
			<tr>
				<td colspan='3'>Concepto Contable Predial Encontrados: $ntr</td>
			</tr>
			<tr>
