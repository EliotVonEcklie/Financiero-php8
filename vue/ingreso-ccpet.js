var app = new Vue({
    ...
    methods:{
        ...
        searchMonitor: function() {
            ...
            axios.post('vue/ingreso-ccpet.php?action=search', keyword)
        ...
        searchHastaNivel10: function(codigo)
        {
            ...
            codigo_n5 = codigo_n6.slice(0,-3);
            codigo_n4 = codigo_n5.slice(0,-4);
            codigo_n3 = codigo_n4.slice(0,-3);
            codigo_n2 = codigo_n3.slice(0,-3);

            this.padreNivel_3 = codigo_n2;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_3)
                .then(function(response){
                    app.nivel_3 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_3)
                .then(function(response){
                    app.nombreNivel_2 = response.data.nombre[0];
                });

            this.padreNivel_4 = codigo_n3;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_4)
                .then(function(response){
                    app.nivel_4 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_4)
                .then(function(response){
                    app.nombreNivel_3 = response.data.nombre[0];
                });
            
            this.padreNivel_5 = codigo_n4;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_5)
                .then(function(response){
                    app.nivel_5 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_5)
                .then(function(response){
                    app.nombreNivel_4 = response.data.nombre[0];
                });

            this.padreNivel_6 = codigo_n5;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_6)
                .then(function(response){
                    app.nivel_6 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_6)
                .then(function(response){
                    app.nombreNivel_5 = response.data.nombre[0];
                });

            this.padreNivel_7 = codigo_n6;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_7)
                .then(function(response){
                    app.nivel_7 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_7)
                .then(function(response){
                    app.nombreNivel_6 = response.data.nombre[0];
                });
            
            this.padreNivel_8 = codigo_n7;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_8)
                .then(function(response){
                     app.nivel_8 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_8)
                .then(function(response){
                    app.nombreNivel_7 = response.data.nombre[0];
                });
            
            this.padreNivel_9 = codigo_n8;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_9)
                .then(function(response){
                    app.nivel_9 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_9)
                .then(function(response){
                    app.nombreNivel_8 = response.data.nombre[0];
                });

            this.padreNivel_10 = codigo_n9;
            axios.post('vue/ingreso-ccpet.php?codigo='+this.padreNivel_10)
                .then(function(response){
                    app.nivel_10 = response.data.codigos;
                });
            axios.post('vue/ingreso-ccpet.php?nombre='+this.padreNivel_10)
                .then(function(response){
