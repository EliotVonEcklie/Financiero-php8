var app = new Vue({
    ...
    methods:{
        ...
        show_levels: function(codigo){
            ...
            //console.log(codigo_final.length);
            if(codigo_final.length == 7)
            {
                codigo_subClase = codigo_final.slice(0,-2);
            }
            else
            {
                codigo_subClase = codigo_final;
            }
            //console.log(codigo_subClase);
        ...
        buscarNombre: async function(codigo_buscar){
            await axios.post('vue/ccp-servicios.php?action=buscaNombre', 
            JSON.stringify({
                name: codigo_buscar
                })
            )
        ...
        searchMonitor: function() {
            ...
            //console.log(keyword);
            axios.post('vue/ccp-servicios.php?action=searchSeccion', keyword)
                .then(function(response){
        ...
        searchMonitorDivision: function() {
            ...
            axios.post('vue/ccp-servicios.php?action=searchDivision&grupoSearch='+this.seccion_p, keywordDivision)
                .then(function(response){
        ...
        searchMonitorGrupos: function() {
            ...
            axios.post('vue/ccp-servicios.php?action=searchGrupo&divisionSearch='+this.division_p, keywordGrupo)
                .then(function(response){
        ...
        searchMonitorClases: function() {
            ...
            axios.post('vue/ccp-servicios.php?action=searchClase&grupoSearch='+this.grupo_p, keywordClase)
                .then(function(response){
        ...
        searchMonitorSubClases: function() {
            ...
            //console.log(this.programa_p);
            axios.post('vue/ccp-servicios.php?action=searchSubClase&subClaseSearch='+this.clase_p, keywordSubClase)
                .then(function(response){
        ...
        buscarSubclase: function(clase, scrollArriba = false)
        {
            ...
            if(app.mostrarSubClase)
            {
                ...
                //console.log();
                axios.post('vue/ccp-servicios.php?clase='+this.clase_p)
                    .then(function(response){
                        app.subClases = response.data.subClases;
                        if(response.data.subClases == ''){
                            app.mostrarSubClase = false;
