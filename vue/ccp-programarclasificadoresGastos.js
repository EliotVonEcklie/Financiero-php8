var app = new Vue({
    ...
    methods:{
        ...
        listClasificadores: function(){
            axios.post('vue/ccp-programarClasificadoresGastos.php?action=list_clasi')
        ...
        mostrarModal: async function(cuenta){
            ...
            await axios.post('vue/ccp-programarClasificadoresGastos.php?action=buscarCuenta&cuenta=' + cuenta[1])
            .then(function(response){
        ...
        traerNivel10: function( DataNivelActual){
            ...
            axios.post('vue/ccp-programarClasificadoresGastos.php?action=traeDatosCodigoPadre', formData)
                .then(function(response){
        ...
        traerNivel9: function(DataNivelActual, padre){
            ...
            if(padre == 'Si'){
                formData.append("codepadre", DataNivelActual);
                var url = 'vue/ccp-programarClasificadoresGastos.php?action=traeDatosCodigoPadre';
            }else if(padre == 'No'){
                formData.append("code", DataNivelActual);
                var url = 'vue/ccp-programarClasificadoresGastos.php?action=traeDatosCodigo';
            }
        ...
        guardarClasificadores: function(){
            ...
            axios.post('vue/ccp-programarClasificadoresGastos.php?action=guardarClasificadores', formData)
                .then(function(response){
        ...
        searchHastaNivel3: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_3) 
                    .then((response) => {
        ...
        searchHastaNivel4: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_4) 
                    .then((response) => {
        ...
        searchHastaNivel5: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_5) 
                    .then((response) => {
        ...
        searchHastaNivel6: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_6) 
                    .then((response) => {
        ...
        searchHastaNivel7: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_7) 
                    .then((response) => {
        ...
        searchHastaNivel8: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_8) 
                    .then((response) => {
        ...
        searchHastaNivel9: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_9) 
                    .then((response) => {
        ...
        searchHastaNivel10: async function(codigo){
           ...
           await axios.post('vue/ccp-programarClasificadoresGastos.php?codigo='+this.padreNivel_10) 
                    .then((response) => {
