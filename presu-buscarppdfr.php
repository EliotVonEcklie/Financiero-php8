...
<?php
	...
	class MYPDF extends TCPDF 
	{
		public function Header() 
		{
			...
			$this->SetY(10);
			$this->SetX(62);
			$this->Cell(190,17,'Registros Presupuestales Reversados',0,0,'C'); 
...
EOD;
	...
	$pdf->SetTitle('RP Reversion');
	$pdf->SetSubject('RP Reversion');
	...
	$sqlr="SELECT TB1.*,TB2.user,TB2.detalle FROM pptorp TB1, pptorp_cab_r TB2 WHERE TB1.estado='R' AND TB1.vigencia=TB2.vigencia AND TB1.consvigencia=TB2.consvigencia AND TB2.tipo_mov='02' $crit1 $crit2 $crit3 ORDER BY TB1.consvigencia";
	$resp = mysql_query($sqlr,$linkbd);
	while ($row =mysql_fetch_row($resp))
	{
