...
document.form2.oculto.value=2;
document.form2.action="teso-conceretencion.php";
document.form2.submit();
}
function validar()
{
...
<table>
	...
	<tr>
		<td colspan="3" class="cinta">
			...
			<a href="teso-buscaconceretencion.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a>
...
if(!$_POST[oculto])
{
		 ...
		 $_POST[valor]=0;		 
		  $sqlr="select MAX(codigo) from conceptoscontables where modulo=4 and tipo='RE' and left(codigo,1)!='P' order by codigo Desc";
		 //echo $sqlr;
...
<?php //**** busca cuenta
    ...
    <table class="inicio" align="center"  >
      <tr >
        <td class="titulos" colspan="7">.: Concepto Contable Retenciones </td>
      ...
      <tr  >
		<td style="width:8%;" class="saludo1">C&oacute;digo:</td>
		 ...
		 <td style="width:8%;" class="saludo1">Nombre:</td>
		  ...
		  <td class="saludo1" style="width:5%;">Tipo:</td><td style="width:15%;"><input name="tipo" value="Retenciones"  type="text">
		  <input name="tipoc" value="RE"  type="hidden">
