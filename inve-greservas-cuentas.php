...
<link href="css/css3.css?<?php echo date('d_m_Y_h_i_s');?>" rel="stylesheet" type="text/css" />
		...
		<script>
			...
			{ 
				parent.document.getElementById('cuenta').value=opc1;	
				parent.document.getElementById('ncuenta').value=opc2;
				//parent.document.getElementById('nreserva').focus();
				//parent.document.getElementById('nreserva').select();
		...
		<form name="form2" method="post">
			...
			?>
 			<table  class="inicio" style="width:99.4%;" >
      			<tr>
              		<td class="titulos" colspan="4">:: Buscar Cuentas Concepto Contables</td>
			...
			<?php
                    ...
                    if ($_POST[nombre]!=""){$crit2="AND nombre LIKE '%$_POST[nombre]%'";}
 					$sqlr="SELECT * FROM conceptoscontables WHERE tipo='C' AND modulo='3' $crit1 $crit2 ";
 					$resp=mysql_query($sqlr,$linkbd);
					$_POST[numtop]=mysql_num_rows($resp);
					$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
					$sqlr="SELECT * FROM conceptoscontables WHERE tipo='C' AND modulo='3' $crit1 $crit2 ORDER BY length(codigo),codigo ASC LIMIT $_POST[numpos],$_POST[numres]";
 					$resp=mysql_query($sqlr,$linkbd);
					...
					echo"
 					<table class='inicio'>
						...
						<tr><td colspan='3'>Articulos Encontrados: $_POST[numtop]</td></tr>
 						<tr>
