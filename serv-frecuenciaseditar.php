		...
		<form name="form2" method="post" action="">
			<?php
				if(@ $_POST['oculto']=="")
				{
					...
					$_POST['codban']=$row[0];ate('d/m/Y',strtotime($fechas[25]));
					$_POST['nomban']=$row[1];
					$_POST['fechac']=date('d/m/Y',strtotime($fechas[2]));
					$_POST['fechaf']=date('d/m/Y',strtotime($fechas[3]));
			...
			<?php
				if(@ $_POST['oculto']=="2")
				{
					...
					$sqlr ="UPDATE srvfrecuencias SET nombre='".$_POST['nomban']."','$fechac','$fechaf',estado='$valest' WHERE id='".$_POST['codban']."'";
