		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="cont-editagastosoperacioncomercial.php?is="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<script>
//************* ver reporte ************
...
{
document.form2.action="cont-buscagastosoperacioncomercial.php";
document.form2.submit();
}
...
<?php titlepag();?>
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta"><a href="cont-gastosoperacioncomercial.php" class="mgbt" ><img src="imagenes/add.png" title="Nuevo" /></a><a class="mgbt"><img src="imagenes/guardad.png"/><a onClick="document.form2.submit();" href="#" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a href="#" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" alt="Nueva Ventana"></a> <a href="cont-menupresupuesto.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
      		</tr>
		</table>	
        <?php
		if($_GET[numpag]!=""){
		...
		?>
 		<form name="form2" method="post" action="cont-buscagastosoperacioncomercial.php">
...
<table  class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="2">:: Buscar Gasto de Operaci&oacute;n Comercial</td>
...
$sqlr="select * from conceptoscontables where tipo='GO' and modulo='3' ".$crit1." order by codigo";
$resp = mysql_query($sqlr,$linkbd);
$ntr = mysql_num_rows($resp);
		$_POST[numtop]=$ntr;
		$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
		$sqlr="select *	 from conceptoscontables where tipo='GO' and modulo='3' ".$crit1." order by codigo ".$cond2;
		$resp = mysql_query($sqlr,$linkbd);			
		$co='saludo1a';
		$co2='saludo2';	
		...
		echo "<table class='inicio' align='center'>
			...
			<tr>
				<td colspan='3'>Gastos de Operaci&oacute;n Comercial Encontrados: $ntr</td>
			</tr>
			<tr>
