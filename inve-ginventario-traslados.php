		...
		<form name="form2" method="post">
			...
			?>
 			<table  class="inicio" style="width:99.4%;" >
      			<tr>
              		<td class="titulos" colspan="4">:: Buscar Traslados</td>
			...
			<?php
                    ...
                    if ($_POST[nombre]!=""){
 					...
 					$sqlr="SELECT codigo, nombre FROM almginventario WHERE tipomov='$tipomov' AND tiporeg='$tipoentra' AND bodega2='$bodega'";
 					$resp=mysql_query($sqlr,$linkbd);
					$_POST[numtop]=mysql_num_rows($resp);
					$nuncilumnas=ceil($_POST[numtop]/$_POST[numres]);
					$sqlr="SELECT consec, nombre, fecha FROM almginventario WHERE tipomov='$tipomov' AND tiporeg='$tipoentra' AND bodega2='$bodega' $crit1 $crit2 ORDER BY fecha DESC, codigo DESC LIMIT $_POST[numpos],$_POST[numres]";
 					$resp=mysql_query($sqlr,$linkbd);
