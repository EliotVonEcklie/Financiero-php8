...
document.form2.action="teso-sinrecaudos-regrabar.php";
document.form2.submit();
}
}
</script>
...
document.form2.action="teso-recaudos-regrabar.php";
document.form2.submit();
 }
}
</script>
...
?>
 <form name="form2" method="post" action=""> 
    <table class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="11">Interfaz Cont Liquidar Ingresos Propios</td>
...
//	$sqlr="update comprobante_det set tercero='$_POST[tercero]' where id_comp='11 $_POST[idcomp]'";
	$sqlr="update comprobante_cab set estado=1 where tipo_comp=2 and numerotipo=$_POST[idcomp]";
	mysql_query($sqlr,$linkbd);			
