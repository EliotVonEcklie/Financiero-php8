...
<body>
	<form name="form2" method="post" action="plan-actareasbuscaredireccionadas.php" >
	<table  class="inicio" align="center" >
		<tr>
        	<td class="titulos" colspan="5">:: Buscar Tareas Redireccionadas </td>
      	</tr>
      	<tr>
    ...
    <div class="subpantallac5" style="height:86%; overflow-x:hidden;">
		...
		if($_POST[oculto])
		{
			...
			$crit2=" AND cgd.codigospid LIKE '%$_POST[documento]%' ";
           	$sqlr="SELECT res.*,rad.numeror,rad.fechalimite,rad.descripcionr FROM planacresponsables res, planacradicacion rad WHERE res.codradicacion=codigobarras AND res.estado='R' AND res.usuariocon='".$_SESSION[cedulausu]."'".$crit1.$crit2."  ORDER BY codigo ASC";
			...
			echo'
				<table class="inicio">        
                	<tr>
                    	<td class="titulos" colspan="6">::Lista de Tareas Redireccionadas</td>
                    </tr>
					<tr>
