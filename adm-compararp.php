	...
	<body>
        ...
        <table>
        	...
        	<tr>
				...
				<a href="adm-comparavalorcomprobantes.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a>
				</td>
         	</tr>	
		</table>
 		<form name="form2" method="post" action="">  
					...
					$vigusu=vigencia_usuarios($_SESSION[cedulausu]);
						...
						echo "<table class='inicio' align='center'>
							<tr class='titulos' style='text-align:center;'>
								<td style='width:7%;'>No rp - tabla original</td>
								<td style='width:7%;'>No rp - tabla general</td>
								<td style='width:7%;'>Valor rp - tabla original</td>
								<td style='width:7%;'>Valor rp - tabla general</td>
			...
			<div class="subpantallac5" style="height:70%; width:99.6%; margin-top:0px; overflow-x:hidden" id="divdet">
				<table class='inicio' align='center'>
					<?php
						$sqlr="select consvigencia,saldo from pptorp where vigencia='$vigusu'";
						$r=mysql_query($sqlr,$linkbd);
						while($row =mysql_fetch_row($r))
						{
							$sqlr1="select sum(valdebito),sum(valcredito), numerotipo,tipo_comp from pptocomprobante_det where vigencia='$vigusu' and numerotipo='$row[0]' and tipo_comp='7'";
