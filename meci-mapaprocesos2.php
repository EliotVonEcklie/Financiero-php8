  ...
  <div class="row">}
      ...
      <div class="col-lg-8">
        <!- Inicio Procesos ->
            ...
            <div class="panel panel-primary" style='margin-bottom: 3px;'> <!-- panel panel-primary-->
              
              <div class="panel-heading" aria-hidden="true" data-toggle="collapse" data-target="#collapseProcesos<?php echo $t ?>" aria-expanded="false" aria-controls="collapseProcesos<?php echo $t ?>"> 
                <h5 class="panel-title"><?php echo "".$tprocesos[$t][2] ?>
                  <span class="glyphicon glyphicon-chevron-right" aria-hidden="true" data-toggle="collapse" data-target="#collapseProcesos<?php echo $t ?>" aria-expanded="false" aria-controls="collapseProcesos<?php echo $t ?>"></span>
                </h5>
              </div> 

              <div class="collapse" id="collapseProcesos<?php echo $t ?>">
                <div class="panel-body" id="P<?php echo $tprocesos[$t][0]?>">
                    <?php	   
                      // echo "sss".$cv;
                      for($x=1;$x<=$cv;$x++ ){
                  	   	   //echo "t:".$tprocesos[$t][1];
