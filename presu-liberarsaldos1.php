...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    ...
    <body >
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta"><a onClick="location.href='presu-liberarsaldos.php'" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar"/></a><a onClick="location.href='presu-buscarp.php'" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a onClick="mypop=window.open('presu-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a <?php if($_POST[oculto]==2) { ?> onClick="pdf()" <?php } ?> class="mgbt"><img src="imagenes/print.png" title="Imprimir"></a></td>
        	</tr>
   		</table>
        <form name="form2" method="post" action="">
			<?php
                ...
                if(!$_POST[oculto])
                {
                    ...
                    if(!$maximo){$_POST[idcomp]=1;}
                    else{$_POST[idcomp]=$maximo+1;}
                }
                //***** busca tercero
                if($_POST[bt]=='1')
                {
                ...
                if($_POST[bc]!='')
                {
                    ...
                    if($nresul!='')
                    {
                        ...
                        $ind=substr($_POST[cuenta],0,1);			
                        if($ind=='R' || $ind=='r'){$ind=substr($_POST[cuenta],1,1);}
                        if ($ind=='2')
    		...
    		<table class="inicio" align="center"  >
                ...
                <tr>
                    <input type="hidden" name="brp" id="brp" value="0">
                    <input type="hidden" name="oculto" id="oculto" value="1" >
                    <td class="saludo1">Registro:</td>
                    <td><input  type="text" name="rp" value="<?php echo $_POST[rp]?>" size="10" onKeyUp="return tabular(event,this)" onBlur="buscarp(event)" >&nbsp;<a href="#" onClick="mypop=window.open('registro-ventana.php?vigencia=<?php echo $_POST[vigencia]?>','','menubar=0,scrollbars=yes, toolbar=no, location=no, width=900,height=500px');mypop.focus();"><img src="imagenes/buscarep.png" align="absmiddle" border="0"></a></td>
                    ...
                    <td colspan="3"><input type="text" id="detallecdp" name="detallecdp" value="<?php echo $_POST[detallecdp]?>" size="80" readonly></td>
                </tr>      
                <tr><td class="saludo1">Concepto Liberacion</td><td colspan="7"><input type="text" id="detalle" name="detalle" value="<?php echo $_POST[detalle]?>" size="155" ></td></tr> 
            </table>
            <?php
                //***** busca tercero
                if($_POST[bt]=='1')
            ...
            <div class="subpantallac" style="height:60%; width:99.6%; overflow-x:hidden;">
				<table class="inicio" >
        			<tr><td class="titulos" colspan="6">Detalle RP</td></tr>
					<tr>
						<td class="titulos2">Cuenta</td>
                        <td class="titulos2">Nombre Cuenta</td>
                        <td class="titulos2">Valor CDP</td>
                        <td class="titulos2">Saldo CDP</td>
                        <td class="titulos2">Valor RP</td>
                        <td class="titulos2">Saldo Liberar</td></tr>
		  				<?php
		  					if ($_POST[oculto]==1)
		   					{
		  	 					$_POST[dcuentas]=array();
							...
							for ($x=0;$x< count($_POST[dcuentas]);$x++)
							{
								...
								<input type='hidden' name='dcdpvalor[]' value='".$_POST[dcdpvalor][$x]."'/>
					...
					onMouseOut=\"this.style.backgroundColor=anterior\">
									...
									<td>".$_POST[dcdpvalor][$x]."</td>
									<td><input name='dcdpsaldo[]' value='".$_POST[dcdpsaldo][$x]."' type='text' style='width:100%;' ></td>
									<td>".$_POST[dgastos][$x]."</td>
									<td ><input name='dsgastos[]' value='".$_POST[dsgastos][$x]."' type='text' style='width:100%;' ></td>
								</tr>";
								//$cred= $vc[$x]*1;
								$gas=$_POST[dgastos][$x];
		 ...
		 echo "<tr><td ></td><td ></td><td class='saludo1'>
		 <input id='cuentacdp' name='cuentacdp' value='$_POST[cuentacdp]' style='width:100%;' readonly>
		 <input id='cuentacdp2' name='cuentacdp2' value='$_POST[cuentacdp2]' type='hidden'></td><td class='saludo1'>
		 <input id='cuentascdp' name='cuentascdp' value='$_POST[cuentascdp]' style='width:100%;' readonly>
		 <input id='cuentascdp2' name='cuentascdp2' value='$_POST[cuentascdp2]' type='hidden'></td><td class='saludo1'>
		 <input id='cuentagas' name='cuentagas' value='$_POST[cuentagas]' style='width:100%;' readonly>
		 <input id='cuentagas2' name='cuentagas2' value='$_POST[cuentagas2]' type='hidden'></td><td class='saludo1'>
		 <input id='cuentasgas' name='cuentasgas' value='$_POST[cuentasgas]' style='width:100%;' readonly>
		 <input id='cuentasgas2' name='cuentasgas2' value='$_POST[cuentasgas2]' type='hidden'></td></tr>";
		 echo "<tr><td class='saludo1'>Son:</td><td class='saludo1' colspan= '4'><input id='letras' name='letras' value='$_POST[letras]' type='text' style='width:100%;'></td></tr>";
		?>
		</table>
        </div>
    </form>
