...
{
if(document.form2.ingreso.value!="" &&  parseFloat(document.form2.valor.value)>0 && document.form2.tercero.value!="")
{ 
 ...
 document.form2.submit();
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta"><a href="ccp-distribucionconpes.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#"  onClick="guardar();" class="mgbt"><img src="imagenes/guarda.png" title="Guardar"/></a><a href="ccp-buscadistribucionconpes.php" class="mgbt"><img src="imagenes/busca.png"  title="Buscar" /></a><a href="#" onClick="mypop=window.open('ccp-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a></td>
        	</tr>		  
        </table>
<?php
$linkbd=conectar_bd();
...
//echo "<br>  Oc:".$_POST[oculto];
		  $sqlr="select  MAX(ID_CONPES) from presuconpes  ";
		 //echo $sqlr;
...
<?php  //***** busca tercero
    ...
    <table class="inicio" align="center" >
      <tr >
        <td class="titulos" colspan="8">.: Agregar Conpes  -   *Nota: No se usa para SSF</td><td class="cerrar" ><a href="ccp-principal.php">Cerrar</a></td>
      </tr>
      <tr  >
	  ...
	  <td colspan="1"><select name="ingreso" id="ingreso" >
				  <option value="-1">Seleccione ....</option>
					<?php
					 $sqlr="Select * from tesoingresos  where estado='S' and tipoIngreso='sgp' order by codigo";
	...
	?>
          ...
          <td class="saludo1">Valor :</td><td ><input type="text" name="valor" value="<?php echo $_POST[valor]?>" size="12" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)"><input  type="button" name="agregact" value="Agregar" onClick="agregardetalle()"><input type="hidden" value="" name="agregadet"></td>
	  </tr>
    </table>
	 <?php
			 //***** busca tercero
	   ...
	   <table class="inicio">
		...
		if ($_POST[elimina]!='')
		 ...
		 <script>
				...
				document.form2.ingreso.value="";
				document.form2.tercero.value="";

				document.form2.ningreso.value="";				
				document.form2.tipog.select();
		  		document.form2.tipog.focus();	
		 </script>         
		  <?php
		  }
		  $_POST[totalc]=0;
		 ...
		 echo "<tr><td></td><td></td><td></td><td class='saludo2'>Total</td><td class='saludo1'><input name='totalcf' type='text' value='$_POST[totalcf]' readonly ><input name='totalc' type='hidden' value='$_POST[totalc]'></td></tr><tr><td class='saludo1'>Son:</td><td colspan='6' ><input name='letras' type='text' value='$_POST[letras]' size='90'></td></tr>";
		?> 
	   </table>       
       </div>
  <?php
...
if($_POST[oculto]=='2')
{
	...
	$consec=0;
	$sqlr="insert into presuconpes (nombre_conpes,fecha,tipo_conpes,vigencia,estado) values('".$_POST[concepto]."','$fechaf','',".$vigusu.",'S')";	  
...
//***cabecera comprobante
	...
	for($x=0;$x<count($_POST[dcoding]);$x++)
	 {
	$sqlr="insert into presuconpes_det(id_conpes,tipomov,cc,tercero,codigo,valor) values($idconsig,'".$_POST[dmovs][$x]."','".$_POST[dccs][$x]."','".$_POST[dterceros][$x]."','".$_POST[dcoding][$x]."',".str_replace(",",".",$_POST[dvalores][$x]).")";	  
