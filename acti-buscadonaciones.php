...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="acti-editardonaciones.php?&idcta="+idcta;
			}
		</script>
		<script>
			...
			function funcionmensaje(){document.location.href = "acti-buscadonaciones.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
	  				<a href="acti-donaciones.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a>
		...
		?>
 		<form name="form2" method="post" action="acti-buscadonaciones.php">
        	<?php 
				if($_POST[oculto]=="")
				{
					$_POST[cambioestado]="";
...
/*				if($_POST[cambioestado]!="")
			...
			<?php 
				...
				//if($_POST[oculto])
				{
					...
					$sqlr="SELECT * FROM acti_recuperaciones_cab";
					...
					<table class='inicio' align='center' width='100%'>
						...
						<tr>
							...
							<td class='titulos2' style=\"width:25%\">Valor</td>
							<td class='titulos2' style=\"width:25%\">Fecha</td>
