...
$actual="";
	...
	$nuevo=1;
		...
		$ntercero="";
		$codigorural="";
		$sqlr2="select *from tesoreportemandamiento where codcatastral='".$_POST[codcatastral][0]."'  group by codcatastral";
		//echo $sqlr2;
		...
		$sqlr="select *from tesopredios where cedulacatastral='".$_POST[codcatastral][0]."' and estado='S' group by cedulacatastral";
		$res=mysql_query($sqlr,$linkbd);
		while($row=mysql_fetch_row($res))
		{
			$direccion=$row[7];
		...
		$sqlr1="select numresolucion,fecha,sum(valortotal) from tesocobroreporte where codcatastral='".$_POST[codcatastral][0]."' group by codcatastral";
