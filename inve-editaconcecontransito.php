...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function funcionmensaje(){document.location.href = "inve-concecontransito.php";}
			function guardar()
			{
			...
			function agregardetalle()
			{
				...
				else {alert('Falta digitar la Fecha');}
			}
			...
			function adelante(scrtop, numpag, limreg, filtro, next)
			{
				...
				if(parseFloat(maximo)>parseFloat(actual))
				{
					...
					document.form2.action="inve-editaconcecontransito.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			...
			{
                var idcta=document.getElementById('codigo').value;
                location.href="inve-buscaconcecontransito.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
            }
			function validar3(formulario)
			{
				document.form2.action="teso-editaconcecontransito.php";
				document.form2.submit();
			}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta"><img src="imagenes/add.png" title="Nuevo" onClick="location.href='inve-concecontransito.php'" class="mgbt"/><img src="imagenes/guarda.png" title="Guardar" onClick="guardar()" class="mgbt"/><img src="imagenes/busca.png" title="Buscar" onClick="location.href='inve-buscaconcecontransito.ph'" class="mgbt"/><img src="imagenes/nv.png" title="Nueva Ventana" onClick="mypop=window.open('cont-principal.php','','');mypop.focus();" class="mgbt"/><img src="imagenes/iratras.png" title="Atr&aacute;s" onClick="iratras(<?php echo"$scrtop,$numpag,$limreg,$filtro";?>)" class="mgbt"/></td>
			</tr>
   		</table>
	 ...
	 ?>
    		<table class="inicio" align="center"  >
      			<tr >
        			<td class="titulos" colspan="8">.: Editar Concepto Contable Articulo en Transito </td>
        			<td class="cerrar" style="width:7%;"><a href="inve-principal.php">&nbsp;Cerrar</a></td>
      			</tr>
      			<tr>
					<td class="saludo1" style="width:2cm;">C&oacute;digo:</td>
          			<td style="width:10%;"><img src="imagenes/back.png" title="anterior" class="icobut" onClick="atrasc(<?php echo "$scrtop,$numpag,$limreg,$filtro,$prev";?>)">&nbsp;<input type="text" name="codigo" id="codigo" onKeyPress="javascript:return solonumeros(event)" onKeyUp="return tabular(event,this)" value="<?php echo $_POST[codigo]?>" readonly style="width:50%;"/>&nbsp;<img src="imagenes/next.png" title="siguiente" class="icobut" onClick="adelante(<?php echo "$scrtop,$numpag,$limreg,$filtro,$next";?>)"></td>
			...
			<table class="inicio">
				...
				<tr>
                    ...
                    <td style="width:20%;">
						<select name="cc" id="cc" onKeyUp="return tabular(event,this)" style='width:75%;text-transform:uppercase'>
							<?php
