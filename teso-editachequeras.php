...
<link href="css/css3.css" rel="stylesheet" type="text/css" />
		<script>
			...
			function iratras(scrtop, numpag, limreg, filtro){
				var idcta=document.getElementById('ids').value;
				location.href="teso-buscachequeras.php?idcta="+idcta+"&scrtop="+scrtop+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
<?php titlepag();?>
</head>
...
?>
 <form name="form2" method="post" action="">
    <table class="inicio" align="center" >
	  ...
	  <td width="161"  class="saludo1">Fecha:        </td>
        ...
        <td style="width:10%" >
						...
						<input type="text" id="numero" name="numero" value="<?php echo $_POST[numero]?>" style="width:15%; text-align:center;" onKeyUp="return tabular(event,this)"  onKeyPress="javascript:return solonumeros(event)" readonly >
	...
	//		  }
	  ...
	  <td width="550" ><input type="text" id="valor2" style="width:25%" name="valor2" value="<?php echo $_POST[valor2]?>"  onKeyUp="return tabular(event,this)"  onKeyPress="javascript:return solonumeros(event)" >
      <td width="10" class="saludo1">Estado:</td>
	    <td>
		  <?php  
                            		if($_POST[estado]=="S")
                            		{
                            			echo "<input name='estado' id='estado' type='text' value='ACTIVO' size='5' style='width:30%; background-color:#0CD02A; color:white; text-align:center;' readonly >";
                            		}
                            		else
                            		{
                            			echo "<input name='estado' id='estado' type='text' value='ANULADO' size='5' style='width:30%; background-color:#FF0000; color:white; text-align:center;' readonly >";
                            		}
                            	?>
		  
		  <input type='hidden' name='ids' id='ids' value= "<?php echo $_POST[ids]?>"></td>
