	...
	<head>
		...
		<script>
			function selexcel()
			{
				...
				switch(tipocdp)
				{
					case "1":	document.form2.action="presu-buscarpexcel.php";break;
					case "2":	document.form2.action="presu-buscarpexcelr.php";break;
					case "3":	document.form2.action="presu-buscarpexcelpr.php";break;
				}
			...
			function selpdf()
			{
				...
				switch(tipocdp)
				{
					case "1":	document.form2.action="presu-buscarppdf.php";break;
					case "2":	document.form2.action="presu-buscarppdfr.php";break;
					case "3":	document.form2.action="presu-buscarppdfpr.php";break;
				}
				document.form2.target="_BLANK";
				document.form2.submit();
				document.form2.action="";
        ...
        <table>
 		...
 		<form name="form2" method="post" action="presu-buscarp.php">
             	...
             	<div class="tab">
                    ...
                    <div class="content" style="overflow-x:hidden;">    
						<?php
                            ...
                            $sqlr="SELECT TB1.* FROM pptorp TB1 WHERE TB1.estado<>'' $crit1 $crit2 $crit3 AND tipo_mov='201' ORDER BY TB1.consvigencia DESC";
                            ...
                            while ($row =mysql_fetch_row($resp)) 
                            {
                                ...
                                $sqlr2="select pptocdp.objeto from pptocdp where pptocdp.consvigencia=$row[2] and pptocdp.vigencia=$row[0] and tipo_mov='201' ";
                                $resp2 = mysql_query($sqlr2,$linkbd);
                                $r2 =mysql_fetch_row($resp2);
                                $sqlr3="select concepto from pptocomprobante_cab where tipo_comp='7' and vigencia='$row[0]' and numerotipo='$row[1]'";
                                $resp3 = mysql_query($sqlr3,$linkbd);
                                $r3 =mysql_fetch_row($resp3);
                                echo "
                               <tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\"
			onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"location.href='presu-rpver.php?is=$row[1]&vig=$row[0]'\" style='text-transform:uppercase; $estilo' >
                                    <td>$row[0]</td>
                                    <td>$row[1]</td>
                                    <td>$row[2]</td>
                                    <td>$r2[0]</td>
                                    ...
                                    <td style='text-align:center;'><a href='presu-rpver.php?is=$row[1]&vig=$row[0]'><img src='imagenes/lupa02.png' style='width:18px' class='icoop' title='Ver'></a></td>
                                </tr>";
                                 $con+=1;
                                 $aux=$iter;
                                 $iter=$iter2;
                ...
                <div class="tab">
                    ...
                    <div class="content" style="overflow-x:hidden;"> 
                    	<?php
							$sqlr="SELECT TB1.*,(select valor FROM pptorp TB2 where TB2.consvigencia=TB1.consvigencia AND TB2.tipo_mov='201' AND TB2.vigencia = TB1.vigencia ) FROM pptorp TB1 WHERE TB1.estado='R' AND TB1.tipo_mov='401' $crit1 $crit2 $crit3 ORDER BY TB1.consvigencia DESC";
                           // echo $sqlr;
                            $resp = mysql_query($sqlr,$linkbd);
                            $ntr = mysql_num_rows($resp);
                            $con=1;
                            ...
                            while ($row =mysql_fetch_row($resp)) 
                            {
								$sqlr1="SELECT sum(saldo) from pptorp_detalle where consvigencia='$row[1]' and vigencia='$row[0]' and tipo_mov like '4%' ";
			...
			onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"location.href='presu-rpver.php?is=$row[1]&vig=$row[0]'\" style='text-transform:uppercase; $estilo' >
                                    ...
                                    <td style='text-align:center;'><img src='imagenes/lupa02.png' class='icoop'  style='width:18px' title='Ver' onClick=\"location.href='presu-cdpver.php?is=$row[2]&vig=$row[1]'\"/></td>
                                </tr>";
                                $con+=1;
                                $aux=$iter;
                                $iter=$iter2;
            	...
            	<div class="tab">
                    ...
                    <div class="content" style="overflow-x:hidden;"> 
                    	<?php
						  $sqlr="SELECT TB1.* FROM pptorp TB1 WHERE TB1.estado='R' AND TB1.tipo_mov='402' $crit1 $crit2 $crit3 ORDER BY TB1.consvigencia DESC";
