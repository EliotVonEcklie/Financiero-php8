...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script> 
			function ponprefijo(pref,opc,tipoDoc,nombrerazonsocial){ 
			//alert(pref);
				var tipodocumento='';
			...
			$iter2='saludo2';
			 while ($row =mysql_fetch_row($resp)) 
			 {
			   if ($row[11]=='31')
			   {
				 ...
				 echo"<tr class='$iter' onClick=\"javascript:ponprefijo('$row[12]','$ntercero','$row[11]','$row[5]')\" onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" >
				 		<td>$con</td>
