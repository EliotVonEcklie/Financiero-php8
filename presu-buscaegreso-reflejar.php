			...
			$iter2='saludo2';
 			while($row =mysql_fetch_row($resp)){
				...
				if ($row[13]=='N')
		 		...
		 		echo "<tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor; this.style.backgroundColor='#40b3ff';\" onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase;cursor:pointer' onDblClick=\"window.open('presu-egreso-reflejar.php?idr=$row[0]','_self');\">
					<td>$row[0]</td>
					...
					<td style='text-align:center;'><img $imagen style='width:16px'></td>";
	 				...
	 				if ($row[13]=='P' || $row[13]=='N')
	 					echo "<td></td>";
	 				echo "<td style='text-align:center;'>
						<a href='presu-egreso-reflejar.php?idr=$row[0]'><img src='imagenes/buscarep.png'></a>
					</td>
				</tr>";
	 			$con+=1;
				$aux=$iter;
