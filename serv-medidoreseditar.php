	...
	<head>
		...
		<script>
			...
			function guardar()
			{
				...
				else {despliegamodalm('visible','2','Falta información para Modificar el Medidor');}
			}
		...
		<form name="form2" method="post" action="">
			<?php
				if(@ $_POST['oculto']=="")
				{
					...
					$_POST['minimo']=$r[0];
					$_POST['maximo']=$r[1];
					$sqlr="SELECT * FROM srvmedidores WHERE id='".$_GET['idban']."'";
					...
					$_POST['vrefe']=$row[5];
					$_POST['vdiam']=$row[6];
					$_POST['fecha']=date('d/m/Y',strtotime($row[7]));
					$_POST['onoffswitch']=$row[8];
				}
			?>
			<table class="inicio">
				<tr>
					<td class="titulos" colspan="8">.: Editar Medidores</td>
				...
				<tr>
					...
					<td colspan="5"><input type="text" name="nomban" id="nomban" value="<?php echo @ $_POST['nomban'];?>" style="width:100%;height:30px;text-transform:uppercase"/></td>
				</tr>
				<tr>
					<td class="tamano01" style="width:3cm;">Fabricante:</td>
					<td><input type="text" name="vfabri" id="vfabri" onKeyUp="return tabular(event,this)" value="<?php echo @ $_POST['vfabri'];?>" style="width:100%;height:30px;"/></td>
					<td class="tamano01" style="width:3cm;">Marca:</td>
					<td style="width:15%;"><input type="text" name="vmarca" id="vmarca" onKeyUp="return tabular(event,this)" value="<?php echo @ $_POST['vmarca'];?>" style="width:100%;height:30px;"/></td>
					<td class="tamano01" style="width:3cm;">Serial:</td>
					<td colspan="3"><input type="text" name="vserial" id="vserial" onKeyUp="return tabular(event,this)" value="<?php echo @ $_POST['vserial'];?>" style="width:100%;height:30px;"/></td>
				</tr>
				<tr>
					<td class="tamano01" style="width:3cm;">Referencia:</td>
					<td><input type="text" name="vrefe" id="vrefe" onKeyUp="return tabular(event,this)" value="<?php echo @ $_POST['vrefe'];?>" style="width:100%;height:30px;"/></td>
					<td class="tamano01" style="width:3cm;">diametro:</td>
					<td style="width:15%;"><input type="text" name="vdiam" id="vdiam" onKeyUp="return tabular(event,this)" value="<?php echo @ $_POST['vdiam'];?>" style="width:100%;height:30px;"/></td>
					<td class="tamano01" style="width:3cm;">Activaci&oacute;n:</td>
					<td><input type="text" name="fecha" value="<?php echo @ $_POST['fecha'];?>" maxlength="10" onKeyUp="return tabular(event,this)"  id="fc_1198971545" onKeyDown="mascara(this,'/',patron,true)" title="DD/MM/YYYY" style="height:30px;" readonly/>&nbsp;<a href="#" onClick="displayCalendarFor('fc_1198971545');" title="Calendario"><img src="imagenes/calendario04.png" style="width:25px;"></a></td>
			...
			<?php
				if(@ $_POST['oculto']=="2")
				{
					...
					$sqlr ="UPDATE srvmedidores SET fabricante='".$_POST['vfabri']."',marca='".$_POST['vmarca']."', serial='".$_POST['vserial']."',referencia='".$_POST['vrefe']."',diametro='".$_POST['vdiam']."', fecha_activacion='$fechaf',estado='$valest' WHERE id='".$_POST['codban']."'";
