	...
	<head>
		...
		<script>
			...
			function detallesnomina(id, radicado)
			{
				...
				var toLoad= 'informacion/ventanasnomina/hum-detallesliquidarnom.php';
        ...
        <div id="bgventanamodalm" class="bgventanamodalm">
 		...
 		<form name="form2" method="post" action=""> 
            ...
            <?php
				...
				if($_POST[idpreli]!="-1"){$_POST[tipo02]=estadotipoprenimina($_POST[idpreli],$_POST[tprimnav]);}
			?>
					...
					while ($row =mysql_fetch_row($resp)) 
	 				{
						...
						if($_POST[tipo02]=='S')
						{
							$sqlrprn="SELECT valprima FROM hum_preprima_det WHERE codigo='$_POST[idpreli]' AND documefun='$row[7]' AND tipoprima= '$_POST[tprimnav]'";
							$resprn = mysql_query($sqlrprn,$linkbd);
							$rowprn =mysql_fetch_row($resprn);
							$primanavi=$rowprn[0];
							$pf[$_POST[tprimnav]][$row[13]]+=$primanavi;
							$sqlrt="select cuentapres from humvariables_det where codigo='$_POST[tprimnav]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
							$resrp = mysql_query($sqlrt,$linkbd);
							$rowrp =mysql_fetch_row($resrp);
							$pfcp[$rowrp[0]]+=$primanavi;
						}
						else{$primanavi=0;}
						
						//salario Dev Incapasidades
						if($row[16]>0)
						{
							$sqlrin="SELECT SUM(dias_inca),SUM(valor_total),pagar_ibc,pagar_arl,pagar_para FROM hum_incapacidades_det WHERE mes='$row[2]' AND vigencia='$row[3]' AND doc_funcionario='$row[7]' AND estado='S'";
						...
						//salario Dev vacaciones
						if($row[17]>0)
						{ 
							$sqlrva="SELECT SUM(dias_vaca),SUM(valor_total),pagar_ibc,pagar_arl,pagar_para FROM hum_vacaciones_det WHERE mes='$row[2]' AND vigencia='$row[3]' AND doc_funcionario='$row[7]' AND estado='S'";
						...
						if($row[6]<=$_POST[balim])
						{
							$sqlrest="SELECT COUNT(*) FROM hum_restricciones WHERE documento='$row[7]' AND tipo_rest='AXAL' AND estado='S'";
							$resprest = mysql_query($sqlrest,$linkbd);
							$rowrest =mysql_fetch_row($resprest);
							if($rowrest[0]==0 || $rowrest[0]==''){$auxalim=round(($_POST[alim]/30)*$row[15],0);}
							else {$auxalim=0;}
						}
						else{$auxalim=0;}
						...
						$valotrospagos=0;
						$totaldevengado=round ($saldev+$auxalim+$auxtra+$valotrospagos+$primanavi,0,PHP_ROUND_HALF_DOWN);
						...
						if($_POST[salrioaux]==1)
						{
							...
							else
							{
								...
								{
									//salarios
									if($_POST[redondeoibc]==1){$ibcnomina1=ceil(($saldev+$auxalim2-$saldevb)/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcnomina1=$saldev+$auxalim-$saldevb;}
									if($_POST[redondeoibcarp]==1){$ibcarp1=ceil(($saldev+$auxalim-$saldevb)/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcarp1=$saldev+$auxalim-$saldevb;}
									if($_POST[redondeoibcpara]==1){$ibcpara1=ceil(($saldev+$auxalim-$saldevb)/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcpara1=$saldev+$auxalim-$saldevb;}
									//vacaciones
						...
						else
						{
							...
							else
							{
								if($_POST[nivelredondeo]==0)
								{
									...
									else {$ibcnomina1=round($saldev,0);}
									if($_POST[redondeoibcarp]==1){$ibcarp1=ceil($saldev/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcarp1=round($saldev,0);}
									if($_POST[redondeoibcpara]==1){$ibcpara1=ceil($saldev/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcpara1=round($saldev,0);}
									//vacaciones
									if($_POST[redondeoibc]==1){$ibcnomina2=ceil($saldevc1/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcnomina2=round($saldevc1,0);}
									if($_POST[redondeoibcarp]==1){$ibcarp2=ceil($saldevc2/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcarp2=round($saldevc2,0);}
									if($_POST[redondeoibcpara]==1){$ibcpara2=ceil($saldevc3/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcpara2=round($saldevc3,0);}
									//incapacidad
									if($_POST[redondeoibc]==1){$ibcnomina3=ceil($saldevb1/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcnomina3=round($saldevb1,0);}
									if($_POST[redondeoibcarp]==1){$ibcarp3=ceil($saldevb2/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcarp3=round($saldevb2,0);}
									if($_POST[redondeoibcpara]==1){$ibcpara3=ceil($saldevb3/$_POST[tiporedondeoibc2])*$_POST[tiporedondeoibc2];}
									else {$ibcpara3=round($saldevb3,0);}
								}
								else
								{
									//salarios
						...
						$sqlrt="select * from humparafiscales_det where codigo='$_POST[tarp]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						$pfcp[$rowrp[6]]+=$valarp;
						//**Salud
						...
						else
						{
							...
							$rsaludemp3=$valsaludtot3-$rsalud3;
							//total
						...
						$sqlrt="select * from humparafiscales_det where codigo='$_POST[tsaludemr]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						...
						if($row[11]!='')
						{
							...
							$sqlrt="select * from humparafiscales_det where codigo='$_POST[tpensionemr]' and cc='$row[13]' and estado='S' and sector='$tpf' and vigencia='$row[3]'";
							$resrp = mysql_query($sqlrt,$linkbd);
							$rowrp =mysql_fetch_row($resrp);
						...
						if($_POST[tipoliquidacion]==0){$valccf=ceil(($ibcpara*$porcentaje)/10000)*100;}
						else
						{
						...
						$sqlrt="select * from humparafiscales_det where codigo='$_POST[tcajacomp]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						$pfcp[$rowrp[6]]+=$valccf;
						//**SENA
						$porcentaje=buscaporcentajeparafiscal($_POST[tsena],'A');
						if($_POST[tipoliquidacion]==0){$valsena=ceil(($ibcpara*$porcentaje)/10000)*100;}
						else
						{
						...
						$sqlrt="select * from humparafiscales_det where codigo='$_POST[tsena]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						$pfcp[$rowrp[6]]+=$valsena;
						//**ICBF
						$porcentaje=buscaporcentajeparafiscal($_POST[ticbf],'A');
						if($_POST[tipoliquidacion]==0){$valicbf=ceil(($ibcpara*$porcentaje)/10000)*100;}
						else
						{
						...
						$sqlrt="select * from humparafiscales_det where codigo='$_POST[ticbf]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						$pfcp[$rowrp[6]]+=$valicbf;
						//**INSTITUTOS TECNICOS
						$porcentaje=buscaporcentajeparafiscal($_POST[titi],'A');
						if($_POST[tipoliquidacion]==0){$valinstec=ceil(($ibcpara*$porcentaje)/10000)*100;}
						else
						{
						...
						$sqlrt="select * from humparafiscales_det where codigo='$_POST[titi]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						$pfcp[$rowrp[6]]+=$valinstec;
						//**ESAP
						$porcentaje=buscaporcentajeparafiscal($_POST[tesap],'A');
						if($_POST[tipoliquidacion]==0){$valesap=ceil(($ibcpara*$porcentaje)/10000)*100;}
						else
						{
						...
						$sqlrt="select * from humparafiscales_det where codigo='$_POST[tesap]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						...
						//**Neto a Pagar
						$totalneto= $totaldevengado-$totalretenciones+$primanavi;
						
						$listaprimasnavidad[]=$primanavi;
						...
						//**devengado
						$sqlrt="select * from  humvariables_det where codigo='$_POST[tsueldo]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						$pfcp[$rowrp[7]]+= $saldev; 
						//**alimentacion
						$sqlrt="select * from  humvariables_det where codigo='$_POST[tsubalim]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);
						$pfcp[$rowrp[7]]+= $auxalim;
						//**transporte
						$sqlrt="select * from  humvariables_det where codigo='$_POST[tauxtrans]' and cc='$row[13]' and estado='S' and vigencia='$row[3]'";
						$resrp = mysql_query($sqlrt,$linkbd);
						$rowrp =mysql_fetch_row($resrp);								
						$pfcp[$rowrp[7]]+= $auxtra;	
					}
	   				...
	   				<div class="content" >
						<table class='inicio' align='center' width='99%'>
                            ...
                            <tr>
                                ...
                                <?php if($_POST[tipo02]=='S'){echo"<td class='titulos2'>PRIMA NAV</td>";}?>
                            ...
                            <?php
								...
								for ($x=0;$x<count($listaempleados);$x++)
								{
									...
									{
										echo"
										<td style='text-align:right;' title='Prima Navidad'>$".number_format($listaprimasnavidad[$x],0,',','.')."</td>";
									}
									echo"
								...
								echo"
							<input type='hidden' name='lista_primanavidad' value='".serialize($listaprimasnavidad)."'/>
							...
							if($_POST[tipo02]=='S')
							{echo"<td style='text-align:right;'>$".number_format(array_sum($listaprimasnavidad),0,',','.')."</td>";}	
							echo"<td style='text-align:right;'>$".number_format(array_sum($listaotrospagos),0,',','.')."</td>
				...
				if($_POST[oculto]==2)
				{
					...
					else
					{
						...
						while ($rowrpn =mysql_fetch_row($resrpn)) 
						{
							...
							$numcc=buscaccnomina("$rowrpn[7]");
							$perpagoi="$rowcn[1]-$rowcn[0]-01";
							$fechar = new DateTime($perpagoi);
							$fechar->modify('last day of this month');
							$fechat=$fechar->format('Y-m-d');
							$perpagof=$fechat;
							$cupres1=buscavariablepago('01',$numcc);
							$cupres2=buscavariablepago('07',$numcc);
							$sqlry1="INSERT INTO hum_salarios_nom (id_list,id_nom,tercero,cc,cuentap,valorneto,valordevengado,fecha,periodopagoi, periodopagof,tipo_item,estado,tipo_mov) VALUES ('$idlist','$id','$rowrpn[7]','$numcc','$cupres1','$listanetoapagar[$x]','$listadevengados[$x]','', '$perpagoi','$perpagof','SL','S','201')";
							$respy1=mysql_query($sqlry1,$linkbd);
							$rowy1=mysql_fetch_row($respy1);
							if($listaauxalimentacion[$x]>0)
							{
								$idlist=selconsecutivo('hum_salarios_nom','id_list');
								$sqlry2="INSERT INTO hum_salarios_nom (id_list,id_nom,tercero,cc,cuentap,valorneto,valordevengado,fecha, periodopagoi,periodopagof,tipo_item,estado,tipo_mov) VALUES ('$idlist','$id','$rowrpn[7]','$numcc','$cupres2','$listaauxalimentacion[$x]', '$listaauxalimentacion[$x]','','$perpagoi','$perpagof','AA','S','201')";
								$respy2=mysql_query($sqlry2,$linkbd);
								$rowy2=mysql_fetch_row($respy2);
							}
							$sqlr="insert into humnomina_det (id_nom,cedulanit,salbas,diaslab,devendias,ibc,auxalim,auxtran,valhorex, totaldev,salud,saludemp,pension,pensionemp,fondosolid,retefte,otrasdeduc,totaldeduc,netopagar,estado,vac,diasarl,cajacf,sena,icbf,instecnicos,esap, tipofondopension,basepara,basearp,arp,totalsalud,totalpension,prima_navi) values ('$id','$rowrpn[7]','$listasalariobasico[$x]','$rowrpn[15]', '$listadevengados[$x]','$listaibc[$x]','$listaauxalimentacion[$x]','$listaauxtrasporte[$x]','0','$listatotaldevengados[$x]', '$listasaludempleado[$x]','$listasaludempresa[$x]','$listapensionempleado[$x]','$listapensionempresa[$x]','$listafondosolidaridad[$x]',0, '$listaotrasdeducciones[$x]','$listatotaldeducciones[$x]','$listanetoapagar[$x]','S','1','$listadiasincapacidad[$x]','$listaccf[$x]', '$listasena[$x]','$listaicbf[$x]','$listainstecnicos[$x]','$listaesap[$x]','$listatipofondopension[$x]','$listabaseparafiscales[$x]', '$listabasearp[$x]','$listaarp[$x]','$listasaludtotal[$x]','$listapensiontotal[$x]','$listaprimasnavidad[$x]')";
							...
							//************ FIN SALARIO ********
							//****** PRIMA NAVIDAD ********
							if($listaprimasnavidad[$x]!=0 && $listaprimasnavidad[$x]!="")
							{
								$sqlr="SELECT DISTINCT * FROM humvariables T1,humvariables_det T2 WHERE T1.codigo=T2.codigo AND T2.modulo=2 AND T1.codigo='$_POST[tprimnav]' AND T2.CC='$rowrpn[13]' AND T2.vigencia='$rowrpn[3]'";
								$resph=mysql_query($sqlr,$linkbd);
								while ($rowh =mysql_fetch_row($resph)) 
								{
									$ctacont=$rowh[11];	 
								...
								$sqlr="insert into humcomprobante_det (id_comp,cuenta,tercero,centrocosto,detalle,cheque,valdebito,valcredito, estado,vigencia) values ('4 $id','$ctacont','$rowrpn[7]','$rowrpn[13]','Prima de Navidad','','$listaprimasnavidad[$x]',0,'1','$rowrpn[3]')";
								mysql_query($sqlr,$linkbd);
								$sqlr="insert into humcomprobante_det (id_comp,cuenta,tercero,centrocosto,detalle,cheque,valdebito,valcredito, estado,vigencia) values ('4 $id','$ctaconcepto','$rowrpn[7]','$rowrpn[13]','Prima de Navidad','',0,'$listaprimasnavidad[$x]','1','$rowrpn[3]')";
								mysql_query($sqlr,$linkbd);
							}
							//****** FIN PRIMA NAVIDAD ********
							//****** ALIMENTACION ****
							...
							//****** FIN TRANSPORTE ****
							$sector=buscasector($rowrpn[7],$_POST[idpreli]);
							//********SALUD EMPLEADO *****
							$ctacont='';
							$ctapres='';
