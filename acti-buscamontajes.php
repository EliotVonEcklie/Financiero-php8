...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="acti-editarmontajes.php?scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&clase="+idcta;
			}
		</script>
		<script>
			...
			function funcionmensaje(){document.location.href = "acti-buscamontajes.php";}
	...
	<body>
		...
		<table>
			...
			<tr>
  				<td colspan="3" class="cinta">
	  				<a href="acti-montajes.php" class="mgbt"><img src="imagenes/add.png"  title="Nuevo" border="0" /></a>
		...
		?>
 		<form name="form2" method="post" action="acti-buscamontajes.php">
        	<?php 
				if($_POST[oculto]=="")
				{
					$_POST[cambioestado]="";
...
/*				if($_POST[cambioestado]!="")
			...
			<?php 
				...
				//if($_POST[oculto])
				{
					...
					$sqlr="SELECT * FROM acti_montajes WHERE estado='S'";
