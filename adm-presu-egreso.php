		...
		?>
				...
				<table class='inicio' id='valores' align='center'>
					<tbody>";
						...
						$sqlr="select T.id_egreso, T.concepto, T.valortotal, T.estado, D.id_orden, sum(D.valor),T.retenciones,T.id_orden from tesoegresos T, tesoordenpago_det D where T.id_orden=D.id_orden and T.estado!='R' AND T.estado!='' $queryDate group by T.id_egreso";
//echo $sqlr."<br>";						
                        ...
                        while ($row =mysql_fetch_row($resp)) 
                        {
							...
							$sq="SELECT sum(valor) FROM tesoordenpago_retenciones WHERE id_orden='$row[4]'";
