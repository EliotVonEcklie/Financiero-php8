...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<body>
        ...
        <table>
 		...
 		<form name="form2" method="post" action="presu-cdpcompara.php">
 			<?php 
			...
			<table width="100%" align="center"  class="inicio" >
                <tr>
                    <td class="titulos" colspan="9">:: Compara Cabecera - Detalle de CDP</td>
          	...
          	<div class="tabsmeci" style="height:64.5%; width:99.6%;">
             	<div class="tab">
                    ...
                    <div class="content" style="overflow-x:hidden;">        
						<?php
                            $sqlr="SELECT TB1.* FROM pptocdp TB1 WHERE TB1.estado<>'R' AND TB1.tipo_mov='201' $crit1 $crit2 $crit3  ORDER BY TB1.consvigencia DESC";
                            $resp = mysql_query($sqlr,$linkbd);
			...
			onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"location.href='presu-cdpver.php?is=$row[2]&vig=$row[1]'\" style='text-transform:uppercase; $estilo' >
                ...
                <div class="tab">
                    ...
                    <div class="content" style="overflow-x:hidden;">       
                    	<?php
							$sqlr="SELECT TB1.*,(SELECT TB2.valor FROM pptocdp TB2 WHERE TB2.consvigencia=TB1.consvigencia AND TB2.estado<>'R' AND TB2.tipo_mov='201' AND TB2.vigencia=TB1.vigencia) FROM pptocdp TB1 WHERE TB1.estado='R' AND TB1.tipo_mov='401' $crit1 $crit2 $crit3 ORDER BY TB1.consvigencia DESC";
			...
			onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"location.href='presu-cdpver.php?is=$row[2]&vig=$row[1]'\" style='text-transform:uppercase; $estilo' >
                ...
                <div class="tab">
                    ...
                    <div class="content" style="overflow-x:hidden;">    
                    	<?php
							$sqlr="SELECT TB1.*,(SELECT TB2.valor FROM pptocdp TB2 WHERE TB2.consvigencia=TB1.consvigencia AND TB2.estado<>'R' AND TB2.tipo_mov='201' AND TB2.vigencia=TB1.vigencia) FROM pptocdp TB1 WHERE TB1.estado='R' AND TB1.tipo_mov='402' $crit1 $crit2 $crit3 ORDER BY TB1.consvigencia DESC";
