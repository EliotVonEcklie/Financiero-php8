...
function guardar()
{
    ...
    <body>
        ...
        <table>
        	...
        	<tr>
          		<td colspan="3" class="cinta"><a href="presu-futinversion.php" class="mgbt"><img src="imagenes/add.png" title="Nuevo"/></a><a href="#"  onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png" title="Guardar" /></a><a href="presu-buscafutinversion.php" class="mgbt"><img src="imagenes/busca.png" title="Buscar"/></a><a href="#" onClick="mypop=window.open('presu-principal.php','','');mypop.focus();" class="mgbt"><img src="imagenes/nv.png" title="Nueva Ventana"></a><a href="presu-datosbasicosfut.php" class="mgbt"><img src="imagenes/iratras.png" title="Atr&aacute;s"></a></td>
			</tr>
        </table>
 <form name="form2" method="post" action="">
    <table class="inicio" align="center" width="80%" >
      <tr>
        <td class="titulos" colspan="4" style='width:93%'>.: Agregar Tipo Inversion</td><td class="cerrar" style='width:7%'><a href="presu-principal.php">Cerrar</a></td>
      </tr>
      <tr>
	  <td class="saludo1">Codigo:
        </td>
        <td><input name="codigo" type="text" value="<?php echo $_POST[codigo]?>" maxlength="100" size="30"  onKeyUp="return tabular(event,this)">
        </td>
...
if ($_POST[nombre]!="")
 {
 $nr="1";
 $sqlr="INSERT INTO pptofutinversion (codigo,nombre)VALUES ('$_POST[codigo]','".$_POST[nombre]."')";
 //echo "sqlr:".$sqlr;
