...
document.form2.action="teso-editarecaudotransferenciaprivado.php";
document.form2.submit();
}
}
</script>
...
document.form2.submit();
	...
	function iratras()
	{
		...
		location.href="teso-buscarecaudotransferenciaprivado.php?id="+idcomp;
	}
</script>
...
<table>
	...
	<tr>
  		<td colspan="3" class="cinta">
  			<a href="teso-recaudotransferenciaprivado.php" class="mgbt"><img src="imagenes/add.png" alt="Nuevo"  border="0" /></a>
  			<a href="#" onClick="guardar()" class="mgbt"><img src="imagenes/guarda.png"  alt="Guardar" /></a>
  			<a href="teso-buscarecaudotransferenciaprivado.php" class="mgbt"> <img src="imagenes/busca.png"  alt="Buscar" /></a>
...
{
	$linkbd=conectar_bd();
	$sqlr="select distinct *from tesorecaudotransferenciaprivado, tesorecaudotransferenciaprivado_det   where	  tesorecaudotransferenciaprivado.id_recaudo=$_GET[idrecaudo]  AND tesorecaudotransferenciaprivado.ID_recaudo=tesorecaudotransferenciaprivado_det.ID_recaudo and tesorecaudotransferenciaprivado_det.id_recaudo=$_GET[idrecaudo]";	
	$res=mysql_query($sqlr,$linkbd);
	$cont=0;
	//echo $sqlr;
...
{	 
	...
	$sqlr="select distinct *from tesorecaudotransferenciaprivado, tesorecaudotransferenciaprivado_det   where	  tesorecaudotransferenciaprivado.id_recaudo=$_POST[idcomp]  AND tesorecaudotransferenciaprivado.ID_recaudo=tesorecaudotransferenciaprivado_det.ID_recaudo and tesorecaudotransferenciaprivado_det.id_recaudo=$_POST[idcomp]";	
	$res=mysql_query($sqlr,$linkbd);
	$cont=0;
	//echo $sqlr;
	//$_POST[idcomp]=$_GET[idrecaudo];	
    ...
    <table class="inicio" align="center" >
        ...
        <tr>
      	...
      	<tr>
        	...
        	<td style="width:10%;">
        		<input name="tercero" type="text" value="<?php echo $_POST[tercero]?>" onKeyUp="return tabular(event,this)" style="width:70%;" onBlur="buscater(event)">
	  	...
	  	<tr>
	  		...
	  		<td style="width:20%;" colspan="3">
	  			<input type="text" id="codingreso" name="codingreso" value="<?php echo $_POST[codingreso]?>" onKeyUp="return tabular(event,this)" onBlur="buscaing(event)" style="width:10%;"> 
	    		...
	    		<input name="ningreso" type="text" id="ningreso" value="<?php echo $_POST[ningreso]?>" style="width:80%;" readonly>
	    	</td> 
     ...
     <div class="subpantalla">
	   	<table class="inicio">
			...
			<tr>
				...
				<td class="titulos2" style='width:5%;'>
...
if($_POST[oculto]=='2')
{
	...
	$sqlr="delete from tesorecaudotransferenciaprivado where id_recaudo='$consec'";
	mysql_query($sqlr,$linkbd);
	
	$sqlr="delete from tesorecaudotransferenciaprivado_det where id_recaudo='$consec'";
	mysql_query($sqlr,$linkbd);

			  
	$sqlr="insert into tesorecaudotransferenciaprivado (id_recaudo,idcomp,fecha,vigencia,banco,ncuentaban,concepto,tercero,cc,valortotal,estado,medio_pago) values($consec,$idcomp,'$fechaf',".$vigusu.",'$_POST[ter]','$_POST[cb]','".strtoupper($_POST[concepto])."','$_POST[tercero]','$_POST[cc]','$_POST[totalc]','S','$_POST[medioDePago]')";
	mysql_query($sqlr,$linkbd);
	...
	for($x=0;$x<count($_POST[dcoding]);$x++)
	{
		$sqlr="insert into tesorecaudotransferenciaprivado_det (id_recaudo,ingreso,valor,estado) values($consec,'".$_POST[dcoding][$x]."',".$_POST[dvalores][$x].",'S')";
		if (!mysql_query($sqlr,$linkbd))
		{
