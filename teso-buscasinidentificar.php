...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	...
	<table>
		...
		<tr>
	  		<td colspan="3" class="cinta">
	  			<a href="teso-sinidentificar.php" class="mgbt">
	...
	<form name="form2" method="post" action="teso-buscasinidentificar.php">
		...
		<table  class="inicio" align="center" >
			<tr>
				<td class="titulos" colspan="6">:. Buscar Ingresos sin Identificar</td>
		...
		<div class="subpantallap">
			<?php
				...
				if($_POST[oculto]==2)
				{
					...
					$sqlr="select *from tesosinidentificar where tesosinidentificar.id_RECAUDO>-1 AND tipo_mov='201' ".$crit1.$crit2." order by tesosinidentificar.id_RECAUDO desc";
					...
					echo "<table class='inicio' align='center' >
							...
							while ($row =mysql_fetch_row($resp)) 
							{
								...
								echo "<tr class='$iter' onMouseOver=\"anterior=this.style.backgroundColor; this.style.backgroundColor='#40b3ff';\"	onMouseOut=\"this.style.backgroundColor=anterior\" onDblClick=\"verUltimaPos($row[0])\" style='text-transform:uppercase; $estilo' >
										...
										echo "<td><a href='teso-editasinidentificar.php?idrecaudo=$row[0]'><center><img src='imagenes/lupa02.png' style='width:18px;'></center></a></td>
									</tr>";
								 	$con+=1;
								 	$aux=$iter;
								 	$iter=$iter2;
