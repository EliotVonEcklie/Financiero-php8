...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		{   
			...
			parent.document.getElementById(''+nfoco).blur() ;
			parent.despliegamodal2("hidden");
			if (parent.document.getElementById(tvalsub).value == 'SI')
		...
		<form name="form2" method="post">
			<?php
				if($_POST[oculto]==""){$_POST[numpos]=0;$_POST[numres]=10;$_POST[nummul]=0;}
          		$_POST[tobjeto]=$_GET[objeto];$_POST[tnobjeto]=$_GET[nobjeto];$_POST[tnfoco]=$_GET[nfoco];$_POST[tvalsub]=valsub;
         	 ?>
			...
			<input type="hidden" name="tvalsub" id="tvalsub" value="<?php echo $_POST[tvalsub]?>"/>
            <input type="hidden" name="numres" id="numres" value="<?php echo $_POST[numres];?>"/>
            <input type="hidden" name="numpos" id="numpos" value="<?php echo $_POST[numpos];?>"/>
            <input type="hidden" name="nummul" id="nummul" value="<?php echo $_POST[nummul];?>"/>
            <div class="subpantalla" style="height:83.5%; width:99.3%; overflow-x:hidden;">
				<?php
					$crit1=" ";
					if ($_POST[nombre]!="")
					...
					$sqlr="SELECT * FROM terceros WHERE estado='S' $crit1 ORDER BY apellido1,apellido2,nombre1,nombre2 LIMIT $_POST[numpos],$_POST[numres]";
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
