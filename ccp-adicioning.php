...
function verep(idfac)
{
  ...
  document.form1.submit();
	...
	{
		document.form2.action="ccp-adicioning-import.php";
    ...
    <body >
        ...
        <table>
        	...
        	<tr>
				...
				<a href="#" class="mgbt" onClick="mypop=window.open('ccp-principal.php','','');mypop.focus();"><img src="imagenes/nv.png" title="Nueva Ventana"></a></td>
        	</tr>
        </table>
		<?php
	   			...
	   			<tr>
					...
					<td style="width:5%;" class="saludo1">Cuenta:</td>
          			<td  valign="middle" style="width:10%;">
          				<input class="colordobleclik" type="text" id="cuenta" name="cuenta" style="width:100%;" onKeyUp="return tabular(event,this)" onBlur="buscacta(event)" value="<?php echo $_POST[cuenta]?>" onClick="document.getElementById('cuenta').focus();document.getElementById('cuenta').select();" ondblclick="mypop=window.open('cuentasppto-ventana.php?ti=<?php echo $_POST[tipocta] ?>','','menubar=0,scrollbars=yes, toolbar=no, location=no, width=700px,height=500px');mypop.focus();"> 
