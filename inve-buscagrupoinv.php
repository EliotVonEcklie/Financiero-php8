...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
		...
		<script>
			function verUltimaPos(idcta, filas, filtro){
				...
				if((limreg==0)||(limreg==""))
					limreg=10;
				numpag++;
				location.href="inve-editargrupoinv.php?codigo="+idcta+"&scrtop="+scrtop+"&totreg="+filas+"&altura="+altura+"&numpag="+numpag+"&limreg="+limreg+"&filtro="+filtro;
			}
		</script>
		<script>
			function cambioswitch(id,valor)
			{
				...
				if(valor==1){despliegamodalm('visible','4','Desea Activar este Grupo de Inventario','1');}
				else{despliegamodalm('visible','4','Desea Desactivar este Grupo de Inventario','2');}
			}
	...
	<body>
		...
		?>
 		<form name="form2" method="post" action="inve-buscagrupoinv.php">
            ...
            <?php
				...
				if($_POST[cambioestado]!="")
				{
					...
					{
						$sqlr ="UPDATE almgrupoinv SET estado='S' WHERE codigo='$_POST[idestado]'";
						mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
					else 
					{
						$sqlr ="UPDATE almgrupoinv SET estado='N' WHERE codigo='$_POST[idestado]'";
						mysql_fetch_row(mysql_query($sqlr,$linkbd)); 
					}
			...
			<table  class="inicio" align="center" >
      			<tr>
        			<td class="titulos" colspan="4">:: Buscar Grupo Inventarios</td>
    		...
    		<div class="subpantalla" style="height:69.5%; width:99.6%; overflow-x:hidden;" id="divdet">
      			<?php
					...
					$sqlr="SELECT * FROM almgrupoinv $crit1 ";
					...
					$sqlr="SELECT * FROM almgrupoinv $crit1 ORDER BY codigo ".$cond2;
					$resp = mysql_query($sqlr,$linkbd);
					$con=1;
					...
					<table class='inicio' align='center' width='80%'>
						...
						<tr><td colspan='6'>Grupos de Inventario Encontrados:  $_POST[numtop]</td></tr>
						<tr>
							<td width='5%' class='titulos2'>C&oacute;digo</td>
							<td class='titulos2'>Nombre</td>
							<td class='titulos2'>Concepto Entrada Almacen</td>
					...
					$filas=1;
 					...
 					{
						$sqlr1="SELECT nombre FROM conceptoscontables WHERE codigo='$row[3]' AND modulo='5' AND tipo='AE'";
