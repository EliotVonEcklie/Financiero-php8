...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
		...
		<script>
			...
			function guardar()
			{
				var valtotal=parseInt(document.getElementById("valcontrao").value);
				var valanticipo=parseInt(document.getElementById("valantio").value);
				...
				switch(pestn)
				{
					...
					case "3":	if (document.form2.vigcontra.value!='')
								{
									if(valtotal>=valanticipo){
										if (confirm("Esta Seguro de Guardar")){document.form2.oculto.value="4";document.form2.submit();}break;
									}else{
										despliegamodalm('visible','2','EL valor total debe ser mayor que el anticipo');
									}
			...
			function despliegamodalm(_valor,_tip,mensa,pregunta)
			{
				...
				else
				{
					switch(_tip)
					{
						...
						case "5":	document.getElementById('ventanam').src="contra-verpaa.php?solicitud="+solicitud;break;
					}
				}
			}
        ...
        <table> 
            ...
            <tr>
  				<td colspan="3" class="cinta">
					...
					<a href="#" id="impre" class="mgbt"><img src="imagenes/print_off.png" title="Imprimir" style="width:30px;"/></a>
					<a><img src="imagenes/iratras.png" title="Atr&aacute;s" onClick="location.href='contra-gestioncontractual.php'" class="mgbt"/></a>
				</td>
			</tr>
        </table>
		...
		<form name="form2" method="post" enctype="multipart/form-data">  
        	<?php 
				...
				if($_POST[oculto]=="")
				{
					...
					$_POST[nproceso]=$row[0]+1;	 
					$_POST[estsemaforo1]="0";	
					$_POST[estsemaforo2]="0";
					$_POST[estsemaforo3]="0";
            ...
            <div class="tabscontra" style="height:75.6%; width:99.6%">
            	<div class="tab"> 
					<input type="radio" id="tab-1" name="tabgroup1" value="1" <?php echo $check1;?> onClick="cambiobotones('1'); cambiopestanas('1');">
               		<label for="tab-1"><img src="<?php echo $p1luzcem1;?>" width="16" height="16"><img src="<?php echo $p1luzcem2;?>" width="16" height="16"><img src="<?php echo $p1luzcem3;?>" width="16" height="16"> Datos Precontractuales</label>
 					<div class="content" style="overflow-x:hidden">
                        <table class="inicio" align="center">
                            <tr>
                                <td class="titulos" colspan="12">Datos Prescontractuales </td>
                            ...
                            <tr>
                              ...
                              <td class="saludo1" style="width:7%;" >Vigencia:</td>
                               ...
                               <td class="saludo1" <?php if($_POST[blgeneralc2]!=""){echo "style=\"display:none;\"";}?>>Finalizar Fase:</td>
                                ...
                                <td class="saludo1" <?php if($_POST[blgeneralc2]==""){echo "style=\"display:none;\"";}?>>Finalizar Fase:</td>
                                <td <?php if($_POST[blgeneralc2]==""){echo "style=\"display:none;\"";}?>>
                                   	<input type="checkbox" name="finalx" id="finalx" checked disabled> 	
                                </td>  
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="solcompra" id="solcompra" onChange="validar()" onKeyUp="return tabular(event,this)" style="width:100%"  <?php echo $_POST[blgeneral2];?>>
                                        ...
                                        <?php
                                            $sqlr="SELECT contrasoladquisiciones.codsolicitud FROM contrasoladquisiciones WHERE activo=1 AND not exists (SELECT 1 FROM contraprocesos WHERE contraprocesos.idproceso = contrasoladquisiciones.codsolicitud)  ORDER BY contrasoladquisiciones.codsolicitud";
                                            $res=mysql_query($sqlr,$linkbd);
                                            while ($row =mysql_fetch_row($res)) 
                                            {
                                                $i=$row[0];
                                                if(0==strcmp($i,$_POST[solcompra])){echo "<option value=$row[0] SELECTED>$row[0]</option>";$_POST[codigot]=$row[0]; }
                        ...
                        <table class="inicio">
                            <tr>
                                ...
                                <td colspan="2" >
                                    ...
                                    <select name="modalidad" id="modalidad" onKeyDown="return tabular(event,this)" onChange="validar1()" style="width:90%" <?php echo $_POST[blgeneral2];?>>
                                        <option  value=""  >Seleccione....</option>
                                        <?php
                                            $sqlr="SELECT * FROM dominios where nombre_dominio='MODALIDAD_SELECCION' and (valor_final is NULL or valor_final='') order by valor_inicial";
                                            $res=mysql_query($sqlr,$linkbd);
                                            while ($rowEmp = mysql_fetch_row($res)) 
                                            {
                                                $i=$rowEmp[0];
                                                if($i==$_POST[modalidad]){echo "<option value='$rowEmp[0]' SELECTED>$rowEmp[2]</option>";}
	 											else{echo "<option value='$rowEmp[0]'>$rowEmp[2]</option>";}
                                            }	
                                        ?> 
                                    </select> 
                                </td>
                                ...
                                <td  colspan="2"> 
                                    ...
                                    <select style="width:100%" name="smodalidad" id="smodalidad" onKeyUp="return tabular(event,this)" onChange="validar1()" <?php echo $_POST[blgeneral2];?>>
                                        ...
                                        <?php
                                            ...
                                            {
                                                $i=$rowEmp[0];
                                                if($i==$_POST[smodalidad]){echo "<option value='$rowEmp[0]' SELECTED>$rowEmp[2]</option>";}
												else {echo "<option value='$rowEmp[0]'>$rowEmp[2]</option>";}
                                            }	
                                        ?> 
                                    </select>
                                    ...
                                    <select name="clasecontrato" id="clasecontrato" onKeyUp="return tabular(event,this)" onChange="validar()" style="width:90%" <?php echo $_POST[blgeneral2];?>>
                                        ...
                                        <?php
                                            ...
                                            while ($rowEmp = mysql_fetch_row($res)) 
                                            {
                                                ...
                                                {
                                                    echo "<option value='$rowEmp[0]' SELECTED>$rowEmp[1]</option>";
                                                    if ($rowEmp[4]!=""){$_POST[fmtmoda]=$rowEmp[4];}
                                                    else{$_POST[fmtmoda]="";}
                                                }
                                                else{echo "<option value='$rowEmp[0]'>$rowEmp[1]</option>";}	 	 
                                            }	
                                        ?> 
                                     </select> 
                                ...
                                <td colspan="3">
                                    <?php
                                        ...
                                        if ($_POST[fmtmoda]!=""){echo "<a href='$ruta' download><img src='imagenes/descargar.png' title='(Descargar)'>".traeico($_POST[fmtmoda])."</a>";}
                                ...
                                <td> 
                                    <select name="modalidadv" id="modalidadv" disabled >
                                    	<option  value="" >Seleccione....</option>
											...
											while ($rowEmp = mysql_fetch_row($res)) 
											{
												if($rowEmp[0]==$_POST[modalidad]){echo "<option value='$rowEmp[0]' SELECTED>$rowEmp[0] - $rowEmp[2]</option>";}
												else{echo "<option value='$rowEmp[0]'>$rowEmp[0] - $rowEmp[2]</option>";}
											}	
                                        ?> 
                                   	</select>
                                </td>
                                ...
                                <td> 
                                    <select name="smodalidadv" id="smodalidadv"  disabled>
                                        ...
                                        <?php
                                            ...
                                            {
                                                $i=$rowEmp[0];
                                                if($i==$_POST[smodalidad]){echo "<option value='$rowEmp[0]' SELECTED>$rowEmp[0] - $rowEmp[2]</option>";}
												else{echo "<option value='$rowEmp[0]'>$rowEmp[0] - $rowEmp[2]</option>";}
                                            }	
                                        ?> 
                                    </select>
