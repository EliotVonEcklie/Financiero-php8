	...
	<head>
		...
		<script> 
			...
			{ 
				...
				if((pref==digitotipo || pref=='sgr-gastos' || pref=='reservas-ingresos') && pref !='deuda')  
				{
				...
				{
				parent.despliegamodalm('visible','2','La clasificacion de la  Cuenta "'+cuentasel+'" esta parametrizada como "'+pref+'" y No pertenece al Tipo de Gasto Seleccionado');
				}
			} 
		</script> 
		<?php titlepag();?>
...
onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase' onClick=\"javascript:ponprefijo('$r[0]','$r[29]','$r[1]')\">";
						}
						else
						{	
							echo"
							<tr class='$co' onMouseOver=\"anterior=this.style.backgroundColor;this.style.backgroundColor='#40b3ff';\"
onMouseOut=\"this.style.backgroundColor=anterior\" style='text-transform:uppercase' onMouseDown=\"anterior2=this.style.backgroundColor; this.style.backgroundColor='#FB1115';\" onMouseUp=\"this.style.backgroundColor=anterior2\">";
						}
						echo"
							<td>$con2</td>
    	 					<td>$r[0]</td>
